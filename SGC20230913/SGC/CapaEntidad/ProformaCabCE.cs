...
public class ProformaCabCE
{
    ...
    public List<ProformaDetCE> lProformaDet { get; set; }
    ...
    public string CodigoPedidoApp { get; set; }
    ...
    public int CodTipoMantenimiento { get; set; }
