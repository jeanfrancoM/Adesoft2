...
$(document).ready(function () {
    ...
    $("#MainContent_btnImport").click(function () {
        ...
        if ($('#lblCodPeriodo').text() === "0")
            Cadena = Cadena + '<p></p>' + "No ha especificado Periodo";            
    ...
    $('#MainContent_txtAñoMesActual').css('background', '#FFFFEE');
    ...
    $('#MainContent_txtAñoPeriodoActual').css('background', '#FFFFE0');
...
function F_Controles_Inicializar() {
    ...
    $('#MainContent_ddlRegimenLaboral').val('2');
