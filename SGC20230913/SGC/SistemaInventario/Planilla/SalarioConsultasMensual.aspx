<%@ Page Title="Consulta Salarios Mensual" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SalarioConsultasMensual.aspx.cs" EnableEventValidation="false" Inherits="SistemaInventario.Planilla.SalarioConsultasMensual" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="SalarioConsultasMensual.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class='overlay'>
        <div class="titulo">
            Consulta de Planilla Regimen Genral</div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="form-inputs" style="width: 1000px">
                                        <tr>
                                            ...
                                            <td style="display: none">
                                                ...
                                                <label id="lblDisplayPeriodo" style="font-size=14; font-weight=">
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td>
                                     <table cellpadding="0" cellspacing="0" >
                                        <tr>    
                                            ...
                                            <td>                                                
                                                <asp:DropDownList ID="ddlEstado" runat="server" Width="140px" Font-Names="Arial" ForeColor="Blue"
        ...
        <div id="div_consulta" style="padding-top: 5px;">
            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton runat="server" ID="imgPdf2" ImageUrl="~/Asset/images/pdf.png" ToolTip="Generar Version PDF"
                                OnClientClick="F_ImprimirDocumento(this.id); return false;" />
                            <%--                            <asp:ImageButton runat="server" ID="imgAnular" ImageUrl="~/Asset/images/EliminarBtn.png"
                    ...
                    <asp:BoundField DataField="AñoPeriodo" HeaderText="Periodo">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
