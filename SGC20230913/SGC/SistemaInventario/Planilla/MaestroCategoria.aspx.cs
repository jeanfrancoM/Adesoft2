...
{
    public partial class MaestroCategoria : System.Web.UI.Page
    {
        ...
        {
            Planilla_CategoriaCE objEntidad = null;
            Planilla_CategoriaCN objOperacion = null;

            DataTable dta_consulta = null;

            objOperacion = new Planilla_CategoriaCN();
            objEntidad = new Planilla_CategoriaCE();
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]);

            dta_consulta = objOperacion.F_Planilla_Categoria_Listar(objEntidad);
