...
{
    public partial class SalarioConsultas : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_ConsultaFactura()
        {
            ...
            dta_consulta.Columns.Add("AñoSemana", typeof(string));
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_Planilla_Salario_Consulta_Construccion_Civil_Detalle(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar, ref string txtEstado)
        {
            ...
            objEntidad.CodSemana = Convert.ToInt32(objTablaFiltro["Filtro_CodSemana"]);
            ...
            DataTable dtabla = (new Planilla_SalarioCN()).F_Planilla_Salario_Consulta_Construccion_Civil(objEntidad);
        ...
        [WebMethod]
        public static Planilla_SalarioCE P_Eliminar_Carga_Excel_PlanillaRCC(int CodSemana)
        {
            Planilla_SalarioCE objEntidad = new Planilla_SalarioCE();
            objEntidad.CodSemana = CodSemana;
            return (new Planilla_SalarioCN()).F_Eliminar_Carga_Excel_PlanillaRCC(objEntidad);

        }
        [WebMethod]
        public static Planilla_SalarioCE P_Confirmar_Pago_PlanillaRCC(int CodSemana)
        {
            Planilla_SalarioCE objEntidad = new Planilla_SalarioCE();
            objEntidad.CodSemana = CodSemana;
            return (new Planilla_SalarioCN()).F_Confirmar_Pago_PlanillaRCC(objEntidad);
