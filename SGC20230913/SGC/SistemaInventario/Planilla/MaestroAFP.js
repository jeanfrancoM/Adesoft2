var AppSession = "../Planilla/MaestroAFP.aspx";
var CodigoMenu = 8000;
...
function F_GrabarDocumento() {
    ...
    var objEntidad = {};
    objEntidad["CodAFP"] = $("#hfCodigo").val();
    ...
    $.ajax({
        ...
        url: '../Servicios/DatosPlanilla_AFP.asmx/F_AFP_Actualizar',
...
function F_EliminarRegistro(Fila) {
    ...
    try {
        ...
        var objEntidad = {};
        objEntidad["CodAFP"] = $(hfCodLinea).val();

        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '../Servicios/DatosPlanilla_AFP.asmx/F_AFP_Eliminar',
            data: JSON.stringify(objEntidad),
            dataType: "json",
            async: false,
            success: function (dbObject) {
