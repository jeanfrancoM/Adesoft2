var AppSession = "../Planilla/MaestroProyecto.aspx";
var CodigoMenu = 8000;
var CodigoInterno = 30;
$(document).ready(function () {
    ...
    $('#MainContent_txtDescuentoSindical').css('background', '#FFFFE0');
    $('#MainContent_txtDescripcionEdicion').css('background', '#FFFFE0');
    $('#MainContent_txtDescuentoSindicalEdicion').css('background', '#FFFFE0');
...
function F_Controles_Inicializar() {
    ...
    utF_Conceptos_Combos('#MainContent_ddlEstadoProceso', 116);
    utF_Conceptos_Combos('#MainContent_ddlEstadoProcesoEdicion', 116);
...
function F_ValidarGrabarDocumento() {
    try {
        ...
        if ($(Cuerpo + 'txtDescuentoSindical').val() == '')
            Cadena = Cadena + '<p></p>' + 'Descuento Sindical';
...
function F_GrabarDocumento() {
    ...
    var objEntidad = {};
    objEntidad["CodProyecto"] = $("#hfCodigo").val();
    objEntidad["Descripcion"] = $('#MainContent_txtDescripcion').val().trim();
    objEntidad["DescuentoSindical"] = $('#MainContent_txtDescuentoSindical').val().trim();
    objEntidad["CodEstado"] = Number($('#MainContent_ddlEstado').val());
    objEntidad["CodEstadoProceso"] = Number($('#MainContent_ddlEstadoProceso').val());
    objEntidad["RegistroOperacion"] = "Insert";

    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '../Servicios/DatosPlanilla_Proyecto.asmx/F_Proyecto_Actualizar',
...
function F_Nuevo() {
    ...
    $(Contenedor + 'txtDescuentoSindical').val('');
...
function F_EliminarRegistro(Fila) {
    ...
    try {
        ...
        var objEntidad = {};
        objEntidad["CodProyecto"] = $(hfCodLinea).val();

        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '../Servicios/DatosPlanilla_Proyecto.asmx/F_Proyecto_Eliminar',
            data: JSON.stringify(objEntidad),
            dataType: "json",
            async: false,
            success: function (dbObject) {
...
function F_EditarRegistro(Fila) {
    try {
        ...
        var hfDescuentoSindical = '#' + imgID.replace('imgEditarRegistro', 'lblDescuentoSindical');
        ...
        $(Cuerpo + 'txtDescuentoSindicalEdicion').val($(hfDescuentoSindical).text());
...
function F_EdicionRegistro() {
    ...
    objEntidad["DescuentoSindical"] = $('#MainContent_txtDescuentoSindicalEdicion').val().trim();
    objEntidad["CodEstado"] = Number($('#MainContent_ddlEstadoProcesoEdicion').val());
...
function F_ValidarEdicionDocumento() {
    try {
        ...
        if ($(Cuerpo + 'txtDescuentoSindicalEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Descripcion';
