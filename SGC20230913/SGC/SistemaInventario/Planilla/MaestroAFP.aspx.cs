...
{
    public partial class MaestroAFP : System.Web.UI.Page
    {
        ...
        {
            Planilla_AFPCE objEntidad = null;
            Planilla_AFPCN objOperacion = null;

            DataTable dta_consulta = null;

            objOperacion = new Planilla_AFPCN();
            objEntidad = new Planilla_AFPCE();
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]);

            dta_consulta = objOperacion.F_Planilla_AFP_Listar(objEntidad);
