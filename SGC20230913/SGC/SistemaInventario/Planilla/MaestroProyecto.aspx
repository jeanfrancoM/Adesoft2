<%@ Page Title="Proyecto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="MaestroProyecto.aspx.cs" Inherits="SistemaInventario.Planilla.MaestroProyecto"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="MaestroProyecto.js"
        charset="UTF-8"></script>
                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDescuentoSindical" runat="server" Width="350px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div id="div1">
                                    <asp:DropDownList ID="ddlEstadoProceso" runat="server" Font-Names="Arial" ForeColor="Blue"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="ELIMINAR Proyecto" OnClientClick="F_EliminarRegistro(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif"
                                    ToolTip="EDITAR Proyecto" OnClientClick="F_EditarRegistro(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Descripcion" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfID" runat="server" Value='<%# Bind("CodProyecto") %>' />
                                <asp:HiddenField ID="hfCodEstado" runat="server" Value='<%# Bind("CodEstado") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Descuento Sindical" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblDescuentoSindical" Text='<%# Bind("DescuentoSindical") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDescuentoSindicalEdicion" runat="server" Width="250" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan='3'>
                            <div id="div2">
                                <asp:DropDownList ID="ddlEstadoProcesoEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
