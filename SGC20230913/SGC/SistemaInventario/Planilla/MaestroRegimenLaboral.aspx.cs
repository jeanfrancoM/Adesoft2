...
{
    public partial class MaestroRegimenLaboral : System.Web.UI.Page
    {
        ...
        private string _menu = "8000"; private string _opcion = "10";
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("Descripcion2", typeof(string));
        ...
        {
            Planilla_RegimenLaboralCE objEntidad = null;
            Planilla_RegimenLaboralCN objOperacion = null;

            DataTable dta_consulta = null;

            objOperacion = new Planilla_RegimenLaboralCN();
            objEntidad = new Planilla_RegimenLaboralCE();
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]);

            dta_consulta = objOperacion.F_Planilla_RegimenLaboral_Listar(objEntidad);
