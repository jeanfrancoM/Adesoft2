                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="chkMantenerCliente" runat="server" Text="Mantener Proveedor fijado"
                                                Font-Bold="True" />
                                        </td>
                                        <td>
                   ...
                   <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                        ...
                        <tr>
                           ...
                           <td style="font-weight: bold;">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="1060px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                        </tr>
                        </table>
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEditar" ImageUrl="~/Asset/images/btnEdit.gif"
                                    ToolTip="EDICION PAGOS" OnClientClick="F_EditarMedioPago(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="ELIMINAR PAGOS" OnClientClick="F_AnularPopUP(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                      ...
                      <asp:BoundField DataField="Deuda" HeaderText="Deuda" DataFormatString="{0:N2}">
                        ...
                        <asp:BoundField DataField="Operacion" HeaderText="Operacion" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        ...
                        <%--<asp:BoundField DataField="NroRecibo" HeaderText="Recibo" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>--%>
            ...
            <div id="div_Eliminados" style="padding-top: 5PX;">
                <asp:GridView ID="grvEliminado" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <asp:TemplateField HeaderText="O">
                            <ItemTemplate>
                                <img id="imgMasObservacion" alt="" style="cursor: pointer" src="../Asset/images/plus.gif"
                                    onclick="imgMasObservacionEliminados_Click(this);" title="OBSERVACIONE" />
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-left: 2px;" colspan='3'>
                                    <asp:TextBox ID="txtNroOperacionEdicion" runat="server" Width="180px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                 <td style="font-weight: bold; padding-left: 5px; display: none;">
                                    Recibo
                ...
                <tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-left: 2px;" colspan='3'>
                                    <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="372px" Height="120px" TextMode="MultiLine"
                                        Font-Names="Arial" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
