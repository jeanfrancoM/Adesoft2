...
{
    public partial class LetrasCompras : System.Web.UI.Page
    {
        ...
        private string _menu = "6000"; private string _opcion = "3";
        ...
        public void P_Obtener_NumeroCorrelativo(Hashtable objTablaFiltro, ref String Numero)
        {
            ...
            objEntidad.CodAlmacen = Convert.ToInt32(objTablaFiltro["Filtro_CodEmpresa"]);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlFormaPago, ref ddlBanco);
        ...
        public String F_AgregarLetraTemporal_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Cargar_Grilla_Letras(obj_parametros, ref grvLetra, ref Total);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
            ref DropDownList ddl_comboformapago, ref DropDownList ddl_combobanco)
        {
