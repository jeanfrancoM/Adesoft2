...
namespace SistemaInventario.CuentasPorPagar
{
    public partial class RegistroPagos : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlMedioPago, ref ddlBanco, ref ddlBancoEdicion, ref ddlFiltroMoneda,
                    ref ddlCajaFisica, ref ddlMedioPagoConsulta, ref ddlCajaFisicaConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlEmpresaConsulta2, ref ddltipodoc2,
                    ref ddlEmpresaConsulta3, ref ddlMedioPagoConsulta2, ref ddlAlmacenDetallado2, ref ddlCobrador);
            ...
            str_ddltipodoc_html + "~" +//20
            str_ddltipodoc2_html + "~" +//21
            str_ddlEmpresaConsulta3_html + "~" + //22
            str_ddlMedioPagoConsulta2_html + "~" +//23
            str_ddlAlmacenDetallado2_html + "~" + //24
            str_ddlCobrador_html; //25
        ...
        protected void grvEliminado_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                GridView grvEliminado = null;
                GridView grvDetalleObservacionE = null;
                GridView grvDetalleAuditoria = null;
                //GridView grvEliminadosObservacion = null;
                HiddenField lblCodigo = null;
                grvEliminado = (GridView)(e.Row.FindControl("grvDetalleEliminado"));
                grvDetalleObservacionE = (GridView)(e.Row.FindControl("grvDetalleObservacionE"));
                grvDetalleAuditoria = (GridView)(e.Row.FindControl("grvDetalleAuditoria"));
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    grvEliminado.DataSource = dta_consultaarticuloEliminado;
                    ...
                    grvDetalleObservacionE.DataSource = dta_consultaarticuloEliminado;
                    grvDetalleObservacionE.DataBind();
        ...
        public void P_Buscar_Eliminados(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_DOCUMENTOVENTACAB_ELIMINADOS_LISTAR_PAGO(objEntidad);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda, ref DropDownList ddl_combomediopago,
            ...
            ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_comboempresaconsulta2, ref DropDownList ddl_tipodoc2,
            ref DropDownList ddl_comboempresaconsulta3, ref DropDownList ddl_combomediopago2, ref DropDownList ddl_CajaFisicaConsulta2, ref DropDownList ddl_cobrador)
        {
            DataTable dta_consulta = null;
