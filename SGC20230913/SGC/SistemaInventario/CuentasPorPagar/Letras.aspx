<%@ Page Title="Letras - Compras" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="Letras.aspx.cs" Inherits="SistemaInventario.CuentasPorPagar.Letras" %>
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <%--      <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:ImageButton runat="server" id="imgAnularDocumento" ImageUrl="~/Asset/images/Eliminar.jpg" ToolTip="ANULAR LETRA" OnClientClick="F_AnularRegistro(this); return false;" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>--%>
