...
{
    public partial class OrdenCompraConvergente : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref Distrito, ref Guia, ref FlagCSIgv,ref Observacion,ref Entrega);
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref String Distrito, ref String Guia, ref Int32 FlagCSIgv,ref String Observacion, ref String Entrega
        )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                Entrega = Convert.ToString(dtTabla.Rows[0]["Entrega"]);
            }
        }
