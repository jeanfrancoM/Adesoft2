...
{
    public partial class RegistroFacturaCompraNuevoUnitarioSM : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref Distrito, ref Guia, ref CodCajaFisica, ref CodFacturaAsociada, ref FlagCSIgv, ref Ingreso);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objOperacion.F_NotaIngresoSalidaCab_Insert_Roy(objEntidad);
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
           ...
           ref Int32 FlagCSIgv, ref String Ingreso
       )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                Ingreso = Convert.ToString(dtTabla.Rows[0]["Ingreso"]);
            }
        }
