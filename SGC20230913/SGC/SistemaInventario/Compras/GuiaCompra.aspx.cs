...
namespace SistemaInventario.Compras
{
    public partial class GuiaCompra : System.Web.UI.Page
    {
        ...
        private string _menu = "3000"; private string _opcion = "4";
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                {
                    P_ReemplazarFactura(obj_parametros, ref Codigo, ref CodCliente, ref CodMoneda, ref Cliente, ref CodFormaPago, ref CodFacturaAnterior,
                     ref FechaIngreso, ref SerieDoc, ref NumeroDoc, ref Periodo, ref FechaEmision, ref FechaVencimiento, ref TipoCambio);
        ...
        public void P_ValidarFactura(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            Mensaje = objOperacion.F_NotaIngresoSalidaCab_Validar_Edicion(objEntidad).MsgError;
        }

        public void P_ReemplazarFactura(Hashtable objTablaFiltro, ref Int32 Codigo, ref Int32 CodCliente, ref Int32 CodMoneda,
                    ref String Cliente, ref Int32 CodFormaPago, ref Int32 CodFacturaAnterior, ref String FechaIngreso, ref String SerieDoc,
                    ref String NumeroDoc, ref String Periodo, ref String FechaEmision, ref String FechaVencimiento, ref decimal TipoCambio)
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                Periodo = Convert.ToString(dtTabla.Rows[0]["Periodo"]);
                TipoCambio = Convert.ToDecimal(dtTabla.Rows[0]["TipoCambio"]);
            }
        }
