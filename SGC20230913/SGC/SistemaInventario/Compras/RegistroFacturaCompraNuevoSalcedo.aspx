<%@ Page Title="Compras Factura" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaCompraNuevoSalcedo.aspx.cs" Inherits="SistemaInventario.Compras.RegistroFacturaCompraNuevoSalcedo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaCompraNuevoSalcedo.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <Columns>
                       <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField HeaderText="Precio" ItemStyle-HorizontalAlign="Center">
                         ...
                         <asp:TemplateField HeaderText="M.Gen." ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtMargen" Width="75px" Font-Bold="true" Style="text-align: center;"
                                    Font-Names="Arial" CssClass="ccsestilo" ForeColor="Blue" Text='<%# Bind("Margen") %>'
                                    onblur="F_ActualizarMargen(this.id); return false;"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="M.Min." ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtMargen2" Width="75px" Font-Bold="true" Style="text-align: center;"
                                    Font-Names="Arial" CssClass="ccsestilo" ForeColor="Blue" Text='<%# Bind("Margen2") %>'
                                    onblur="F_ActualizarMargen2(this.id); return false;"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                                ...
                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                        ...
                                        <Columns>
                                          ...
                                          <asp:BoundField DataField="Anexo" HeaderText="OC">
                                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Fecha">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfCodTipoDoc" runat="server" Value='<%# Bind("CodTipoDoc") %>' />
                                        <asp:HiddenField ID="hfMargen1" runat="server" Value='<%# Bind("Margen1") %>' />
                                        <asp:HiddenField ID="hfMargen2" runat="server" Value='<%# Bind("Margen2") %>' />
                                        <asp:HiddenField ID="hfCantidadFacturada" runat="server" Value='<%# Bind("CantidadFacturadas") %>' />
                                        <asp:HiddenField ID="hfCantidadTotal" runat="server" Value='<%# Bind("cantidadtotal") %>' />
    ...
    <div id="divFacturarVentas" style="display: none;">
     ...
     <div id="div_NumeroDocumento" style="background-color: #CCE6FF; text-align: center;
        ...
        <br />
        <center>
            <asp:Label ID="Label4" runat="server" Text="Codigo Factura Compra" Font-Bold="true"
