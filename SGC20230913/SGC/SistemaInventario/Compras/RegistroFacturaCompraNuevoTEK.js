var AppSession = "../Compras/RegistroFacturaCompraNuevoTEK.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_Empresa', result.split('~')[21]);
                        F_Update_Division_HTML('div_EmpresaConsulta', result.split('~')[22]);
                        $('#hfCodEmpresa').val(result.split('~')[23]);
        ...
        try {
            ...
            F_ReemplazarFactura_NET(arg, function (result) {
                ...
                if (result.split('~')[33]!=0)
                {
                    ...
                    $('#MainContent_ddlEmpresa').val(result.split('~')[35]);
                    F_BuscarDireccionesCliente();                
                    $('.ccsestilo').css('background', '#FFFFE0');
