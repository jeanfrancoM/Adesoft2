...
{
    public partial class ImportacionReeim : System.Web.UI.Page
    {
        ...
        protected void grvDetalleArticulo_RowDataBound2(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Error.Text.Trim() != "")
                {
                    ...
                    Label lblCodigoFabrica = (Label)(e.Row.FindControl("lblCodigoFabrica"));
                    Label lblCantidad = (Label)(e.Row.FindControl("lblCantidad"));
                    Label lblCosto = (Label)(e.Row.FindControl("lblCosto"));
                    Label lblMarca = (Label)(e.Row.FindControl("lblMarca"));
                    ...
                    {
                        lblCodigoFabrica.Text = lblCodigoFabrica.Text + " (REPETIDO)";
                        lblCodigoFabrica.BackColor = Color.Orange;
                    }
                    ...
                    else if (Error.Text == "MARCA NULA O INEXISTENTE")
                    {
                        if (lblMarca.Text.Trim() == "")
                            lblMarca.Text = "INGRESE UNA MARCA EXISTENTE";
                        lblMarca.BackColor = Color.Orange;
                    }
                    else if (Error.Text == "LINEA NULA O INEXISTENTE")
                    {
                        if (lblLinea.Text.Trim() == "")
                            lblLinea.Text = "INGRESE UNA LINEA EXISTENTE";
                        lblLinea.BackColor = Color.Orange;
                    }
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_NotaIngresoSalidaDet_Select_Importaciones_REEIM(objEntidad);
                grvDetalle.DataBind();
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            DocumentoVentaCabCN objOperacion = new DocumentoVentaCabCN();
            //validacion
            dtValidacionesProductos = objOperacion.F_ListaPreciosExcel_VALIDACIONES_PRODUCTOS_REEIM(Convert.ToInt64(HiddenField1.Value));
            ...
            if (FileUpload1.HasFile)
            {
                if (FileUpload1.PostedFile.ContentType == ExcelContentType || FileUpload1.PostedFile.ContentType == Excel2010ContentType)
                {
                    ...
                    try
                    {
                        ...
                        Cadena = string.Format("Select [CODIGOFABRICA],[CODIGO],[CODIGOREMPLAZO],[DESCRIPCION],[LINEA],[MARCA],[CANTIDAD],[COSTO],[MARGEN1],[MARGEN2]," + HiddenField1.Value + " AS IDPruebasExcelCab,'" + FileUpload1.FileName + "' AS NombreArchivo FROM [{0}] ", "IMPORTACION$");
                        ...
                        using (OleDbConnection connection = new OleDbConnection(excelConnectionString))
                        {
                            ...
                            using (DbDataReader dr = command.ExecuteReader())
                            {
                                ...
                                using (SqlBulkCopy bulkCopy = new SqlBulkCopy(sqlConnectionString))
                                {
                                    ...
                                    bulkCopy.ColumnMappings.Add("[CODIGOFABRICA]", "CodigoFabrica");
                                    bulkCopy.ColumnMappings.Add("[CODIGO]", "Codigo");
                                    bulkCopy.ColumnMappings.Add("[CODIGOREMPLAZO]", "CodigoRemplazo");
                                    ...
                                    bulkCopy.ColumnMappings.Add("[MARGEN1]", "Margen1");
                                    bulkCopy.ColumnMappings.Add("[MARGEN2]", "Margen2");
                    ...
                    catch (Exception ex)
                    {
                        try
                        {
                            MensajeError = "Error en la lectura del excel. <p></p> " +
                                            ...
                                            " Columnas: <p></p>" +
                                            " <b>[A]=CODIGOFABRICA, [B]=CODIGO, [C]=CODIGOREMPLAZO, [D]=DESCRIPCION, [E]=LINEA, [F]=MARCA, [G]=CANTIDAD, [H]=COSTO, [I]=MARGEN1, [J]=MARGEN2 </b>";
        ...
        private void ProcedimientoTrasladar(ref string Mensaje, ref int CodMovimiento)
        {
            ...
            objOperacion.F_ListaPreciosExcel_ACTUALIZARPRODUCTOS_REEIM(objEntidad);
        ...
        protected void ExportarExcelNuevo(long IdExcel, int CodMovimiento)
        {
            DocumentoVentaCabCN objOperacion = null;
            objOperacion = new DocumentoVentaCabCN();
            DataTable ds = objOperacion.F_ListaPreciosExcel_Exportacion_REEIM(IdExcel, CodMovimiento, decimal.Parse(txtGastosOperativos.Text));
