...
{
    public partial class RegistroFacturaCompraNuevoConvergente : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref Distrito, ref Guia, ref CodCajaFisica, ref CodFacturaAsociada, ref FlagCSIgv);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objEntidad.Entrega = Convert.ToString(objTablaFiltro["Filtro_Entrega"]);

            objOperacion = new NotaIngresoSalidaCabCN();

            objOperacion.F_NotaIngresoSalidaCab_Insert_Convergentes(objEntidad);
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref String Distrito, ref String Guia, ref Int32 CodCajaFisica, ref Int32 CodFacturaAsociada, ref Int32 FlagCSIgv
        )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
