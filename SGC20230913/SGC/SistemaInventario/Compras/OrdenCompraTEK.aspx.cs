...
{
    public partial class OrdenCompraTEK : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_Series_Documentos_PopUp_NET);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref ddlTipoDocumento, ref ddlClasificacion, ref ddlCategoria,
                                        ...
                                        ref ddlEmpleadoConsulta, ref ddlCajaFisica, ref ddlEstado, ref ddlEmpresa, ref ddlEmpresaConsulta);
            ...
            str_resultado =
                ...
                str_ddlEmpresa_html + "~" +//20
                str_ddlEmpresaConsulta_html + "~" +//21
                Session["CodEmpresa"].ToString(); //22
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref CodTasa, ref SubTotal, ref Igv, ref Total, ref Dscto,ref CodDireccion,
                                        ref CodDepartamento, ref CodProvincia, ref CodDistrito, ref Distrito, ref Guia, ref FlagCSIgv, ref CodEmpresa);
        ...
        public String F_Series_Documentos_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Series_Documentos(obj_parametros, ref ddlSerie);
        ...
        public String F_Series_Documentos_PopUp_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_ddl_serie_html = "";
            ...
            try
            {
                ...
                P_Series_Documentos_PopUp(obj_parametros, ref ddlSerieDocVentas);
              ...
              ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta)
        {
            ...
            ddlSerieConsulta.Items.Insert(0, new ListItem("TODOS", "0"));
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref String Distrito, ref String Guia, ref Int32 FlagCSIgv, ref Int32 CodEmpresa
        )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
        ...
        public void P_Series_Documentos_PopUp(Hashtable objTablaFiltro, ref DropDownList ddl_serie)
        {
            TCCorrelativoCE objEntidad = null;
            TCCorrelativoCN objOperacion = null;
