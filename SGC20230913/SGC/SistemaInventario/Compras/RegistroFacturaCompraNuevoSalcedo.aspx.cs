...
{
    public partial class RegistroFacturaCompraNuevoSalcedo : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ref NroRuc, ref Codigo, ref CodCtaCte, ref CodMoneda, ref  Proveedor, ref CodFormaPago,
                                        ref CodFacturaAnterior, ref  NumeroDoc, ref  FechaEmision, ref  FechaVencimiento, ref  SerieDoc,
                                        ref CodCategoria, ref FlagPercepcion, ref Periodo, ref CodClasificacion, ref CodTasa, ref SubTotal,
                                        ref Igv, ref Total, ref Dscto, ref CodDireccion, ref CodDepartamento, ref CodProvincia, ref CodDistrito,
                                        ref Distrito, ref Guia, ref CodCajaFisica, ref CodFacturaAsociada, ref FlagCSIgv, ref FechaIngreso, ref FlagCosteable);
             ...
             ref DropDownList ddl_comboestado, ref DropDownList ddl_combodocumentoconsulta)
        {
            ...
            ddl_combodocumentoconsulta.Items.Clear();

            ddl_combodocumentoconsulta.DataSource = dta_consulta;
            ddl_combodocumentoconsulta.DataTextField = "Descripcion";
            ddl_combodocumentoconsulta.DataValueField = "CodTipoDoc";
            ddl_combodocumentoconsulta.DataBind();
            ddl_combodocumentoconsulta.Items.Insert(0, new ListItem("TODOS", "0"));
        ...
        public void P_Inicializar_GrillaVacia_DetalleArticulo()
        {
            ...
            dta_consultadetalle.Columns.Add("CantidadOC", typeof(string));
            dta_consultadetalle.Columns.Add("Margen", typeof(string));
            dta_consultadetalle.Columns.Add("Margen2", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleOC()
        {
            ...
            dta_consultadetalleoc.Columns.Add("CodAlterno", typeof(string));
            ...
            dta_consultadetalleoc.Columns.Add("Margen1", typeof(string));
            dta_consultadetalleoc.Columns.Add("Margen2", typeof(string));
            dta_consultadetalleoc.Columns.Add("CantidadFacturadas", typeof(string));
            dta_consultadetalleoc.Columns.Add("cantidadtotal", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " Margen2 = '" + item.Margen2 + "'";
            ...
            {
                objOperacion.F_TemporalFacturacionDet_Insert_Salcedo(objEntidad);
                Codigo = objEntidad.CodDocumentoVenta;
            }
            else
            {
                objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
                objOperacion.F_TemporalFacturacionDetalle_Insert_Salcedo(objEntidad);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objEntidad.FechaIngreso = Convert.ToDateTime(objTablaFiltro["Filtro_FechaRegistro"]);
            objEntidad.CodUsuario = Convert.ToInt32((Session["CodUsuario"]));
            ...
            objOperacion.F_NotaIngresoSalidaCab_Insert_Salcedo(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_NotaIngresoSalidaCab_Select_Compras_FACTURA(objEntidad);
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref String Distrito, ref String Guia, ref Int32 CodCajaFisica, ref Int32 CodFacturaAsociada,
            ref Int32 FlagCSIgv, ref String FechaIngreso, ref Int32 FlagCosteable
        )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                CodCajaFisica = Convert.ToInt32(dtTabla.Rows[0]["CodCajaFisica"]);
                CodFacturaAsociada = Convert.ToInt32(dtTabla.Rows[0]["CodFacturaAsociada"]);
        ...
        public void P_Devolucion(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodMovimiento = '" + item.CodMovimiento + "'";
                XmlDetalle = XmlDetalle + " />";
            }
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                grvAuditoria.DataSource = objOperacion.F_AUDITORIA_NOTAINGRESO(objEntidad);
