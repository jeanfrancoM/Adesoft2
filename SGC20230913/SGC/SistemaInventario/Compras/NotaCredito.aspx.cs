...
namespace SistemaInventario.Compras
{
    public partial class NotaCredito : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlcomboestado_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlTipoOperaciones, ref ddlIgv, ref ddlFormaPago, ref ddlCajaFisica,
                                        ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlEstado);
                ...
                str_ddlcomboestado_html = Mod_Utilitario.F_GetHtmlForControl(ddlEstado);
            ...
            str_resultado =
                ...
                CodCajaFisica + "~" + //11
                str_ddlEmpresa_html + "~" +//12
                str_ddlEmpresaConsulta_html + "~" + //13
                Session["CodEmpresa"].ToString() +"~" + //14
            str_ddlcomboestado_html; //15
        ...
        public String F_FacturacionNotaCredito_NET(String arg)
        {
            ...
            try
            {
                ...
                P_FacturacionCotizacion(obj_parametros, ref str_mensaje_operacion, ref Codigo, ref CodCtaCte, ref CodMoneda,
                   ref SubTotal, ref Igv, ref Total, ref Cliente, ref CodDocumentoVenta,ref Serie,ref Numero);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda, ref DropDownList ddl_combotipooperaciones,
                                            ref DropDownList ddl_comboigv, ref DropDownList ddl_comboformapago,ref DropDownList ddl_CajaFisica,
                                            ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_comboestado)             
        {
            DataTable dta_consulta = null;
        ...
        public void P_FacturacionCotizacion(Hashtable objTablaFiltro, ref String Mensaje, ref Int32 Codigo, ref Int32 CodCtaCte,
           ref Int32 CodMoneda, ref Decimal SubTotal, ref Decimal Igv, ref Decimal Total, ref String Cliente, ref Int32 CodDocumentoVenta,ref String Serie,ref String Numero)
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                Serie = Convert.ToString(dta_consulta.Rows[0][13]);
                Numero = Convert.ToString(dta_consulta.Rows[0][14]);
