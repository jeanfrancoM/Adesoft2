...
{
    public partial class OrdenCompraSalcedo : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_PromediarVentas_Net);                                     
        }
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref CodDireccion, ref CodDepartamento, ref CodProvincia, ref CodDistrito, ref Distrito, ref Guia, ref FlagCSIgv);
        ...
        public void P_Inicializar_GrillaVacia_ConsultaArticulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("Promedio", typeof(string));
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            objEntidad.FlagCompra = 2;

            grvConsulta.DataSource = objOperacion.F_LGProductos_Select_Ventas_Salcedo(objEntidad);
            grvConsulta.DataBind();
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objOperacion.F_NotaIngresoSalidaCab_Insert_ORDENCOMPRA_Salcedo(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_NotaIngresoSalidaCab_Select_Compras_OC_Salcedo(objEntidad);
        ...
        public void P_AnularRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_Anulacion_NotaIngreso_Salcedo(objEntidad);
        ...
        public void P_EditarTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_NotaIngresoSalidaCab_Update_Salcedo(objEntidad);
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TemporalFacturacionDet_Update_Salcedo(objEntidad);
        ...
        public void P_ActualizarDetalle(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TemporalFacturacionDet_Actualizar_Salcedo(objEntidad);
        ...
        public void P_ValidarFactura(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            Mensaje = objOperacion.F_NotaIngresoSalidaCab_Validar_Factura_Salcedo(objEntidad).MsgError;
        }
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref String Distrito, ref String Guia, ref Int32 FlagCSIgv
        )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            dtTabla = objOperacion.F_NotaIngresoSalidaCab_Reemplazar_Salcedo(objEntidad);
        ...
        public void P_EliminarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_Eliminacion_NotaIngreso_Salcedo(objEntidad);
        ...
        public String F_PromediarVentas_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            Decimal Promedio = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_PromedioVentas(obj_parametros, ref Promedio);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
        ...
        public void P_PromedioVentas(Hashtable objTablaFiltro, ref Decimal Promedio)
        {
            ...
            objOperacion.F_PromedioVentas(objEntidad);

            Promedio = objEntidad.Promedio;
