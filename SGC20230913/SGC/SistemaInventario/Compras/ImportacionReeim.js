var AppSession = "../Compras/ImportacionReeim.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_btnEdi').click(function () {
        ...
        try {
            ...
            $.ajax({
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                url: 'ImportacionReeim.aspx/F_ModificarObservacion',
                dataType: "json",
    ...
    $('#MainContent_txtObservacion').css('height', '50px');

    $('#MainContent_txtFechaLlegadaIng').css('font-size', '12px');

    $('#MainContent_txtProveedorIng').css('font-size', '12px');

    $('#MainContent_txtNumIng').css('font-size', '12px');

    $('#MainContent_txtProveedorEli').css('font-size', '12px');

    $('#MainContent_txtNumEli').css('font-size', '12px');

    $('#MainContent_txtObservacionEli').css('height', '50px');

    $('#MainContent_txtProvEdi').css('font-size', '12px');

    $('#MainContent_txtNumEdi').css('font-size', '12px');

    $('#MainContent_txtObEdi').css('height', '50px');
...
function F_IngresarRegistro(Fila) {
    ...
    try {
        ...
        if ($(lblEstadoImportacion).text() == "GENERADO") {
