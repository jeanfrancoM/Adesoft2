var AppSession = "../Compras/RegistroFacturaCompraNuevoRoman.aspx";
...
//                    {
                        ...
                        CantidadOC: 0,
                        Precio: (parseFloat($('#MainContent_txtPrecioDisplay').val())) /parseFloat($('#MainContent_txtCantidad').val()) / parseFloat(tasaigv),
                        PrecioDscto: (parseFloat($('#MainContent_txtPrecioDisplay').val()))  /parseFloat($('#MainContent_txtCantidad').val()) / parseFloat(tasaigv) * (1-(parseFloat(0) / 100)),
...
//                });
                ...
                $('#lblNumRegistros').text(F_Numerar_Grilla("grvDetalleArticulo",'lblProducto')); 
                    //F_LimpiarGrillaConsulta();
                }
                else 
                {
 ...
 try 
        {
            ...
            var hfCodDetalleOC = txtCantidad.replace('txtPrecio', 'hfCodDetalleOC');
            var tasaigv;
            var FlagIgv = 0;
            var Contenedor = '#MainContent_';    
...
function F_ImprimirFacturaPDF(Fila) {
        ...
        var NombreArchivo = "Web_Reporte_Compras_rptFacturaCompra.rpt";
...
if (!F_SesionRedireccionar(AppSession)) return false;
       ...
       var lblcliente_grilla = '#' + imgID.replace('imgAnularDocumento', 'lblcliente');
        ...
        {alertify.log("ESTE ORDEN DE COMPRA SE ENCUENTRA FACTURADA; ELIMINE LA FACTURA");
        return false;}
        ...
        $('#div_Anulacion').dialog({
               resizable: false,
               modal: true,
               title: "Eliminacion de Orden de Compra",
               title_html: true,
               height: 190,
               width: 470,
               autoOpen: false
