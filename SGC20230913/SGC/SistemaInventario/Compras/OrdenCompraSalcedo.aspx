<%@ Page Title="Orden Compra" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="OrdenCompraSalcedo.aspx.cs" Inherits="SistemaInventario.Compras.OrdenCompraSalcedo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="OrdenCompraSalcedo.js" charset="UTF-8"></script>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Código">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hfperiodo" runat="server" Value='6' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="UM">
                                             ...
                                             <asp:TemplateField HeaderText="Pro">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblPromedio" Text='<%# Bind("Promedio") %>' Font-Size="Medium"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPeriodoPromedio" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPromedio" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"  Font-Size="16"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
