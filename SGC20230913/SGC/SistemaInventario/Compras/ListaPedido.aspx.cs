...
namespace SistemaInventario.Compras
{
    public partial class ListaPedido : System.Web.UI.Page
    {
        ...
        private string _menu = "3000"; private string _opcion = "7";
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Text != "")
                {
                    ...
                    grvDetalle.DataSource = objOperacion.F_TemporalFacturacionDet_Listar(objEntidad);
                    grvDetalle.DataBind();
                }
            }
        }
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_TemporalFacturacionCab_Listar(objEntidad);
