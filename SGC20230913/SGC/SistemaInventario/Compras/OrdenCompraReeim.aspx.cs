...
{
    public partial class OrdenCompraReeim : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref ddlTipoDocumento, ref ddlClasificacion, ref ddlCategoria,
                                        ...
                                        ref ddlEmpleadoConsulta, ref ddlCajaFisica, ref ddlEstado, ref ddlTipoDocConsulta);
            ...
            str_resultado =
                ...
                str_ddlTipoDocConsulta_html; //21
        ...
        public String F_Observacion_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_ORDENCOMPRA_OBSERVACION(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodMovimiento = Codigo;
                grvAuditoria.DataSource = objOperacion.F_ORDENCOMPRA_AUDITORIA(objEntidad);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_comboformapago, ref DropDownList ddl_combomoneda,
              ...
              ref DropDownList ddl_comboclasificacionconsulta, ref DropDownList ddl_comboserie, ref DropDownList ddl_comboserieconsulta,ref DropDownList ddl_comboserieventas,
               ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_CajaFisica, ref DropDownList ddl_comboestado, ref DropDownList ddl_combodocumentoconsulta)
        {
            DataTable dta_consulta = null;
            ...
            dta_consulta = objOperacionDocumento.F_TCDocumentos_ListarCompras_OC_NP();
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_NotaIngresoSalidaCab_Select_Compras_OC(objEntidad);
