...
{
    public partial class RegistroFacturaCompraNuevoTEK : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref ddlTipoDocumento, ref ddlClasificacion, ref ddlCategoria,
                    ...
                    ref ddlEmpresa, ref ddlEmpresaConsulta);
            ...
            str_resultado =
                ...
                str_ddlEmpresa_html + "~" +//21
                str_ddlEmpresaConsulta_html + "~" + //22
                Session["CodEmpresa"].ToString(); //23
        ...
        public String F_Observacion_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_FACTURACOMPRA_OBSERVACION(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodMovimiento = Codigo;
                grvAuditoria.DataSource = objOperacion.F_FACTURACOMPRA_AUDITORIA(objEntidad);
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(obj_parametros,
                                        ...
                                        ref Distrito, ref Guia, ref CodCajaFisica, ref CodFacturaAsociada, ref FlagCSIgv, ref CodEmpresa);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_comboformapago,
             ...
             ref DropDownList ddl_comboestado, ref DropDownList ddl_combodocumentoconsulta,ref DropDownList ddl_comboempresa, 
             ref DropDownList ddl_comboempresaconsulta)
        {
            DataTable dta_consulta = null;
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            EntidadClienteAzure.CodCtaCte = objEntidad.CodCtaCte;
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref Int32 FlagCSIgv, ref Int32 CodEmpresa
        )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
