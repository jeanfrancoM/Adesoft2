var AppSession = "../Compras/OrdenCompraTEK.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_Empresa', result.split('~')[20]);
                        F_Update_Division_HTML('div_EmpresaConsulta', result.split('~')[21]);
                        $('#hfCodEmpresa').val(result.split('~')[22]);
...
function F_EliminarRegistro(Fila) {
 ...
 try 
    ...
    if(!confirm("ESTA SEGURO DE ELIMINAR LA ORDEN DE COMPRA : " + $(lblnumero_grilla).text() + "\n" + "DEL PROVEEDOR : " +  $(lblcliente_grilla).text()))
    return false;
        ...
        try {
            ...
            F_ReemplazarFactura_NET(arg, function (result) {
                ...
                if (str_resultado_operacion == "1") {
                    ...
                    $('#MainContent_ddlEmpresa').val(result.split('~')[33]);
                    F_BuscarDireccionesCliente();
                    F_CambioSerie_TipoDoc_Consulta();
                    $("#MainContent_ddlSerie option:selected").text(result.split('~')[17]);
                    $('.ccsestilo').css('background', '#FFFFE0');
