<%@ Page Title="Guia Compras" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaCompra.aspx.cs" Inherits="SistemaInventario.Compras.GuiaCompra" %>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtSerie" runat="server" Width="25" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtSubTotal" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" Style="display: none;" ReadOnly="True" Text="0.00"></asp:TextBox>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="Eliminar Guia Compra" OnClientClick="F_AnularRegistro(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--
                                                              <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:ImageButton runat="server" id="imgReemplazar" ImageUrl="~/Asset/images/Reemplazo.png" ToolTip="MODIFICAR ORDEN COMPRA" OnClientClick="F_ReemplazarFactura(this); return false;" />
                                                            </ItemTemplate>
                                                         </asp:TemplateField>   --%>
                        <asp:TemplateField>
                            <ItemTemplate>
            ...
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Código">
                        ...
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="hlkCodNeumaticoGv" Font-Underline="true" ForeColor="Blue"
                                Style="cursor: hand" Text='<%# Bind("CodigoProducto") %>' onclick="F_VerUltimoPrecio(this.id); return false;"
                                ToolTip="Ultimo Precio">
                    ...
                    <asp:TemplateField HeaderText="Costo" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtPrecioLibre" Width="55px" Font-Bold="true" Style="text-align: center;"
                                CssClass="ccsestilo" ForeColor="Blue" Font-Names="Arial" Text='<%# Bind("Costo") %>'
                                onblur="F_ValidarPrecioGrilla(this.id);"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Cant." ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtCantidad" Width="55px" Font-Bold="true" Style="text-align: center;"
                                CssClass="ccsestilo" Font-Names="Arial" onblur="F_ValidarStockGrilla();" ForeColor="Blue"
