var AppSession = "../Compras/OrdenCompraSalcedo.aspx";
...
//            toastr.warning("Error Detectado: " + e);
    ...
    $('#MainContent_txtPeriodoPromedio').on('change', function (e) {
       F_PromediarVentas();
    });

        $('#MainContent_txtPeriodoPromedio').blur( function (e) {
       F_PromediarVentas();
    });
   ...
   //ventana busqueda de producto
    ...
    $('#MainContent_txtPeriodoPromedio').css('background', '#FFFFE0');
    $('#MainContent_txtPromedio').css('background', '#FFFFE0');
...
function F_CamposAlternativas(Campos) {
                ...
                switch (Campos)
                {
                    ...
                    break;
                     case "MainContent_txtPeriodoPromedio":
                        $('#MainContent_txtPromedio').select();
                    break;
                     case "MainContent_txtPromedio":
                        $('#MainContent_txtCantidad').select();
                    break;
...
function F_AgregarArticulo(ControlID, DirectoBoton) {
    ...
    var lblCosto_grilla = '';
    var lblCodUm_grilla = '';
    var lblPeriodo_grilla = '';
    var lblPromedio_grilla = '';
    ...
    lblPeriodo_grilla = imgAgregar_grilla.replace('imgAgregar', 'hfperiodo');
    lblPromedio_grilla = imgAgregar_grilla.replace('imgAgregar', 'lblPromedio');
    ...
    $('#MainContent_txtPeriodoPromedio').val($(lblPeriodo_grilla).val());
    $('#MainContent_txtPromedio').val($(lblPromedio_grilla).text());
        ...
        if ($('#MainContent_chkConIgvMaestro').is(':checked'))
             ...
             tasaigv=1;
                ...
                if (str_resultado_operacion == "1") 
                {
                    ...
                    $('#MainContent_ddlPrecio').empty();
                    $('#MainContent_txtArticuloAgregar').val('');
                    $('#MainContent_txtPeriodoPromedio').val('');
                    $('#MainContent_txtPromedio').val('');
                    $('#MainContent_txtCantidad').val('1');
                    $("#hfMenorPrecioAgregar").val(0);
                    $('.ccsestilo').css('background', '#FFFFE0');
...
if (parseFloat($("#MainContent_txtPeriodoPromedio").val()) <= 0) {
            alertify.log("Periodo Invalido");
            $("#MainContent_txtPeriodoPromedio").val(parseFloat(lblstock));
            return false;
    }
    try 
        {
              var objParams = {
                                Filtro_Periodo: $("#MainContent_txtPeriodoPromedio").val(),
                                 Filtro_CodProducto: $('#hfCodProductoAgregar').val()
                              };

                var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
                    MostrarEspera(true);

                F_PromediarVentas_Net(arg, function (result) {
                MostrarEspera(false);
                ...
                if (str_resultado_operacion == "1") 
                    $('#MainContent_txtPromedio').val(result.split('~')[2]);
                else 
                    alertify.log(result.split('~')[1]);
