<%@ Page Title="Cobranzas Concar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ContabilidadConcar_RegistroCobranza.aspx.cs" Inherits="SistemaInventario.Reportes.ContabilidadConcar_RegistroCobranza" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ContabilidadConcar_RegistroCobranza.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte de Registro de Cobranzas - Concar</div>
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                           ...
                           <tr>
                            ...
                            <td style="width:55px">
                                <asp:TextBox ID="txtNumero" runat="server" Width="55px" Font-Names="Arial" ForeColor="Blue"></asp:TextBox> 
                             </td>                        
                        </tr>
                        <tr>
