...
namespace SistemaInventario.Reportes {
    ...
    public class Web_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yordan : ReportClass {
        
        public Web_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yordan() {
        }
        
        public override string ResourceName {
            get {
                return "Web_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yordan.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SistemaInventario.Reportes.Web_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yor" +
                    "dan.rpt";
            }
            set {
                // Do nothing
    ...
    public class CachedWeb_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yordan : Component, ICachedReport {
        
        public CachedWeb_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yordan() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Web_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yordan rpt = new Web_Reporte_Ventas_rptElectronica_NotaVenta_Ticket_Yordan();
            rpt.Site = this.Site;
            return rpt;
        }
