...
{
    public partial class Ventas_ServiciosPorFacturar : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlEmpleado, ref ddlSucursal);

                str_ddlEmpleado_html = Mod_Utilitario.F_GetHtmlForControl(ddlEmpleado);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList comboempleado, ref DropDownList combosucursal)
        {         
            ...
            comboempleado.DataSource = dta_consulta;
            comboempleado.DataTextField = "NombreCompleto";
            comboempleado.DataValueField = "CodEmpleado";
            comboempleado.DataBind();

            ListItem iTodos = new ListItem("--TODOS--", "0");
            comboempleado.Items.Add(iTodos);
