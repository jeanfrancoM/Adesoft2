var AppSession = "../Reportes/Reporte_RPH.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 706;
    var NombreArchivo = 'REPORTE_DE_RECIBOSXHONORARIOS.rpt';
    var Titulo = 'REPORTE DE RECIBOS POR HONORARIOS';
    var SubTitulo = 'REPORTE DE RECIBOS POR HONORARIOS';
    ...
    rptURL = rptURL + 'SubTitulo= Desde ' + $('#MainContent_txtDesde').val() +' AL '+ $('#MainContent_txtHasta').val() + '&';
...
function F_Excel() {
    ...
    var CodMenu = 3001;
    var NombreArchivo = 'Xls_Registro_RXH.xlsx';
    var NombreHoja = 'RPH';
