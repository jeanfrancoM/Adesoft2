var AppSession = "../Reportes/Ventas_VentaXVendedorDetallado.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 405;
    var Titulo = "REPORTE VENTAS POR VENDEDOR DETALLADO";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombreTabla = "VentasVendedorDetallado";
    var NombreArchivo = "Web_Reporte_Ventas_rptVentasXVendedor_Detallado_TEK.rpt";
  ...
  //  if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Consultar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    ...
    try { 
        var objParams = {        
            ...
            Filtro_CodFormaPago: $('#MainContent_ddlFormaPago').val(),
