<%@ Page Title="Ventas Por Movimientos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_VentaXMovimiento.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_VentaXMovimiento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="Ventas_VentaXMovimiento.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 390px">REPORTE DE VENTAS POR MOVIMIENTOS</div> 
                                                 ...
                                                 <td>
                                                            ...
                                                            <tr>
                                                              <td>
                                                                ...
                                                                <asp:TextBox ID="txtDesde" runat="server" Width="50px"  Font-Names="Arial"  ForeColor="Blue"  Font-Bold="True"   CssClass="MesAnioPicker" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            <td style="font-weight: bold">
                                                            HASTA
                                                            </td>
                                                        <td style="padding-left:5px;">
                                                                ...
                                                                <asp:TextBox ID="txtHasta" runat="server" Width="50px"  Font-Names="Arial"  ForeColor="Blue"  Font-Bold="True"   CssClass="MesAnioPicker" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            </tr>
                                                            </table>
                                                            </td>
