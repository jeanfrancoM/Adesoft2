...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 930px">Reporte de Kardex Por Periodo (CONTABLE)</div> 
     ...
     <div id="div_grvConsultaArticulo" style ="padding-top:5px;">
                                            ...
                                            Width="900px" >  
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="dscProducto" HeaderText="Descripcion">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                               
                                                    <asp:BoundField DataField="UnidaddeMedida" HeaderText="UM" >
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
