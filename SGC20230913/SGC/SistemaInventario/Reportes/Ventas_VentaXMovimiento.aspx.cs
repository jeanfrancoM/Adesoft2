...
{
    public partial class Ventas_VentaXMovimiento : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlVendedor, ref ddlSucursal,ref ddlFamilia);
                ...
                str_ddlFamilia_html = Mod_Utilitario.F_GetHtmlForControl(ddlFamilia);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
            ref DropDownList ddl_empleado, ref DropDownList combosucursal, ref DropDownList combofamilia)
        {
            ...
            combofamilia.DataSource = dta_consulta;
            combofamilia.DataTextField = "DscFamilia";
            combofamilia.DataValueField = "IdFamilia";
            combofamilia.DataBind();
            combofamilia.Items.Add(iTodos);
        }
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_MOVIMIENTOS_PRODUCTOS_VENTAS(objEntidad);
