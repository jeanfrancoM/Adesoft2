<%@ Page Title="Reporte Pagos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="CXP_Pagos.aspx.cs" Inherits="SistemaInventario.Reportes.CXP_Pagos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CXP_Pagos.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 500px">
        Reporte de Pagos</div>
    <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all"
        style="width: 500px">
        <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
            Criterio de busqueda
        </div>
        <div class="ui-jqdialog-content" style="width: 500px;">
                    ...
                    <td colspan='4' style="padding-left: 4px;">
                        <div id="div_TipoDocumento">
                            <asp:DropDownList ID="ddlTipoDocumento" runat="server" Font-Names="Arial" ForeColor="Blue"
                                Font-Bold="True" Width="160" BackColor="#FFFF99">
                                <asp:ListItem Value="0">--TODOS--</asp:ListItem>
                                <asp:ListItem Value="1">FACTURA</asp:ListItem>
                                <asp:ListItem Value="5">ORDEN DE COMPRA</asp:ListItem>
               ...
               <%--                 <asp:ListItem Value="3">NOTA DE CREDITO</asp:ListItem>
                ...
                <tr>
                    ...
                    <td style="padding-left: 5px;">
                        <asp:TextBox ID="txtCliente" runat="server" Width="335px" Font-Names="Arial" ForeColor="Blue"
                            Font-Bold="True"></asp:TextBox>
                    </td>
                    <td style="display:none">
                        <asp:CheckBox ID="chkVencidas" runat="server" Text="Solo Vencidas" Checked="True"
                            Font-Bold="True" />
                    </td>
                    <td style="display:none">
