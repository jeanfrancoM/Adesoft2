<%@ Page Title="Caja Chica" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="VoucherCobranzas.aspx.cs" Inherits="SistemaInventario.CajaChica.CajaChica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="VoucherCobranzas.js" charset="UTF-8"></script>
...
<%--                    <asp:Button ID="btnGenerarCaja" runat="server" Text="GENERAR VOUCHER" Font-Names="Arial"
                        Style="display: none;" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Width="200px" />--%>
                    <asp:Button ID="btnReGenerarCaja" runat="server" Text="GENERAR VOUCHER COBRANZA" Font-Names="Arial"
