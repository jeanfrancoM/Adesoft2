<%@ Page Title="Facturas Vencidas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CXC_FacturasVencidas.aspx.cs" Inherits="SistemaInventario.Reportes.CXC_FacturasVencidas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CXC_FacturasVencidas.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 700px">
        Reporte de Facturas Vencidas</div>
                    ...
                    <td colspan='4' style="padding-left: 4px;">
                        <div id="div_Vendedor">
                            <asp:DropDownList ID="ddlVendedor" runat="server" Font-Names="Arial" ForeColor="Blue"
                                Font-Bold="True" Width="600" BackColor="#FFFF99">
                            </asp:DropDownList>
                        </div>
                    </td>
                </tr>
                    ...
                    <td colspan='4'>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="font-weight: bold;">
                                        <asp:CheckBox ID="chkResumido" runat="server" Text="Resumido" Font-Bold="True" />
                                </td>
