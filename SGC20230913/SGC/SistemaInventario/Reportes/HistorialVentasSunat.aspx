<%@ Page Title="Historial Ventas Sunat" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistorialVentasSunat.aspx.cs" Inherits="SistemaInventario.Reportes.HistorialVentasSunat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="HistorialVentasSunat.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 300px">Reporte de Historial Ventas Sunat</div> 
                                        ...
                                        <table  cellpadding="0" cellspacing="0" class="form-inputs">
                                                   ...
                                                   <tr>    
                                                            ...
                                                            <td style="padding-left:5px;">
                                                                ...
                                                                <asp:TextBox ID="txtPeriodo" runat="server" Width="38px"  Font-Names="Arial"  ForeColor="Blue"  Font-Bold="True"   CssClass="MesAnioPicker" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                       </tr>
