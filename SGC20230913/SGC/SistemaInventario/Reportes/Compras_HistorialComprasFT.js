var AppSession = "../Reportes/Compras_HistorialComprasFT.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 300;
    var Titulo = "REPORTE DE COMPRAS";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombreTabla = "ComprasReporte";
    var NombreArchivo = "Web_Reporte_Compras_rptHistorialComprasFT.rpt";
    var CodTipoDoc = 1;
    ...
    rptURL = rptURL + 'FlagImportacion=' + FlagImportacion + '&';
