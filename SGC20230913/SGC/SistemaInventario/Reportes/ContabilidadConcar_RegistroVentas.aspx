<%@ Page Title="Ventas Concar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ContabilidadConcar_RegistroVentas.aspx.cs" Inherits="SistemaInventario.Reportes.ContabilidadConcar_RegistroVentas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ContabilidadConcar_RegistroVentas.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte de Registro de Ventas - Concar</div>
