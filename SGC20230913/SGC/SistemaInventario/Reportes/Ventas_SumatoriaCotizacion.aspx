<%@ Page Title="Reporte Sumatoria Cotizacion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_SumatoriaCotizacion.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_SumatoriaCotizacion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Ventas_SumatoriaCotizacion.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte Sumatoria Cotizacion</div>
