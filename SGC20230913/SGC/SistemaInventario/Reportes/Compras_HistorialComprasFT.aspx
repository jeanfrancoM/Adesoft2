<%@ Page Title="Record Compras" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Compras_HistorialComprasFT.aspx.cs" Inherits="SistemaInventario.Reportes.Compras_HistorialComprasFT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Compras_HistorialComprasFT.js" charset="UTF-8"></script>
            ...
            <div id="divConsultaArticulo">
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                            <td colspan='4'>
                                <asp:CheckBox ID="chkImportacion" runat="server" Text="INCLUIR IMPORTACIONES"
                                    Font-Bold="True" />
                            </td>
                        </tr>
                    </table>
