var AppSession = "../Reportes/Ventas_SumatoriaCotizacion.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 299;
    var Titulo = "REPORTE SUMATORIA COTIZACION";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombreTabla = "SumatoriaCotizacion";
    var NombreArchivo = "Web_Reporte_Ventas_rptSumatoriaCotizacion.rpt";
