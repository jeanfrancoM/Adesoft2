var AppSession = "../Reportes/CXC_FacturasVencidas.aspx";
var ddlCliente;
...
function F_Buscar(){
    ...
    $.each(ddlCliente.selected(), function (index, item) {
        ...
        var NombreArchivo = "";
        if ($('#MainContent_chkResumido').is(':checked'))
        {
            Titulo = "REPORTE DE FACTURAS VENCIDAS RESUMIDO";
            NombreArchivo = "Web_Reporte_Cobranzas_rptFacturasVencidasResumida.rpt";
            CodMenu = 407;
        }
        else
        {
            Titulo = "REPORTE DE FACTURAS VENCIDAS DETALLADO";         
            NombreArchivo = "Web_Reporte_Cobranzas_rptCobranzasGrupal.rpt";
            CodMenu = 406;
        }
