...
{
    public partial class ListaPreciosRoman : System.Web.UI.Page
    {
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " Precio4     = '" + item.Precio4 + "'";
                XmlDetalle = XmlDetalle + " Precio5     = '" + item.Precio5 + "'";
                XmlDetalle = XmlDetalle + " M1     = '" + item.M1 + "'";
                XmlDetalle = XmlDetalle + " M2     = '" + item.M2 + "'";
                XmlDetalle = XmlDetalle + " M3     = '" + item.M3 + "'";
                XmlDetalle = XmlDetalle + " M4     = '" + item.M4 + "'";
