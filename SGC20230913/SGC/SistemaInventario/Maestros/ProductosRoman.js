var AppSession = "../Maestros/ProductosKarina.aspx";
var myDropzone = null;
...
$(document).ready(function () {
    ...
    $("#MainContent_txtCosto").blur(function () {
        ...
        if ($('#MainContent_txtCosto').val() == '') {
            ...
            $('#MainContent_txtPrecio4').val('');
            if (($('#MainContent_txtCosto').val() == '' && $('#MainContent_txtMargen5').val() != ''))
                $('#MainContent_txtPrecio5').val('');
        ...
        if ($('#MainContent_txtMargen4').val() != '') {
            $('#MainContent_txtPrecio4').val($('#MainContent_txtCosto').val() * (($('#MainContent_txtMargen4').val() / 100) + 1));
        }
        if ($('#MainContent_txtMargen5').val() != '') {
            $('#MainContent_txtPrecio5').val($('#MainContent_txtCosto').val() * (($('#MainContent_txtMargen5').val() / 100) + 1));
        } 
    ...
    $("#MainContent_txtCostoEdicion").blur(function () {
        ...
        if ($('#MainContent_txtCostoEdicion').val() == '') {
            ...
            $('#MainContent_txtPrecio4Edicion').val('');
            if (($('#MainContent_txtCostoEdicion').val() == '' && $('#MainContent_txtMargen5Edicion').val() != ''))
                $('#MainContent_txtPrecio5Edicion').val('');
        ...
        if ($('#MainContent_txtMargen4Edicion').val() != '') {
            $('#MainContent_txtPrecio4Edicion').val($('#MainContent_txtCostoEdicion').val() * (($('#MainContent_txtMargen4Edicion').val() / 100) + 1));
        }
        if ($('#MainContent_txtMargen5Edicion').val() != '') {
            $('#MainContent_txtPrecio5Edicion').val($('#MainContent_txtCostoEdicion').val() * (($('#MainContent_txtMargen5Edicion').val() / 100) + 1));
        } 
    ...
    $('#MainContent_txtPrecio4').css('background', '#FFFFE0');

    $('#MainContent_txtPrecio5').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtMargen4').css('background', '#FFFFE0');

    $('#MainContent_txtMargen5').css('background', '#FFFFE0');

    $('#MainContent_txtPrecio4Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtPrecio5Edicion').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtMargen4Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtMargen5Edicion').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtD4').css('background', '#FFFFE0');

    $('#MainContent_txtD5').css('background', '#FFFFE0');

    $('#MainContent_txtD6').css('background', '#FFFFE0');

    $('#MainContent_txtD7').css('background', '#FFFFE0');

    $('#MainContent_txtM1').css('background', '#FFFFE0');

    $('#MainContent_txtM2').css('background', '#FFFFE0');

    $('#MainContent_txtM3').css('background', '#FFFFE0');

    $('#MainContent_txtD1Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtD2Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtD3Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtD4Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtD5Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtD6Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtD7Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtM1Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtM2Edicion').css('background', '#FFFFE0');

    $('#MainContent_txtM3Edicion').css('background', '#FFFFE0');
    ...
    $("#MainContent_txtMargen4").blur(function () {
        try {
            ...
            if ($('#MainContent_txtCosto').val() == '') {
                ...
                var Margen4 = ($('#MainContent_txtMargen4').val() / 100) + 1

                $("#MainContent_txtPrecio4").val($("#MainContent_txtCosto").val() * Margen4);
            }
    ...
    $("#MainContent_txtMargen5").blur(function () {
        try {
...
//            }
            ...
            if ($('#MainContent_txtCosto').val() == '') {
                ...
                var Margen5 = ($('#MainContent_txtMargen5').val() / 100) + 1

                $("#MainContent_txtPrecio5").val($("#MainContent_txtCosto").val() * Margen5);
            }
    ...
    $("#MainContent_txtPrecio5").blur(function () {
        try {


            if ($('#MainContent_txtPrecio5').val() != '') {

                $("#MainContent_txtMargen5").val('');
            } else {
    ...
    $("#MainContent_txtMargen4Edicion").blur(function () {
        try {
            ...
            if ($('#MainContent_txtCostoEdicion').val() == '') {
                ...
                var Margen4 = ($('#MainContent_txtMargen4Edicion').val() / 100) + 1

                $("#MainContent_txtPrecio4Edicion").val($("#MainContent_txtCostoEdicion").val() * Margen4);
            }
    ...
    $("#MainContent_txtMargen5Edicion").blur(function () {
        try {
            ...
            if ($('#MainContent_txtCostoEdicion').val() == '') {
                ...
                var Margen5 = ($('#MainContent_txtMargen5Edicion').val() / 100) + 1

                $("#MainContent_txtPrecio5Edicion").val($("#MainContent_txtCostoEdicion").val() * Margen5);
            }
    ...
    $("#MainContent_txtPrecio5Edicion").blur(function () {
        try {


            if ($('#MainContent_txtPrecio5Edicion').val() != '') {

                $("#MainContent_txtMargen5Edicion").val('');
            } else {
...
//            Cadena = Cadena + '<p></p>' + 'Codigo Interno';
        ...
        if ($(Cuerpo + 'txtPrecio4').val() == '')
            Cadena = Cadena + '<p></p>' + 'Precio 4';
...
function F_GrabarDocumento() {
    try {
        ...
        var Precio4Dolares = 0;
        var Precio5Dolares = 0;
        var Margen5 =0;
        ...
        if ($(Contenedor + 'ddlMoneda').val() == '1') {
            ...
            Precio4Dolares = (Number($(Contenedor + 'txtPrecio4').val()) / Number($(Contenedor + 'txtTC').val())).toFixed(2);
            Precio5Dolares = (Number($(Contenedor + 'txtPrecio5').val()) / Number($(Contenedor + 'txtTC').val())).toFixed(2);
        } else {
            ...
            Precio4Dolares = Number($(Contenedor + 'txtPrecio4').val());
            Precio5Dolares = Number($(Contenedor + 'txtPrecio5').val());
        }

        if($(Contenedor + 'txtMargen5').val()!=''){
        Margen5=Number($(Contenedor + 'txtMargen5').val());
        }
        ...
        var objParams = {
            ...
            Filtro_Precio4: $(Contenedor + 'txtPrecio4').val(),
            Filtro_Precio5: $(Contenedor + 'txtPrecio5').val(),
            Filtro_PrecioDolares: Precio1Dolares,
            Filtro_Precio2Dolares: Precio2Dolares,
            Filtro_Precio3Dolares: Precio3Dolares,
            Filtro_Precio4Dolares: Precio4Dolares,
            Filtro_Precio5Dolares: Precio5Dolares,
            ...
            //MARGEN
            Filtro_Margen1: $(Contenedor + 'txtMargen1').val(),
            Filtro_Margen2: $(Contenedor + 'txtMargen2').val(),
            Filtro_Margen3: $(Contenedor + 'txtMargen3').val(),
            Filtro_Margen4: $(Contenedor + 'txtMargen4').val(),
            Filtro_Margen5: Margen5,
            //MARGEN
            Filtro_FlagCpe: ($('#MainContent_chkCpe').is(':checked')) ? '1' : '0',
            Filtro_D1: $(Contenedor + 'txtD1').val(),
            Filtro_D2: $(Contenedor + 'txtD2').val(),
            Filtro_D3: $(Contenedor + 'txtD3').val(),
            Filtro_D4: $(Contenedor + 'txtD4').val(),
            Filtro_D5: $(Contenedor + 'txtD5').val(),
            Filtro_D6: $(Contenedor + 'txtD6').val(),
            Filtro_D7: $(Contenedor + 'txtD7').val(),
            Filtro_M1: $(Contenedor + 'txtM1').val(),
            Filtro_M2: $(Contenedor + 'txtM2').val(),
            Filtro_M3: $(Contenedor + 'txtM3').val(),
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtPrecio4').val('');
                    $(Contenedor + 'txtPrecio5').val('');

                    $(Contenedor + 'txtPartidaArancelaria').val('');
                    $(Contenedor + 'txtPais').val('');
                    $(Contenedor + 'txtAño').val('');

                    $(Contenedor + 'chkCpe').prop('checked', false);
                    $(Contenedor + 'txtD1').val('');
                    $(Contenedor + 'txtD2').val('');
                    $(Contenedor + 'txtD3').val('');
                    $(Contenedor + 'txtD4').val('');
                    $(Contenedor + 'txtD5').val('');
                    $(Contenedor + 'txtD6').val('');
                    $(Contenedor + 'txtD7').val('');
                    $(Contenedor + 'txtM1').val('');
                    $(Contenedor + 'txtM2').val('');
                    $(Contenedor + 'txtM3').val('');
                    //MARGEN
                    $(Contenedor + 'txtMargen1').val('');
                    $(Contenedor + 'txtMargen2').val('');
                    $(Contenedor + 'txtMargen3').val('');
                    $(Contenedor + 'txtMargen4').val('');
                    $(Contenedor + 'txtMargen5').val('');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        var imgID = Fila.id;
        var lblCodigo_grilla = '#' + imgID.replace('imgEditarRegistro', 'lblCodigoProducto');
        ...
        var hfPrecio4_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfPrecio4');
        var hfPrecio5_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfPrecio5');
        var hfUbicacion_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfUbicacion');
        var hfPais_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfPais');
        var hfCodEstado_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodEstado');

        var hfCpe = '#' + imgID.replace('imgEditarRegistro', 'hfCpe');
        var hfD1 = '#' + imgID.replace('imgEditarRegistro', 'hfD1');
        var hfD2 = '#' + imgID.replace('imgEditarRegistro', 'hfD2');
        var hfD3 = '#' + imgID.replace('imgEditarRegistro', 'hfD3');
        var hfD4 = '#' + imgID.replace('imgEditarRegistro', 'hfD4');
        var hfD5 = '#' + imgID.replace('imgEditarRegistro', 'hfD5');
        var hfD6 = '#' + imgID.replace('imgEditarRegistro', 'hfD6');
        var hfD7 = '#' + imgID.replace('imgEditarRegistro', 'hfD7');
        //medidas
        var hfM1 = '#' + imgID.replace('imgEditarRegistro', 'hfM1');
        var hfM2 = '#' + imgID.replace('imgEditarRegistro', 'hfM2');
        var hfM3 = '#' + imgID.replace('imgEditarRegistro', 'hfM3');
        //margenes
        var hfMargenes1 = '#' + imgID.replace('imgEditarRegistro', 'hfMargenes1');
        var hfMargenes2 = '#' + imgID.replace('imgEditarRegistro', 'hfMargenes2');
        var hfMargenes3 = '#' + imgID.replace('imgEditarRegistro', 'hfMargenes3');
        var hfMargenes4 = '#' + imgID.replace('imgEditarRegistro', 'hfMargenes4');
        var hfMargenes5 = '#' + imgID.replace('imgEditarRegistro', 'hfMargenes5');
        ...
        var Precio4 = Number($(hfPrecio4_grilla).val()).toFixed(2);
        var Precio5 = Number($(hfPrecio5_grilla).val()).toFixed(2);
        ...
        $(Cuerpo + 'txtPrecio4Edicion').val(Precio4);
        $(Cuerpo + 'txtPrecio5Edicion').val(Precio5);
        ...
        $(Cuerpo + 'txtPaisEdicion').val($(hfPais_grilla).val());
        $(Cuerpo + 'chkCpeEdicion').prop('checked', ($(hfCpe).val() === '1') ? true : false);
        $(Cuerpo + 'txtD1Edicion').val($(hfD1).val());
        $(Cuerpo + 'txtD2Edicion').val($(hfD2).val());
        $(Cuerpo + 'txtD3Edicion').val($(hfD3).val());
        $(Cuerpo + 'txtD4Edicion').val($(hfD4).val());
        $(Cuerpo + 'txtD5Edicion').val($(hfD5).val());
        $(Cuerpo + 'txtD6Edicion').val($(hfD6).val());
        $(Cuerpo + 'txtD7Edicion').val($(hfD7).val());
        //medidas
        $(Cuerpo + 'txtM1Edicion').val($(hfM1).val());
        $(Cuerpo + 'txtM2Edicion').val($(hfM2).val());
        $(Cuerpo + 'txtM3Edicion').val($(hfM3).val());
        //margenes
        $(Cuerpo + 'txtMargen1Edicion').val($(hfMargenes1).val());
        $(Cuerpo + 'txtMargen2Edicion').val($(hfMargenes2).val());
        $(Cuerpo + 'txtMargen3Edicion').val($(hfMargenes3).val());
        $(Cuerpo + 'txtMargen4Edicion').val($(hfMargenes4).val());
        if ($(hfMargenes5).val() == 0) {
            $(Cuerpo + 'txtMargen5Edicion').val('');
        } else {
            $(Cuerpo + 'txtMargen5Edicion').val($(hfMargenes5).val());
        }
...
function F_VisualizarRegistro(Fila) {
    ...
    //lblProducto
    var hlblCodigoProducto = '#' + imgID.replace('imgVisualizarRegistro', 'lblCodigoProducto'); $(Cuerpo + 'txtCodigoVisualizacion').val($(hlblCodigoProducto).val());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        if ($(Contenedor + 'ddlMonedaEdicion').val() == '1') {
            ...
            Precio4Dolares = (Number($(Contenedor + 'txtPrecio4Edicion').val()) / Number($(Contenedor + 'txtTCEdicion').val())).toFixed(2);
            Precio5Dolares = (Number($(Contenedor + 'txtPrecio5Edicion').val()) / Number($(Contenedor + 'txtTCEdicion').val())).toFixed(2);
        } else {
            ...
            Precio4Dolares = Number($(Contenedor + 'txtPrecio4Edicion').val());
            Precio5Dolares = Number($(Contenedor + 'txtPrecio5Edicion').val());
        }

         if($(Contenedor + 'txtMargen5Edicion').val()!=''){
        Margen5=Number($(Contenedor + 'txtMargen5Edicion').val());
        }
        ...
        var objParams = {
                ...
                Filtro_Precio4: $(Contenedor + 'txtPrecio4Edicion').val(),
                Filtro_Precio5: $(Contenedor + 'txtPrecio5Edicion').val(),
                Filtro_PrecioDolares: Precio1Dolares,
                Filtro_Precio2Dolares: Precio2Dolares,
                Filtro_Precio3Dolares: Precio3Dolares,
                Filtro_Precio4Dolares: Precio4Dolares,
                ...
                Filtro_FlagCpe: ($('#MainContent_chkCpeEdicion').is(':checked')) ? '1' : '0',
                Filtro_D1: $(Contenedor + 'txtD1Edicion').val(),
                Filtro_D2: $(Contenedor + 'txtD2Edicion').val(),
                Filtro_D3: $(Contenedor + 'txtD3Edicion').val(),
                Filtro_D4: $(Contenedor + 'txtD4Edicion').val(),
                Filtro_D5: $(Contenedor + 'txtD5Edicion').val(),
                Filtro_D6: $(Contenedor + 'txtD6Edicion').val(),
                Filtro_D7: $(Contenedor + 'txtD7Edicion').val(),
                //medidas
                Filtro_M1: $(Contenedor + 'txtM1Edicion').val(),
                Filtro_M2: $(Contenedor + 'txtM2Edicion').val(),
                Filtro_M3: $(Contenedor + 'txtM3Edicion').val(),
                //MARGEN
                Filtro_Margen1: $(Contenedor + 'txtMargen1Edicion').val(),
                Filtro_Margen2: $(Contenedor + 'txtMargen2Edicion').val(),
                Filtro_Margen3: $(Contenedor + 'txtMargen3Edicion').val(),
                Filtro_Margen4: $(Contenedor + 'txtMargen4Edicion').val(),
        ...
        F_EdicionRegistro_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Actualizo Correctamente.') {
                    ...
                    $('#MainContent_chkCpe').prop('checked', false);
                    $(Contenedor + 'txtD1Edicion').val('');
                    $(Contenedor + 'txtD2Edicion').val('');
                    $(Contenedor + 'txtD3Edicion').val('');
                    $(Contenedor + 'txtD4Edicion').val('');
                    $(Contenedor + 'txtD5Edicion').val('');
                    $(Contenedor + 'txtD6Edicion').val('');
                    $(Contenedor + 'txtD7Edicion').val('');
                    $(Contenedor + 'txtM1Edicion').val('');
                    $(Contenedor + 'txtM2Edicion').val('');
                    $(Contenedor + 'txtM3Edicion').val('');
