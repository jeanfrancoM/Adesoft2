...
namespace SistemaInventario.Maestros
{
    public partial class Productos : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("CantidaEdicion", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("LimiteEdicion", typeof(string));
        ...
        public void P_Permiso_Mayorista(Hashtable objTablaFiltro, ref Int32 Mayorista)
        {
            ...
            dta_consulta = objOperacion.P_Permiso_Mayorista(objEntidad);

            if (dta_consulta.Rows.Count > 0)
                Mayorista = Convert.ToInt32(dta_consulta.Rows[0]["permiso"]);
