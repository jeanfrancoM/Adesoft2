...
namespace SistemaInventario.Maestros
{
    public partial class Perfiles : System.Web.UI.Page
    {
        ...
        public static csInicializar F_Inicializar_NET(int CodEstado)
        {
            ...
            Inicializar.lCajas = (new CajaFisicaCN()).F_CajaFisica_Listar(CodEstado, Convert.ToInt32(HttpContext.Current.Session["CodSede"].ToString()), 3);
            //lleno la lista de usuarios
        ...
        public static List<UsuarioCE> F_Usuario_Listar_NET(int CodEstado, int FlagActivo) //aqui debe recibir el parametro
        {
            ...
            return objOperacion.F_Usuario_Listar(Convert.ToInt32(HttpContext.Current.Session["CodSede"].ToString()), CodEstado, FlagActivo);
        }
