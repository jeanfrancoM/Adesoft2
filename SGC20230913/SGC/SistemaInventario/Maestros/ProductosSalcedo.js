var AppSession = "../Maestros/ProductosSalcedo.aspx";
var myDropzone = null;
...
$(document).ready(function () {
    ...
    $('#MainContent_txtModeloDetalle').autocomplete(
    {
        ...
        $('#MainContent_txtFamilia').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
        ...
        select: function (e, i) {
            $('#hfIDFamilia').val(i.item.val);
            $('#MainContent_txtFamilia').val(i.item.Descripcion);
            $('#MainContent_txtCodfamilia').val(i.item.Codigo);
//            $('#MainContent_txtDescripcion').val(i.item.Descripcion);
            $('#hfDescripcionFamilia').val(i.item.Descripcion);
    ...
    $("#MainContent_txtStockMaximoEdicion").blur(function () {
      ...
      $("#MainContent_txtMargen").blur(function () {
        try {
            ...
            if ($('#MainContent_txtCosto').val() == '') {
                ...
                var Margen = ($('#MainContent_txtMargen').val() / 100) + 1
                $("#MainContent_txtPrecio1").val(parseFloat($("#MainContent_txtCosto").val() * Margen).toFixed(2));
            }
     ...
     $("#MainContent_txtMargenMinimo").blur(function () {
        try {

            if ($('#MainContent_txtMargenMinimo').val() == '') {
            ...
            if ($('#MainContent_txtCosto').val() == '') {
                ...
                var Margen = ($('#MainContent_txtMargenMinimo').val() / 100) + 1
                $("#MainContent_txtPrecio2").val(parseFloat($("#MainContent_txtCosto").val() * Margen).toFixed(2));
            }
    ...
    $("#MainContent_txtMargenEdicion").blur(function () {
        try {
            ...
            if ($('#MainContent_txtMargenEdicion').val() == '') {
            ...
            if ($('#MainContent_txtCostoEdicion').val() == '') {
                ...
                var Margen = ($('#MainContent_txtMargenEdicion').val() / 100) + 1

                $("#MainContent_txtPrecio1Edicion").val(parseFloat($("#MainContent_txtCostoEdicion").val() * Margen).toFixed(2));
            }
    ...
    $("#MainContent_txtMargenMinimoEdicion").blur(function () {
        try {

            if ($('#MainContent_txtMargenMinimoEdicion').val() == '') {
            ...
            if ($('#MainContent_txtCostoEdicion').val() == '') {
                ...
                var Margen = ($('#MainContent_txtMargenMinimoEdicion').val() / 100) + 1

                $("#MainContent_txtPrecio2Edicion").val(parseFloat($("#MainContent_txtCostoEdicion").val() * Margen).toFixed(2));
            }
    ...
    $("#MainContent_txtCosto").blur(function () {
        ...
        if ($('#MainContent_txtMargen').val() != '') {
            $('#MainContent_txtPrecio1').val(parseFloat($('#MainContent_txtCosto').val() * (($('#MainContent_txtMargen').val() / 100) + 1)).toFixed(2));
            $('#MainContent_txtPrecio2').val(parseFloat($('#MainContent_txtCosto').val() * (($('#MainContent_txtMargenMinimo').val() / 100) + 1)).toFixed(2));
        }
    ...
    $("#MainContent_txtCostoEdicion").blur(function () {
        ...
        if ($('#MainContent_txtMargenEdicion').val() != '') {
            $('#MainContent_txtPrecio1Edicion').val(parseFloat($('#MainContent_txtCostoEdicion').val() * (($('#MainContent_txtMargenEdicion').val() / 100) + 1)).toFixed(2));
             $('#MainContent_txtPrecio2Edicion').val(parseFloat($('#MainContent_txtCostoEdicion').val() * (($('#MainContent_txtMargenMinimoEdicion').val() / 100) + 1)).toFixed(2));
       }
       ...
       $("#MainContent_txtCodfamilia").blur(function () {
    

        if ($('#MainContent_txtCodfamilia').val() == '') {
            $('#MainContent_txtCodigoInterno').val($('#MainContent_txtCodfamilia').val()+'.'+$('#MainContent_txtCodigo').val());
             //$('#MainContent_txtDescripcion').val($('#MainContent_txtFamilia').val().substring(4));
           
            return true;
        }
         $('#MainContent_txtCodigoInterno').val($('#MainContent_txtCodfamilia').val()+'S.'+$('#MainContent_txtCodigo').val());
        //$('#MainContent_txtDescripcion').val($('#MainContent_txtFamilia').val().substring(4));
     ...
     $("#MainContent_txtFamilia").blur(function () {
    

        if ($('#MainContent_txtFamilia').val() == '') {
            $('#MainContent_txtCodigoInterno').val($('#MainContent_txtCodfamilia').val()+'.'+$('#MainContent_txtCodigo').val());
            //$('#MainContent_txtDescripcion').val($('#MainContent_txtFamilia').val().substring(4));
           
            return true;
        }
//        if ($('#MainContent_txtMotor').val() != '')
//        {
//          $('#MainContent_txtDescripcion').val($('#hfDescripcionFamilia').val()+' '+$('#MainContent_txtMotor').val());
//        }
      ...
      $("#MainContent_txtCodigo").blur(function () {
     ...
     $("#MainContent_txtMotor").blur(function () {
    F_Descripcion();
    });
    $("#MainContent_txtFamilia").blur(function () {
    F_Descripcion();
    });
    $("#MainContent_txtChasis").blur(function () {
    F_Descripcion();
    });
    $("#MainContent_txtDescCom").blur(function () {
    F_Descripcion();
    });

         $("#MainContent_txtMotorEdicion").blur(function () {
    F_DescripcionEdicion();
    });
    $("#MainContent_txtFamiliaEdicion").blur(function () {
    F_DescripcionEdicion();
    });
    $("#MainContent_txtChasisEdicion").blur(function () {
    F_DescripcionEdicion();
    });
    $("#MainContent_txtDescComEdicion").blur(function () {
    F_DescripcionEdicion();
    });
...
//        if ($('#MainContent_txtMotorEdicion').val() == '') {
//            $('#MainContent_txtDescripcionEdicion').val($('#hfDescripcionFamiliaEdicion').val()+' '+$('#MainContent_txtMotorEdicion').val());
//            //$('#MainContent_txtDescripcion').val($('#MainContent_txtFamilia').val().substring(4));
//           
//            return true;
//        }

//         if ($('#MainContent_txtMotorEdicion').val() != $('#hfMotorEdicion').val()) {
//         $('#MainContent_txtDescripcionEdicion').val($('#hfDescripcionFamiliaEdicion').val()+' '+$('#MainContent_txtMotorEdicion').val());
//       }
//        return true;
//    });

     $("#MainContent_txtCodfamiliaEdicion").blur(function () {
    

        if ($('#MainContent_txtCodfamiliaEdicion').val() == '') {
            $('#MainContent_txtCodigoInternoEdicion').val($('#MainContent_txtCodfamiliaEdicion').val()+'.'+$('#MainContent_txtCodigoEdicion').val());
     ...
     $("#MainContent_txtFamiliaEdicion").blur(function () {
        ...
        if ($('#MainContent_txtCodigoInternoEdicion').val() == '') {
            $('#MainContent_txtCodigoInternoEdicion').val($('#MainContent_txtCodfamiliaEdicion').val()+'.'+$('#MainContent_txtCodigoEdicion').val());
            return true;
        }
//        if ($('#MainContent_txtDescripcionEdicion').val() == ''){
//        
//           $('#MainContent_txtDescripcionEdicion').val($('#MainContent_txtFamiliaEdicion').val().substring(4)+'.');
//           return true;
//        }
        if ($('#MainContent_txtCodfamiliaEdicion').val() != $('#hfcodigoFamiliaEdicion').val()){
        $('#MainContent_txtCodigoInternoEdicion').val($('#MainContent_txtCodfamiliaEdicion').val()+'.'+$('#MainContent_txtCodigoEdicion').val());
//           $('#MainContent_txtDescripcionEdicion').val($('#hfDescripcionFamiliaEdicion').val()+' '+$('#MainContent_txtMotorEdicion').val());
        }
...
// 
      ...
      $("#MainContent_txtCodigoEdicion").blur(function () {
    

        if ($('#MainContent_txtCodigoEdicion').val() == '') {
            $('#MainContent_txtCodigoInternoEdicion').val($('#MainContent_txtCodfamiliaEdicion').val()+'.'+$('#MainContent_txtCodigoEdicion').val());
    ...
    $('#MainContent_txtProcedencia').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: '../Servicios/Servicios.asmx/F_Procedencia_AUTOCOMPLETE',
                data: "{'Descripcion':'" + request.term + "'}",
                dataType: "json",
                async: true,
                success: function (data) {
        ...
        select: function (e, i) {
            $('#hfCodProcedencia').val(i.item.val);
            $('#MainContent_txtProcedencia').val(i.item.label);
        },
        complete: function () {
    ...
    $('#MainContent_txtLinea').autocomplete(
    {
        ...
        select: function (e, i) {
            ...
            $('#MainContent_txtLinea').val(i.item.label);
        },
        complete: function () {
     ...
     $('#MainContent_txtFamiliaEdicion').autocomplete(
    {
        ...
        select: function (e, i) {
            $('#hfIDFamiliaEdicion').val(i.item.val);
            $('#MainContent_txtFamiliaEdicion').val(i.item.label);
            $('#MainContent_txtCodfamiliaEdicion').val(i.item.Codigo);
//            $('#MainContent_txtDescripcionEdicion').val(i.item.Descripcion);
            $('#hfDescripcionFamiliaEdicion').val(i.item.Descripcion);
            $('#MainContent_txtCodigoEdicion').focus();
        },
        complete: function () {
      ...
      $('#MainContent_txtFamiliaConsulta').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
        ...
        select: function (e, i) {
            $('#hfIDFamiliaConsulta').val(i.item.val);
            $('#MainContent_txtFamiliaConsulta').val(i.item.label);
//            $('#MainContent_txtCodfamiliaEdicion').val(i.item.Codigo);
        },
        complete: function () {
    ...
    $('#MainContent_txtProcedenciaEdicion').autocomplete(
    {
        source: function (request, response) {
            $.ajax({
                type: "POST",
        ...
        select: function (e, i) {
            $('#hfCodProcedenciaEdicion').val(i.item.val);
            $('#MainContent_txtProcedenciaEdicion').val(i.item.label);
        },
        complete: function () {
    ...
    $('#MainContent_txtLineaEdicion').autocomplete(
    {
        ...
        select: function (e, i) {
            ...
            $('#MainContent_txtLineaEdicion').val(i.item.label);
        },
        complete: function () {
    ...
    $("#MainContent_txtDescripcionConsulta").blur(function () {
        ...
        var cadena='';
            ...
            if ($('#MainContent_txtDescripcionConsulta').val == "" | $('#MainContent_txtDescripcionConsulta').val().length < 3){
                cadena = "Descripcion (Minimo 3 Caracteres)"
                 toastr.warning(cadena);
                 return false;
                 }
    ...
    $('#MainContent_txtDescCom').css('background', '#FFFFE0');

    

    $('#MainContent_txtDescComEdicion').css('background', '#FFFFE0');

    $('#MainContent_txtPrecio2').css('background', '#FFFFE0');
    $('#MainContent_txtMargenMinimo').css('background', '#FFFFE0');
    $('#MainContent_txtMargenMinimoEdicion').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtCodfamilia').css('background', '#FFFFE0');

    $('#MainContent_txtFamilia').css('background', '#FFFFE0');

    $('#MainContent_txtProcedencia').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtProcedenciaEdicion').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtFamiliaConsulta').css('background', '#FFFFE0');
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_Procedencia', result.split('~')[12]);
                        F_Update_Division_HTML('div_ProcedenciaEdicion', result.split('~')[13]);
                        F_Update_Division_HTML('div_Linea', result.split('~')[14]);
                        F_Update_Division_HTML('div_LineaEdicion', result.split('~')[15]);
                        ...
                        $('#MainContent_ddlProcedencia').val('-1');
                        $('#MainContent_ddlLinea').val('-1');
                        ...
                        $('#MainContent_ddlProcedenciaEdicion').css('background', '#FFFFE0');
                        $('#MainContent_ddlLinea').css('background', '#FFFFE0');
                        $('#MainContent_ddlLineaEdicion').css('background', '#FFFFE0');
...
function F_ValidarGrabarDocumento() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtFamilia').val() == '' )
            Cadena = Cadena + '<p></p>' + 'Familia';

            if ($(Cuerpo + 'txtCodigo').val().trim() == '')
            Cadena = Cadena + '<p></p>' + 'Codigo';

        if ($(Cuerpo + 'txtCodigoInterno').val().trim() == '' || $(Cuerpo + 'txtCodigoInterno').val().trim() == '.')
            Cadena = Cadena + '<p></p>' + 'Codigo Nuevo';
        ...
        if ($(Cuerpo + 'txtDescCom').val() == '')
            Cadena = Cadena + '<p></p>' + 'Desc Com';

            if ($(Cuerpo + 'ddlProcedencia').val() == null)
            Cadena = Cadena + '<p></p>' + 'Procedencia';

            if ($(Cuerpo + 'ddlLinea').val() == null)
            Cadena = Cadena + '<p></p>' + 'Linea';

            if ($(Cuerpo + 'txtMarca').val() == '' && $('#hfCodMarca').val()=='0')
        ...
        if ($(Cuerpo + 'txtCosto').val() == '' || Number($(Cuerpo + 'txtCosto').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Costo';

            if ($(Cuerpo + 'txtMargen').val() == '' || Number($(Cuerpo + 'txtMargen').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Margen General';

             if ($(Cuerpo + 'txtMargenMinimo').val() == '' || Number($(Cuerpo + 'txtMargenMinimo').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Margen Minimo';

            if ($(Cuerpo + 'txtPrecio1').val() == '' || Number($(Cuerpo + 'txtPrecio1').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Precio General';
 
            if ($(Cuerpo + 'txtPrecio2').val() == '' || Number($(Cuerpo + 'txtPrecio2').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Precio Minimo';

//        if ($(Cuerpo + 'txtPrecio3').val() == '')
//            Cadena = Cadena + '<p></p>' + 'Precio 3';

        if (parseFloat($(Cuerpo + 'txtPrecio1').val()) < parseFloat($(Cuerpo + 'txtCosto').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO GENERAL NO PUEDE SER MENOR QUE EL COSTO';

              if (parseFloat($(Cuerpo + 'txtPrecio1').val()) < parseFloat($(Cuerpo + 'txtPrecio2').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO General NO PUEDE SER MENOR QUE PRECIO MINIMO';


            if (parseFloat($(Cuerpo + 'txtPrecio2').val()) < parseFloat($(Cuerpo + 'txtCosto').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO MINIMO NO PUEDE SER MENOR QUE EL COSTO';
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        $(Contenedor + 'txtPrecio3').val('0.00');
        ...
        var objParams = {
            ...
            Filtro_Procedencia: $(Contenedor + 'ddlProcedencia').val(),
            Filtro_CodLinea: $(Contenedor + 'ddlLinea').val(),
            Filtro_Margen: $(Contenedor + 'txtMargen').val(),
            Filtro_Margen2: $(Contenedor + 'txtMargenMinimo').val(),
            Filtro_Motor: $(Contenedor + 'txtMotor').val(),
            Filtro_Chasis: $(Contenedor + 'txtChasis').val(),
            Filtro_DescCom: $(Contenedor + 'txtDescCom').val(),
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtCodfamilia').val(''),
                    $(Contenedor + 'txtFamilia').val(''),
                    $(Contenedor + 'txtProcedencia').val(''),
                    ...
                    $(Contenedor + 'txtPrecio3').val('0');
                    $(Contenedor + 'txtPrecio2').val('');
                    $(Contenedor + 'txtMargen').val('   ');
                    $(Contenedor + 'txtMargenMinimo').val('   ');
                    $(Contenedor + 'txtMotor').val('   ');
                    $(Contenedor + 'txtChasis').val('   ');
                    $(Contenedor + 'txtDescCom').val('   ');
                    $(Contenedor + 'ddlProcedencia').val('0');
                    $('#hfCodMarca').val('0');
                    $(Contenedor + 'ddlLinea').val(-1);
                    $(Contenedor + 'ddlProcedencia').val(-1);
                    $('#hfCodProcedencia').val('0');
...
function F_Buscar() {
    ...
    try {
        var objParams = {
            ...
            Filtro_IdFamilia: $('#hfIDFamiliaConsulta').val(),
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfDscFamilia_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfDscFamilia');
        var hfCodProcedencia_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodProcedencia');
        var hfCodigoProcedencia_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodigoProcedencia');
        var hfCodProducto_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodProducto');
        var hfCodMarcaProducto_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodMarcaProducto');
        var hfMargen_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfMargen');
        var hfMargen2_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfMargen2');
        var hfCodLinea_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodLinea');
        var hfLinea_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfLinea');
        var hfCodEstado_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodEstado');
        var hfMotor_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfMotor');
        var hfChasis_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfChasis');
        var hfDescCom_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfDescCom');

        var Cuerpo = '#MainContent_';

        $(Cuerpo + 'txtCodigoEdicion').val($(lblCodigoProducto_grilla).text());
        
            $('#hfcodigoFamiliaEdicion').val($(hfCodFamilia_grilla).val());
        $(Cuerpo + 'txtCodigoInternoEdicion').val($(hfCodigoInterno_grilla).val());
        $(Cuerpo + 'txtCodfamiliaEdicion').val($(hfCodFamilia_grilla).val());
        $(Cuerpo + 'txtFamiliaEdicion').val($(hfCodFamilia_grilla).val()+'-'+$(hfDscFamilia_grilla).val());
        ...
        $(Cuerpo + 'txtCodigoEdicion').val($(hfCodProducto_grilla).val());
        $(Cuerpo + 'txtMargenEdicion').val($(hfMargen_grilla).val());
        $(Cuerpo + 'txtMargenMinimoEdicion').val($(hfMargen2_grilla).val());
        $(Cuerpo + 'txtMotorEdicion').val($(hfMotor_grilla).val());
        $(Cuerpo + 'txtChasisEdicion').val($(hfChasis_grilla).val());
        $(Cuerpo + 'txtDescComEdicion').val($(hfDescCom_grilla).val());
        $('#hfMotorEdicion').val($(hfMotor_grilla).val());
        $('#hfDescripcionFamiliaEdicion').val($(hfDscFamilia_grilla).val());
        
        $(Cuerpo + 'ddlProcedenciaEdicion').val($(hfCodProcedencia_grilla).val());
        $(Cuerpo + 'ddlLineaEdicion').val($(hfCodLinea_grilla).val());

        $(Cuerpo + 'txtProcedenciaEdicion').val($(hfCodigoProcedencia_grilla).val());
        $(Cuerpo + 'txtLineaEdicion').val($(hfLinea_grilla).val());
        $(Cuerpo + 'ddlRepreEstado').val($(hfCodEstado_grilla).val());
        ...
        $('#hfCodProducto').val($(lblcodigo_grilla).val());
          $('#hfIDFamiliaEdicion').val($(hfIdFamilia_grilla).val());
            $('#hfCodMarcaEdicion').val($(hfCodMarcaProducto_grilla).val());
              $('#hfCodLineaEdicion').val($(hfCodLinea_grilla).val());
                $('#hfCodProcedenciaEdicion').val($(hfCodProcedencia_grilla).val());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            Filtro_CodProducto: $('#hfCodProducto').val(),
            Filtro_IdFamilia: $('#hfIDFamiliaEdicion').val(),
            ...
            Filtro_Procedencia: $(Contenedor + 'ddlProcedenciaEdicion'  ).val(),
            Filtro_CodLinea: $(Contenedor + 'ddlLineaEdicion'  ).val(),
            Filtro_Margen: $(Contenedor + 'txtMargenEdicion').val(),
            Filtro_Margen2: $(Contenedor + 'txtMargenMinimoEdicion').val(),
            Filtro_IdImagenProducto1: IdImagenEdit,
            Filtro_CodEstado: $(Contenedor + 'ddlRepreEstado').val(),
            Filtro_Motor: $(Contenedor + 'txtMotorEdicion').val(),
            Filtro_Chasis: $(Contenedor + 'txtChasisEdicion').val(),
            Filtro_DescCom: $(Contenedor + 'txtDescComEdicion').val(),
            Filtro_Imagenes: Sys.Serialization.JavaScriptSerializer.serialize(arrImg)
        };
...
function F_ValidarEdicionDocumento() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtCostoEdicion').val() == '' || Number($(Cuerpo + 'txtCostoEdicion').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Costo';

        if ($(Cuerpo + 'txtPrecio1Edicion').val() == ''|| Number($(Cuerpo + 'txtPrecio1Edicion').val()) == 0)
...
//            Cadena = Cadena + '<p></p>' + 'Precio 3';
        ...
        if ($(Cuerpo + 'ddlProcedenciaEdicion').val() == 0 )
            Cadena = Cadena + '<p></p>' + 'Procedencia';

        if ($(Cuerpo + 'ddlLineaEdicion').val() == 0)
            Cadena = Cadena + '<p></p>' + 'Linea';

            if ($(Cuerpo + 'txtMarcaEdicion').val() == '' && $('#hfCodMarcaEdicion').val()=='0')
            Cadena = Cadena + '<p></p>' + 'Marca';
            ...
            Cadena = Cadena + '<p></p>' + 'Codigo';
              ...
              if ($(Cuerpo + 'txtDescComEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Desc Com';

             if ($(Cuerpo + 'txtMargenEdicion').val() == '' || Number($(Cuerpo + 'txtMargenEdicion').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Margen General';

             if ($(Cuerpo + 'txtMargenMinimoEdicion').val() == '' || Number($(Cuerpo + 'txtMargenMinimoEdicion').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Margen Minimo';

        if (parseFloat($(Cuerpo + 'txtPrecio1Edicion').val()) < parseFloat($(Cuerpo + 'txtCostoEdicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO GENERAL NO PUEDE SER MENOR QUE EL COSTO';

        if (parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) < parseFloat($(Cuerpo + 'txtCostoEdicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO MINIMO NO PUEDE SER MENOR QUE EL COSTO';

//        if (parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()) < parseFloat($(Cuerpo + 'txtCostoEdicion').val()))
//            Cadena = Cadena + '<p></p>' + 'PRECIO 3 NO PUEDE SER MENOR QUE EL COSTO';

        if (parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) > 0 &  parseFloat($(Cuerpo + 'txtPrecio1Edicion').val()) < parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO GENERAL NO PUEDE SER MENOR QUE EL PRECIO MINIMO';

//        if (parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()) > 0 &  parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) < parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()))
//            Cadena = Cadena + '<p></p>' + 'PRECIO 2 NO PUEDE SER MENOR QUE EL PRECIO 3';
...
function F_Consultar_Almacenes_Stocks(CodigoProducto) {
    ...
    var CodProductoAzure = $("#" + CodigoProducto.replace("imgAgregar", "lblcodigo")).val();
...
function F_Consulta_Stock(CodigoProducto, CodigoInterno) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: '../Servicios/Servicios.asmx/F_Consulta_Stock_Azure_NET_Salcedo',
        dataType: "json",
...
function F_Inicializar_Tabla_Almacenes_Stocks() {
    ...
    //Table
    var Table = '   <table id="tbStocksAlmacenes" Class="GridView"> <thead> <tr> <th style="width:180px"> sucursales </th> <th style="width:25px"> Stock </th> </tr> </thead> ' +
...
function F_HistorialMargenes(Fila) {
//    if (F_PermisoOpcion(CodigoMenu, '333004', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try {
        var imgID = Fila.id;
        var hfCodProducto = '#' + imgID.replace('imgHistorialMargen', 'lblcodigo');
        var lblCodigoProducto_grilla = '#' + imgID.replace('imgHistorialMargen', 'lblCodigoProducto');
        var lblProducto_grilla = '#' + imgID.replace('imgHistorialMargen', 'lblProducto');
        var lblMarca_grilla = '#' + imgID.replace('imgHistorialMargen', 'hfMarca');
        var lblcostomercado_grilla = '#' + imgID.replace('imgHistorialMargen', 'hfCostoMercado');
        var hfCodMoneda_grilla = '#' + imgID.replace('imgHistorialMargen', 'hfCodMoneda');
        var Mon = 'S/ ';
        if ($(hfCodMoneda_grilla).val() === '2')
            Mon = '$/ '

        var MarcaProducto = $(lblMarca_grilla).text();
        var TituloProducto = $(lblCodigoProducto_grilla).val() + ' - ' + $(lblProducto_grilla).text();
//        $('#MainContent_txtCostoActual').val(Mon + $(lblcostomercado_grilla).val());
        ...
        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
        MostrarEspera(true);
        F_ConsultaHistorialMargenes_NET(arg, function (result) {
            var str_resultado_operacion = "";
            var str_mensaje_operacion = "";

            if (result.split('~')[1] == "") {

                F_Update_Division_HTML('div_grvHistorialMargenes', result.split('~')[2]);
...
//                $('#MainContent_txtMarcaHistorial').val(MarcaProducto);
                ...
                $("#div_HistorialMargen").dialog({
                    resizable: false,
                    modal: true,
                    title: "Historial de Margenes de Productos",
                    title_html: true,
                    height: 500,
                    width: 1150,
                    autoOpen: false
                ...
                $('#div_HistorialMargen').dialog('open');
            }
            else {
                toastr.warning(result.split('~')[1]);
            }
...
function F_HistorialCosto(Fila) {
//    if (F_PermisoOpcion(CodigoMenu, '333004', '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    try {
        var imgID = Fila.id;
        ...
        var lblMarca_grilla = '#' + imgID.replace('imgHistorialCosto', 'hfMarca');
...
//        $('#MainContent_txtCostoActual').val(Mon + $(lblcostomercado_grilla).val());
        ...
        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
        MostrarEspera(true);
        F_ConsultaHistorialCosto_NET(arg, function (result) {
            var str_resultado_operacion = "";
            var str_mensaje_operacion = "";

            if (result.split('~')[1] == "") {

                F_Update_Division_HTML('div_grvHistorialCosto', result.split('~')[2]);


                $("#div_HistorialCosto").dialog({
                    resizable: false,
                    modal: true,
                    title: "Historial de Costos de Productos",
                    title_html: true,
                    height: 500,
                    width: 1150,
                    autoOpen: false
                ...
                $('#div_HistorialCosto').dialog('open');
            }
            else {
                toastr.warning(result.split('~')[1]);
            }
...
function F_Descripcion(){
    
    var Familia=$('#hfDescripcionFamilia').val();
    var Motor=$('#MainContent_txtMotor').val();
    var Chasis=$('#MainContent_txtChasis').val();
    var DscCom=$('#MainContent_txtDescCom').val();

    
       $('#MainContent_txtDescripcion').val(Familia+' '+Motor+' '+Chasis+' '+DscCom);
      
}

function F_DescripcionEdicion(){
    
    var Familia=$('#hfDescripcionFamiliaEdicion').val();
    var Motor=$('#MainContent_txtMotorEdicion').val();
    var Chasis=$('#MainContent_txtChasisEdicion').val();
    var DscCom=$('#MainContent_txtDescComEdicion').val();

    
       $('#MainContent_txtDescripcionEdicion').val(Familia+' '+Motor+' '+Chasis+' '+DscCom);
