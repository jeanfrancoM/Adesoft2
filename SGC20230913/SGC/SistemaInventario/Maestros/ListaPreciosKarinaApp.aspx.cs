...
{
    public partial class ListaPreciosKarinaApp : System.Web.UI.Page
    {
        ...
        private string _menu = "1000"; private string _opcion = "20";
        ...
        public void P_Inicializar_GrillaVacia()
        {
            ...
            dta_consultaarticulo.Columns.Add("EmpresaRuc", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("CodigoApp", typeof(string));
            dta_consultaarticulo.Columns.Add("Familia", typeof(string));
            dta_consultaarticulo.Columns.Add("CantidadImagenes", typeof(string));
            dta_consultaarticulo.Columns.Add("PublicadoApp", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("TipoValorUM", typeof(string));
            dta_consultaarticulo.Columns.Add("UM", typeof(string));

            dta_consultaarticulo.Columns.Add("Tags", typeof(string));
            dta_consultaarticulo.Columns.Add("TagsMarcaModelo", typeof(string));
            dta_consultaarticulo.Columns.Add("TagsMarcas", typeof(string));
            dta_consultaarticulo.Columns.Add("TagsModelos", typeof(string));
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            objEntidad.SoloConImagenes = Convert.ToInt32(objTablaFiltro["Filtro_SoloConImagenes"]);
            objEntidad.SoloYaEnviados = Convert.ToInt32(objTablaFiltro["Filtro_SoloYaEnviados"]);

            objOperacion = new LGProductosCN();

            grvConsulta.DataSource = objOperacion.F_LGProductos_Listar_App(objEntidad);
