...
{
    public partial class FamiliasSalcedo : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodigoFamilia = Convert.ToString(objTablaFiltro["Filtro_CodigoFamilia"]);
            ...
            objOperacion.F_LGFamilias_Insert_Salcedo(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_LGFamilias_Listado_Salcedo(objEntidad);
        ...
        public void P_EliminarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_LGFamilias_Delete_Salcedo(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.DscFamilia = Convert.ToString(objTablaFiltro["Filtro_DscFamilia"]);
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            objEntidad.CodigoFamilia = Convert.ToString(objTablaFiltro["Filtro_CodFamilia"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);

            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_LGFamilias_Update_Salcedo(objEntidad);
