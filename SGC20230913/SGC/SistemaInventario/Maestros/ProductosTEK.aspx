    ...
    CodeBehind="ProductosTEK.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosTEK" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosTEK.js" charset="UTF-8"></script>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtCodigo" runat="server" Width="170px" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtMarca" runat="server" Width="170px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                       <td style="font-weight: bold">
                                                        MEDIDA
                                                       ...
                                                       <td>
                                                        <asp:TextBox ID="txtMedida" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Posicion
                                                    ...
                                                    <td style="padding-left: 1px;">
                                                        <asp:TextBox ID="txtPosicion" runat="server" Width="63px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        um
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold;padding-left: 98px">
                                                        Costo
                                                    </td>
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                  ...
                  <%--      <asp:TemplateField ItemStyle-Width="20px">
                        ...
                        <asp:BoundField DataField="Precio1" HeaderText="MAYORISTA" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="170px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                  <td style="font-weight: bold">
                                        medida
                                                         ...
                                                         <td>
                                                    <asp:TextBox ID="txtMedidaEdicion" runat="server" Width="148px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    Posicion
                                                ...
                                                <td >
                                                    <asp:TextBox ID="txtPosicionEdicion" runat="server" Width="63px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    UM
