...
{
    public partial class ClientesPyme : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_ActivarRegistroContacto_NET);
            ...
            CallbackManager.Register(F_EliminarContactos_Net);
            CallbackManager.Register(F_LlenarGridDetalle_NET);
            CallbackManager.Register(F_Correo_NET);
        }
        ...
        protected void grvConsultaDetalle_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HiddenField hfPrincipal = null;
                HiddenField hfCodEstado = null;
                HiddenField hfGPSLong = null;
                ImageButton imgBtnPrincipal = null;
                ImageButton imgBtnEstado = null;
                ImageButton imgBtnGPSCompartir = null;
                ImageButton imgBtnGPSCopiar = null;
                ImageButton imgBtnGPSAbrir = null;
                GridView grvDetalleCorreo = null;

                grvDetalle = (GridView)(e.Row.FindControl("grvDetalleDocumentos"));
                lblCodigo = (HiddenField)(e.Row.FindControl("hfCodigo"));
                hfPrincipal = (HiddenField)(e.Row.FindControl("hfPrincipal"));
                hfCodEstado = (HiddenField)(e.Row.FindControl("hfCodEstado"));
                hfGPSLong = (HiddenField)(e.Row.FindControl("hfGPSLong"));
                imgBtnPrincipal = (ImageButton)(e.Row.FindControl("imgPrincipal"));
                imgBtnEstado = (ImageButton)(e.Row.FindControl("imgActivarRegistro"));
                imgBtnGPSCompartir = (ImageButton)(e.Row.FindControl("imgGPS"));
                imgBtnGPSCopiar = (ImageButton)(e.Row.FindControl("imgCopiar"));
                imgBtnGPSAbrir = (ImageButton)(e.Row.FindControl("imgAbrir"));
                grvDetalleCorreo = (GridView)(e.Row.FindControl("grvDetalleCorreo"));
                ...
                if (lblCodigo.Value.ToString() != "")
                {
                    ...
                    try
                    {
                        ...
                        imgBtnGPSCopiar.Enabled = false;
                        imgBtnGPSAbrir.Enabled = false;
                        imgBtnGPSCopiar.ImageUrl = "../Asset/images/nada.png";
                        imgBtnGPSAbrir.ImageUrl = "../Asset/images/nada.png";
                        imgBtnGPSCopiar.ToolTip = "SIN UBICACION GPS ASIGNADO";
                        imgBtnGPSAbrir.ToolTip = "SIN UBICACION GPS ASIGNADO";


                        if (hfGPSLong.Value.ToString() != "")
                        {

                            if (hfGPSLong.Value.ToString() != "0.00000000000000000")
                            {
                                imgBtnGPSCopiar.Enabled = true;
                                imgBtnGPSAbrir.Enabled = true;
                                imgBtnGPSCopiar.ImageUrl = "../Asset/images/historial.png";
                                imgBtnGPSAbrir.ImageUrl = "../Asset/images/gpsgoogleiconx36.png";
                                imgBtnGPSCopiar.ToolTip = "Click para copiar la ubicacion de mapa";
                                imgBtnGPSAbrir.ToolTip = "Click para Abrir la ubicacion de mapa";
                            }
                        }
                    }
                    catch (Exception ex)
                    ...
                    grvDetalleCorreo.DataSource = dta_consultaarticulo;
                    grvDetalleCorreo.DataBind();
        ...
        protected void grvConsultaContacto_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                GridView grvDetalle = null;
                ...
                grvDetalle = (GridView)(e.Row.FindControl("grvContactos"));
                lblCodigo = (HiddenField)(e.Row.FindControl("hfCodCtaCte"));
                hfCodEstado = (HiddenField)(e.Row.FindControl("hfCodEstado"));
                imgBtnEstado = (ImageButton)(e.Row.FindControl("imgActivarRegistroContacto"));
        ...
        protected void grvConsultaDireccionesPOPUP_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                GridView grvDetalle = null;
                ...
                if (lblCodigo.Text != "")
                {
                    ...
                    if (hfCodEstado.Value == "2")
                    {
                        imgBtnGPSCompartir.ImageUrl = "../Asset/images/poweroff.png";
                        imgBtnGPSCompartir.ToolTip = "INACTIVO: PRESIONES PARA ACTIVAR";
                    }

                    try
                    {
                        imgBtnGPSCompartir.Enabled = false;
                        imgBtnGPSCompartir.ToolTip = "SIN UBICACION GPS ASIGNADO";
                        imgBtnGPSCompartir.ImageUrl = "../Asset/images/nada.png";

                        decimal gpsLong = Convert.ToDecimal(hfGPSLong.Value);

                        if (gpsLong != 0)
                        {
                            imgBtnGPSCompartir.Enabled = true;
                            imgBtnGPSCompartir.ToolTip = "Click para copiar la ubicacion de mapa";
                            imgBtnGPSCompartir.ImageUrl = "../Asset/images/gpsgoogleiconx36.png";
                        }
                    }
                    catch (Exception ex)
                    {
        ...
        public String F_Buscar_NET(String arg)
        {
            ...
            String str_grvDirecciones_html = "";
            String str_grvContactos_html = "";
            int int_resultado_operacion = 0;
            DataTable dt = null;
            int Count = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Buscar(obj_parametros, ref grvConsulta, ref dt);
                ...
                {
                    str_mensaje_operacion = "";
                    int id = int.Parse(dt.Rows[0]["Codigo"].ToString());
                    P_BuscarContactos(id, ref grvContactos, ref Count);
                    if (grvContactos.Rows.Count == 0)
                    {
                        P_Inicializar_GrillaVacia_Contactos();
                    }
                ...
                str_grvContactos_html = Mod_Utilitario.F_GetHtmlForControl(grvContactos);
                int_resultado_operacion = 1;
            ...
            str_resultado =
                ...
                + "~" +
                str_grvDirecciones_html
                + "~" +
                str_grvContactos_html;
        ...
        public void P_Inicializar_GrillaVacia_Direcciones()
        {
            ...
            dta_consultaarticulo.Columns.Add("Contacto", typeof(string));
            dta_consultaarticulo.Columns.Add("Destino", typeof(string));
            dta_consultaarticulo.Columns.Add("CodRutaDespacho", typeof(string));
            dta_consultaarticulo.Columns.Add("CodRutaDespachoHermana", typeof(string));
            dta_consultaarticulo.Columns.Add("GPSLong", typeof(string));
            dta_consultaarticulo.Columns.Add("GPSLat", typeof(string));
            dta_consultaarticulo.Columns.Add("GPSDireccion", typeof(string));
            ...
            grvConsultaDetalle.DataSource = dta_consultaarticulo;
            grvConsultaDetalle.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.GpsLong = Convert.ToDecimal(objTablaFiltro["Filtro_GPSLong"]);
            objEntidad.GpsLat = Convert.ToDecimal(objTablaFiltro["Filtro_GPSLat"]);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar, ref DataTable dt)
        {
        ...
        public String F_Contactos_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_BuscarContactos(CodCtaCte, ref grvContactos, ref Count);
                if (Count == 0)
                {
                    P_Inicializar_GrillaVacia_Contactos();
                    str_mensaje_operacion = "No se encontraron registros.";
        ...
        public String F_GrabarContacto_NET(String arg)
        {
            ...
            try
            {
                ...
                P_BuscarContactos(CodContacto, ref grvContactos, ref Count);
        ...
        public String F_ActualizarContactos_NET(String arg)
        {
            ...
            try
            {
                ...
                CodCtaCte = Convert.ToInt32(obj_parametros["Filtro_CodCtaCte"]);
                P_BuscarContactos(CodCtaCte, ref grvContactos, ref Count);
        ...
        public void P_BuscarContactos(int CodCtaCte, ref GridView GrillaBuscar, ref int Count)
        {
        ...
        public void P_BuscarMotivo(int CodCtaCte, ref GridView GrillaBuscar)
        {
            //CONSULTA DEL CLIENTE
            TCCuentaCorrienteCE objEntidad = null;
            TCCuentaCorrienteCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_TCCuentaCorriente_BuscarMotivo(objEntidad);
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                //Consulta
                TCDistritoCN objOperacion = new TCDistritoCN();
                TCDistritoCE objEntidad = new TCDistritoCE(); objEntidad.CodCtaCte = Convert.ToInt32(Codigo);

                grvConsultaDetalle.DataSource = objOperacion.F_TCDireccion_ListarXCodCtaCte(objEntidad);
                grvConsultaDetalle.DataBind();
                if (grvConsultaDetalle.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_Direcciones();
                }
                ...
                str_grv_Detalle_html = Mod_Utilitario.F_GetHtmlForControl(grvConsultaDetalle);
        ...
        public String F_EliminarContactos_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvContacto_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarContactos(obj_parametros, ref str_mensaje_operacion);
                CodCtaCte = Convert.ToInt32(obj_parametros["Filtro_CodCtaCte"]);
                P_BuscarContactos(CodCtaCte, ref grvContactos, ref Count);
                if (Count == 0)
                    P_Inicializar_GrillaVacia_Contactos();
        ...
        public void P_EliminarContactos(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ContactosCE objEntidad = null;
            TCCuentaCorrienteCN objOperacion = null;
            ...
            objOperacion.F_Contactos_Eliminar(objEntidad);
        ...
        public String F_ActivarRegistroContacto_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvContacto_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_ActivarRegistroContacto(obj_parametros, ref str_mensaje_operacion);
                CodCtaCte = Convert.ToInt32(obj_parametros["Filtro_CodCtaCte"]);
                P_BuscarContactos(CodCtaCte, ref grvContactos, ref Count);
                if (Count == 0)
                    P_Inicializar_GrillaVacia_Contactos();
        ...
        public void F_ActivarRegistroContacto(Hashtable objTablaFiltro, ref String MsgError)
        {

            TCDistritoCN objOperacion = null;
            objOperacion = new TCDistritoCN();

            bool respuesta = objOperacion.F_TCContacto_ActivarDesactivar(Convert.ToInt32(objTablaFiltro["Filtro_CodContacto"]), Convert.ToInt32(objTablaFiltro["Filtro_NuevoEstado"]), out MsgError);
        }

        public String F_Correo_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            ...
            try
            {
                ...
                GridView grvCorreo = (GridView)grvConsultaDetalle.Rows[0].FindControl("grvDetalleCorreo");
                ...
                grvCorreo.DataSource = objOperacion.F_CORREO_DIRECCION(objEntidad);
                grvCorreo.DataBind();

                str_grv_Correo_html = Mod_Utilitario.F_GetHtmlForControl(grvCorreo);
            }
            catch (Exception exxx)
            {
                str_resultado = "ERROR AL BUSCAR DETALLE: " + exxx;
