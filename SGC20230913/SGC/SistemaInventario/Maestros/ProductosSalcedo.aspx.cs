...
{
    public partial class ProductosSalcedo : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_ConsultaHistorialMargenes_NET);
            CallbackManager.Register(F_ConsultaHistorialCosto_NET);
        }
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_Procedencia_html = "";
            String str_ddl_ProcedenciaEdicion_html = "";
            String str_ddl_Linea_html = "";
            String str_ddl_LineaEdicion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlProcedencia, ref ddlProcedenciaEdicion, ref ddlLinea, ref ddlLineaEdicion);
                ...
                str_ddl_Procedencia_html = Mod_Utilitario.F_GetHtmlForControl(ddlProcedencia);
                str_ddl_ProcedenciaEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlProcedenciaEdicion);
                str_ddl_Linea_html = Mod_Utilitario.F_GetHtmlForControl(ddlLinea);
                str_ddl_LineaEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlLineaEdicion);
            ...
            str_resultado =
                ...
                + "~" +
                str_ddl_Procedencia_html
                + "~" +
                str_ddl_ProcedenciaEdicion_html
                + "~" +
                str_ddl_Linea_html
                + "~" +
                str_ddl_LineaEdicion_html
                + "~" +
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
            ...
            ref DropDownList ddl_comboProcedencia, ref DropDownList ddl_comboProcedenciaEdicion, ref DropDownList ddl_comboLinea, ref DropDownList ddl_comboLineaEdicion)
        {
            ...
            //procedencia linea
            dta_consulta = null;
            TCCuentaCorrienteCN objOperacionConcepto = null;

            objOperacionConcepto = new TCCuentaCorrienteCN();

            dta_consulta = objOperacionConcepto.F_Procedencia_Listar();

            ddl_combofamilia.Items.Clear();

            ddl_comboProcedencia.DataSource = dta_consulta;
            ddl_comboProcedencia.DataTextField = "DscProcedencia";
            ddl_comboProcedencia.DataValueField = "CodProcedencia";
            ddl_comboProcedencia.DataBind();

            ddl_comboProcedenciaEdicion.Items.Clear();

            ddl_comboProcedenciaEdicion.DataSource = dta_consulta;
            ddl_comboProcedenciaEdicion.DataTextField = "DscProcedencia";
            ddl_comboProcedenciaEdicion.DataValueField = "CodProcedencia";
            ddl_comboProcedenciaEdicion.DataBind();

            dta_consulta = null;
            dta_consulta = objOperacionConcepto.F_Linea_Listar();

            ddl_combofamilia.Items.Clear();

            ddl_comboLinea.DataSource = dta_consulta;
            ddl_comboLinea.DataTextField = "DscLinea";
            ddl_comboLinea.DataValueField = "CodLinea";
            ddl_comboLinea.DataBind();

            ddl_comboLineaEdicion.Items.Clear();

            ddl_comboLineaEdicion.DataSource = dta_consulta;
            ddl_comboLineaEdicion.DataTextField = "DscLinea";
            ddl_comboLineaEdicion.DataValueField = "CodLinea";
            ddl_comboLineaEdicion.DataBind();
        }
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodProcedencia", typeof(string));
            dta_consultaarticulo.Columns.Add("CodigoProcedencia", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("DescCom", typeof(string));
            dta_consultaarticulo.Columns.Add("Margen2", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.M1 = Convert.ToDecimal(objTablaFiltro["Filtro_Margen"]);
            objEntidad.M2 = Convert.ToDecimal(objTablaFiltro["Filtro_Margen2"]);
            ...
            objEntidad.DescComp = Convert.ToString(objTablaFiltro["Filtro_DescCom"]);
            ...
            objOperacion.F_LGProductos_Insert_Salcedo(objEntidad, "", "", "", "", "", "");
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Salcedo(objEntidad, "", "", "", "", "", "");
        ...
        public String F_ConsultaHistorialMargenes_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            Int32 int_resultado_operacion = 0;
            String str_grvConsulta_Margenes_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_ConsultaHistorialAuditoria(obj_parametros, ref grvHistorialMargenes);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";

                str_grvConsulta_Margenes_html = Mod_Utilitario.F_GetHtmlForControl(grvHistorialMargenes);
            }
            catch (Exception ex)
            {
        ...
        public void F_ConsultaHistorialAuditoria(Hashtable objTablaFiltro, ref GridView gridMargenes)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            //grid de costos
            objOperacion = new LGProductosCN();
            dtTabla = objOperacion.F_LGProductos_HistorialMargenes(objEntidad);

            gridMargenes.DataSource = dtTabla;
            gridMargenes.DataBind();
        ...
        public String F_ConsultaHistorialCosto_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            Int32 int_resultado_operacion = 0;
            String str_grvConsulta_Costo_html = "";
            String str_grvConsulta_Precios_html = "";
            Hashtable obj_parametros = null;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_ConsultaCostoAuditoria(obj_parametros, ref grvHistorialCosto);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";

                str_grvConsulta_Costo_html = Mod_Utilitario.F_GetHtmlForControl(grvHistorialCosto);
            }
            catch (Exception ex)
            {
            ...
            str_resultado =
                Convert.ToString(int_resultado_operacion) + "~" +
                str_mensaje_operacion + "~" +
                str_grvConsulta_Costo_html;

            return str_resultado;

        }

        public void F_ConsultaCostoAuditoria(Hashtable objTablaFiltro, ref GridView gridCosto)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            //grid de costos
            objOperacion = new LGProductosCN();
            dtTabla = objOperacion.F_LGProductos_HistorialCosto(objEntidad);
