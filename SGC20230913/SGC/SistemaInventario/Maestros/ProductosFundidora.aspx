<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosFundidora.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosFundidora" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosFundidora.js" charset="UTF-8"></script>
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                     ...
                                                     <td style="font-weight: bold; padding-left: 198px">
                                                        Moneda
                                                    </td>
                                                    <td style="padding-left: 2px;">
                                                        <div id="div_moneda">
                                    ...
                                    <tr style="display: none;">
                                     ...
                                     <tr >
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
            ...
            <div>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                        ...
                                        <asp:BoundField DataField="Observacion" HeaderText="Observacion" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Categoria" HeaderText="Categoria" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                        ...
                        <td valign="top" style="padding-left: 5px;display: none;">
                        ...
                        <div class="ui-jqdialog-content" style="width: 700px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            ...
                                            <td style="font-weight: bold; padding-left: 138px">
                                                    Moneda
                                                </td>
                                                <td style="padding-left: 2px;">
                                                ...
                                                <td style="padding-left: 34px">
                                                    <asp:TextBox ID="txtCostoEdicion" runat="server" Width="96px" Font-Names="Arial"
                                ...
                                <tr >
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="568px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
