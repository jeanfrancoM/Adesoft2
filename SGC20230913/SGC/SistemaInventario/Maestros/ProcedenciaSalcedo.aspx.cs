...
{
    public partial class ProcedenciaSalcedo : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodigoProcedencia = Convert.ToString(objTablaFiltro["Filtro_Codigo"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.IPRegistro = "";

            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_Procedencia_Insertar_Salcedo(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objOperacion = new TCCuentaCorrienteCN();
            objEntidad = new TCCuentaCorrienteCE();
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_DscProcedencia"]);

            dta_consulta = objOperacion.F_Procedencia_Listado_Salcedo(objEntidad);
        ...
        public void P_EliminarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objEntidad.CodProcedencia = Convert.ToInt32(objTablaFiltro["Filtro_CodProcedencia"]);

            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_Procedencia_Eliminar_Salcedo(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodProcedencia = Convert.ToInt32(objTablaFiltro["Filtro_CodProcedencia"]);
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]);
            objEntidad.CodigoProcedencia = Convert.ToString(objTablaFiltro["Filtro_CodigoEdicion"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);

            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_Procedencia_Actualizar_Salcedo(objEntidad);
