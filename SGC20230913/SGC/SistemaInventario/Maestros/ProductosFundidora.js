var AppSession = "../Maestros/ProductosFundidora.aspx";
var myDropzone = null;
...
$(document).on("change", "select[id $= 'MainContent_ddlcategoria']", function () {
    ...
    if ($("#MainContent_ddlcategoria").val() == '1'){
        $("#MainContent_txtCosto").prop('disabled', true);
        $("#MainContent_txtCosto").val('0');
        }

        else
            $("#MainContent_txtCosto").prop('disabled', false);
...
$(document).on("change", "select[id $= 'MainContent_ddlcategoriaedicion']", function () {
    ...
    if ($("#MainContent_ddlcategoriaedicion").val() == '1'){
        $("#MainContent_txtCostoEdicion").prop('disabled', true);
        $("#MainContent_txtCostoEdicion").val('0');
        }
        else
            $("#MainContent_txtCostoEdicion").prop('disabled', false);
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_categoria', result.split('~')[13]);
                        ...
                        F_Update_Division_HTML('div_categoriaedicion', result.split('~')[14]);
...
//            Cadena = Cadena + '<p></p>' + 'Codigo Interno';
    ...
    if ($(Cuerpo + 'ddlcategoria').val().trim() == '0')
        ...
        if ($(Cuerpo + 'txtCosto').val() == '0' && $(Cuerpo + 'ddlcategoria').val()=='2')
            Cadena = Cadena + '<p></p>' + 'Costo';
...
//        if (parseFloat($(Cuerpo + 'txtPrecio3').val()) > 0 &  parseFloat($(Cuerpo + 'txtPrecio3').val()) < parseFloat($(Cuerpo + 'txtCosto').val()))
...
//        if (parseFloat($(Cuerpo + 'txtPrecio3').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio2').val()) < parseFloat($(Cuerpo + 'txtPrecio3').val()))
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Categoria: $(Contenedor + 'ddlcategoria').val(),
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtCosto').val('0.00');
                    $(Contenedor + 'txtCosto').prop('disabled', true);
...
function F_Nuevo() {
    ...
    $(Contenedor + 'txtPrecio1').val('0'),
    $(Contenedor + 'txtPrecio2').val('0');
    $(Contenedor + 'txtPrecio3').val('0');
    $(Contenedor + 'txtUbicacion').val('');
    $(Contenedor + 'txtObservacion').val('');
    $(Contenedor + 'MainContent_ddlcategoria').val('1');
    $(Contenedor + 'txtStockMinimo').val('0.00');
    $(Contenedor + 'txtStockMaximo').val('0.00');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfCodCategoria_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCodCategoria');
        ...
        $(Cuerpo + 'ddlcategoriaedicion').val($(hfCodCategoria_grilla).val());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Imagenes: Sys.Serialization.JavaScriptSerializer.serialize(arrImg),
            Filtro_categoria: $(Contenedor + 'ddlcategoriaedicion').val(),
...
function F_ValidarEdicionDocumento() {
    ...
    try {
        ...
        if ($(Cuerpo + 'txtPrecio1Edicion').val() == '')
            ...
            if ($(Cuerpo + 'ddlcategoriaedicion').val().trim() == '0')
            Cadena = Cadena + '<p></p>' + 'Categoria';
...
//            if (parseFloat( $(Cuerpo + 'txtCostoEdicion').val()) == 0 && $(Cuerpo + 'ddlcategoriaedicion').val()=='2')
//            Cadena = Cadena + '<p></p>' + 'Costo';
