...
{
    public partial class ProductosReeim : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlEstadoEdicion);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_comboventaedicion, ref DropDownList ddl_combomonedaedicion, ref DropDownList ddl_comboestadoedicion)
        {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("Precio1Original", typeof(string));
            dta_consultaarticulo.Columns.Add("Precio2Original", typeof(string));
            dta_consultaarticulo.Columns.Add("CostoSimbolo", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodigoFabrica = Convert.ToString(objTablaFiltro["Filtro_CodigoFabrica"]);
        ...
        public void P_Obtener_TipoCambio(Hashtable objTablaFiltro, ref Decimal TipoCambio)
        {
            ...
            objEntidad.Fecha = DateTime.Now;//Convert.ToDateTime(objTablaFiltro["Filtro_Fecha"]);
