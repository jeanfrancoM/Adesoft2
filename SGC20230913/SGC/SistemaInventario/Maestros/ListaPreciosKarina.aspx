<%@ Page Title="Lista Precios" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ListaPreciosKarina.aspx.cs" Inherits="SistemaInventario.Maestros.ListaPreciosKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ListaPreciosKarina.js"   charset="UTF-8"></script>   
            ...
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="COSTO">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblCostoOriginal" Text='<%# Bind("CostoOriginal") %>' CssClass="detallesart" Font-Size="Medium"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
               
         
            
                    <asp:TemplateField HeaderText="MINORISTA - 1" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="MINORISTA - 2" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtPrecioLista2" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
                                Text='<%# Bind("Precio2") %>' Enabled="False"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="MAYORISTA" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtPrecioLista3" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
