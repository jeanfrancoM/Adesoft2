...
namespace SistemaInventario.Maestros
{
    public partial class Bancos : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("bancointerno", typeof(string));
            dta_consultaarticulo.Columns.Add("Caja", typeof(string));
            dta_consultaarticulo.Columns.Add("DscBanco", typeof(string));
            dta_consultaarticulo.Columns.Add("FlagCaja", typeof(string));
            dta_consultaarticulo.Columns.Add("FlagBancoInterno", typeof(string));
