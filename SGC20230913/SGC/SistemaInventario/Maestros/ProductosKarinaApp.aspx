<%@ Page Title="Productos App" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductosKarinaApp.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosKarinaApp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosKarinaApp.js"
        charset="UTF-8"></script>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtMarca" runat="server" Width="244" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Modelo
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" >
                                                <tr>
                                                    <td style="padding-left: 11px;">
                                                        <div id="div1">
                                                            <asp:DropDownList ID="ddlSeVendeEnApp" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="207">
                                                                <asp:ListItem Value="0">NO SE VENDE EN APP</asp:ListItem>
                                                                <asp:ListItem Value="1">SE VENDE EN APP</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtPrecioApp" runat="server" Width="60px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" >
                                                <tr>
                                                    <td style="padding-left: 11px;">
                                                        <asp:TextBox ID="txtTituloApp" runat="server" Width="400px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" >
                                                <tr>
                                                    <td style="padding-left: 11px;">
                                                        <asp:TextBox ID="txtDescripcionDetalleApp" runat="server" Width="400px" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfPrecioApp" runat="server" Value='<%# Bind("PrecioAppEdicion") %>' />
                                <asp:HiddenField ID="hfPrecioAppDolares" runat="server" Value='<%# Bind("PrecioAppDolaresEdicion") %>' />
                                <asp:HiddenField ID="hfSeVendeEnApp" runat="server" Value='<%# Bind("SeVendeEnApp") %>' />
                                <asp:HiddenField ID="hfTituloApp" runat="server" Value='<%# Bind("TituloApp") %>' />
                        ...
                        <asp:BoundField DataField="Precio1" HeaderText="M-1" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Precio2" HeaderText="M-2" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Precio3" HeaderText="MAY" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="Raymondi" HeaderText="Ray" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Principal" HeaderText="Pri" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Chorrillos" HeaderText="Cho" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="5TO PISO" HeaderText="5P" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="CUADRA 3" HeaderText="C3" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="LURIN 1" HeaderText="Lu1" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="LURIN 2" HeaderText="Lu2" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="LA CURVA" HeaderText="AC" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="VES" HeaderText="VES" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="244px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    Modelo
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td style="padding-left: 11px;">
                                                    <div id="div2">
                                                        <asp:DropDownList ID="ddlSeVendeEnAppEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" Width="207">
                                                            <asp:ListItem Value="0">NO SE VENDE EN APP</asp:ListItem>
                                                            <asp:ListItem Value="1">SE VENDE EN APP</asp:ListItem>
                                                        </asp:DropDownList>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecioAppEdicion" runat="server" Width="60px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td style="padding-left: 11px;">
                                                    <asp:TextBox ID="txtTituloAppEdicion" runat="server" Width="400px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td style="padding-left: 11px;">
                                                    <asp:TextBox ID="txtDescripcionDetalleAppEdicion" runat="server" Width="400px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
