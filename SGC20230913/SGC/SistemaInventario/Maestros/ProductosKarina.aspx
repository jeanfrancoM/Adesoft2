<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductosKarina.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosKarina.js" charset="UTF-8"></script>
                        ...
                        <asp:TemplateField ItemStyle-Width="20px">
                            ...
                            <ItemTemplate >
                                <img id="imgMasObservacion" alt="" style="cursor: pointer" src="../Asset/images/plus.gif"
                                    onclick="imgMasObservacion_Click(this);" title="OBSERVACION UNION DE CODIGO" />
                                <asp:Panel ID="pnlOrdersObservacion" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalleObservacion" runat="server" border="0" CellPadding="0"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="Observacion" HeaderText="Observacion Union de Codigo">
