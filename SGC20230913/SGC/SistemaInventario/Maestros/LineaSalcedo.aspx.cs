...
{
    public partial class LineaSalcedo : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodigoLinea", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.Codigolinea = Convert.ToString(objTablaFiltro["Filtro_Codigo"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.IPRegistro = "";

            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_Linea_Insertar_Salcedo(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objOperacion = new TCCuentaCorrienteCN();
            objEntidad = new TCCuentaCorrienteCE();
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_DscLinea"]);

            dta_consulta = objOperacion.F_Linea_Listado_Salcedo(objEntidad);
        ...
        public void P_EliminarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_Linea_Eliminar_Salcedo(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodLinea = Convert.ToInt32(objTablaFiltro["Filtro_CodLinea"]);
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]);
            objEntidad.Codigolinea = Convert.ToString(objTablaFiltro["Filtro_CodigoLinea"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.IPModificacion = "";

            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_Linea_Actualizar_Salcedo(objEntidad);
