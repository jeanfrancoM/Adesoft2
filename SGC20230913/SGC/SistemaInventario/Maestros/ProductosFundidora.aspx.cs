...
{
    public partial class ProductosFundidora : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_Categoria_html = "";
            String str_ddl_Categoriaedicion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlUMCompra,
                    ...
                    ref ddlCompraEdicion, ref ddlVentaEdicion, ref ddlMonedaEdicion, ref ddlcategoria, ref ddlcategoriaedicion);
                ...
                str_ddl_Categoria_html = Mod_Utilitario.F_GetHtmlForControl(ddlcategoria);
                str_ddl_Categoriaedicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlcategoriaedicion);
            ...
            str_resultado =
                ...
                Session["CodSede"].ToString()
                 + "~" +
                str_ddl_Categoria_html
                 + "~" +
                str_ddl_Categoriaedicion_html;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
                                            ...
                                            ref DropDownList ddl_comboventaedicion, ref DropDownList ddl_combomonedaedicion, ref DropDownList ddl_combocategoria
                                            , ref DropDownList ddl_combocategoriaedicion)
        {
            ...
            ddl_combocategoriaedicion.Items.Clear();


            ddl_combocategoriaedicion.DataSource = dta_consulta;
            ddl_combocategoriaedicion.DataTextField = "DscAbvConcepto";
            ddl_combocategoriaedicion.DataValueField = "CodConcepto";
            ddl_combocategoriaedicion.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodCategoria = Convert.ToInt32(objTablaFiltro["Filtro_Categoria"]);
            ...
            objOperacion.F_LGProductos_Insert_Fundidora(objEntidad, "", "", "", "", "", "");
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Fundidora(objEntidad, "", "", "", "", "", "");
