...
$(document).ready(function () {
    ...
    $('#MainContent_btnGrabar').click(function () {
        ...
        try {
            $('#MainContent_txtCodigoInterno').val(   $('#MainContent_txtCodigo').val()   );
            $('#MainContent_txtPrecio2').val(0);
            $('#MainContent_txtPrecio3').val(0);
            $('#MainContent_txtUbicacion').val('');
...
function F_ActualizarRemoto(Fila) {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_CodigoInterno: $(lblCodigoProducto_grilla).text().toUpperCase().trim(),
