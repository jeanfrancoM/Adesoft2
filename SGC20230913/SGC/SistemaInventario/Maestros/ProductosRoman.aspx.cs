...
{
    public partial class ProductosRoman : System.Web.UI.Page
    {
        ...
        /// <returns></returns>
        public String F_LlenarGridDetalle_NET_Original(String arg)
        {
            ...
            try
            {
                ...
                Codigo = Convert.ToString(obj_parametros["Filtro_Codigo"]);

                LGStockAlmacenCN objOperacion = new LGStockAlmacenCN();
                ...
                objEntidadAlmacen.CodAlmacen = Convert.ToInt32(Session["CodSede"].ToString());
                DataTable dta_Almacen = objOperacionalmacen.F_TCAlmacen_Actual(objEntidadAlmacen);
                string Almacen = dta_Almacen.Rows[0]["DscAlmacen"].ToString().Replace(" ", "");

                grvDetalle.DataSource = objOperacion.F_LGProductos_Stocks_Externos_Azure(Convert.ToInt32(Codigo), Almacen);
                grvDetalle.DataBind();
        ...
        public String F_ConsultaHistorialCostos_NET(String arg)
        {
            ...
            String str_grvConsulta_Costos_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                F_ConsultaHistorialAuditoria(obj_parametros, ref grvHistorialCostos, ref grvHistorialPrecios);
                int_resultado_operacion = 1;
                str_mensaje_operacion = "";

                str_grvConsulta_Costos_html = Mod_Utilitario.F_GetHtmlForControl(grvHistorialCostos);
                str_grvConsulta_Precios_html = Mod_Utilitario.F_GetHtmlForControl(grvHistorialPrecios);
            }
            catch (Exception ex)
            {
            ...
            str_resultado =
                Convert.ToString(int_resultado_operacion) + "~" +
                str_mensaje_operacion + "~" +
                str_grvConsulta_Costos_html + "~" +
                str_grvConsulta_Precios_html;
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_codestado_html = "";
            String str_ddl_codestadoedicion_html = "";
            ...
            try
            {
                ...
                str_ddl_codestado_html = Mod_Utilitario.F_GetHtmlForControl(ddlEstado);
                str_ddl_codestadoedicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlEstadoEdicion);
            ...
            str_resultado =
                ...
                str_ddl_codestado_html + "~" + //13
                str_ddl_codestadoedicion_html; //14
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("Precio4Dolares", typeof(string));
            dta_consultaarticulo.Columns.Add("Precio5Dolares", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("Precio4Edicion", typeof(string));
            dta_consultaarticulo.Columns.Add("Precio5Edicion", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("Precio4DolaresEdicion", typeof(string));
            dta_consultaarticulo.Columns.Add("Precio5DolaresEdicion", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("FlagCpe", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("D4", typeof(string));
            dta_consultaarticulo.Columns.Add("D5", typeof(string));
            dta_consultaarticulo.Columns.Add("D6", typeof(string));
            dta_consultaarticulo.Columns.Add("D7", typeof(string));
            //Margenes
            dta_consultaarticulo.Columns.Add("M1", typeof(string));
            dta_consultaarticulo.Columns.Add("M2", typeof(string));
            dta_consultaarticulo.Columns.Add("M3", typeof(string));
            dta_consultaarticulo.Columns.Add("M4", typeof(string));
            dta_consultaarticulo.Columns.Add("M5", typeof(string));
            //Medidas
            dta_consultaarticulo.Columns.Add("Interna", typeof(string));
            dta_consultaarticulo.Columns.Add("Externa", typeof(string));
            dta_consultaarticulo.Columns.Add("Altura", typeof(string));

            //dta_consultaarticulo.Columns.Add("Principal", typeof(string));
            dta_consultaarticulo.Columns.Add("LAVICTORIA", typeof(string));
            dta_consultaarticulo.Columns.Add("ATE", typeof(string));
            dta_consultaarticulo.Columns.Add("LaVictoriaUbicacion", typeof(string));
            dta_consultaarticulo.Columns.Add("AteUbicacion", typeof(string));
            dta_consultaarticulo.Columns.Add("Villa", typeof(string));
            dta_consultaarticulo.Columns.Add("VillaUbicacion", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.Precio4 = Convert.ToDecimal(objTablaFiltro["Filtro_Precio4"]);
            objEntidad.Precio5 = Convert.ToDecimal(objTablaFiltro["Filtro_Precio5"]);
            ...
            objEntidad.Precio4Dolares = Convert.ToDecimal(objTablaFiltro["Filtro_Precio4Dolares"]);
            objEntidad.Precio5Dolares = Convert.ToDecimal(objTablaFiltro["Filtro_Precio5Dolares"]);
            ...
            //margen
            objEntidad.Margen1 = Convert.ToDecimal(objTablaFiltro["Filtro_Margen1"]);
            objEntidad.Margen2 = Convert.ToDecimal(objTablaFiltro["Filtro_Margen2"]);
            objEntidad.Margen3 = Convert.ToDecimal(objTablaFiltro["Filtro_Margen3"]);
            objEntidad.Margen4 = Convert.ToDecimal(objTablaFiltro["Filtro_Margen4"]);
            objEntidad.Margen5 = Convert.ToDecimal(objTablaFiltro["Filtro_Margen5"]);
            //margen
            objEntidad.Pais = Convert.ToString(objTablaFiltro["Filtro_Pais"]);
            objEntidad.FlagCpe = Convert.ToInt32(objTablaFiltro["Filtro_FlagCpe"]);
            objEntidad.D1 = Convert.ToString(objTablaFiltro["Filtro_D1"]);
            objEntidad.D2 = Convert.ToString(objTablaFiltro["Filtro_D2"]);
            objEntidad.D3 = Convert.ToString(objTablaFiltro["Filtro_D3"]);
            objEntidad.D4 = Convert.ToString(objTablaFiltro["Filtro_D4"]);
            objEntidad.D5 = Convert.ToString(objTablaFiltro["Filtro_D5"]);
            objEntidad.D6 = Convert.ToString(objTablaFiltro["Filtro_D6"]);
            objEntidad.D7 = Convert.ToString(objTablaFiltro["Filtro_D7"]);
            objEntidad.M1str = Convert.ToString(objTablaFiltro["Filtro_M1"]);
            objEntidad.M2str = Convert.ToString(objTablaFiltro["Filtro_M2"]);
            objEntidad.M3str = Convert.ToString(objTablaFiltro["Filtro_M3"]);
            ...
            objOperacion.F_LGProductos_Insert_Roman(objEntidad, "", "", "", "", "", "");
        ...
        public void P_ActivarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objOperacion.F_LGProductos_Activar(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_LGProductos_Update_Roman(objEntidad, "", "", "", "", "", "");
        ...
        public void F_ConsultaHistorialAuditoria(Hashtable objTablaFiltro, ref GridView gridCostos, ref GridView gridPrecios)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
