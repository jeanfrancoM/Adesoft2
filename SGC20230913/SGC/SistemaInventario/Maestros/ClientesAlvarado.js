var AppSession = "../Maestros/ClientesAlvarado.aspx";
...
function F_ExclusivoMayorista() {
                       
           if ($('#MainContent_chkExclusivoEdicion').is(':checked'))
           {
               $('#MainContent_chkMayoristaEdicion').prop('checked', false);              
               $('#MainContent_chkExclusivoEdicion').prop('checked', true);
           }              
           else
           {
               $('#MainContent_chkExclusivoEdicion').prop('checked',false );      
               $('#MainContent_chkMayoristaEdicion').prop('checked', true);
           }              
