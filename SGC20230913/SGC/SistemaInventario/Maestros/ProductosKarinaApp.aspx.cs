...
{
    public partial class ProductosKarinaApp : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_LlenarGridDetalle_NET2);
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    //dta_consultaarticulo.Columns.Add("FUA", typeof(string));
        ...
        /// <returns></returns>
        public String F_LlenarGridDetalle_NET2(String arg)
        {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            str_resultado =
                ...
                P_CodMoneda_LineaCredito_Inicial; //15
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("Precio2", typeof(string));
            dta_consultaarticulo.Columns.Add("Precio3", typeof(string));
            dta_consultaarticulo.Columns.Add("PrecioApp", typeof(string));
            dta_consultaarticulo.Columns.Add("TituloApp", typeof(string));
            dta_consultaarticulo.Columns.Add("DescripcionDetalladaApp", typeof(string));

            
            dta_consultaarticulo.Columns.Add("SeVendeEnApp", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("PrecioAppDolares", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("VES", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("VESUbicacion", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("PrecioAppEdicion", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("PrecioAppDolaresEdicion", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.PrecioApp = Convert.ToDecimal(objTablaFiltro["Filtro_PrecioApp"]);
            objEntidad.TituloApp = Convert.ToString(objTablaFiltro["Filtro_TituloApp"]);
            objEntidad.DescripcionDetalladaApp = Convert.ToString(objTablaFiltro["Filtro_DescripcionDetalladaApp"]);
            objEntidad.SeVendeEnApp = Convert.ToInt32(objTablaFiltro["Filtro_SeVendeEnApp"]);
            ...
            objEntidad.PrecioAppDolares = Convert.ToDecimal(objTablaFiltro["Filtro_PrecioAppDolares"]);
