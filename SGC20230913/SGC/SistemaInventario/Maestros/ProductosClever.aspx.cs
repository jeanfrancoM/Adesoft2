...
{
    public partial class ProductosClever : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_Buscar_Presentaciones_NET);
            CallbackManager.Register(F_ConsultaHistorialCostos_NET);

            CallbackManager.Register(F_Agregar_Producto_Temporal_NET);
            CallbackManager.Register(F_GrabarDocumentoImagen_NET);
            CallbackManager.Register(F_Eliminar_Producto_Temporal_NET);
            CallbackManager.Register(F_EliminarDocumentoImagen_NET);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //P_Inicializar_GrillaVacia_Consulta_Presentaciones();
            Session["datos"] = true;
        }
        ...
        public String F_Buscar_Presentaciones_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsulta_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Buscar_Presentaciones(obj_parametros, ref grvPresentaciones);
                if (grvConsulta.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_Consulta_Presentaciones();
                    str_mensaje_operacion = "No se encontraron registros.";
                ...
                str_grvConsulta_html = Mod_Utilitario.F_GetHtmlForControl(grvPresentaciones);
                int_resultado_operacion = 1;
        ...
        public String F_ConsultaHistorialCostos_NET(String arg)
        {
            ...
            String str_grvHistorialCostos_html = "";
            String str_grvHistorialPrecios_html = "";
            Hashtable obj_parametros = null;
            ...
            try
            {
                ...
                str_grvHistorialCostos_html = Mod_Utilitario.F_GetHtmlForControl(grvHistorialCostos);
                str_grvHistorialPrecios_html = Mod_Utilitario.F_GetHtmlForControl(grvHistorialPrecios);
            ...
            str_resultado =
                ...
                str_mensaje_operacion
                + "~" +
                str_grvHistorialCostos_html
                + "~" +
                str_grvHistorialPrecios_html;
        ...
        public void P_Inicializar_GrillaVacia_Consulta_Presentaciones()
        {
            DataTable dta_consultaarticulo = null;
            DataRow dtr_consultafila = null;
            ...
            dta_consultaarticulo.Columns.Add("CodProductoPresentacion", typeof(string));
            dta_consultaarticulo.Columns.Add("CodProducto", typeof(string));
            dta_consultaarticulo.Columns.Add("CodEstado", typeof(string));
            dta_consultaarticulo.Columns.Add("Estado", typeof(string));
            dta_consultaarticulo.Columns.Add("CodUnidadMedida", typeof(string));
            dta_consultaarticulo.Columns.Add("UnidadMedida", typeof(string));
            dta_consultaarticulo.Columns.Add("Factor", typeof(string));
            dta_consultaarticulo.Columns.Add("CodMoneda", typeof(string));
            dta_consultaarticulo.Columns.Add("Moneda", typeof(string));
            dta_consultaarticulo.Columns.Add("Costo", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("Precio6", typeof(string));
            dta_consultaarticulo.Columns.Add("Principal", typeof(string));
            ...
            grvPresentaciones.DataSource = dta_consultaarticulo;
            grvPresentaciones.DataBind();
        ...
        public void P_Buscar_Presentaciones(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_LGProductos_Presentaciones_Listar(objEntidad);
        ...
        {
            if (ID_Proceso == "")
                ID_Proceso = DateTime.Now.ToString("yyyyMMddhhmmss");

            LGProductosCE objEntidadCE = new LGProductosCE();
            objEntidadCE.ID_Proceso = Convert.ToInt64(ID_Proceso);
            LGProductosCN objOperacion = new LGProductosCN();
            ...
            foreach (string s in Request.Files)
            {
                try
                {
                    ...
                    bol_resultado_operacion = objOperacion.F_AgregarImagen_Carpeta(objEntidadCE);
        ...
        public void F_ConsultaHistorialCostos(Hashtable objTablaFiltro, ref GridView gridCostos)
        {
            ...
            objOperacion = new LGProductosCN();
            dtTabla = objOperacion.F_LGProductos_HistorialPrecios(objEntidad);

            grvHistorialPrecios.DataSource = dtTabla;
            grvHistorialPrecios.DataBind();

        }

        public String F_Agregar_Producto_Temporal_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsultaProductosTemporal_html = "";
            int int_resultado_operacion = 0;
            ...
            try
            {
                ...
                F_Agregar_Producto_Temporal(obj_parametros, ref MsgError);
                F_Buscar_Producto_Temporal(obj_parametros, ref grvProductosAgregar);

                str_grvConsultaProductosTemporal_html = Mod_Utilitario.F_GetHtmlForControl(grvProductosAgregar);
            ...
            str_resultado =
                ...
                str_grvConsultaProductosTemporal_html; //2
        ...
        public String F_Eliminar_Producto_Temporal_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsultaProductosTemporal_html = "";
            ...
            try
            {
                ...
                F_Eliminar_Producto_Temporal(obj_parametros, ref MsgError);
                F_Buscar_Producto_Temporal(obj_parametros, ref grvProductosAgregar);
        ...
        public String F_GrabarDocumentoImagen_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarDocumentoImagen(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public void P_GrabarDocumentoImagen(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objEntidad.CodEmpresa = iCodEmpresa;
            objEntidad.CodigoProducto = Convert.ToString(objTablaFiltro["Filtro_Carpeta"]);
            objEntidad.DscProducto = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]);
            objEntidad.CodClaseImagen = Convert.ToInt32(objTablaFiltro["Filtro_CodClaseImagen"]);
            objEntidad.ID_Proceso = Convert.ToInt64(ID_Proceso);
            objEntidad.CodUsuario = int.Parse(Session["CodUsuario"].ToString());

            objOperacion = new LGProductosCN();

            objOperacion.F_Grabar_Producto_Temporal_a_Final(objEntidad);

            MsgError = objEntidad.MsgError;
        }
        public void F_Agregar_Producto_Temporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_Agregar_Producto_Temporal_Carpeta(objEntidad);

            MsgError = objEntidad.MsgError;

        }

        public void F_Eliminar_Producto_Temporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_Eliminar_Producto_Temporal_Carpeta(objEntidad);

            MsgError = objEntidad.MsgError;

        }

        public String F_EliminarDocumentoImagen_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarDocumento(obj_parametros, ref MsgError);
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError;
            }
            catch (Exception ex)
        ...
        public void F_Buscar_Producto_Temporal(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            objEntidad = new LGProductosCE();
            ...
            DataTable dta_consulta = null;
            dta_consulta = objOperacion.F_Buscar_Producto_Temporal_Carpeta(objEntidad);
        ...
        public void P_EliminarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            LGProductosCE objEntidad = null;
            LGProductosCN objOperacion = null;
            ...
            objEntidad.CodProducto = Convert.ToInt32(objTablaFiltro["Filtro_CodProducto"]);
            objEntidad.IdImagenProducto1 = Convert.ToInt32(objTablaFiltro["Filtro_IdImagen"]);
            objEntidad.CodClaseImagen = Convert.ToInt32(objTablaFiltro["Filtro_CodClaseImagen"]);
            objEntidad.CodUsuario = int.Parse(Session["CodUsuario"].ToString());

            objOperacion = new LGProductosCN();

            objOperacion.F_Eliminar_Producto_Temporal_a_Final(objEntidad);
