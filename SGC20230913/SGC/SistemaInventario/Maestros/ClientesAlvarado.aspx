<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientesAlvarado.aspx.cs" Inherits="SistemaInventario.Maestros.ClientesAlvarado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ClientesAlvarado.js" charset="UTF-8"></script>
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    ...
                                    <tr>
                                        ...
                                        <td style="display:none">
                                         ...
                                         <td style="padding-left: 2px; font-weight: bold">
                                            <asp:TextBox ID="txtGPSLongLat" runat="server" Width="328px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                                         <td style="font-weight: bold">
                                            Categoria
                      ...
                      <td style="padding-left: 0px">
                            ...
                            <td style="padding-left: 10px">
                              ...
                              <td>
                                <asp:CheckBox ID="chkExclusivo" runat="server" Text="Cliente Exclusivo"
                                    Font-Bold="True" />
                            </td>
            ...
            <tr>
               <td style="padding-left: 2px;font-weight: bold">
                ...
                <td style="padding-left: 32px;">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding-left: 13px;font-weight: bold">
                                <asp:TextBox ID="txtCorreo1ContactoRegistro" runat="server" Width="210px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                            <td style="padding-left: 18px;font-weight: bold">
                                Correo 2
                            </td>
                            <td >
                        ...
                        <asp:TemplateField HeaderText="Retencion" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblRetencion" Text='<%# Bind("Retencion") %>'></asp:Label>
                                 ...
                                 <asp:BoundField DataField="BloqueoCredito" HeaderText="BLOQUEO CREDITO" HeaderStyle-Width="50px">
                ...
                <asp:GridView ID="grvConsultaDetalle" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                          ...
                          <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEditarRegistroCorreo" ImageUrl="~/Asset/images/Mail2.png"
                                    ...
                                    <asp:GridView ID="grvDetalleCorreo" runat="server" border="0" CellPadding="0"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="Correo" HeaderText="Correo">
                                             ...
                                             <asp:BoundField DataField="Correo2" HeaderText="Correo2">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Correo3" HeaderText="Correo3">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Correo4" HeaderText="Correo4">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Correo5" HeaderText="Correo5">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Correo6" HeaderText="Correo6">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                 <tr>
                    ...
                    <td style="font-weight: bold">
                            ...
                            <td>
                                <asp:TextBox ID="txtD1EnReporte" runat="server" Width="40px" Font-Names="Arial"
                                  CssClass="Derecha"    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                            <td style="font-weight: bold">
                                DM
                            ...
                            <td>
                                <asp:TextBox ID="txtD2EnReporte" runat="server" Width="40px" Font-Names="Arial"
                                   CssClass="Derecha"   ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                                        ...
                                        <td>
                                            <div id="div_CategoriaEdicion">
                                                <asp:DropDownList ID="ddlCategoriaEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="101" BackColor="#FFFF99">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                            ...
                            <td style="padding-left: 30px;display:none;">
                              ...
                              <td style="display:none;">
                                <asp:CheckBox ID="chkExclusivoEdicion" runat="server" Text="CLIENTE EXCLUSIVO"
                                    Font-Bold="True" />
                            </td>
                             <td style="display:none;">
                                <asp:CheckBox ID="chkMayoristaEdicion" runat="server" Text="MAYORISTA"
                                    Font-Bold="True" />
                            </td>
                            </tr>
                            </table>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="display: none;">
                                 ...
                                 <td style="padding-left: 3px; padding-top: 5px; font-weight: bold">
    ...
    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all"> 
        ...
        <div class="ui-jqdialog-content">
            <table cellpadding="0" cellspacing="0" class="form-inputs">
                ...
                <tr style="font-weight: bold; padding-left: 10px">
                    <td style="font-weight: bold">
                       Correo 3
                    </td>
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="font-weight: bold">
                                    <asp:TextBox ID="txtCorreoContactoEdicion3" runat="server" Width="230px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="font-weight: bold; padding-left: 10px">
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="font-weight: bold; padding-left: 2px">
                                    <asp:TextBox ID="txtCelularContactoEdicion2" runat="server" Width="230px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="font-weight: bold; padding-left: 10px">
                                    Celular 3
