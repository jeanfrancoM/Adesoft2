<%@ Page Title="Territorio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Territorio.aspx.cs" Inherits="SistemaInventario.Maestros.Territorio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Territorio.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Territorio" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblTerritorio" Text='<%# Bind("DscTerritorio") %>' CssClass="detallesart"></asp:Label>
                                ...
                                <asp:HiddenField ID="lblCodTerritorio" runat="server" Value='<%# Bind("CodTerritorio") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <input id="hfCodTerritorio" type="hidden" value="0" />
</asp:Content>
