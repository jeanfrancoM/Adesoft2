<%@ Page Title="Procedencia" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProcedenciaSalcedo.aspx.cs" Inherits="SistemaInventario.Maestros.ProcedenciaSalcedo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="ProcedenciaSalcedo.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo" >Procedencia    </div> 
                     <div id="divTabs">
                            ...
                            <div id="div_consulta" style="padding-top:5px;" >
                                                ...
                                                <Columns>                                                 
                                                         ...
                                                         <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center">
                                                           ...
                                                           <ItemTemplate>
                                                             <asp:Label runat="server" ID="lblCodigoProcedencia"  Text='<%# Bind("CodigoProcedencia") %>' CssClass="detallesart"></asp:Label>
