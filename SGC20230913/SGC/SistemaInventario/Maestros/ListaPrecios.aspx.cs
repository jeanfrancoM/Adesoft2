...
namespace SistemaInventario.Maestros
{
    public partial class ListaPrecios : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia()
        {
            ...
            dta_consultaarticulo.Columns.Add("PrecioLista", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " DscProducto = '" + Convert.ToString(item.DscProducto).Replace("'", "&apos;") + "'";          
                XmlDetalle = XmlDetalle + " Marca = '" + Convert.ToString(item.Marca).Replace("'", "&apos;") + "'";
                XmlDetalle = XmlDetalle + " Modelo = '" + Convert.ToString(item.Modelo).Replace("'", "&apos;") + "'";
                XmlDetalle = XmlDetalle + " Medida = '" + Convert.ToString(item.Medida).Replace("'", "&apos;") + "'";
                XmlDetalle = XmlDetalle + " DescripcionIngles = '" + Convert.ToString(item.DescripcionIngles).Replace("'", "&apos;") + "'";
