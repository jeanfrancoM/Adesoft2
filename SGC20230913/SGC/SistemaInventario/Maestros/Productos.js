...
$(document).ready(function () {
    ...
    $('#MainContent_txtPrecio1Visualizacion').css('background', '#FFFFE0');
    $('#MainContent_txtPrecio2Visualizacion').css('background', '#FFFFE0');
    $('#MainContent_txtCostoVisualizacion').css('background', '#FFFFE0');
    $('#MainContent_txtEstadoVisualizacion').css('background', '#FFFFE0');
    $('#MainContent_txtMonedaVisualizacion').css('background', '#FFFFE0');
    $('#MainContent_txtUMVisualizacion').css('background', '#FFFFE0');
    $('#MainContent_txtLimite').css('background', '#FFFFE0');
...
function F_Controles_Inicializar() {
    ...
    var arg;
    var Permiso = F_PermisoOpcion_SinAviso(CodigoMenu, PermisoMayorista, '');
    try {
        var objParams = {
        };
...
//                        $('#MainContent_txtMonedaVisualizacion').css('background', '#FFFFE0');
                        ...
                        if (Permiso === "0") {
                            $('#tdMayorista').css('display', 'none');
                        }

                        if (Permiso === "0") {
                            $('#tdMayoristaEdicion').css('display', 'none');
                        }
...
function F_ValidarGrabarDocumento() {
    ...
    try {
        var Permiso = F_PermisoOpcion_SinAviso(CodigoMenu, 1000305, '');
        ...
        if (Permiso == 1 & $(Cuerpo + 'txtPrecio3').val() == '')
            Cadena = Cadena + '<p></p>' + 'Precio 3';

        if (Permiso == 1 & $(Cuerpo + 'txtCantidad').val() == '')
        ...
        if (parseFloat($(Cuerpo + 'txtPrecio2').val()) > 0 &  parseFloat($(Cuerpo + 'txtPrecio2').val()) < parseFloat($(Cuerpo + 'txtCosto').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO 2 NO PUEDE SER MENOR QUE EL COSTO';

//        if (Permiso == 1 & parseFloat($(Cuerpo + 'txtPrecio3').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio3').val()) < parseFloat($(Cuerpo + 'txtCosto').val()))
//            Cadena = Cadena + '<p></p>' + 'PRECIO 3 NO PUEDE SER MENOR QUE EL COSTO';

        if (parseFloat($(Cuerpo + 'txtPrecio2').val()) > 0 &  parseFloat($(Cuerpo + 'txtPrecio1').val()) < parseFloat($(Cuerpo + 'txtPrecio2').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO 1 NO PUEDE SER MENOR QUE EL PRECIO 2';

//        if (Permiso == 1 & parseFloat($(Cuerpo + 'txtPrecio3').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio2').val()) < parseFloat($(Cuerpo + 'txtPrecio3').val()))
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Limite: $(Contenedor + 'txtLimite').val(),
            Filtro_Exclusivo: $(Contenedor + 'txtExclusivo').val(),
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtLimite').val('0');
                    $(Contenedor + 'txtCantidad').val('3');
...
function F_Nuevo() {
    ...
    $(Contenedor + 'txtPrecio3').val('0');
    $(Contenedor + 'txtExclusivo').val('0');
    $(Contenedor + 'txtCantidad').val('0');
    $(Contenedor + 'txtUbicacion').val('');
    $(Contenedor + 'txtStockMinimo').val('0.00');
    $(Contenedor + 'txtStockMaximo').val('0.00');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfLimite = '#' + imgID.replace('imgEditarRegistro', 'hfLimite');
        var hfExclusivo = '#' + imgID.replace('imgEditarRegistro', 'hfExclusivo');
        ...
        $(Cuerpo + 'txtLimiteEdicion').val($(hfLimite).val());
...
function F_VisualizarRegistro(Fila) {
    ...
    var hfCodigo1 = '#' + imgID.replace('imgVisualizarRegistro', 'hfCodigoInterno'); $(Cuerpo + 'txtCodigoVisualizacion').val($(hfCodigo1).val());

    var hfCosto = '#' + imgID.replace('imgVisualizarRegistro', 'lblCosto'); $(Cuerpo + 'txtCostoVisualizacion').val($(hfCosto).val());
    var hfPRecio1 = '#' + imgID.replace('imgVisualizarRegistro', 'hfPrecio1'); $(Cuerpo + 'txtPrecio1Visualizacion').val($(hfPRecio1).val());
    var hfPRecio2 = '#' + imgID.replace('imgVisualizarRegistro', 'hfPrecio2'); $(Cuerpo + 'txtPrecio2Visualizacion').val($(hfPRecio2).val());
    var lblMoneda = '#' + imgID.replace('imgVisualizarRegistro', 'lblMoneda'); $(Cuerpo + 'txtMonedaVisualizacion').val($(lblMoneda).text());
    var hfUM = '#' + imgID.replace('imgVisualizarRegistro', 'hfUM'); $(Cuerpo + 'txtUMVisualizacion ').val($(hfUM).val());
    var hfEstado = '#' + imgID.replace('imgVisualizarRegistro', 'hfEstado'); $(Cuerpo + 'txtEstadoVisualizacion ').val($(hfEstado).val());
...
function F_CrearDropzone_JS() {
    ...
    midiv.setAttribute("style", "width:650px; height:400px; margin-left: 10px; border-radius:12px; min-height:200px; padding:0px;");
