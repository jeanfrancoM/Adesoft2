    ...
    public partial class ComprobanteEgreso : System.Web.UI.Page
    {
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodTipoDoc = Convert.ToInt32(obj_parametros["Filtro_CodTipoDoc"]);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlTipoEgresoEdicion_html = "";
            decimal TC = 0;
            int int_resultado_operacion = 0;
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlTipoIngreso, ref ddlMoneda, ref ddlSerie, ref ddlSerieConsulta,
                    ...
                    ref ddlFormaPago, ref ddlBanco, ref ddlEmpresa, ref ddlEmpresaConsulta,ref ddlTipoEgresoEdicion);
                ...
                str_ddlTipoEgresoEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlTipoEgresoEdicion);
            ...
            str_resultado =
                ...
                str_ddlTipoEgresoEdicion_html; //21
            return str_resultado;
        }
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_tipoingreso,
            ...
            ref DropDownList ddl_comboformapago, ref DropDownList ddl_combobanco, ref DropDownList ddl_comboempresa,
            ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_tipoingresoedicion)
        {
            ...
            ddl_tipoingresoedicion.Items.Clear();
            
            ddl_tipoingresoedicion.DataSource = dta_consulta;
            ddl_tipoingresoedicion.DataTextField = "DscAbvConcepto";
            ddl_tipoingresoedicion.DataValueField = "CodConcepto";
            ddl_tipoingresoedicion.DataBind();
