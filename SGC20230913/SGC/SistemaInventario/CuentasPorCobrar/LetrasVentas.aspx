...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <td>
                                        ...
                                        <td>
                                           ...
                                           <td>
                                            <asp:CheckBox ID="chkNotaVenta" runat="server" Text="INCLUIR NOTA VENTA" Checked="false" Font-Bold="True" />
                                        </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="A">
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlAuditoria" runat="server" Style="display: none">
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlDetalle" runat="server" Style="display: none">                                 
                                        <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0"
                                        CellSpacing="1" AutoGenerateColumns="False" GridLines="None" class="GridView">
                                        <Columns>
                       ...
                       <%--    <asp:BoundField DataField="Empresa" HeaderText="EMP">
                        ...
                        <asp:TemplateField HeaderText="RazonSocial">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfCodigo" runat="server" Value='<%# Bind("Codigo") %>' />
                                <asp:HiddenField ID="hfDetalle" runat="server" Value='0' />
                                <asp:HiddenField ID="hfDetalleAuditoria" runat="server" Value='0' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Numero">
                            <ItemStyle HorizontalAlign="Right" />
                        ...
                        <asp:TemplateField HeaderText="A">
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlOrdersAuditoriaEliminados" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalleAuditoriaEliminado" runat="server" border="0" CellPadding="0"
                                        CellSpacing="1" AutoGenerateColumns="False" GridLines="None" class="GridView">
                                        <Columns>
                                            <asp:BoundField DataField="Auditoria" HeaderText="Auditoria">
                                                <HeaderStyle HorizontalAlign="Center" />
