...
namespace SistemaInventario.CuentasPorCobrar
{
    public partial class RegistroCobranzas : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            + "~" +
            Session["ComisionTarjeta"].ToString();//32
            return str_resultado;
        }
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("ComisionTarjeta", typeof(string));
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_ChkFecha"]) == 1 | Convert.ToInt32(objTablaFiltro["Filtro_ChkRegistro"]) ==1)
            {
