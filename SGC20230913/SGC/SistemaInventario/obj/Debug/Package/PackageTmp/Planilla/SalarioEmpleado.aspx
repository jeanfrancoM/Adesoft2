<%@ Page Title="Salario Empleado" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SalarioEmpleado.aspx.cs" EnableEventValidation="false" Inherits="SistemaInventario.Planilla.SalarioEmpleado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="SalarioEmpleado.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class='overlay'>
        <div class="titulo">
            Planilla Empleado</div>
        <div id="divTabs">
            <div id="tabRegistro">
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                    <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                        Datos de la Planilla Empleado
                    </div>
                    <div>
                                ...
                                <td style="width:500px">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtAñoPeriodoActual" runat="server" Width="50px" Font-Names="Arial"
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtAñoPeriodo" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                    ...
                    <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="DNI">
                                <ItemStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblDNI" Text='<%# Bind("COD") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
