<%@ Page Title="Comparacion Contable Vs. Planilla" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SalarioComparacion.aspx.cs" EnableEventValidation="false" Inherits="SistemaInventario.Planilla.SalarioComparacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="SalarioComparacion.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class='overlay'>
        <div class="titulo">
            Comparacion Contable vs. Planilla</div>
        <div id="divTabs">
            <div id="tabRegistro">
