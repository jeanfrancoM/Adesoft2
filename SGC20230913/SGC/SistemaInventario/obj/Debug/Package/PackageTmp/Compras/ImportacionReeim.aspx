<%@ Page Title="Importacion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ImportacionReeim.aspx.cs" Inherits="SistemaInventario.Compras.ImportacionReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ImportacionReeim.js" charset="UTF-8"></script>
                    ...
                    <div id="div_grvDetalleArticulo" style="padding-top: 5px;">
                        <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CodigoFabrica">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCodigoFabrica" Text='<%# Bind("CodigoFabrica") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField DataField="CodigoRemplazo" HeaderText="CodigoRemplazo" Visible="false">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                               ...
                               <asp:TemplateField HeaderText="Cantidad" Visible="false">
                                ...
                                <asp:BoundField DataField="Margen1" HeaderText="Margen1">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Margen2" HeaderText="Margen2">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
                                ...
                                <asp:Panel ID="pnlOrdersObservacion" runat="server" Style="display: none">
                                    <asp:GridView ID="grvObservacion" runat="server" border="0" CellPadding="0"
                                        ...
                                        <Columns>
                                            ...
                                            <ItemTemplate>
                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Asset/images/btnEdit.gif"
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                        <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="CodigoFabrica" HeaderText="CodigoFabrica">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
