var AppSession = "../Compras/RegistroFacturaCompraNuevoReeim.aspx";
...
var P_TIPO_BUSQUEDA_CODIGO_PRODUCTO;
...
function F_Inicializar_Parametros() {
    ...
    P_TIPO_BUSQUEDA_CODIGO_PRODUCTO;
...
$.each(Parametros, function (index, item) {
    ...
    switch(item.Parametro) {
        case "P_CODMONEDA" :
            ...
            break;
        case "P_TIPO_BUSQUEDA_CODIGO_PRODUCTO" :
            P_TIPO_BUSQUEDA_CODIGO_PRODUCTO = item.Valor;
            break;
