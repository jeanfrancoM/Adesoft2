var AppSession = "../Compras/OrdenCompraConvergente.aspx";
...
//              
   ...
   //ventana busqueda de producto
    ...
    $("#MainContent_txtEntrega").css('background', '#FFFFE0');
  ...
  try 
        ...
        if (NroRuc.length == 8) NroRuc = '';
                ...
                var objParams = {
                                        ...
                                        Filtro_Entrega: $(Contenedor + 'txtEntrega').val(),
        ...
        try {
            ...
            F_ReemplazarFactura_NET(arg, function (result) {
                ...
                if (str_resultado_operacion == "1") {
                    ...
                    $('#MainContent_txtObservacion').val(result.split('~')[33]);
                    $('#MainContent_txtEntrega').val(result.split('~')[34]);
                    F_BuscarDireccionesCliente();
...
function F_ImprimirFacturaPDF(Fila) {
        ...
        var NombreArchivo = "Web_Reporte_Compras_rptOrdenCompra_Convergente.rpt";
