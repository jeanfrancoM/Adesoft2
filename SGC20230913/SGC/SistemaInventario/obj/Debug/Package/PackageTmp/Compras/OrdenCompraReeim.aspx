<%@ Page Title="Orden Compra" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="OrdenCompraReeim.aspx.cs" Inherits="SistemaInventario.Compras.OrdenCompraReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="OrdenCompraReeim.js" charset="UTF-8"></script>
                        ...
                        <tbody>
                            <tr>
                             <td style="font-weight: bold;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtClienteConsulta" runat="server" Width="220" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="font-weight: bold">
                                    ESTADO
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                                ...
                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Anexo2" HeaderText="Anexo">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
                        ...
                        <asp:BoundField DataField="Vcto" HeaderText="Vcto">
                         ...
                         <asp:BoundField DataField="FechaCancelacion" HeaderText="Cancelacion">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                 ...
                                                 <asp:TemplateField>
                                        <ItemTemplate>
                                            <img id="imgMasProducto" alt="" style="cursor: pointer" src="../Asset/images/plus.gif" onclick="imgMasProducto_Click(this);"
