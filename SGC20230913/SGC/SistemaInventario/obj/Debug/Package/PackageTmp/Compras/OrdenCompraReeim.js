var AppSession = "../Compras/OrdenCompraReeim.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_TipoDocConsulta', result.split('~')[21]);
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        $('#MainContent_ddlSerieDocVentas').css('background', '#FFFFE0');
                        $('.ccsestilo').css('background', '#FFFFE0');     
                        F_Mostrar_CorrelativoVarios($("#MainContent_ddlTipoDocumento").val());                   
                    }
                    else {
                        alertify.log(str_mensaje_operacion);
                    }
