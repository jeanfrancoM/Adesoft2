<%@ Page Title="Orden Compra" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="OrdenCompraConvergente.aspx.cs" Inherits="SistemaInventario.Compras.OrdenCompraConvergente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="OrdenCompraConvergente.js" charset="UTF-8"></script>
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                       ...
                       <td>
                         ...
                         <tr>
                                        ...
                                        <td>
                                             <asp:TextBox ID="txtObservacion" runat="server" Width="428px" Font-Names="Arial"
                              ...
                              <td>
                                             <asp:TextBox ID="txtEntrega" runat="server" Width="428px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>  
                         </tr>
                         </table>
            ...
            <div style="padding-top: 5px;">
               <table cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        ...
                                        <td style="font-weight: bold">
                                            <label id="lblCantidadRegistro">0</label>
                                        </td>                                
                                    </tr>
                                </table>
            </div>
              ...
              <div style="padding-top: 5px;">
               <table cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        ...
                                        <td style="font-weight: bold">
                                            <label id="lblGrillaConsulta">0</label>
                                        </td>                                
                                    </tr>
                                </table>
            </div>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/Eliminar.jpg"
                                    ToolTip="ANULAR ORDEN DE COMPRA" OnClientClick="F_AnularRegistro(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                            ...
                            <div style="overflow-y: scroll; height: 375px;">
                                <div id="div_grvConsultaArticulo" style="padding-top: 5px">
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        GridLines="None" Width="1190px" OnRowDataBound="grvConsultaArticulo_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
