<%@ Page Title="Compras Factura" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaCompraNuevoTEK.aspx.cs" Inherits="SistemaInventario.Compras.RegistroFacturaCompraNuevoTEK" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaCompraNuevoTEK.js" charset="UTF-8"></script>
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtClienteConsulta" runat="server" Width="332" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                            </table>
