<%@ Page Title="Compras Factura" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaCompraNuevoKarina.aspx.cs" Inherits="SistemaInventario.Compras.RegistroFacturaCompraNuevoKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaCompraNuevoKarina.js" charset="UTF-8"></script> 
            ...
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                ...
                <div class="linea-button">
                    ...
                    <asp:Button ID="btnVentas" runat="server" Text="Ventas (F3)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Font-Bold="True" Width="120" sytle="display:none;" />
                            ...
                            <td>
                                <div id="div_TipoDocVentas">
                                    <asp:DropDownList ID="ddlTipoDocVentas" runat="server" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <asp:ListItem Value="5">ORDEN COMPRA</asp:ListItem>
