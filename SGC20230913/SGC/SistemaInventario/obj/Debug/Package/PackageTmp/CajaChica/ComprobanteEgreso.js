   ...
   
    {
        source: function (request, response) {
            $.ajax({
                ...
                data: "{'NroRuc':'" + "" + "','RazonSocial':'" + request.term + "','CodTipoCtaCte':'0','CodTipoCliente':'" + 2 + "'}",
                dataType: "json",
                async: true,
...
//                MostrarEspera(false);
    ...
    $('#MainContent_btnAgregarFactura').click(function () {
        ...
        try {
            ...
            if ($('#MainContent_ddlTipoIngreso').val()!=3 & $('#MainContent_ddlTipoIngreso').val()!=2 & $('#MainContent_ddlTipoIngreso').val()!=5)
            {
            Cadena = Cadena + '<p></p>' + "TIPO DE EGRESO DEBE SER COMISION O DEVOLUCION O MOVILIDAD MERCADERIA";
            alertify.log(Cadena);
                return false;
            }
           ...
           {
              if ($('#MainContent_ddlTipoIngreso').val()!=2 & $('#MainContent_ddlTipoIngreso').val()!=3  & $('#MainContent_ddlTipoIngreso').val()!=5)
                    Cadena = Cadena + '<p></p>' + "EL TIPO DOC DEBE SER COMPROBANTE EGRESO, TIPO DE EGRESO DEBE SER COMISION O DEVOLUCION";   
           }
           else
           {
            if ($('#MainContent_ddlTipoIngreso').val()!=5)
               Cadena = Cadena + '<p></p>' + "TIPO DE EGRESO DEBE SER MOVILIDAD MERCADERIA";           
           }
...
//                 {
//                        $('#MainContent_grvConsultaFactura .ccsestilo').each(function () {
//                            txtMontoObligacion = '#MainContent_grvConsultaFactura_txtMontoObligacion_'+F;
//                            $(txtMontoObligacion).prop('readonly',true);
//                            F++
//                        });
//                 }
//                 else
...
//                        $('#MainContent_grvConsultaFactura .ccsestilo').each(function () {
//                            txtMontoObligacion = '#MainContent_grvConsultaFactura_txtMontoObligacion_'+F;
//                            $(txtMontoObligacion).prop('readonly',false);
//                            F++
//                        });
//                 }
//                
...
//var F=0;
//        
//        $('#MainContent_grvFactura .ccsestilo').each(function () {
//     txtMontoObligacion = '#MainContent_grvFactura_txtMontoObligacion_'+F;
//            $(txtMontoObligacion).prop('disabled',true);
//          
//            F++
//     });
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_EmpresaConsulta', result.split('~')[19]);
                           ...
                           F_Update_Division_HTML('div_TipoEgresoEdicion', result.split('~')[21]);
                        ...
                        $('#MainContent_ddlTipoEgresoEdicion').css('background', '#FFFFE0');
                        $('#MainContent_txtNroRuc').focus();
                        F_CambioTipo();           
                        $('.ccsestilo').css('background', '#FFFFE0');
                        F_InicializarCombo();
...
function F_ValidarGrabarDocumento(){
    try 
        ...
        if ($(Cuerpo + 'ddlTipoDoc').val()== '13') {
            ...
            if(($(Cuerpo + 'ddlTipoIngreso').val()== '3' | $(Cuerpo + 'ddlTipoIngreso').val()== '5') & F_Numerar_Grilla("grvFactura", 'lblFactura') == 0)
           Cadena=Cadena + '<p></p>' + 'COMISION O MOVILIDAD NECESITA MERCADERIA NECESITA UN DOCUMENTO ADJUNTO';
       ...
       try 
        {
              ...
              var objParams = {
                                        ...
                                        Filtro_CodMotivo: $('#MainContent_ddlTipoEgresoEdicion').val()                                        
                               };
...
try 
        ...
        var arrDetalle = new Array();
                ...
                $('#MainContent_grvConsultaFactura .chkSi :checkbox').each(function () {
                    ...
                    hfTipo = chkSi.replace('chkOK', 'hfTipo'); 
