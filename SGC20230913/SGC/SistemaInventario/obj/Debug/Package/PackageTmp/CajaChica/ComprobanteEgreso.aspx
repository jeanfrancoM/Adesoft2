                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtNumero" runat="server" Width="56" Font-Names="Arial" Font-Bold="True"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtsubtotal" runat="server" Width="75px" Font-Names="Arial" Font-Bold="True"
                                        ...
                                        <td style="padding-left: 10px;">
                                            <asp:TextBox ID="txtigv" runat="server" Width="75px" Font-Names="Arial" Font-Bold="True"
                                                CssClass="Derecha" ForeColor="Blue" Text="0.00"></asp:TextBox>
                                        </td>
                                        ...
                                        <td style="padding-left: 12px;">
                                            <asp:TextBox ID="txtTotal" runat="server" Width="75px" Font-Names="Arial" Font-Bold="True"
                                                CssClass="Derecha" ForeColor="Blue" Text="0.00"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td>
                                            <asp:TextBox ID="txtPlaca" runat="server" Width="50px" Font-Names="Arial"
                                ...
                                Observacion
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="764px" Font-Names="Arial"
                                                Font-Bold="True" ForeColor="Blue"></asp:TextBox>
                                        </td>
   ...
   <td>
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                            <div id="div_TipoEgresoEdicion">
                                                <asp:DropDownList ID="ddlTipoEgresoEdicion" runat="server" Font-Names="Arial" Font-Bold="True"
                                                    Width="130px" ForeColor="Blue">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
