<%@ Page Title="Cierre Caja" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="CajaChicaPymes.aspx.cs" Inherits="SistemaInventario.CajaChica.CajaChicaPymes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CajaChicaPymes.js" charset="UTF-8"></script>
                            ...
                            <asp:TemplateField ItemStyle-Width="20px">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="imgImprimirIndividual" ImageUrl="~/Asset/images/pdf.png" ToolTip="VISUALIZAR PDF"
                                        OnClientClick="F_ReporteIndividual(716, this,0); return false;" />
                                </ItemTemplate>
                            </asp:TemplateField>     
