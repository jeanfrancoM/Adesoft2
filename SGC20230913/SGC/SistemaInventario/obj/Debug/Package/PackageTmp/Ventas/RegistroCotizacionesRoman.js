    ...
    try 
        {        
            ...
            var Cadena = 'Ingresar los sgtes. Datos:'; 
             ...
             if ($(Cuerpo + 'txtNroRuc').val() != '55555555555' & $(Cuerpo + 'txtNroRuc').val() != '11111111111') {
...
//if (F_PermisoOpcion(CodigoMenu, 1000112, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
//        var Codigo = '';
//     
...
if (F_PermisoOpcion(CodigoMenu, 4000102, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
  var imgID = Fila.id;
        ...
        var TipoArchivo = 'application/pdf';
        var CodMenu = '209';
        var NombreArchivo = 'Web_Reporte_Ventas_rptCotizacion_Roman.rpt';
