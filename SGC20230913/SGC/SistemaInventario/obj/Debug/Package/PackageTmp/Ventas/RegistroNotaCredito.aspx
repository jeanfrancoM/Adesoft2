<%@ Page Title="Nota de Credito-Venta" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="RegistroNotaCredito.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroNotaCredito" %>
            ...
            <div id="div_grvDetalleArticulo">
                <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                     ...
                     <%--   <asp:TemplateField HeaderText="REEMPLAZO" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="TXTREEMPLAZO" Font-Bold="true" CssClass="ccsestilo"
                                    Width="80px" Font-Names="Arial" ForeColor="Blue" 
                                    onblur="F_ActualizarDescripcion(this.id); return false;"></asp:TextBox>      
                           </ItemTemplate>
                        </asp:TemplateField>       --%>           
                    </Columns>
                        ...
                        <asp:TemplateField HeaderText="NC">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="IMPRIMIR NOTA DE CREDITO" OnClientClick="F_ImprimirFacturaGrilla(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
