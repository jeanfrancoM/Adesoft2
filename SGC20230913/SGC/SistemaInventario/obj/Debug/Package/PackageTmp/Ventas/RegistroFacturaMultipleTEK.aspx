<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMultipleTEK.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleTEK" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleTEK.js"
        charset="UTF-8"></script>
                                                         ...
                                                         <td style="display: none" id="tdftOC">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td id="tdtxtNumeroOC">
                                                                            <asp:TextBox ID="txtNumeroOC" runat="server" Width="45px" ForeColor="Blue" Font-Names="Arial"
                                                                                Font-Bold="True"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtConductorRazonSocial" runat="server" Width="210" Font-Names="Arial"
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox runat="server" ID="txtCantidadEntregada" Width="55px" Font-Bold="true"
                                            Style="text-align: center;" Font-Names="Arial" onblur="F_ValidarStockGrillaOC(this.id);"
                                             CssClass="ccsestilo"  ForeColor="Blue"    Enabled="False"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
