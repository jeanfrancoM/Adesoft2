<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleFundicion.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleFundicion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleFundicion.js" charset="UTF-8"></script>       
                        ...
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCelular" CssClass="Derecha" runat="server" Width="100px"
                                                            Font-Names="Arial" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="display: none">
                            ...
                            <div class="linea-button">
                                ...
                                <asp:Button ID="btnNotaVenta" runat="server" Text="Nota Venta (F3)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                                <asp:Button ID="btnAnticipo" runat="server" Text="ANTICIPO" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                                     ...
                                     <%--       <asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="UM">
                                              ...
                                              <asp:TemplateField HeaderText="Costo">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblCostoConIgv" Text='<%# Bind("CostoConIgv") %>' Font-Size="Medium"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Precio">
                                                <ItemStyle HorizontalAlign="Right" />
