<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleClever.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleClever" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleClever.js"  charset="UTF-8"></script>      
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    ui-corner-top ui-helper-clearfix">
           ...
           <table cellpadding="0" cellspacing="0">
              ...
              <td style="font-weight: bold" colspan='2' align="center">
                ...
                <tr>
                  <td style="padding-left:2px;">
                                    <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="845px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                   </td>
                    </tr>
                </table>
            ...
            <div class="linea-button">
                <asp:Button ID="btnEditarFactura" runat="server" Text="Guardar" class="ui-button  ui-widget ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True"
                    Width="120" />
            </div>
        </div>
    </div>
