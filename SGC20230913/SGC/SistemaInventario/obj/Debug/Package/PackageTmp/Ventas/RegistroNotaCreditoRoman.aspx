<%@ Page Title="Nota de Credito-Venta" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="RegistroNotaCreditoRoman.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroNotaCreditoRoman" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroNotaCreditoRoman.js"        charset="UTF-8"></script>
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="Descripcion" ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField HeaderText="Precio">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblPrecio" Text='<%# Bind("PrecioDesc") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="NC">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="VISUALIZAR NOTA DE CREDITO" OnClientClick="F_ImprimirDocumento(undefined,this,'imgPdf','IMP'); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
