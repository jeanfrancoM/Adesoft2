var AppSession = "../Ventas/RegistroCotizaciones.aspx";

var CodigoMenu = 4000;
var CodigoInterno = 1;
var CodCategoria = 1;
var PermisoMayorista = 1000305;
...
////   hEcho por Adrian
    ...
    $("#MainContent_chkProductoNuevo").click(function(){
        if($(this).is(":checked")){
            $("#MainContent_chkProductoNuevo").prop("disabled",true);        
            $('#MainContent_txtCodigoInternoEdicion').val('');
            $('#MainContent_txtDescripcionEdicion').val('');
            $('#MainContent_txtCostoEdicion').val('');
            $('#MainContent_txtPrecio1Edicion').val('');
            $('#MainContent_txtPrecio2Edicion').val('0.00');
            $('#MainContent_txtPrecio3Edicion').val('');
            $('#MainContent_txtExclusivoEdicion').val('0.00');
            $('#MainContent_txtCantidadEdicion').val('3');
            $('#MainContent_txtLimiteEdicion').val('0');
            $('#hfCodProducto').val(0);
            $('#lblEdicionProducto').text('REGISTRO DE PRODUCTO NUEVO');
        }
    })
    ...
    if (F_PermisoOpcion(CodigoMenu, 4000101, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try 
        {
                ...
                $('#MainContent_txtCantidadMayorista').val('');
                $('#MainContent_txtPrecioMayorista').empty();
                $('#MainContent_ddlPrecio').empty();
    ...
    if (!F_SesionRedireccionar(AppSession)) return false;
     ...
     $('#MainContent_btnEdicion').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        try {
            if (!F_ValidarEdicionDocumentoProducto())
                return false;
            var Mensaje = 'ESTA SEGURO DE ACTUALIZAR EL PRODUCTO';

             if ($('#MainContent_chkProductoNuevo').is(':checked'))
                    Mensaje = 'ESTA SEGURO DE REGISTRAR EL PRODUCTO';

            if (confirm(Mensaje))
                F_EdicionRegistroProducto();
...
if (!F_SesionRedireccionar(AppSession)) return false;
    ...
    if (parseFloat($('#MainContent_lblD1').text())==0)
        F_ExclusivoACero();
}
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_MonedaEdicion', result.split('~')[19]);
                        F_Update_Division_HTML('div_CompraEdicion', result.split('~')[20]);
                        F_Update_Division_HTML('div_FamiliaEdicion', result.split('~')[21]);
                        ...
                        $('#MainContent_txtCodigo1Edicion').css('background', '#FFFFE0');
                        ...
                        $('#MainContent_txtLimiteEdicion').css('background', '#FFFFE0');
                        ...
                        if($("#hfIdAlmacen").val()==1){                            
                            $("#MainContent_txtCantidad173").prop('disabled', true); 
                            $("#MainContent_txtCantidad173Ped").prop('disabled', true); 
                        }else if($("#hfIdAlmacen").val()==5){
                            $("#MainContent_txtCantidadABC").prop('disabled', true);                                                   
                            $("#MainContent_txtCantidadABCPed").prop('disabled', true); 
                        }else if ($("#hfIdAlmacen").val()==7){
                            $("#MainContent_txtCantidad250").prop('disabled', true);                                                        
                            $("#MainContent_txtCantidad250Ped").prop('disabled', true);                                                        
                        }else{
                            $("#MainContent_txtCantidad173").prop('disabled', true);                            
                            $("#MainContent_txtCantidad250").prop('disabled', true);                            
                            $("#MainContent_txtCantidadABC").prop('disabled', true);                            
...
function F_AgregarTemporal() {
    ...
    try {
        ...
        var objDetalle = {
            ...
            Precio: parseFloat($('#MainContent_txtPrecioDisplay').val())/ tasaigv,
            PrecioDscto: parseFloat($('#MainContent_txtPrecioDisplay').val()) / tasaigv,
...
function F_ActualizarCantidad(Fila) {
    try {
        ...
        var hfExclusivo = txtCantidad.replace('txtCantidad', 'hfExclusivo');
...
function F_InicializarCajaTexto()
{
    ...
    $("#MainContent_txtExclusivoEdicion").css('background', '#FFFFE0');
...
function F_EditarRegistro(Fila) {
    if (F_PermisoOpcion(CodigoMenu, 4000106, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
    try {
        var imgID = Fila.id;
        var lblCodigo_grilla = '#' + imgID.replace('imgEditarRegistro', 'lblcodproducto');
        ...
        var hfCantidadMayorista_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfCantidadMayorista');
        var hfLimiteMayorista_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfLimiteMayorista');
        var hfUbicacion_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfUbicacion');
        var hfExclusivo = '#' + imgID.replace('imgEditarRegistro', 'hfExclusivoEdicion');
        ...
        $(Cuerpo + 'txtCantidadEdicion').val($(hfCantidadMayorista_grilla).val());
        $(Cuerpo + 'txtAñoEdicion').val($(hfAnio).val());
        $(Cuerpo + 'txtLimiteEdicion').val($(hfLimiteMayorista_grilla).val());
        $(Cuerpo + 'txtExclusivoEdicion').val(parseFloat($(hfExclusivo).val()).toFixed(2));
        ...
        {
           $(Cuerpo + 'txtCodigoEdicion').val('');
        $(Cuerpo + 'txtCodigoInternoEdicion').val('');
        $(Cuerpo + 'ddlFamiliaEdicion').val('54');
        $(Cuerpo + 'txtDescripcionEdicion').val('');
        $(Cuerpo + 'txtMarcaEdicion').val('');
        $(Cuerpo + 'txtModeloEdicion').val('');
        $(Cuerpo + 'txtMedidaEdicion').val('');
        $(Cuerpo + 'txtPosicionEdicion').val('');
        $(Cuerpo + 'txtFactorEdicion').val('');
        $(Cuerpo + 'ddlMonedaEdicion').val('1');
        $(Cuerpo + 'ddlCompraEdicion').val('22');
        $(Cuerpo + 'ddlVentaEdicion').val('22');
        $(Cuerpo + 'txtCantidadEdicion').val(0);
        $(Cuerpo + 'txtAñoEdicion').val('');
        $(Cuerpo + 'txtLimiteEdicion').val(0);

        var CostoSoles = Number(0).toFixed(2);
        var CostoDolares = Number(0).toFixed(2);
        var Precio1 = Number(0).toFixed(2);
        var Precio2 = Number(0).toFixed(2);
        var Precio3 = Number(0).toFixed(2);
        var Exclusivo = Number(0).toFixed(2);
        ...
        $(Cuerpo + 'txtPrecio2Edicion').val(Precio2);
        $(Cuerpo + 'txtPrecio3Edicion').val(Precio3);
        $(Cuerpo + 'txtExclusivoEdicion').val(Precio3);

        $('#hfCodProducto').val('1');
        $(Cuerpo + 'ddlFamiliaConsulta').val(0);

        $(Cuerpo + 'txtStockMaximoEdicion').val('');
        $(Cuerpo + 'txtStockMinimoEdicion').val('');
        $(Cuerpo + 'txtCodigo2Edicion').val('');
        $(Cuerpo + 'txtDescripcionInglesEdicion').val('');
        $(Cuerpo + 'txtPartidaArancelariaEdicion').val('');
        $(Cuerpo + 'txtPartidaArancelariaEdicion').val('');
        $(Cuerpo + 'txtUbicacionEdicion').val('');       
        $(Cuerpo + 'lblEdicionProducto').text('EDITAR PRODUCTO');    
        }
        var d = new Date();
         var objParams = {
        ...
        F_ConsultaMovimiento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                ...
                $(Cuerpo + 'chkProductoNuevo').prop('checked', false);
                $(Cuerpo + 'chkProductoNuevo').prop('disabled', false);
                $('#lblEdicionProducto').text('EDICION DE PRODUCTO'); 
...
function F_ValidarEdicionDocumentoProducto() {

    try {

        var Cuerpo = '#MainContent_';
        var Cadena = 'Ingresar los sgtes. Datos: <br> <p></p>';
        var Permiso = F_PermisoOpcion_SinAviso(1000, 1000305, '');
...
//            Cadena = Cadena + '<p></p>' + 'La unidad de compra y venta son distintas,el Factor no puede ser 1.';
        ...
        if (Permiso == 1 & $(Cuerpo + 'txtPrecio3Edicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'MAYORISTA';

        if (Permiso == 1 & $(Cuerpo + 'txtCantidadEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Cantidad';

        if (Permiso == 1 & $(Cuerpo + 'txtLimiteEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Limite';

        if (parseFloat($(Cuerpo + 'txtPrecio1Edicion').val()) < parseFloat($(Cuerpo + 'txtCostoEdicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO 1 NO PUEDE SER MENOR QUE EL COSTO';
        ...
        if (parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) < parseFloat($(Cuerpo + 'txtCostoEdicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO 2 NO PUEDE SER MENOR QUE EL COSTO';

        if (Permiso == 1 & parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()) < parseFloat($(Cuerpo + 'txtCostoEdicion').val()))
            Cadena = Cadena + '<p></p>' + 'MAYORISTA NO PUEDE SER MENOR QUE EL COSTO';
        ...
        if (parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) > 0 &  parseFloat($(Cuerpo + 'txtPrecio1Edicion').val()) < parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()))
            Cadena = Cadena + '<p></p>' + 'PRECIO 1 NO PUEDE SER MENOR QUE EL PRECIO 2';

//        if (Permiso == 1 & parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()) > 0 & parseFloat($(Cuerpo + 'txtPrecio2Edicion').val()) < parseFloat($(Cuerpo + 'txtPrecio3Edicion').val()))
//            Cadena = Cadena + '<p></p>' + 'PRECIO 2 NO PUEDE SER MENOR QUE EL MAYORISTA';
...
function F_EdicionRegistroProducto() {
    var CodTipoProducto = 2;
    var chkNotaPedido = 0;
    var chkServicio = 0;
    var chkProductoNuevo = 0;
    try {
        var Contenedor = '#MainContent_';
    ...
    if ($('#MainContent_chkServicios').is(':checked'))
        ...
        var objParams = {
            ...
            Filtro_CodigoProducto: $(Contenedor + 'txtCodigoInternoEdicion').val().toUpperCase().trim(),
            ...
            Filtro_Exclusivo: $(Contenedor + 'txtExclusivoEdicion').val(),
            Filtro_Cantidad: $(Contenedor + 'txtCantidadEdicion').val(),
            Filtro_Limite: $(Contenedor + 'txtLimiteEdicion').val(),
            ...
            Filtro_PermisoMayorista: PermisoMayorista,
            Filtro_CodigoMenu: 1000,
            Filtro_Imagenes: Sys.Serialization.JavaScriptSerializer.serialize(arrImg),
            Filtro_CodTipoProducto: CodTipoProducto,
            Filtro_CodMoneda: $('#MainContent_ddlMoneda').val(),
            Filtro_Servicio: chkServicio,
            Filtro_NotaPedido: chkNotaPedido,
            Filtro_ProductoNuevo: chkProductoNuevo,
            Filtro_Cliente:$('#hfCodCtaCte').val()
        };
        ...
        F_EdicionRegistro_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                ...
                }  else if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                        F_Update_Division_HTML('div_grvConsultaArticulo', result.split('~')[2]);
                    $('#divEdicionRegistro').dialog('close');
                    var nombrecampo = $('#hid_id_nombre_edit').val();
                    $(Contenedor + 'txtCodigoProductoEdicion').val('');
