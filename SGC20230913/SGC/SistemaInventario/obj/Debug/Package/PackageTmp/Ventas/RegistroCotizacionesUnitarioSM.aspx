<%@ Page Title="Cotizacion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroCotizacionesUnitarioSM.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesUnitarioSM" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesUnitarioSM.js"   charset="UTF-8"></script>     
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDistrito" runat="server" Width="315px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                                        ...
                                                        <div id="div_moneda">
                                                           ...
                                                           <td style="font-weight: bold;">
                                                                ...
                                                                <td  style="padding-left: 6px">
                                                                    <div id="div_serie">
                                                                        <asp:DropDownList ID="ddlSerie" Width="75" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                            Font-Bold="True">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </td> 
                                    ...
                                    <tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td  style="padding-left: 13px">
                                                        <asp:TextBox ID="txtKM" runat="server" Width="78px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="display: none">
                                     ...
                                     <tr>
                                        ...
                                        <tr>
                                        <td>
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="901px" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                     ...
                                     <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Precio">
                                                <ItemStyle HorizontalAlign="Right"/>
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblPrecio" Text='<%# Bind("Precio1") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
