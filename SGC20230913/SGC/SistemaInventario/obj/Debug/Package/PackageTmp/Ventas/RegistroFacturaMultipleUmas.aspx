<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleUmas.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleUmas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleUmas.js"  charset="UTF-8"></script>      
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-weight: bold; padding-left: 10px">
                                                    <asp:CheckBox ID="chkKM" runat="server" Text="KM" Font-Bold="True" />
                                        </td>
                                            ...
                                            <asp:TextBox ID="txtKM" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                                    ...
                                                    <td style="font-weight: bold; padding-left: 2px">
                                                                <asp:CheckBox ID="chkOC" runat="server" Text="OC" Font-Bold="True" />
                                                    </td>
                                                    <td style="padding-left: 0px;">
                                                        <asp:TextBox ID="txtNroOC" runat="server" Width="170px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Cotizacion
                                  ...
                                  Observacion
                                      ...
                                      <td>
                                                                           <asp:TextBox ID="txtObservacion" runat="server" Width="737px" Font-Names="Arial"
                                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                    </tr>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Panel ID="pnlOrdersObservacion" runat="server" Style="display: none">
                                                <asp:GridView ID="grvDetalleObservacion" runat="server" border="0" CellPadding="0"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="ObservacionesCliente" HeaderText="Observacion">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
              ...
              <td style="font-weight: bold" colspan='2' align="center">
                        ...
                        <table>
                            <tr>
                                ...
                                <td id="div_lblPlaca1Editar" style="font-weight: bold;">
                                                    <asp:CheckBox ID="chkPlacaEdicion" runat="server" Text="Placa" Font-Bold="True" />
                                </td>
                                ...
                                <td style="font-weight: bold">
                                    <asp:CheckBox ID="chkKMEdicion" runat="server" Text="KM" Font-Bold="True" />
                                </td>
                                <td>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td style="font-weight: bold">
                                    <asp:CheckBox ID="chkOCEdicion" runat="server" Text="OC" Font-Bold="True" />
                                </td>
                                <td>
                ...
                <tr>
                 ...
                 <td style="font-weight: bold">
                                ...
                                <td>
                                    <asp:TextBox ID="txtClaveAgencia" runat="server" Width="100px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                ...
                <tr>
                                                    ...
                                                    <td  style="padding-left: 4px;">
                                                     <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="837px" Font-Names="Arial"
                                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    </tr>
            </table>
