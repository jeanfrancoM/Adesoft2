var AppSession = "../Ventas/RegistroFacturaMultipleUmas.aspx";
...
//            $('#div_ImpresorasNotaPedido').dialog('close');
    ...
    //esta alteracion del igv solo es para UMAS
...
//                            $('#MainContent_ddlVendedor').val(CodEmpleado);
                        ...
                        F_ValdiarCheckEdicionInicializar();
...
//            return false;
    ...
    function F_ValdiarCheckEdicionInicializar(){
