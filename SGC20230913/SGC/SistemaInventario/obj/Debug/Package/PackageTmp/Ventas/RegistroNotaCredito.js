...
//            F_BuscarDireccionPorDefecto();
    ...
    $('#MainContent_btnEliminar').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        if (F_PermisoOpcion(CodigoMenu, 4000604, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try {
    ...
    try {
        ...
        F_FacturacionNotaCredito_NET(arg, function (result) {
            ...
            if (str_mensaje_operacion == "") {
                ...
                $('#MainContent_ddlCajaFisica').val(result.split('~')[13]);
