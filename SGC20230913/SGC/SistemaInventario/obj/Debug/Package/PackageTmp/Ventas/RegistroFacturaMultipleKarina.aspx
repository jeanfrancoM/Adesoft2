<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMultipleKarina.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleKarina.js"
        charset="UTF-8"></script>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtNroRuc" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" MaxLength="11" onblur="F_ValidaRucDni(); return false;" placeholder="Buscar..."></asp:TextBox>
                                                    </td>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div id="div_SerieCotizacion">
                                                            <asp:DropDownList ID="ddlSerieCotizacion" Width="55" runat="server" Font-Names="Arial"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ID">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="Hfobsevacioncliente" runat="server" Value='<%# Bind("ObservacionesCliente") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <img id="imgMas" alt="" style="cursor: pointer" src="../Asset/images/plus.gif" onclick="F_DetalleMultiple(this);"
                                                        title="Ver Kardex" />
                                            ...
                                            <asp:TemplateField HeaderText="Código">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label runat="server" Font-Size="Medium" ID="hlkCodNeumaticoGv" Text='<%# Bind("CodigoProducto") %>'></asp:Label>
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-weight: bold;">
                                <asp:CheckBox ID="chkServicios" runat="server" Text="ADICIONAL" Font-Bold="True" />
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
              ...
              <td style="font-weight: bold" colspan='2' align="center">
                ...
                <tr>
                 ...
                 <td style="font-weight: bold">
                                         ...
                                         <td  style="padding-left: 5PX; ">
                                                        <asp:TextBox ID="txtobservacionEditar" runat="server" Width="825px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" ReadOnly="False"></asp:TextBox>
                                                    </td>
            </table>
            <div class="ui-jqgrid-titlebar ui-widget-header
