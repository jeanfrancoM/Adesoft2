<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleCosmetica.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleCosmetica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleCosmetica.js" charset="UTF-8"></script>       
                    ...
                    <div id="tabRegistro">
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                            ...
                            <div class="linea-button">
                                <asp:Button ID="btnListarCotizaciones" runat="server" Text="Listar Pedido" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                ...
                                <asp:Button ID="btnNotaVenta" runat="server" Text="Nota Venta (F3)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                                <asp:Button ID="btnCotizacion" runat="server" Text="Nota Pedido (F4)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
