<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMultipleFundidora.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleFundidora" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleFundidora.js"  charset="UTF-8"></script>      
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr valign="top">
                                        ...
                                        <td style="padding-left: 4px;">
                                            <div id="div_Empresa">
                                                <asp:DropDownList ID="ddlEmpresa" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="529" Font-Size="Medium">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtTotal" runat="server" Width="84px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True" ReadOnly="True" Text="0.00"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div id="div3">
                                                            <asp:DropDownList ID="ddlTipoDocumentoJalar" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="90">
                                                                <asp:ListItem Value="15">Cotizacion</asp:ListItem>
                                                                <asp:ListItem Value="23">Pedido</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                                    <td >
                                                    ...
                                                    <td style="padding-left: 15px;">
                                                        <asp:TextBox ID="txtNroOC" runat="server" Width="302px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                        ...
                                        <td style="display:none;">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <div id="div4">
                                                            <asp:DropDownList ID="ddlFormatoImpresion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td id="div_Placa1" style="padding-left: 13px;;display: none">
                                                    ...
                                                    <td id="Td1" style="padding-left: 16px;display: none">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                ...
                                                <td style="font-weight: bold; padding-left: 2px">
                                                    ...
                                                    <td style="">
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="922" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                        </td>
                            ...
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="UM" HeaderText="UM">
                                     ...
                                     <asp:BoundField DataField="Pestimado" HeaderText="Pestimado">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>
                                                        ...
                                                        <td style="">
                                                            <div id="div_TipoDoc2">
                                                                <asp:DropDownList ID="ddlTipoDoc2" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                    ...
                                                                    <asp:ListItem Value="17">FACTURA</asp:ListItem>
                                                                    <asp:ListItem Value="2">BOLETA</asp:ListItem>
                                                                    <asp:ListItem Value="15">COTIZACION</asp:ListItem>
                                                                    <asp:ListItem Value="16">NOTA DE PEDIDO</asp:ListItem>
                                                                </asp:DropDownList>
                                            ...
                                            <td>
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 4px;">
                                                            <asp:TextBox ID="txtClienteConsulta" runat="server" Width="452" Font-Names="Arial"
                                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <div id="div_consulta">
                            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                             ...
                             <%--       <asp:TemplateField>
                                  ...
                                  <%--  <asp:TemplateField HeaderText="GRE">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgImprimirGuiaPDF" ImageUrl="~/Asset/images/pdf.png"
                                                ToolTip="PDF GUIA ELECTRONICA" OnClientClick="F_ImprimirGuiaPDF(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                   <%-- <asp:TemplateField HeaderText="IMP">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/imprimir.gif"
                                                ToolTip="Imprimir Factura" OnClientClick="F_ImprimirElectronica(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
            ...
            <td valign="top" style="width: 120px;display:none;">
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 250px;
                    ...
                    <div id="div1" class="ui-jqdialog-content">
                        <ul id="lu_Pedidos" class="ul-float" style="padding-left: 5px; width: 220px">
                        </ul>
                    </div>
                </div>
            </td>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding-left: 4px;">
                                            <div id="div5">
                                                <asp:DropDownList ID="ddlTipoBusquedaArticulo" runat="server" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" Width="150">
                                                    <asp:ListItem Value="2" Selected="True">PRODUCTOS</asp:ListItem>
                                                    <asp:ListItem Value="4">ANTICIPO</asp:ListItem>                                                  
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtArticulo" runat="server" Width="615px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemStyle Font-Bold="true" />
                                                <ItemTemplate>
                                                    <img id="imgMas" alt="" style="cursor: pointer" src="../Asset/images/plus.gif" onclick="F_MarcasProductos(this);"
                                                        title="Ver Kardex" />
                                                    <asp:Panel ID="pnlOrdersMarcaProducto" runat="server" Style="display: none">
                                                        <asp:GridView ID="grvDetalleMarcaProducto" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                            AutoGenerateColumns="False" GridLines="None" class="GridView">
                                                            <Columns>
                                        ...
                                        <%--    <asp:TemplateField HeaderText="MINORISTA">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="hfPrecio3" Text='<%# Bind("Precio2") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddlUM" Style="width: 207px" runat="server" Font-Size="16">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="font-weight: bold">
                                            Dscto.
    ...
    ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True" Width="120" />
                    <asp:Button ID="btnAgregarItemCT" runat="server" Text="Agregar" class="ui-button
    ui-widget ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True"
                        Width="120" />
                </td>
            </tr>
    ...
    %>' />
                                ...
                                <asp:TemplateField HeaderText="Codigo">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCodigo" Text='<%# Bind("Codigo")
    %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Descripcion">
                                ...
                                <asp:TemplateField HeaderText="Acuenta" Visible="false">
                                    <ItemStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblAcuenta" Text='<%# Bind("Acuenta")
    %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Cantidad" ItemStyle-HorizontalAlign="Center">
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtClienteEditar" runat="server" Width="250px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                </td>
                                ...
                                <td style="font-weight: bold">
                                  ...
                                  <td>
                                                        <div id="div_VendedorEditar">
                                                            <asp:DropDownList ID="dllvendedorEditor" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="120">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                    ...
                    <td>
                        ...
                        <tr>
                            <td style="font-weight: bold">
                                ...
                                <td>
                                    <asp:TextBox ID="txtObservacionEdicion" runat="server" Width="900px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                    </td>
    ...
    <input id="hfminimoPrecioAgregar" type="hidden" value="0" />
    ...
    <input id="hfCodCategoriaGuarda" type="hidden" value="0" />
