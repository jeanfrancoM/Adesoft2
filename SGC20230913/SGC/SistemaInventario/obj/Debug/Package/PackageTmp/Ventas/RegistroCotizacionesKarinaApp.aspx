<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroCotizacionesKarinaApp.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesKarinaApp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesKarinaApp.js"  charset="UTF-8"></script>     
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table>
        <tr valign="top">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold; padding-left: 87px">
                                                        total
                                                    </td>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgReemplazar" ImageUrl="~/Asset/images/Reemplazo.png"
                                                ToolTip="ACTUALIZAR COTIZACION" OnClientClick="F_ReemplazarDocumento2(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <td valign="top" style="width: 120px; padding-top: 68px">
                ...
                <table>
                    <tr>
                        <td valign="top">
                            ...
                            <div style="overflow-y: scroll; height: 385px;">
                                <div id="div_grvConsultaArticulo" >
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        GridLines="None" Width="947px" OnRowDataBound="grvConsultaArticulo_RowDataBound"
                                        >
                                        <Columns>
                                            <asp:TemplateField>
                        ...
                        <td valign="top">
                            <div id="divStocksEmpresas" style="width: 230px;">
                                <table>
                                    <thead>
                                        <tr>
                            ...
                            <div id="div_ultimoprecio">
                                <div class="ui-jqdialog-content">
                                    <div class="ui-jqdialog-content">
                                        ...
                                        <div id="div_grvConsultaUltimosPrecios">
