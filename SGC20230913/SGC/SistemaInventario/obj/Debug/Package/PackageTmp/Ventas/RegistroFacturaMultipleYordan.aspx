<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleYordan.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleYordan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleYordan.js"  charset="UTF-8"></script>      
    ...
    <table>
        <tr valign="top">
                        ...
                        <div id="div_grvDetalleArticulo" style="padding-top: 5px;">
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Descripcion" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtDescripcion" Font-Bold="true" CssClass="ccsestilo"
                                                Width="480px" Font-Names="Arial" ForeColor="Blue"  ReadOnly="True" Text='<%# Bind("Producto") %>'
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgPermiso" ImageUrl="../Asset/images/Circle_Green.png"
                                                OnClientClick="F_SoloActualizarDetalle(); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                                    ...
                                    <asp:TemplateField HeaderText="IMP">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/imprimir.gif"
                                                ToolTip="Imprimir Factura" OnClientClick="F_ImprimirDocumento(undefined,this,'imgPdf','TK'); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <td valign="top" style="width: 120px">
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 250px;display:none;height: 100%;">
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 250px;
                    height: 100%;">
                    <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                        Estado de Solicitudes de Descuentos
                    </div>
                    <div id="div1" class="ui-jqdialog-content">
                        <table>
                            <tr>
                                <td>
                                    <img src="../Asset/images/Circle_Green.png" />
                                </td>
                                <td>
                                    Aceptado
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="../Asset/images/Circle_Yellow.png" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../Asset/images/Circle_Red.png" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../Asset/images/btnEdit.gif" />
                                </td>
                                <td>
                                    Precio Sugerido por Supervisor
                                </td>
                            </tr>
                        </table>
                    </div>
                            ...
                            <div id="div_ultimoprecio">
                                <div class="ui-jqdialog-content">
                                    <div class="ui-jqdialog-content">
                                        ...
                                        <div id="div_grvConsultaUltimosPrecios" style="overflow-y: scroll; overflow-x: scroll; padding-top: 5px; height: 140px; Width: 230px;">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td id="tdStock" style="font-weight: bold">
                                            Stock
                                        </td>
                                        <td>
