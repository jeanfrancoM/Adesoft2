<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultiple.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultiple" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultiple.js" charset="UTF-8"></script>       
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 15px;">
                                                        <asp:TextBox ID="txtNroOC" runat="server" Width="155px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        Placa
                                                    </td>
                                                    <td id="div_Placa1"  style="padding-left: 39px;">
     ...
     <td>
                    ...
                    <div id="tabConsulta">
                        <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                            ...
                            <asp:CheckBox ID="chkFactura" runat="server" Text="VISUALIZAR SOLO PDF Factura" Font-Bold="True" />
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                               ...
                                               <%--         <asp:BoundField DataField="ID" HeaderText="ID">
                                                        ...
                                                        <asp:BoundField DataField="Anexo2" HeaderText="COMPRA 1">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                            <asp:BoundField DataField="Anexo3" HeaderText="COMPRA 2">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                    ...
                    <div id="div_DetalleNV">
                        <asp:GridView ID="grvDetalleNV" runat="server" AutoGenerateColumns="False" border="0"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                              <%--   <HeaderTemplate>
                                                                <asp:CheckBox ID="checkAll" runat="server" onclick="F_ChequearTodo(this);" />
                                                            </HeaderTemplate>--%>
                                    <ItemTemplate>
                                        <asp:CheckBox runat="server" ID="chkEliminar" CssClass="chkDelete" Text="" onclick="F_ValidarCheck_OC(this.id);" />
                                    </ItemTemplate>
  ...
  <input id="hfCodTransportistaEdicion" type="hidden" value="0" />
   ...
   <input id="hfCodCtaCteTransportista" type="hidden" value="0" />
    ...
    <input id="Hidden2" type="hidden" value="0" />
     ...
     <input id="Hidden3" type="hidden" value="" />
