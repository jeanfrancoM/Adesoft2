<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleTractos.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleTractos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleTractos.js"  charset="UTF-8"></script>      
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 0px;">
                                                        <asp:TextBox ID="txtNroOC" runat="server" Width="180px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Cotizacion
