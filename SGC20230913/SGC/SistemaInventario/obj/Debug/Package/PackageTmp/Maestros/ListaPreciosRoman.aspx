<%@ Page Title="Lista Precios" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ListaPreciosRoman.aspx.cs" Inherits="SistemaInventario.Maestros.ListaPreciosRoman" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ListaPreciosRoman.js"   charset="UTF-8"></script>   
        ...
        <div id="div_grvConsultaArticulo" style="padding-top: 5px;">
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            ...
                            <asp:BoundField DataField="Codigo" HeaderText="Codigo">
                                 ...
                                 <asp:BoundField DataField="CodigoAlternativo" HeaderText="Codigo 2">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="CostoUniOriginal" HeaderText="COSTO">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                    ...
                    <asp:TemplateField HeaderText="MARGEN - 1" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtM1" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
                                Text='<%# Bind("M1") %>'  ></asp:TextBox>
                            ...
                            <asp:HiddenField ID="hfMargen3" runat="server" Value='<%# Bind("M3") %>' />
                            <asp:HiddenField ID="hfMargen4" runat="server" Value='<%# Bind("M4") %>' />
                            <asp:HiddenField ID="hfMargen5" runat="server" Value='<%# Bind("M5") %>' />
                    ...
                    <asp:TemplateField HeaderText="MARGEN - 2" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtM2" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
                                Text='<%# Bind("M2") %>' ></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="MARGEN - 3" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtM3" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
                                Text='<%# Bind("M3") %>' ></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                       <asp:TemplateField HeaderText="MARGEN - 4" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtM4" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
                                Text='<%# Bind("M4") %>' ></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="PRECIO 5" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtPrecioLista5" Width="80px" Style="text-align: center;"
                                Font-Names="Arial" ForeColor="Blue" Font-Bold="True" CssClass="ccsestilo" onblur="F_Precio(this.id);"
                                Text='<%# Bind("Precio5") %>' ></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Moneda">
                      ...
                      <asp:TemplateField HeaderText="Total">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblstock" Text='<%# Bind("Total") %>'  CssClass="detallesart" Font-Size="Medium"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
