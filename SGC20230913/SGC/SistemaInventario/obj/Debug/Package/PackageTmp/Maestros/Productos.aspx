<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="Productos.aspx.cs" Inherits="SistemaInventario.Maestros.Productos" %>
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtDescripcion" runat="server" Width="496px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                        </td>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 2px;">
                                                        <div id="div_moneda">
                                                            <asp:DropDownList ID="ddlMoneda" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                Font-Bold="True" Width="80" Enabled="False">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPrecio2" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                     <td style="font-weight: bold">
                                                        Exclusivo
                                                    ...
                                                    <td >
                                                        <asp:TextBox ID="txtExclusivo" runat="server" Width="71px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                     ...
                                     <td style="font-weight: bold">
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 2px">
                                                        <asp:TextBox ID="txtPrecio3" runat="server" Width="76px" Font-Names="Arial" ForeColor="Blue"
                                    ...
                                    <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                        ...
                                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hfCantidadMayorista" runat="server" Value='<%# Bind("CantidaEdicion") %>' />
                                                <asp:HiddenField ID="hfLimiteEdicion" runat="server" Value='<%# Bind("LimiteEdicion") %>' />
                                                ...
                                                <asp:HiddenField ID="hfLimite" runat="server" Value='<%# Bind("LimiteEdicion") %>' />
                                     ...
                                     <%--    <asp:BoundField DataField="Precio3Edicion" HeaderText="MAYO" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>--%>
                                         <asp:BoundField DataField="Exclusivo" HeaderText="Exclusivo" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                       <%--  <asp:BoundField DataField="CantidaEdicion" HeaderText="CANT.">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                         <asp:BoundField DataField="LimiteEdicion" HeaderText="LIMITE" >
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>--%>
                        ...
                        <div class="ui-jqdialog-content" style="width: 700px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                     <td style="padding-left: 4px;">
                                        <asp:TextBox ID="txtDescripcionEdicion" runat="server" Width="496px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                            ...
                                            <tr>
                                                <td style="padding-left: 2px;">
                                                    <div id="div_MonedaEdicion">
                                                        <asp:DropDownList ID="ddlMonedaEdicion" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                           Enabled="False"  Font-Bold="True" Width="80">
                                                        </asp:DropDownList>
                                                    </div>
                                                </td>
                                                <td style="font-weight: bold; padding-left: 8px">
                                                ...
                                                <td style="padding-left: 5px">
                                                 ...
                                                 <td style="font-weight: bold">
                                                    ...
                                                    <td >
                                                        <asp:TextBox ID="txtExclusivoEdicion" runat="server" Width="71px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                            </tr>
                                        </table>
                                ...
                                <tr id="tdMayoristaEdicion" style ="display:none;" >
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtPrecio3Edicion" runat="server" Width="76px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold; padding-left: 8px;">
                                                    Cant.
                                ...
                                <td colspan='5'>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtDescripcionVisualizacion" runat="server" Width="300px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            <td style="font-weight: bold; width: 60px; text-align: right">
                                                Moneda
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtMonedaVisualizacion" runat="server" Width="180px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="padding-left: 0px;">
                                                <asp:TextBox ID="txtPrecio1Visualizacion" runat="server" Width="100px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            ...
                                            <td style="padding-left:5px;">
                                                <asp:TextBox ID="txtPrecio2Visualizacion" runat="server" Width="100px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td >
                                             <td style="font-weight: bold; width: 60px; text-align: left;padding-left: 10px;">
                                                Costo
                                            </td>
                                            <td style="padding-left: 15px;">
                                                <asp:TextBox ID="txtCostoVisualizacion" runat="server" Width="120px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                           ...
                                           <td style="font-weight: bold; width: 60px; text-align: right">
                                            ...
                                            <td style="padding-left: 15px;">
                                                <asp:TextBox ID="txtUMVisualizacion" runat="server" Width="102px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtEstadoVisualizacion" runat="server" Width="180px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                           <%-- <td style="font-weight: bold; width: 50px; text-align: right">
                                                Stock
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtStockvisualizacion" runat="server" Width="50px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>--%>
                                        </tr>
                                    </table>
