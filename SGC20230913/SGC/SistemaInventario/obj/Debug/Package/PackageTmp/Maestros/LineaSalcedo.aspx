<%@ Page Title="Linea" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LineaSalcedo.aspx.cs" Inherits="SistemaInventario.Maestros.LineaSalcedo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="LineaSalcedo.js" charset="UTF-8"></script>
                            ...
                            <div id="div_consulta" style="padding-top:5px;" >
                                                ...
                                                <Columns>                                                 
                                                         ...
                                                         <asp:TemplateField HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center">
                                                           ...
                                                           <ItemTemplate>
                                                             <asp:Label runat="server" ID="lblCodigoLinea"  Text='<%# Bind("CodigoLinea") %>' CssClass="detallesart"></asp:Label>
