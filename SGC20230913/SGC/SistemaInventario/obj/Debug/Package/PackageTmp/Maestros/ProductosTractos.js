var AppSession = "../Maestros/ProductosTractos.aspx";
var myDropzone = null;
...
$(document).ready(function () {
    ...
    $('#MainContent_txtFamiliaVisualizacion').css('background', '#FFFFE0');
...
function F_ValidarGrabarDocumento() {
    try {
        ...
        $(Cuerpo + 'txtCodigoInterno').val($(Cuerpo + 'txtCodigo').val());
...
//            Cadena = Cadena + '<p></p>' + 'Codigo Interno';
        ...
        if (parseFloat($(Cuerpo + 'txtTC').val()) == 0)
...
function F_Nuevo() {
    ...
    $(Contenedor + 'txtMedida').val(''),
    $(Contenedor + 'txtFactor').val('1'),
    $(Contenedor + 'txtCostoConIgv').val('0');
    $(Contenedor + 'txtCostoSolesIgv').val('0');
    $(Contenedor + 'ddlMoneda').val('1');
    $(Contenedor + 'ddlUMCompra').val('22');
    $(Contenedor + 'ddlUMVenta').val('22');
    $(Contenedor + 'txtPrecio1').val(''),
...
function F_VisualizarRegistro(Fila) {
    ...
    var hlblcosto = '#' + imgID.replace('imgVisualizarRegistro', 'hfCostoSoles'); $(Cuerpo + 'txtCostoVisualizacion').val($(hlblcosto).val());

    var hlblFamilia = '#' + imgID.replace('imgVisualizarRegistro', 'hfFamilia'); $(Cuerpo + 'txtFamiliaVisualizacion').val($(hlblFamilia).val());
    var hlblMoneda = '#' + imgID.replace('imgVisualizarRegistro', 'lblMoneda'); $(Cuerpo + 'txtMonedaVisualizacion').val($(hlblMoneda).text());
    ...
    var hlblPrecio = '#' + imgID.replace('imgVisualizarRegistro', 'hfPrecio1'); $(Cuerpo + 'txtPrecio1Visualizacion').val($(hlblPrecio).val());
...
function F_CrearDropzone_JS() {
    ...
    midiv.setAttribute("style", "width:670px; height:400px; margin-left: 10px; border-radius:12px; min-height:200px; padding:0px;");
...
function F_Consultar_Imagen(str_tipoConsulta) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset= utf-8",
        url: "ProductosTractos.aspx/F_UltimaImagenTMP_JS",
        dataType: "json",
...
function F_Eliminar_Temporal_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosTractos.aspx/F_Eliminar_Temporal_Imagen',
        dataType: "json",
...
function F_Eliminar_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosTractos.aspx/F_Eliminar_Imagen',
        dataType: "json",
        data: JSON.stringify({ 'objEntidad': param }),
        success: function (dataObject, textStatus) {
            if (textStatus == "success") {
...
function F_ConsultarArticulosRelacionados(CodAlterno) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosTractos.aspx/F_LGProductosRelaciones_Listar_NET',
        dataType: "json",
