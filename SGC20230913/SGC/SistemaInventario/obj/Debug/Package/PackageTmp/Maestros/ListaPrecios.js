var AppSession = "../Maestros/ListaPrecios.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#lblNumeroConsulta').text(F_Numerar_Grilla("grvConsultaArticulo", 'txtCodigoProducto'));
                        var hfCodMoneda = '';
                        $('#MainContent_grvConsultaArticulo .chkSi :checkbox').each(function () {
                            var chkSi = '#' + this.id;
                            hfCodMoneda = chkSi.replace('chkOK', 'hfCodMoneda');
...
function F_AgregarTemporal() {
    try {
        ...
        $('#MainContent_grvConsultaArticulo .chkSi :checkbox').each(function () {
            ...
            txtPrecioLista = chkSi.replace('chkOK', 'txtPrecioLista');
            ...
            if ($(chkSi).is(':checked')) {
                var objDetalle = {
                        ...
                        Precio: $(txtPrecioLista).val(),
                        CodMoneda: $(ddlMonedaLista).val(),
                        DscProducto: $(txtDescripcion).val(),
                        Marca: $(txtMarca).val(),
                        Modelo: $(txtModelo).val(),
                        Medida: '',
                        DescripcionIngles: $(txtDescripcionIngles).val()
                };
...
function F_ValidarCheck(ControlID) {
    ...
    var txtPrecioLista = chkok_grilla.replace('chkOK', 'txtPrecioLista');
    ...
    if ($(chkok_grilla).is(':checked')) 
    {
        ...
        $(txtPrecioLista).prop('disabled', false);
    ...
    else 
    {
        ...
        $(txtPrecioLista).prop('disabled', true);
...
function F_Reporte() {
    ...
    rptURL = rptURL + 'FechaVigencia=' + '01/01/1990' + '&';
