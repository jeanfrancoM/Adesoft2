<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductosTractos.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosTractos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosTractos.js" charset="UTF-8"></script>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                          <td style="font-weight: bold;">
                                                    ...
                                                    <tr>
                                                       <td>
                                                        <asp:TextBox ID="txtPrecio1" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 13px;">
                                                        <asp:TextBox ID="txtFactor" runat="server" Width="74px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" Text="1"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtCosto" runat="server" Width="60px" Font-Names="Arial" ForeColor="Blue"
                                                           Text="0"  Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                        ...
                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfUbicacion" runat="server" Value='<%# Bind("Ubicacion") %>' />
                                 ...
                                 <asp:HiddenField ID="hfFamilia" runat="server" Value='<%# Bind("Familia") %>' />
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    ...
                                                    Text="0.00"    ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 5px; font-weight: bold">
                                                    Precio 3
                                                </td>
                                ...
                                <td colspan='5'>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtFamiliaVisualizacion" runat="server" Width="100px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtMonedaVisualizacion" runat="server" Width="230px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                           ...
                                           <td style="font-weight: bold; width: 60px; text-align: right">
                                            ...
                                            <td style="font-weight: bold; width: 60px; text-align: right;display:none;">
                                                Posicion
                                            </td>
                                            <td style="padding-left: 5px;display:none;">
                                            ...
                                            <td style="font-weight: bold; width: 50px; text-align: right;display:none;">
                                                Año
                                            </td>
                                            <td style="padding-left: 5px;display:none;">
