<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductosYordan.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosYordan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosYordan.js" charset="UTF-8"></script>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtCosto" runat="server" Width="90px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtPrecio1" runat="server" Width="90px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtPrecio2" runat="server" Width="90px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtPrecio3" runat="server" Width="110px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        Precio 4
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtPrecio4" runat="server" Width="80px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        ubicacion
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtUbicacion" runat="server" Width="245px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtCostoEdicion" runat="server" Width="95px" Font-Names="Arial"
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio1Edicion" runat="server" Width="90px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 5px; font-weight: bold">
                                                    Precio 2
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio2Edicion" runat="server" Width="90px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtPrecio3Edicion" runat="server" Width="105px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 5px; font-weight: bold">
                                                    Precio 4
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio4Edicion" runat="server" Width="85px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    ubicacion
                                                ...
                                                <td style="padding-left: 2px;">
                                                    <asp:TextBox ID="txtUbicacionEdicion" runat="server" Width="245px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
