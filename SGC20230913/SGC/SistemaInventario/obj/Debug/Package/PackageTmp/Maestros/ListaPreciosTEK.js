var AppSession = "../Maestros/ListaPreciosTEK.aspx";
var CodigoMenu = 1000;
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#MainContent_grvConsultaArticulo .chkSi :checkbox').each(function () {
                            var chkSi = '#' + this.id;
                            hfCodMoneda = chkSi.replace('chkOK', 'hfCodMoneda');
                            ddlMoneda = chkSi.replace('chkOK', 'ddlMonedaLista');
                            $(ddlMoneda).val($(hfCodMoneda).val());
...
function F_AgregarTemporal() {
    try {
        ...
        $('#MainContent_grvConsultaArticulo .chkSi :checkbox').each(function () {
            ...
            txtCostoOriginal = chkSi.replace('chkOK', 'txtCostoOriginal');
            ...
            if ($(chkSi).is(':checked')) {
                var objDetalle = {
                    ...
                    Precio2: 0,
                    Precio3: 0,
                    CostoOriginal: $(txtCostoOriginal).val(),
...
function F_ValidarCheck(ControlID) {
    ...
    var txtCostoOriginal = chkok_grilla.replace('chkOK', 'txtCostoOriginal');
    ...
    if ($(chkok_grilla).is(':checked')) {
        ...
        $(txtCostoOriginal).prop('disabled', false);
        ...
        $(txtCostoOriginal).prop('disabled', true);
