<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ProductosPOVIS.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosPOVIS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosPOVIS.js" charset="UTF-8"></script>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 21px; font-weight: bold; display: none">
                                                        <div id="div_umventa">
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="">
                                                        <asp:TextBox ID="txtCosto" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td style="">
                                                        <asp:TextBox ID="txtMargen3" runat="server" Width="23px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        %P.F.
                                                    ...
                                                    <td style="">
                                                        <asp:TextBox ID="txtMargen2" runat="server" Width="23px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        %P.C.
                                                    ...
                                                    <td style="">
                                                        <asp:TextBox ID="txtMargen1" runat="server" Width="23px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                     <td style="padding-left: 5px; font-weight: bold">
                                                        P.MIM.
                                                    ...
                                                    <td style="padding-left: 7px">
                                                        <asp:TextBox ID="txtPrecio3" ReadOnly="True" runat="server" Width="58px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        P.F.
                                                    ...
                                                    <td style="padding-left: 7px">
                                                        <asp:TextBox ID="txtPrecio2" ReadOnly="True" runat="server" Width="58px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        P.C.
                                                    ...
                                                    <td style="padding-left: 7px">
                                                        <asp:TextBox ID="txtPrecio1" ReadOnly="True" runat="server" Width="58px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                     ...
                                     <td colspan='5'>
                                                    ...
                                                    <tr>
                                                     <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtUbicacion" runat="server" Width="170px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                     <td style="font-weight: bold; padding-left: 5px;">
                                                        Orden
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <asp:TextBox ID="txtOrden" runat="server" Width="60px" Font-Names="Arial" ForeColor="Blue"
                ...
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDescripcionConsulta" runat="server" Width="447" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                              <td  >
                            ...
                            <td>
                                <asp:TextBox ID="txtMarcaConsulta" runat="server" Width="150px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                            </td>
                            <td style="padding-left: 5px; font-weight: bold;">
                                Estado
                        ...
                        <asp:TemplateField ItemStyle-Width="120px">
                            <ItemTemplate>
                                <center>
                                    ...
                                    <asp:ImageButton runat="server" ID="imgRepresentaciones" ImageUrl="../Asset/images/box.png"
                                        Width="16px" Height="16px" ToolTip="Representaciones de Producto" OnClientClick="F_Representaciones(this); return false;" />
<%--                                         <asp:ImageButton runat="server" ID="imgAgregar" ImageUrl="~/Asset/images/ok.gif"
                       ...
                       <%-- <asp:TemplateField ItemStyle-Width="20px">
                        ...
                        <asp:BoundField DataField="Precio3Edicion" HeaderText="P.MIN" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                           <asp:BoundField DataField="Precio2Edicion" HeaderText="P.F" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Precio1Edicion" HeaderText="P.C" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
          ...
          <%-- <td valign="top" style="padding-left: 5px;">
                            <div id="divStocksEmpresas" style="width: 200px; padding-top: 5px">
                                <table>
                                    <thead>
                                        <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="300px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="">
                                                    <asp:TextBox ID="txtCostoEdicion" runat="server" Width="50px" Font-Names="Arial"
                                                ...
                                                <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen3Edicion" runat="server" Width="25px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                     <td style="padding-left: 5px; font-weight: bold">
                                                        %P.F.
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen2Edicion" runat="server" Width="25px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                 <td style="padding-left: 5px; font-weight: bold">
                                                        %P.C.
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen1Edicion" runat="server" Width="25px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                ...
                                                <td style="padding-left: 5px;">
                                                    <asp:TextBox ID="txtPrecio3Edicion" ReadOnly="True" runat="server" Width="58px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    P.F.
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio2Edicion" ReadOnly="True" runat="server" Width="58px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        P.C.
                                                    ...
                                                    <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio1Edicion" ReadOnly="True" runat="server" Width="58px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding-left: 2px;">
                                                    <asp:TextBox ID="txtUbicacionEdicion" runat="server" Width="182px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                 <td style="font-weight: bold; padding-left: 5px;">
                                                        Orden
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <asp:TextBox ID="txtOrdenEdicion" runat="server" Width="60px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" Text="0" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                <td style="font-weight: bold; padding-left: 5px;">
                                                    Stock Min
    ...
    <div id="div_representaciones" class="wrapper" style="display: none;">
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 1080px;">
            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                DATOS PRODUCTOS
            </div>
            <div>
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tr>
                        ...
                        <tr>
                           <td>
                            <asp:TextBox ID="txtRepreCodigo" runat="server" Width="120px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold">
                            descripcion
                        </td>
                        <td>
                            <asp:TextBox ID="txtRepreDescripcion" runat="server" Width="350px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold">
                            UM
                        ...
                        <td>
                            <asp:TextBox ID="txtRepreUM" runat="server" Width="30px" Font-Names="Arial" ForeColor="Blue"
                                Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold">
                            MON
                        </td>
                        <td>
                            <asp:TextBox ID="txtRepreMon" runat="server" Width="20px" Font-Names="Arial" ForeColor="Blue"
                                Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold">
                            Costo
                        ...
                        <td>
                            <asp:TextBox ID="txtRepreCostoDisplay" runat="server" Width="100px" Font-Names="Arial"
                               CssClass="Derecha"  ForeColor="Blue" Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                      <td>
                            <asp:TextBox ID="txtReprePMIN" runat="server" Width="120px" Font-Names="Arial" ForeColor="Blue"
                               CssClass="Derecha"  Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td> 
                           <td style="font-weight: bold;padding-left:16px;">
                            P.F
                        </td>
                            <td>
                            <asp:TextBox ID="txtReprePF" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                               CssClass="Derecha"  Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td> 
                        <td style="font-weight: bold;padding-left:16px;">
                            P.C
                            ...
                            <td>
                            <asp:TextBox ID="txtReprePC" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                               CssClass="Derecha"  Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td> 
                    </tr>
                    </table>
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tr>
                        ...
                        <tr>
                             <td>
                            <div>
                                <asp:DropDownList ID="ddlRepreUM" runat="server" Font-Names="Arial" ForeColor="Blue"
                        ...
                        <td >
                            <asp:TextBox ID="txtRepreFactor" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                        ...
                        <td >
                            <asp:TextBox ID="txtRepreEjemplo" runat="server" Width="633px" Font-Names="Arial"
                    ...
                    <tr>
                        ...
                        <tr>
                           <td>
                            <div>
                                <asp:DropDownList ID="ddlRepreMoneda" runat="server" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True" Width="70">
                                </asp:DropDownList>
                            </div>
                        </td>
                        ...
                        <td style="padding-left:7px;">
                            <asp:TextBox ID="txtRepreCosto" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                              CssClass="Derecha"   Font-Bold="True" Enabled="false"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold;">
                            P.MIN
                        </td>
                        <td style="padding-left:16px;">
                            <asp:TextBox ID="txtReprePrecio1" runat="server" Width="100px" Font-Names="Arial"
                        ...
                        <td>
                            <asp:TextBox ID="txtReprePrecio2" runat="server" Width="100px" Font-Names="Arial"
                               CssClass="Derecha"  ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold;">
                            P.C 
                        ...
                        <td style="width: 60px;">
                            <asp:TextBox ID="txtReprePrecio3" runat="server" Width="100px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True" CssClass="NumericosRepre" Text="0"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold; width: 60px; display: none">
                            Precio 4
                        </td>
                        <td style="width: 60px; display: none">
                            <asp:TextBox ID="txtReprePrecio4" runat="server" Width="50px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True" CssClass="NumericosRepre"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold; width: 60px; display: none">
                            Precio 5
                        </td>
                        <td style="width: 60px; display: none">
                            <asp:TextBox ID="txtReprePrecio5" runat="server" Width="50px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True" CssClass="NumericosRepre"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold; width: 60px; display: none">
                            Precio 6
                        ...
                        <td style="width: 60px; display: none">
                            <asp:TextBox ID="txtReprePrecio6" runat="server" Width="50px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True" CssClass="NumericosRepre"></asp:TextBox>
                        </td>
                        <td style="font-weight: bold;">
                            Estado
                 ...
                 <div class="linea-button">
                <asp:Button ID="btnAgregarRepresentacion" runat="server" Text="Agregar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                    Font-Names="Arial" Font-Bold="True" Width="120px" OnClientClick="F_RetencionesAnteriores_Insertar(); return false;" />
                    </div>
            </div>
        </div>
        <div style="padding-top: 10px">
            <div id="div_Presentaciones">
                <asp:GridView ID="grvPresentaciones" runat="server" AutoGenerateColumns="False" border="0"
                    CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="860px">
                    <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="ELIMINAR PRESENTACION" OnClientClick="F_EliminarPresentacion(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif"
                                    ToolTip="EDITAR PRESENTACION" OnClientClick="F_RetencionesAnteriores_Editar(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="UM" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblUnidadMedida" Text='<%# Bind("UnidadMedida") %>'></asp:Label>
                                <asp:HiddenField ID="hfCodProductoPresentacion" runat="server" Value='<%# Bind("CodProductoPresentacion") %>' />
                                <asp:HiddenField ID="hfCodProducto" runat="server" Value='<%# Bind("CodProducto") %>' />
                                <asp:HiddenField ID="hfCodEstado" runat="server" Value='<%# Bind("CodEstado") %>' />
                                <asp:HiddenField ID="hfCodUnidadMedida" runat="server" Value='<%# Bind("CodUnidadMedida") %>' />
                                <asp:HiddenField ID="hfCodMoneda" runat="server" Value='<%# Bind("CodMoneda") %>' />
                                <asp:HiddenField ID="hfPrecio4" runat="server" Value='<%# Bind("Precio4") %>' />
                                <asp:HiddenField ID="hfPrecio5" runat="server" Value='<%# Bind("Precio5") %>' />
                                <asp:HiddenField ID="hfPrecio6" runat="server" Value='<%# Bind("Precio6") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Factor" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblFactor" Text='<%# Bind("Factor") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="P.MIN" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblPrecio3" Text='<%# Bind("Precio3") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>  
                        <asp:TemplateField HeaderText="P.F" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblPrecio2" Text='<%# Bind("Precio2") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>  
                        <asp:TemplateField HeaderText="P.C" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Principal" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblPrincipal" Text='<%# Bind("Principal") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
    ...
    <div id="div_HistorialCostos" style="display: none;">
        ...
        <div id="div_tabHistorial" style="width: 1120px;">
            <ul>
    ...
    <input id="hfCodMonedaRepres" type="hidden" value="0" />
    <input id="hfCodProductoPresentacion" type="hidden" value="0" />
