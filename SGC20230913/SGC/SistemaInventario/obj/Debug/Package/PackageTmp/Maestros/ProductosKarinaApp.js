...
$(document).ready(function () {
    ...
    $("#MainContent_txtPrecioApp").blur(function () {
        F_ValidaMonto("MainContent_txtPrecioApp");
        //$("#MainContent_txtPrecio3DolaresIgv").val(parseFloat($("#MainContent_txtPrecio3SolesIgv").val() / $("#MainContent_txtTC").val()).toFixed(2));
        return true;
    });

    $("#MainContent_txtPrecioAppEdicion").blur(function () {
        F_ValidaMonto("MainContent_txtPrecioAppEdicion");
        //$("#MainContent_txtPrecio3DolaresIgv").val(parseFloat($("#MainContent_txtPrecio3SolesIgv").val() / $("#MainContent_txtTC").val()).toFixed(2));
        return true;
    });
    ...
    $("#MainContent_txtPrecioAppEdicion").keydown(function (e) {
        if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
            (e.keyCode == 65 && e.ctrlKey === true) ||
            (e.keyCode >= 35 && e.keyCode <= 39)) {
            return;
    ...
    $("#MainContent_txtPrecioApp").keydown(function (e) {
        if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
            (e.keyCode == 65 && e.ctrlKey === true) ||
            (e.keyCode >= 35 && e.keyCode <= 39)) {
            return;
    ...
    $('#MainContent_txtPrecioApp').css('background', '#FFFFE0');
    
    $('#MainContent_txtPrecioAppEdicion').css('background', '#FFFFE0');

    $('#MainContent_ddlSeVendeEnApp').css('background', '#FFFFE0');
    
    $('#MainContent_ddlSeVendeEnAppEdicion').css('background', '#FFFFE0');

    $('#MainContent_txtTituloApp').css('background', '#FFFFE0');

    $('#MainContent_txtTituloAppEdicion').css('background', '#FFFFE0');

    $('#MainContent_txtDescripcionDetalleApp').css('background', '#FFFFE0');

    $('#MainContent_txtDescripcionDetalleAppEdicion').css('background', '#FFFFE0');
...
//            Cadena = Cadena + '<p></p>' + 'Codigo Interno';
        ...
        if ($(Cuerpo + 'ddlSeVendeEnApp').val() === "1" && $(Cuerpo + 'txtPrecioApp').val() == '')
            Cadena = Cadena + '<p></p>' + 'Precio App';

        if ($(Cuerpo + 'ddlSeVendeEnApp').val() === "1" && Number($(Cuerpo + 'txtPrecioApp').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Precio App';

        if ($(Cuerpo + 'ddlSeVendeEnApp').val() === "1" && $(Cuerpo + 'txtTituloApp').val() == '')
            Cadena = Cadena + '<p></p>' + 'Descripcion App';
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        if ($(Contenedor + 'ddlMoneda').val() == '1') {
            ...
            PrecioAppDolares = (Number($(Contenedor + 'txtPrecioApp').val()) / Number($(Contenedor + 'txtTC').val())).toFixed(2);
        } else {
            ...
            PrecioAppDolares = Number($(Contenedor + 'txtPrecioApp').val());
        }

        if ($('#MainContent_ddlSeVendeEnApp').val() === "0" && Number($('#MainContent_txtPrecioApp').val()) == 0) {
            $('#MainContent_txtPrecioApp').val("0");
            PrecioAppDolares = 0;
        }
        ...
        var objParams = {
            ...
            Filtro_PrecioAppDolares: PrecioAppDolares,
            Filtro_SeVendeEnApp: $('#MainContent_ddlSeVendeEnApp').val(),
            Filtro_PrecioApp: $(Contenedor + 'txtPrecioApp').val(),
            Filtro_TituloApp: $(Contenedor + 'txtTituloApp').val(),
            Filtro_DescripcionDetalladaApp: $(Contenedor + 'txtDescripcionDetalleApp').val(),
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'txtPrecioApp').val('');
                    $(Contenedor + 'txtTituloApp').val('');
                    $(Contenedor + 'txtDescripcionDetalleApp').val('');

                    $(Contenedor + 'ddlSeVendeEnAppEdicion').val("0");
...
function F_Nuevo() {
    ...
    $(Contenedor + 'txtPrecioApp').val('');
    $(Contenedor + 'txtTituloApp').val('');
    $(Contenedor + 'txtDescripcionDetalladaApp').val('');
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfPrecioApp_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfPrecioApp');
        var hfSeVendeEnApp_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfSeVendeEnApp');

        var hfTituloApp_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfTituloApp');
        var hfDescripcionDetalladaApp_grilla = '#' + imgID.replace('imgEditarRegistro', 'hfDescripcionDetalladaApp');
        ...
        var PrecioApp = Number($(hfPrecioApp_grilla).val()).toFixed(2);
        ...
        $(Cuerpo + 'txtPrecioAppEdicion').val(PrecioApp);

        $('#hfCodProducto').val($(lblcodigo_grilla).val());
        $(Cuerpo + 'ddlFamiliaConsulta').val($(hfIdFamilia_grilla).val());

        $(Cuerpo + 'ddlSeVendeEnAppEdicion').val($(hfSeVendeEnApp_grilla).val());
        ...
        $(Cuerpo + 'txtTituloAppEdicion').val($(hfTituloApp_grilla).val());
        $(Cuerpo + 'txtDescripcionDetalleAppEdicion').val($(hfDescripcionDetalladaApp_grilla).val());
...
if (F_PermisoOpcion(CodigoMenu, 1000301, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
    ...
    try {
        ...
        var hfPrecioApp_grilla = '#' + imgID.replace('imgRefresh', 'hfPrecioApp');
        ...
        var hfPrecioAppDolares_grilla = '#' + imgID.replace('imgRefresh', 'hfPrecioAppDolares');
        ...
        var objParams = {
            ...
            Filtro_PrecioApp: Number($(hfPrecioApp_grilla).val()).toFixed(2),
            ...
            Filtro_PrecioAppDolares: Number($(hfPrecioAppDolares_grilla).val()).toFixed(2),
            Filtro_SeVendeEnApp: $('#MainContent_ddlSeVendeEnAppEdicion').val(),
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        if ($(Contenedor + 'ddlMonedaEdicion').val() == '1') {
            ...
            PrecioAppDolares = (Number($(Contenedor + 'txtPrecioAppEdicion').val()) / Number($(Contenedor + 'txtTCEdicion').val())).toFixed(2);
        } else {
            ...
            PrecioAppDolares = Number($(Contenedor + 'txtPrecioAppEdicion').val());
        }

        if ($('#MainContent_ddlSeVendeEnAppEdicion').val() === "0" && Number($('#MainContent_txtPrecioAppEdicion').val()) == 0) {
            $('#MainContent_txtPrecioAppEdicion').val("0");
            PrecioAppDolares = 0;
        }
        ...
        var objParams = {
                ...
                Filtro_PrecioApp: $(Contenedor + 'txtPrecioAppEdicion').val(),
                Filtro_PrecioAppDolares: PrecioAppDolares,
                Filtro_SeVendeEnApp: $('#MainContent_ddlSeVendeEnAppEdicion').val(),
                Filtro_TituloApp: $(Contenedor + 'txtTituloAppEdicion').val(),
                Filtro_DescripcionDetalladaApp: $(Contenedor + 'txtDescripcionDetalleAppEdicion').val(),
        };
        ...
        F_EdicionRegistro_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Actualizo Correctamente.') {
                    ...
                    $(Contenedor + 'txtPrecio2').val('');
                    $(Contenedor + 'txtPrecio3').val('');
                    $(Contenedor + 'txtPrecioAppEdicion').val('');
                    $(Contenedor + 'txtTituloAppEdicion').val('');
                    $(Contenedor + 'txtDescripcionDetalladaAppEdicion').val('');
...
//            Cadena = Cadena + '<p></p>' + 'Factor';
        ...
        if ($(Cuerpo + 'ddlSeVendeEnAppEdicion').val() === "1" && $(Cuerpo + 'txtPrecioAppEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Precio App';

        if ($(Cuerpo + 'ddlSeVendeEnAppEdicion').val() === "1" && Number($(Cuerpo + 'txtPrecioAppEdicion').val()) == 0)
            Cadena = Cadena + '<p></p>' + 'Precio App';

        if ($(Cuerpo + 'ddlSeVendeEnAppEdicion').val() === "1" && $(Cuerpo + 'txtTituloAppEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Descripcion App';
...
function F_LlenarGridDetalle2(Fila) {
    try {
