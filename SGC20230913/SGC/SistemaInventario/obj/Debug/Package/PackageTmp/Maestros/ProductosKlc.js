var AppSession = "../Maestros/ProductosKlc.aspx";
var myDropzone = null;
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        $(Cuerpo + 'txtMargenEdicion').val($(hfM1).val());
...
function F_EdicionRegistro() {
    try {
        ...
        if ($(Contenedor + 'txtStockMaximoEdicion').val() == '')
            ...
            $(Contenedor + 'txtPrecio2Edicion').val('0.00');
        ...
        F_EdicionRegistro_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Actualizo Correctamente.') {
                    ...
                    $(Contenedor + 'txtDescuentoEdicion').val('');
...
function F_Precio(Mantenimiento) {
    if (Mantenimiento == 0) {
        if ($("#MainContent_txtCosto").val() == '' | $("#MainContent_txtMargen").val() == '')
            return false;

        $("#MainContent_txtPrecio1").val(parseFloat($("#MainContent_txtCosto").val() * ((parseFloat($("#MainContent_txtMargen").val()) / 100) + 1)).toFixed(2));

        if ($("#MainContent_ddlMoneda").val() == '2')
            $("#MainContent_txtCostoSolesIgv").val(parseFloat(parseFloat($("#MainContent_txtCosto").val()) * parseFloat($("#MainContent_txtTC").val())).toFixed(2));
        else
            $("#MainContent_txtCostoSolesIgv").val(parseFloat(("#MainContent_txtCosto").val()).toFixed(2));

        if ($("#MainContent_txtMargen") != '')
            $("#MainContent_txtPrecio1").val(parseFloat($("#MainContent_txtCosto").val() * ((parseFloat($("#MainContent_txtMargen").val()) / 100) + 1)).toFixed(2));

        if ($("#MainContent_txtMargen") != '')
            $("#MainContent_txtPrecio2").val(parseFloat($("#MainContent_txtCosto").val() * ((parseFloat($("#MainContent_txtMargen").val()) / 100) + 1)).toFixed(2));
        ...
        if ($("#MainContent_txtMargenEdicion") != '')
            $("#MainContent_txtPrecio1Edicion").val(parseFloat($("#MainContent_txtCostoEdicion").val() * ((parseFloat($("#MainContent_txtMargenEdicion").val()) / 100) + 1)).toFixed(2));
