                ...
                <div class="ui-jqdialog-content">
                    <table width="600">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCompraSunat" runat="server" Width="65px" CssClass="Derecha" Font-Names="Arial"
                            ...
                            <td>
                                <asp:TextBox ID="txtVentaSunat" runat="server" Width="65px" CssClass="Derecha" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                            <td style="padding-left: 5px; font-weight: bold;">
                                Paralelo
                            ...
                            <td>
                                <asp:TextBox ID="txtParalelo" runat="server" Width="65px" CssClass="Derecha" Font-Names="Arial"
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 30px;">
                                <asp:HyperLink ID="HyperLink1" Target="_blank" runat="server" ForeColor="Blue" Font-Bold="True"
                                    Text="TIPO DE CAMBIO SUNAT" NavigateUrl="https://e-consulta.sunat.gob.pe/cl-at-ittipcam/tcS01Alias">TIPO DE CAMBIO SUNAT</asp:HyperLink>
                            </td>
                            <td style="padding-left: 30px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtParaleloEdicion" runat="server" Width="65px" Font-Names="Arial"
                                ForeColor="Blue" Font-Bold="True" class="MesAnioPicker hasDatepicker" CssClass="Derecha"></asp:TextBox>
                        </td>
