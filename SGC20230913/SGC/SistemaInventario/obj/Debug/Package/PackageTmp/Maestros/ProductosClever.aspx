<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ProductosClever.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosClever" EnableEventValidation="false"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosClever.js" charset="UTF-8"></script>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCodigo2" runat="server" Width="203px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold; padding-left: 38px">
                                                        Costo
                                                    </td>
                                                    ...
                                                    <td style="padding-left: 34px; font-weight: bold;display:none;">
                                                        MINORISTA
                                                    </td>
                                                    <td style="display:none;">
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <center>
                                    ...
                                    ToolTip="ELIMINAR PLAN" OnClientClick="F_AnularRegistro(this); return false;" />                                 
                                    <asp:ImageButton runat="server" ID="imgEditarRegistro" ImageUrl="../Asset/images/btnEdit.gif"
                                        ToolTip="Editar PLAN" OnClientClick="F_EditarRegistro(this); return false;" />
                                  <%--  <asp:ImageButton runat="server" ID="imgVisualizarRegistro" ImageUrl="../Asset/images/Viewx16.png"
                                        ToolTip="Visualizar PLAN" OnClientClick="F_VisualizarRegistro(this); return false;" />--%>
                     ...
                     <%--   <asp:TemplateField ItemStyle-Width="20px">
                        ...
                        <asp:BoundField DataField="Precio1Edicion" HeaderText="PRECIO" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCodigo2Edicion" runat="server" Width="203px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                     <td style="padding-left: 1px; font-weight: bold">
                                                    t.c.
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtCostoEdicion" runat="server" Width="100px" Font-Names="Arial"
                                                ...
                                                <td style="padding-left: 15px">
                                                    <asp:TextBox ID="txtPrecio1Edicion" runat="server" Width="100px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                ...
                                                <td style="padding-left: 16px;display:none;">
                                                    <asp:TextBox ID="txtPrecio2Edicion" runat="server" Width="101px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 5px; font-weight: bold;display:none;">
                                                    Precio 3
                                ...
                                <td colspan='5'>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtUbicacionVisualizacion" runat="server" Width="230px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="padding-left: 0px;">
                                                <asp:TextBox ID="txtMonedaVisualizacion" runat="server" Width="100px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            <td style="font-weight: bold; width: 60px; text-align: right">
                                                Costo
                                            ...
                                            <td style="padding-left: 5px;">
                                                <asp:TextBox ID="txtCostoVisualizacion" runat="server" Width="100px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            <td style="font-weight: bold; width: 80px; text-align: right;display: none;">
                                                Modelo
                                            </td>
                                            <td style="padding-left: 5px;display:none;">
                                            ...
                                            <td style="font-weight: bold; width: 64px; text-align: right">
                                                UM
                                            </td>
                                            <td style="padding-left: 20px;">
                                                <asp:TextBox ID="txtUMVisualizacion" runat="server" Width="121px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                            <td style="font-weight: bold; width: 50px; text-align: right; padding-left: 30px;">
                                                Estado
                                            </td>
                                            <td style="padding-left: 25px;">
                                                <asp:TextBox ID="txtEstadovisualizacion" runat="server" Width="50px" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
        ...
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 1080px;">
            ...
            <div>
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    ...
                    <tr>
                      <td>
                            <asp:TextBox ID="txtReprePrecio" runat="server" Width="120px" Font-Names="Arial" ForeColor="Blue"
                           ...
                           <td style="font-weight: bold;padding-left:16px;">
                            ...
                            <td>
                            <asp:TextBox ID="txtMinoristaPresentacion" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                               CssClass="Derecha"  Font-Bold="True" ReadOnly="true" Font-Size="14px"></asp:TextBox>
                        </td> 
                    </tr>
                    </table>
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    ...
                    <tr>
                        ...
                        <td style="width: 60px;display:none;">
                            <asp:TextBox ID="txtReprePrecio3" runat="server" Width="50px" Font-Names="Arial"
            ...
            <div id="div_Presentaciones">
                <asp:GridView ID="grvPresentaciones" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CALLE" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblPrecio1" Text='<%# Bind("Precio1") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MINORISTA" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
