<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="ProductosUnitario.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosUnitario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosUnitario.js" charset="UTF-8"></script>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 13px;display:none;">
                                                       ...
                                                       <td style="font-weight: bold;padding-left: 4px;display:none;">
                                                        Limite
                                                    </td>
                        ...
                        <td valign="top">
                            <div id="div_consulta" style="padding-top: 5px;">
                                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                    CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="1202px"
                                ...
                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                    <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                        ...
                                        <asp:BoundField DataField="Precio2Edicion" HeaderText="P2" DataFormatString="{0:N2}">
                                         ...
                                         <asp:BoundField DataField="Precio3Edicion" HeaderText="P3" DataFormatString="{0:N2}">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
