<%@ Page Title="Productos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductosRoman.aspx.cs" Inherits="SistemaInventario.Maestros.ProductosRoman" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ProductosRoman.js" charset="UTF-8"></script>
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtPais" runat="server" Width="244px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Marca
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtMarca" runat="server" Width="275px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtModelo" runat="server" Width="568px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen1" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M2
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen2" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M3
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen3" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M4
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen4" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M5
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen5" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <td style="font-weight: bold; padding-left: 5px">
                                     ...
                                     <td colspan='5'>
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtPrecio4" ReadOnly="True" runat="server" Width="58px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        Precio 5
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtPrecio5" runat="server" Width="58px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    </tr>
                                                    </table>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtD1" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtD2" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtD3" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 14px; font-weight: bold">
                                                        D4
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtD4" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 14px; font-weight: bold">
                                                        D5
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtD5" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 14px; font-weight: bold">
                                                        D6
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtD6" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 14px; font-weight: bold">
                                                        D7
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtD7" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td colspan='5'>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 2px;">
                                                        <asp:TextBox ID="txtM1" runat="server" Width="163px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        EXT
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtM2" runat="server" Width="163px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        ALT
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtM3" runat="server" Width="163px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td colspan='2'>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox ID="chkCpe" runat="server" Text="Compra En Plaza" Font-Bold="True" />
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Estado
                                                    </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Producto" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfPrecio4" runat="server" Value='<%# Bind("Precio4Edicion") %>' />
                                <asp:HiddenField ID="hfPrecio5" runat="server" Value='<%# Bind("Precio5Edicion") %>' />
                                ...
                                <asp:HiddenField ID="hfPrecio4Dolares" runat="server" Value='<%# Bind("Precio4DolaresEdicion") %>' />
                                <asp:HiddenField ID="hfPrecio5Dolares" runat="server" Value='<%# Bind("Precio5DolaresEdicion") %>' />
                                ...
                                <asp:HiddenField ID="hfCpe" runat="server" Value='<%# Bind("FlagCpe") %>' />
                                ...
                                <asp:HiddenField ID="hfD4" runat="server" Value='<%# Bind("D4") %>' />
                                <asp:HiddenField ID="hfD5" runat="server" Value='<%# Bind("D5") %>' />
                                <asp:HiddenField ID="hfD6" runat="server" Value='<%# Bind("D6") %>' />
                                <asp:HiddenField ID="hfD7" runat="server" Value='<%# Bind("D7") %>' />
                              <%--  margeners--%>
                                <asp:HiddenField ID="hfMargenes1" runat="server" Value='<%# Bind("M1") %>' />
                                <asp:HiddenField ID="hfMargenes2" runat="server" Value='<%# Bind("M2") %>' />
                                <asp:HiddenField ID="hfMargenes3" runat="server" Value='<%# Bind("M3") %>' />
                                <asp:HiddenField ID="hfMargenes4" runat="server" Value='<%# Bind("M4") %>' />
                                <asp:HiddenField ID="hfMargenes5" runat="server" Value='<%# Bind("M5") %>' />
                                <%--  margeners--%>
                                <asp:HiddenField ID="hfM1" runat="server" Value='<%# Bind("Interna") %>' />
                                <asp:HiddenField ID="hfM2" runat="server" Value='<%# Bind("Externa") %>' />
                                <asp:HiddenField ID="hfM3" runat="server" Value='<%# Bind("Altura") %>' />
                                <asp:HiddenField ID="hfLaVictoriaUbicacion" runat="server" Value='<%# Bind("LaVictoriaUbicacion") %>' />
                                <asp:HiddenField ID="hfAteUbicacion" runat="server" Value='<%# Bind("AteUbicacion") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="CostoSoles" HeaderText="Costo" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="Precio4" HeaderText="P4" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Precio5" HeaderText="P5" DataFormatString="{0:N2}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="Principal" HeaderText="PRINCIPAL" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="LAVICTORIA" HeaderText="VICTORIA" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ATE" HeaderText="ATE" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="VILLA" HeaderText="VILLA" DataFormatString="{0:N0}">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                        ...
                        <div class="ui-jqdialog-content" style="width: 700px">
                            <table cellpadding="0" cellspacing="0" class="form-inputs">
                                ...
                                <tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding-left: 2px;">
                                                    <asp:TextBox ID="txtPaisEdicion" runat="server" Width="244px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    Marca
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtMarcaEdicion" runat="server" Width="273px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 4px;">
                                        <asp:TextBox ID="txtModeloEdicion" runat="server" Width="568px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 25px;">
                                                    <asp:TextBox ID="txtPosicionEdicion" runat="server" Width="239px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 25px; font-weight: bold; display: none">
                                                    Factor
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                  ...
                                                  <td style="padding-left: 5px; font-weight: bold">
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen1Edicion" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M2
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen2Edicion" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M3
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen3Edicion" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M4
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen4Edicion" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                                    <td style="padding-left: 5px; font-weight: bold">
                                                        M5
                                                    ...
                                                    <td style="padding-left: 5px">
                                                        <asp:TextBox ID="txtMargen5Edicion" runat="server" Width="43px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                    </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <table>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio4Edicion" ReadOnly="True"  runat="server" Width="58px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 5px; font-weight: bold">
                                                    Precio 5
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:TextBox ID="txtPrecio5Edicion"   runat="server" Width="58px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                    </table>
                                    </td>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtD1Edicion" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                        CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 3px; font-weight: bold">
                                                    D2
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtD2Edicion" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                        CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 2px; font-weight: bold">
                                                    D3
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtD3Edicion" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                        CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 14px; font-weight: bold">
                                                    D4
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtD4Edicion" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                        CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 14px; font-weight: bold">
                                                    D5
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtD5Edicion" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                        CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 14px; font-weight: bold">
                                                    D6
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtD6Edicion" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                        CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="padding-left: 14px; font-weight: bold">
                                                    D7
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtD7Edicion" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                        CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 2px;">
                                                    <asp:TextBox ID="txtM1Edicion" runat="server" Width="163px" Font-Names="Arial" ForeColor="Blue"
                                                        Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    M2
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtM2Edicion" runat="server" Width="163px" Font-Names="Arial" ForeColor="Blue"
                                                        Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    M3
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtM3Edicion" runat="server" Width="163px" Font-Names="Arial" ForeColor="Blue"
                                                        Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td colspan='2'>
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="chkCpeEdicion" runat="server" Text="Compra En Plaza" Font-Bold="True" />
                                                </td>
                                                <td style="font-weight: bold">
                                                    Estado
                                                </td>
        ...
        <div id="div_HistorialCostos" style="display: none;">
            ...
            <div id="tabPrecios">
                <div id="div_grvHistorialPrecios" style="padding-top: 5px;">
                    <asp:GridView ID="grvHistorialPrecios" runat="server" AutoGenerateColumns="False" border="0"
                        CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="1100px">
                        <Columns>
                            <asp:BoundField DataField="FechaRegistro" HeaderText="Registro" HeaderStyle-Width="80px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            ...
                            <asp:BoundField DataField="DscProductoAnterior" HeaderText="Descripcion Anterior" HeaderStyle-Width="40px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
