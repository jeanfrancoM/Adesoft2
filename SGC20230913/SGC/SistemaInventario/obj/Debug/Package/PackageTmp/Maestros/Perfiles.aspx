                        ...
                        <tr>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/EliminarBtn.png"
                                    ToolTip="ELIMINAR USUARIO" OnClientClick="F_EliminarUsuario(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                            </td>
                            <td style="width: 20px;">
                    ...
                    Width="700px">
                                                <columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Sucursales" ItemStyle-HorizontalAlign="Left">
                                                            ...
                                                            <ItemTemplate >
                                                                <asp:Label runat="server" ID="lblDescripcion" Width="200px" Font-Names="Arial" Text='<%# Bind("DscAlmacen") %>'></asp:Label>
