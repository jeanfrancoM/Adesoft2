var AppSession = "../Maestros/ProductosClever.aspx";
var myDropzone = null;
...
$(document).ready(function () {
    ...
    $('#MainContent_btnNuevoImagen').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        try {
            F_NuevoImagen();
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_CodigoInterno: $(Contenedor + 'txtCodigo').val().toUpperCase().trim(),
...
function F_VisualizarRegistro(Fila) {
    ...
    var hlblCodigo = '#' + imgID.replace('imgVisualizarRegistro', 'hfCodigoInterno'); $(Cuerpo + 'txtCodigoVisualizacion').val($(hlblCodigo).val());
    var txtMoneda = '#' + imgID.replace('imgVisualizarRegistro', 'lblMoneda'); $(Cuerpo + 'txtMonedaVisualizacion').val($(txtMoneda).text());
    var txtUbicacion1 = '#' + imgID.replace('imgVisualizarRegistro', 'hfUbicacion'); $(Cuerpo + 'txtUbicacionVisualizacion').val($(txtUbicacion1).val());
    var hfCostoSoles = '#' + imgID.replace('imgVisualizarRegistro', 'hfCostoSoles'); $(Cuerpo + 'txtCostoVisualizacion').val($(hfCostoSoles).val());
    var txtUMVisualizacion = '#' + imgID.replace('imgVisualizarRegistro', 'hfUM'); $(Cuerpo + 'txtUMVisualizacion').val($(txtUMVisualizacion).val());
...
function F_CrearDropzone_JS() {
    ...
    midiv.setAttribute("style", "width:670px; height:420px; margin-left: 10px; border-radius:12px; min-height:200px; padding:0px;");
...
function F_Consultar_Imagen(str_tipoConsulta) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset= utf-8",
        url: "ProductosClever.aspx/F_UltimaImagenTMP_JS",
        dataType: "json",
...
function F_Eliminar_Temporal_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosClever.aspx/F_Eliminar_Temporal_Imagen',
        dataType: "json",
...
function F_Eliminar_Imagen(id_Imagen, str_tipoConsulta) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosClever.aspx/F_Eliminar_Imagen',
        dataType: "json",
        data: JSON.stringify({ 'objEntidad': param }),
        success: function (dataObject, textStatus) {
            if (textStatus == "success") {
...
function F_ConsultarArticulosRelacionados(CodAlterno) {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ProductosClever.aspx/F_LGProductosRelaciones_Listar_NET',
        dataType: "json",
...
function F_Representaciones(Fila) {
    ...
    $("#MainContent_txtReprePrecio").val(parseFloat($(hfPrecio1).val()).toFixed(2));
    $("#MainContent_txtMinoristaPresentacion").val(parseFloat($(hfPrecio2).val()).toFixed(2));
...
function F_GeneraCostoRepresentacion() {
    ...
    if ($("#MainContent_txtRepreFactor").val() === "0"
        ...
        $('#MainContent_txtReprePrecio1').val(parseFloat(parseFloat($('#MainContent_txtReprePrecio').val())*Factor).toFixed(2));
        $('#MainContent_txtReprePrecio2').val(parseFloat(parseFloat($('#MainContent_txtMinoristaPresentacion').val())*Factor).toFixed(2));
    }
...
function F_RepreNuevo() {
    ...
    $("#MainContent_txtReprePrecio1").val("");
    $("#MainContent_txtReprePrecio2").val("");
    $("#MainContent_txtReprePrecio3").val("0");
