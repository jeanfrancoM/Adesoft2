var AppSession = "../Reportes/Ventas_Comisiones_Povis.aspx";
...
function F_Reporte() {
    ...
    var Vendedor= $('#MainContent_ddlVendedor').val() ;
     var NombreTabla = "ReporteComision";
    var NombreArchivo = "Web_Reporte_Ventas_rptComisionVendedor_Povis.rpt";
    var Titulo = "COMISION VENDEDOR";
    ...
    rptURL = rptURL + 'chkFecha=' + chkFecha + '&';
    rptURL = rptURL + 'DesdeCancelacion=' + $('#MainContent_txtDesdeCancelacion').val() + '&';
    rptURL = rptURL + 'HastaCancelacion=' + $('#MainContent_txtHastaCancelacion').val() + '&';
    rptURL = rptURL + 'NombreTabla='    + NombreTabla + '&';
    rptURL = rptURL + 'NombreArchivo='  + NombreArchivo + '&';
    rptURL = rptURL + 'Titulo='         + Titulo + '&';
    rptURL = rptURL + 'NombreVendedor='         + $("#MainContent_ddlVendedor option:selected").text() + '&';
    rptURL = rptURL + 'NombreRuta='         + $("#MainContent_ddlRuta option:selected").text() + '&';
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        $('#MainContent_txtHastaCancelacion').css('background', '#FFFFE0');  
                        $('#MainContent_txtDesdeCancelacion').css('background', '#FFFFE0');     
