<%@ Page Title="Reporte Placa" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="Ventas_Reporte_Placa.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_Reporte_Placa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Ventas_Reporte_Placa.js" charset="UTF-8"></script>   
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr style="display:none;">
                         ...
                         <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtPlaca" runat="server" Width="114px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                            </td>
                        </tr>
                            <tr>
