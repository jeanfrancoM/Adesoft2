<%@ Page Title="Historial OC-Venta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistorialOCV.aspx.cs" Inherits="SistemaInventario.Reportes.HistorialOCV" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript"  src="HistorialOCV.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 300px">Reporte de Historial OC-VENTA</div> 
                                ...
                                <div id="divConsultaArticulo">
                                        ...
                                        <table  cellpadding="0" cellspacing="0" class="form-inputs">
                                                   ...
                                                   <tr>    
                                                            ...
                                                            <td>
                                                             <asp:TextBox ID="txtHasta" runat="server" Width="55px"  Font-Names="Arial"  CssClass="Jq-ui-dtp" ReadOnly="true" ForeColor="Blue"  Font-Bold="True"></asp:TextBox>
                                                            </td>
                                        ...
                                        <tr>
                                        <td>
                                              <asp:CheckBox ID="chkPendiente" runat="server" Text="PENDIENTES DE COBRANZA"  Font-Bold="True"/>
                                            </td>
