var AppSession = "../Reportes/CajaBanco_LiquidacionCaja.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 719;
    var Titulo = "REPORTE LIQUIDACION DE CAJA";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombreHoja = "LIQUIDACION";
    var NombreArchivo = "Xls_LiquidacionCaja.xlsx";
...
function F_Pdf() {
    ...
    var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
    var CodMenu = 217;
    var Titulo = "REPORTE DE VENTAS DIARIAS";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombreTabla = "VENTASNETAS";
    var NombreArchivo = "Web_Reporte_Ventas_rptVentasDiarias.rpt";
