<%@ Page Title="Reporte de Recibos Por Honorarios" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="Reporte_RPH.aspx.cs" Inherits="SistemaInventario.Reportes.Contabilidad_RegistroCompras" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Reporte_RPH.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
       Reporte de Recibos Por Honorarios</div>
