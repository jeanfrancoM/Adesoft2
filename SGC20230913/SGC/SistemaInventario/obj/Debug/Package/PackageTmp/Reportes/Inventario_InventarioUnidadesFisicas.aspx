<%@ Page Title="Inventario Unidades Fisicas" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="Inventario_InventarioUnidadesFisicas.aspx.cs"
    Inherits="SistemaInventario.Reportes.Inventario_InventarioUnidadesFisicas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Inventario_InventarioUnidadesFisicas.js"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 930px">
        Reporte de Inventario Unidades Fisicas</div>
    <div id="tabRegistro" style="width: 900px">
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                Inventario Unidades Fisicas
            </div>
