<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InventarioPeriodo.aspx.cs" Inherits="SistemaInventario.Reportes.InventarioPeriodo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 930px">Reporte de Inventario Por Periodo (CONTABLE)</div> 
                                        ...
                                        <table width="900">
                                                   ...
                                                   <tr>    
                                                           <td>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtPeriodo" runat="server" Width="50px"  Font-Names="Arial" Font-Bold="True" CssClass="MesAnioPicker" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" Width="100px" 
                                                                 />
                                                                <asp:Button ID="btnPdf" runat="server" Text="PDF"  Font-Names="Arial" Font-Bold="True" style="display:none;"
                                                                class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" Width="100px" 
                                                                 />
                                                                </td>
