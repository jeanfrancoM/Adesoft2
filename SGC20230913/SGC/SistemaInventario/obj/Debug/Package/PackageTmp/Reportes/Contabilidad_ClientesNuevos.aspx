<%@ Page Title="Reporte Clientes Nuevos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="Contabilidad_ClientesNuevos.aspx.cs" Inherits="SistemaInventario.Reportes.Contabilidad_ClientesNuevos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Contabilidad_ClientesNuevos.js" charset="UTF-8"></script>
        ...
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            ...
            <div id="divConsultaArticulo">
              ...
              <%--          <tr style="display:none;">
                            <td colspan='2' >
                                <asp:CheckBox ID="chkDevolucion" runat="server" Text="Devolucion"
                                    Font-Bold="True" />
                            </td>
                        </tr>--%>
                    </table>
