var AppSession = "../Reportes/Ventas_CP.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 715;
    var NombreArchivo = 'Xls_Venta_CP.xlsx';
    var NombreHoja = 'CP';
    var FlagDevolucion = 0;

    if ($("#MainContent_chkDevolucion").is(':checked'))
        FlagDevolucion = 1;

    rptURL = '../Reportes/Web_Pagina_ConstruirExcel.aspx';
    rptURL = rptURL + '?';
    rptURL = rptURL + 'CodMenu=' + CodMenu + '&';
    rptURL = rptURL + 'ChkDevolucion=' + FlagDevolucion + '&';
