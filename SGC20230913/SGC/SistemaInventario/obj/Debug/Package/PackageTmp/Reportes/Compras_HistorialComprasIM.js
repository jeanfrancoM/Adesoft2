var AppSession = "../Reportes/Compras_HistorialComprasIM.aspx";
...
function F_Reporte() {
    ...
    var CodMenu = 300;
    var Titulo = "REPORTE DE IMPORTACIONES";
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var NombreTabla = "ComprasReporte";
    var NombreArchivo = "Web_Reporte_Compras_rptHistorialComprasIM.rpt";
    var CodTipoDoc = 1;
    var FlagImportacion = 1;
