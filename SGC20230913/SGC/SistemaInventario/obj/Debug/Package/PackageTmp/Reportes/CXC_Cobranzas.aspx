<%@ Page Title="Reporte Cobranzas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CXC_Cobranzas.aspx.cs" Inherits="SistemaInventario.Reportes.CXC_Cobranzas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CXC_Cobranzas.js" charset="UTF-8"></script>
        ...
        <div class="ui-jqdialog-content" style="width: 750px;">
            <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
               ...
               <%--                 <asp:ListItem Value="3">NOTA DE CREDITO</asp:ListItem>
                ...
                <tr>
                    <td style="font-weight: bold">
                        <asp:CheckBox ID="chkRango" runat="server" Text="Cobrado Hasta" Font-Bold="True" />
                    </td>
                    <td colspan='4'>
