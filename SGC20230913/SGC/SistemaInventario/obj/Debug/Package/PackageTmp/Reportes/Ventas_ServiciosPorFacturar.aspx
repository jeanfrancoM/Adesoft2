<%@ Page Title="Reporte Servicios Comprar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_ServiciosPorFacturar.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_ServiciosPorFacturar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Ventas_ServiciosPorFacturar.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 410px">
        Reporte Servicios Por Comprar</div>
                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                      <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="div_Empleado">
                                    <asp:DropDownList ID="ddlEmpleado" runat="server" Font-Names="Arial" ForeColor="Blue"
                                        Font-Bold="True" Width="100px">
                                    </asp:DropDownList>
                                </div>
                            </td>
