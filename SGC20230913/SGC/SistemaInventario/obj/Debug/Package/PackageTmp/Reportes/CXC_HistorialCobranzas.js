var AppSession = "../Reportes/CXC_HistorialCobranzas.aspx";
...
function F_Buscar(){
    ...
    var Titulo = 'HISTORIAL DE COBRANZAS RESUMIDO';
    var SubTitulo = "DESDE " + $("#MainContent_txtDesde").val() + " HASTA " + $('#MainContent_txtHasta').val();
    var Resumido = 0;
    var NombreTabla = "CobradosResumido";
    var NombreArchivo = "Web_Reporte_Cobranzas_rptCobradosResumido.rpt";
    ...
    if ($('#MainContent_chkDetallado').is(':checked')) {
        Resumido = 1;
        Titulo = 'HISTORIAL DE COBRANZAS DETALLADO';
        NombreTabla = "CobradosResumido";
        NombreArchivo = "Web_Reporte_Cobranzas_rptCobradosDetallado.rpt";
    }
    ...
    rptURL = rptURL + 'Resumido='       + Resumido + '&';
