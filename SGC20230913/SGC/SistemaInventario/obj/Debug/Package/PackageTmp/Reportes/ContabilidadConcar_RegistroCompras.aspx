<%@ Page Title="Compras Concar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="ContabilidadConcar_RegistroCompras.aspx.cs" Inherits="SistemaInventario.Reportes.ContabilidadConcar_RegistroCompras" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ContabilidadConcar_RegistroCompras.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte de Registro de Compras - Concar</div>
