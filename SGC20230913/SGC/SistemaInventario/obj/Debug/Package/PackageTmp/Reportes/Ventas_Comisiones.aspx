<%@ Page Title="Comisiones" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_Comisiones.aspx.cs" Inherits="SistemaInventario.Reportes.Ventas_Comisiones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titulo"    style="width: 300px">Reporte Comisiones</div> 
                                        ...
                                        <table  cellpadding="0" cellspacing="0" class="form-inputs">
                                                   ...
                                                   <tr>    
                                                            ...
                                                            <td style="padding-left:5px;">
                                                                ...
                                                                <asp:TextBox ID="txtDesde" runat="server" Width="55px"  Font-Names="Arial"  CssClass="Jq-ui-dtp" ReadOnly="true"></asp:TextBox>
                                                            </td>
                                                            ...
                                                            <td>
                                                             <asp:TextBox ID="txtHasta" runat="server" Width="55px"  Font-Names="Arial"  CssClass="Jq-ui-dtp" ReadOnly="true"></asp:TextBox>
                                                            </td>
