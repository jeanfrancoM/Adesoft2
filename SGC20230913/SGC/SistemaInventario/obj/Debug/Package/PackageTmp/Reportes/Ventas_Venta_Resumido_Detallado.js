var AppSession = "../Reportes/Ventas_Venta_Resumido_Detallado.aspx";
...
function F_Reporte(Tipo) {
    ...
    var NombreTabla = "VentasReporte";
    var NombreArchivo = "Web_Reporte_Ventas_rptVentasReporteResumido.rpt";

    if ($('#MainContent_chkDetallado').is(':checked')) {
        Resumido = 0;
        NombreArchivo = "Web_Reporte_Ventas_rptVentasReporteDetalle.rpt";
        Titulo = "REPORTE DE VENTAS DETALLADO";
    }
        

    if ($("#MainContent_ddlSerie option:selected").text() != "TODOS")
