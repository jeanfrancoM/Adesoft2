<%@ Page Title="Nota de Ingreso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="NotaIngresoSalidaSalcedo.aspx.cs" Inherits="SistemaInventario.Inventario.NotaIngresoSalidaSalcedo" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="NotaIngresoSalidaSalcedo.js" charset="UTF-8"></script>
     ...
     <td style="width: 900px" valign="top">
            ...
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                                    ...
                                    <tr>
                                       ...
                                       <td style="font-weight: bold;">
                                        ...
                                        <td style="padding-left: 36px;">
                                            <asp:TextBox ID="txtObservacionNS" runat="server" Width="405px" Font-Names="Arial"
                                                ForeColor="Blue" Font-Bold="True" ReadOnly="true"></asp:TextBox>
                                        </td>
                ...
                <div class="linea-button">
                 <asp:Button ID="btnBuscarGuiaAlmacenExterno" runat="server" Text="Buscar Documento" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Font-Bold="True" Width="140" />
                         <asp:Button ID="btnNotaingreso" runat="server" Text="Nota Ingreso" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
      ...
      <td valign="top" style="width: 120px">
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 250px;
                    ...
                    <div id="divListanotaingreso" class="ui-jqdialog-content">
                        <ul id="lu_notaingreso" class="ul-float" style="padding-left: 5px; width: 220px">
                        </ul>
                    </div>
                </div>
            </td>
 ...
 <td style="font-weight: bold;display:none;">
    ...
    ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True" Width="120" />
        ...
        <br />
        <center>
            <asp:Label ID="Label4" runat="server" Text="Codigo Nota Ingreso" Font-Bold="true"
