<%@ Page Title="Nota de Ingreso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NotaIngresoSalidaAraSac.aspx.cs" Inherits="SistemaInventario.Inventario.NotaIngresoSalidaAraSac" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="NotaIngresoSalidaAraSac.js" charset="UTF-8"></script>
            ...
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                        ...
                                        <td>
                                            <div id="div_Almacen">
                                                <asp:DropDownList ID="ddlAlmacen" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="433px">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                         <td>
                                                <asp:CheckBox ID="chkImportacion" runat="server" Text="IMPORTACION" Font-Bold="True" />
                                        </td>
                                         <td>
                        ...
                        <tr>
                        <td>
                             <asp:TextBox ID="txtMensaje" runat="server" Width="920px" Font-Names="Arial" ForeColor="Blue"
