...
{
    public partial class NotaIngresoSalidaSalcedo : System.Web.UI.Page
    {
        ...
        public String F_AgregarTemporal_GuiaExterna_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_AgregarTemporal_GuiaExterna(obj_parametros, ref Codigo, ref MsgError, ref NroRuc, ref Observacion);
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(
                        ...
                        ref CodAlmacen, ref Observacion, ref CodTipoOperacion, ref Observacionns
                        );
        ...
        public void P_AgregarTemporal_GuiaExterna(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError, ref string NroRucProeedor, ref string Observacion)
        {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado, ref Int32 CodigoMov)
        {
            ...
            objEntidad.ObservacionNS = Convert.ToString(objTablaFiltro["Filtro_ObservacionNS"]);
            objEntidad.CodTipoDoc = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"]);
            ...
            objOperacion.F_Transferencias_Insert_Salcedo(objEntidad);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref int CodAlmacen, ref string Observacion, ref int CodTipoOperacion, ref string Observacionns
           )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                Observacionns = Convert.ToString(dtTabla.Rows[0]["ObservacionNS"]);
            }
        }
        ...
        public static jqNotaIngresoSalidaCab F_Consulta_Notaingreso_Pendientes_NET(int CodAlmacen)
        {
            jqNotaIngresoSalidaCab data = new jqNotaIngresoSalidaCab();
            NotaIngresoSalidaCabCE par = new NotaIngresoSalidaCabCE() { CodEmpresa = 3, CodAlmacen = CodAlmacen, CodEstado = 7 };
            data.rows = (new NotaIngresoSalidaCabCN()).F_Notaingreso_ListarXEstado(par);
            return data;
        }
        public class jqNotaIngresoSalidaCab
        {
            public String msg { get; set; }
            public String ID_Imagen { get; set; }
            public int total { get; set; }
            public List<NotaIngresoSalidaCabCE> rows { get; set; }
        }
