<%@ Page Title="Nota de Salida" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionSalcedo.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionSalcedo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionSalcedo.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                        ...
                                        <td>
                                            <div id="div_MotivoTrabajo">
                                                <asp:DropDownList ID="ddlMotivoTrabajo" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="187px" Enabled="True">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                          <td style="font-weight: bold;padding-left: 27px; display: none">
                                            Ref
                                        </td>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtConductorRazonSocial" runat="server" Width="310" Font-Names="Arial"
                                        ...
                                        <td style="padding-left: 14px;">
                                            <asp:TextBox ID="txtFechaTraslado" runat="server" Width="55px" CssClass="Jq-ui-dtp"
                         ...
                         <tr >
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="888" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/Eliminar.jpg"
                                    ToolTip="ANULAR GUIA REMISION" OnClientClick="F_AnularPopUP(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                         ...
                         <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgConfirmar" ImageUrl="~/Asset/images/ok.gif"
                                    ToolTip="Confirmar Documento" OnClientClick="F_ConfirmarRegistro(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgImprimir" ImageUrl="~/Asset/images/imprimir.gif"
                                    ToolTip="IMPRIMIR GUIA REMISION" OnClientClick="F_ImprimirGuia2(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td id="tdPanelStocks" valign="top" >
    ...
    <input id="hfDireccionTransportista" type="hidden" />
