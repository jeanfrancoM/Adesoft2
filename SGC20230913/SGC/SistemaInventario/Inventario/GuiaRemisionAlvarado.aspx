<%@ Page Title="Guia Remision" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionAlvarado.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionAlvarado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionAlvarado.js" charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <div id="div4">
                                                <asp:DropDownList ID="ddlFormatoImpresion" runat="server" Font-Names="Arial" ForeColor="Blue" Font-Bold="True" Width="403">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                         <td>
                        ...
                        <tr>
                        <td>
                             <asp:TextBox ID="txtMensaje" runat="server" Width="883px" Font-Names="Arial" ForeColor="Blue"
                             Font-Bold="True" Enabled="False" ReadOnly="True" Font-Size="Large"></asp:TextBox>
                        </td>
                        </tr>
                        </table>
                        </td>
 ...
 <td style="font-weight: bold;display:none;">
    ...
    ui-state-default ui-corner-all ui-button-text-only" Font-Names="Arial" Font-Bold="True" Width="120" />
      ...
      <div id="div_FacturaCompra" style="display: none;">
        <div class="ui-jqdialog-content">
            <table>
                <tr>
                    <td>
    ...
    Font-Bold="True" Font-Size="Small"></asp:TextBox>--%>
                    ...
                    <td style="padding-left: 5px;">
                        <asp:Button ID="btnFacturarCompra" runat="server" Text="Facturar" class="ui-button
    ...
    <input id="NombreClaveAzure" type="hidden" value="" />
</asp:Content>
