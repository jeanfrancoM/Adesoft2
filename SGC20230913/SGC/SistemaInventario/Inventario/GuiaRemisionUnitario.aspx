<%@ Page Title="Guia Remision" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionUnitario.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionUnitario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionUnitario.js" charset="UTF-8"></script>
