...
{
    public partial class GuiaRemisionAlvarado : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            str_resultado =
                ...
                Session["NroRuc"].ToString() + "~" +  //18; 
                Session["NombreClaveAzure"].ToString(); //19; 
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(
                        ...
                        ref Referencia, ref CodAlmacenLlegada, ref CodDireccion, ref CodEmpresa, ref Observacion, ref FlagMotorizado);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref string Destino, ref int CodTipoDoc, ref string Referencia, ref int CodAlmacenLlegada, ref int CodDireccion,
            ref int CodEmpresa, ref string Observacion, ref int FlagMotorizado)
        {
            TrasladosCabCE objEntidad = new TrasladosCabCE();
            TrasladosCabCN objOperacion = new TrasladosCabCN();
        ...
        [WebMethod]
        public static NotaIngresoSalidaCabCE F_ObtenerNotaIngreso_PorID_Net(string Serie, int Numero, string Conexion, string Ruc, int Destino, int CodTipoDoc)
        {
            ...
            return objOperacion.F_NotaingresoCab_ObtenerXNumero(objEntidad);
        }

        [WebMethod]
        public static NotaIngresoSalidaCabCE F_ObtenerFacturaCompra_PorID_Net(int ID)
        {
            NotaIngresoSalidaCabCE objEntidad = new NotaIngresoSalidaCabCE();
            NotaIngresoSalidaCabCN objOperacion = new NotaIngresoSalidaCabCN();
            ...
            objEntidad.ID = ID;
            return objOperacion.F_NotaingresoCab_ObtenerXIDCompra(objEntidad);
        }
