...
{
    public partial class GuiaRemisionSalcedo : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlMotivoTrabajo, ref str_direccion, ref ddlSerieConsulta,
                    ref ddlAlmacen, ref ddlTipoDocumento, ref ddlTipoDocConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlDestino);
            ...
            str_resultado =
                ...
                str_ddlDestino_html + "~" +//16; 
                Session["CodEmpresa"].ToString() + "~" + //17; 
                Session["CodSede"].ToString(); //18; 
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            int CodDireccionTransportista = 0;
            string Referencia = "";
            string Placa = "";
            string Marca = "";
            string licencia = "";
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    P_ReemplazarFactura(
                        ...
                        ref Referencia, ref CodAlmacenLlegada, ref CodDireccion, ref CodEmpresa, ref Codtransportista, ref CodDireccionTransportista, ref Placa, ref Marca, ref licencia, ref NroBultos, ref Peso, ref Transportista, ref DireccionTransportista, ref observacion);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combomotivotrabajo,
              ...
              ref DropDownList ddl_TipoDocumentoConsulta, ref DropDownList ddl_comboempresa, ref DropDownList ddl_comboempresaconsulta, ref DropDownList ddl_combodestino)
        {
            DataTable dta_consulta = null;
            ...
            //dta_consulta = null;
            //dta_consulta = (new TCAlmacenCN()).F_TCAlmacen_Destino(objEntidadAlmacen);
            //ddl_combodestino.Items.Clear();
            //ddl_combodestino.DataSource = dta_consulta;
            //ddl_combodestino.DataTextField = "DscAlmacen";
            //ddl_combodestino.DataValueField = "CodAlmacen";
            //ddl_combodestino.DataBind();
        }
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro,
            ...
            ref string Destino, ref int CodTipoDoc, ref string Referencia, ref int CodAlmacenLlegada, ref int CodDireccion, ref int CodEmpresa, ref int Codtransportista, ref int CodDireccionTransportista, ref string Placa, ref string Marca, ref string licencia, ref string NroBultos, ref string Peso, ref string Transportista, ref string DireccionTransportista, ref string Observacion)
        {
            TrasladosCabCE objEntidad = new TrasladosCabCE();
            TrasladosCabCN objOperacion = new TrasladosCabCN();
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                CodDireccionTransportista = Convert.ToInt32(dtTabla.Rows[0]["CodDireccionTrans"]);
                Placa = Convert.ToString(dtTabla.Rows[0]["Placa"]);
                Marca = Convert.ToString(dtTabla.Rows[0]["MarcaVehiculo"]);
                licencia = Convert.ToString(dtTabla.Rows[0]["Licencia"]);
                NroBultos = Convert.ToString(dtTabla.Rows[0]["Peso"]);
                Peso = Convert.ToString(dtTabla.Rows[0]["NroBultos"]);
                Transportista = Convert.ToString(dtTabla.Rows[0]["Transportista"]);
                DireccionTransportista = Convert.ToString(dtTabla.Rows[0]["DireccionTransportista"]);
            }
        }
