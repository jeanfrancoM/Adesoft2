<%@ Page Title="Guia Remision" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuiaRemisionTek.aspx.cs" Inherits="SistemaInventario.Inventario.GuiaRemisionTek" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="GuiaRemisionTek.js" charset="UTF-8"></script>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnAgregar" runat="server" Text="Agregar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                                Font-Names="Arial" Font-Bold="True" Width="90" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
