...
{
    public partial class NotaIngresoSalidaAraSac : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_AgregarTemporal_Servidor_NET);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            str_resultado =
                ...
                Session["NroRuc"].ToString() + "~" +  //21; 
                Session["NombreClaveAzure"].ToString(); //22; 
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                {
                    P_ReemplazarFactura(
                        obj_parametros, ref Codigo, ref CodFacturaAnterior, ref FechaEmision, ref SerieDoc,
                        ref NumeroDoc, ref CodTipoDoc, ref CodCtaCte, ref RazonSocial, ref CodDireccion,ref CodAlmacen,
                         ref Observacion, ref CodTipoOperacion, ref CodMotivoTraslado, ref FlagImportacion, ref FlagMotorizado
                        );
            ...
            str_resultado =
                ...
                FlagImportacion.ToString() + "~" +   //16
                FlagMotorizado.ToString(); //17
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 CodTraslado, ref Int32 CodigoMov)
        {
            ...
            objEntidad.FlagImportacion = Convert.ToInt32(objTablaFiltro["Filtro_FlagImportacion"]);
            objEntidad.FlagMotorizado = Convert.ToInt32(objTablaFiltro["Filtro_FlagMotorizado"]);

            objOperacion = new TrasladosCabCN();

            objOperacion.F_Transferencias_Insert_Alvarado(objEntidad);
      ...
      ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura)
        ...
        public void P_ReemplazarFactura(Hashtable objTablaFiltro, ref int Codigo, ref int CodFacturaAnterior, ref string FechaEmision,
            ref string SerieDoc, ref string NumeroDoc, ref int CodTipoDoc, ref int CodCtaCte, ref string RazonSocial, ref int CodDireccion,
            ref int CodAlmacen, ref string Observacion, ref int CodTipoOperacion, ref int CodMotivoTraslado, ref int FlagImportacion, ref int FlagMotorizado
           )
        {
            NotaIngresoSalidaCabCE objEntidad = null;
            NotaIngresoSalidaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                FlagImportacion = Convert.ToInt32(dtTabla.Rows[0]["FlagImportacion"]);
        ...
        [WebMethod]
        public static TrasladosCabCE F_ObtenerTraslados_PorID_Net(string Serie, int Numero, string Conexion, string Ruc, int Destino, int CodTipoDoc)
        {
            TrasladosCabCE objEntidad = new TrasladosCabCE();
            TrasladosCabCN objOperacion = new TrasladosCabCN();
                       
            objEntidad.Serie = Serie.ToString();
            objEntidad.Numero = Numero;
            objEntidad.Conexion = Conexion.ToString();
            objEntidad.NroRuc = Ruc.ToString();
            objEntidad.destino = Destino;
            objEntidad.CodTipoDoc = CodTipoDoc;

            return objOperacion.F_TrasladosCab_ObtenerXNumero(objEntidad);          
        }


        public String F_AgregarTemporal_Servidor_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_AgregarTemporal_Servidor(obj_parametros, ref Codigo, ref MsgError);
                if (MsgError == "Los Producto(s) se han agregado con exito")
                    P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta);
        ...
        public void P_AgregarTemporal_Servidor(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " OC = '" + item.OC + "'";
                XmlDetalle = XmlDetalle + " Descripcion = '" + Convert.ToString(item.Descripcion).Replace("'", "&apos;") + "'";
                XmlDetalle = XmlDetalle + " CodigoInterno = '" + Convert.ToString(item.CodigoInterno).Replace("'", "&apos;") + "'";
                XmlDetalle = XmlDetalle + " Acuenta = '" + item.Acuenta + "'";
                XmlDetalle = XmlDetalle + " CodTipoDoc = '" + item.CodTipoDoc + "'";
                XmlDetalle = XmlDetalle + " />";
            }
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]) == 0)
            {
                objOperacion.F_TemporalFacturacionDet_Insert_Alvarado_Servidor(objEntidad);
                Codigo = objEntidad.CodDocumentoVenta;
            }
            else
            {
