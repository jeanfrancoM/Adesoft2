var AppSession = "../Ventas/RegistroOrdenPedidoPOVIS.aspx";
...
$(document).ready(function () {
  ...
  if($("#MainContent_txtDescuento2").val()<100 && $("#MainContent_txtDescuento2").val()>=0){
    ...
    if (!F_SesionRedireccionar(AppSession)) return false;
    if (F_PermisoOpcion(CodigoMenu, 4000501, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try 
        {
...
//    if (Precio3 != '' && $('#hfCodCategoriaCliente').val() === "3") {
...
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'RegistroOrdenPedidoPovis.aspx/F_ObtenerOrdenPedido_PorID_Net',
        dataType: "json",
