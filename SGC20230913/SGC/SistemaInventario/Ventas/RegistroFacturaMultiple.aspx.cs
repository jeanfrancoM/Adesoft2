...
{
    public partial class RegistroFacturaMultiple : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_LlenarGridDevolucion_NET);
            CallbackManager.Register(F_AgregarDevolucion_NET);
            CallbackManager.Register(F_PermisoObservacion_NET);
            CallbackManager.Register(F_LlenarGridDetalleEdicion_NET);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Utilitarios.Menu.F_ValidarPermisoOpcion(4000, 777001, "") == "1")
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lblNumero = (HyperLink)(e.Row.FindControl("lblnumero"));
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("Anexo3", typeof(string));
                    ...
                    dta_consultaarticulo.Columns.Add("NCV", typeof(string));
                    dta_consultaarticulo.Columns.Add("NCC", typeof(string));
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_DocumentoVentaDet_Listar_Alvarado(objEntidad);
                grvDetalle.DataBind();
        ...
        //comision
        public String F_LlenarGridDetalleEdicion_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String grvNombre = "";
            String str_grv_grvDetalleEdicion_html = "";
            int Col = 0;
            int Codigo = 0;
            int CodTipoDoc = 0;
            ...
            try
            {
                ...
                grvDetalleEdicion.DataSource = objOperacion.F_DocumentoVentaDet_Listar_Alvarado(objEntidad);
                grvDetalleEdicion.DataBind();

                //se crea el html a partir del grid llenado
                str_grv_grvDetalleEdicion_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleEdicion);
            ...
            str_resultado =
                Convert.ToString(int_resultado_operacion) + "~" +
                str_mensaje_operacion + "~" +
                str_grv_grvDetalleEdicion_html + "~" +
                grvNombre;
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta,ref ddlGratuito,ref ddlVendedorEdicion);
                ...
                str_grvDeudas_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleDeudas);
            ...
            str_resultado =
                ...
                str_grvDeudas_html + "~" + //25
                str_ddlGratuito_html + "~" + //26
                str_ddlVendedorEdicion_html + "~" +  //27
                Session["ComisionTarjeta"].ToString();//28
        ...
        public String F_GrabarDocumento_NET(String arg)
        {
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GrabarDocumento(obj_parametros, ref str_mensaje_operacion, ref Codigo, ref CodigoGuia);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref CodCtaCte, ref Motorizado,
                                               ref DistritoTrans,ref CodDistritoTrans, ref Placa, ref Marca, ref Licencia, ref Bulto, ref Peso,
                                               ref NroConductor, ref Conductor, ref CodConductor, ref Serie, ref CodVendedor, ref NombreAgencia,
                                               ref GuiaAgencia, ref ClaveAgencia, ref codcomprobanteegreso, ref FlagConCodigo);
                                               

                //ref Int32 CodTraslado, ref String SerieGuia, ref String NumeroGuia, ref String Fecha, 
                //ref String Destino, ref String DireccionTrans
            ...
            str_resultado =
                ...
                CodCtaCte.ToString()+ "~" + //23
                Motorizado.ToString()+ "~" +//24
                DistritoTrans.ToString() + "~" +//25
                Placa.ToString() + "~" +//26
                Marca.ToString()+ "~" +//27
                Licencia.ToString()+ "~" +//28
                Bulto.ToString()+ "~" +//29
                Peso.ToString()+ "~" +//30
                NroConductor.ToString()+ "~" +//31
                Conductor.ToString()+ "~" +//32
                CodConductor.ToString() + "~" +//33
                Serie + "~" + //34
                CodVendedor.ToString() + "~" + //35
                NombreAgencia + "~" +//36
                GuiaAgencia + "~" + //37
                ClaveAgencia+ "~" + //38
                codcomprobanteegreso + "~" + //39
            FlagConCodigo.ToString();//40
            return str_resultado;
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_Gratuito, ref DropDownList ddl_VendedorEdicion)
        {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("CodDocNC", typeof(string));
            dta_consulta.Columns.Add("NumeroNC", typeof(string));
        ...
        //Comision
        public void P_Inicializar_GrillaVacia_DetalleEdicion()
        {
            DataTable dta_consultadetalle = null;
            DataRow dtr_filadetalle = null;
            ...
            dta_consultadetalle.Columns.Add("CodGratuito", typeof(string));
            dta_consultadetalle.Columns.Add("Exclusivo", typeof(string));
            dta_consultadetalle.Columns.Add("Comision", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleNV()
        {
            ...
            dta_consultadetallenv.Columns.Add("flagtraslado", typeof(string));
            dta_consultadetallenv.Columns.Add("NroRucTrasnportista", typeof(string));
            dta_consultadetallenv.Columns.Add("Placa", typeof(string));
            dta_consultadetallenv.Columns.Add("Marca", typeof(string));
            dta_consultadetallenv.Columns.Add("Licencia", typeof(string));
            dta_consultadetallenv.Columns.Add("Bultos", typeof(string));
            dta_consultadetallenv.Columns.Add("Peso", typeof(string));
            dta_consultadetallenv.Columns.Add("NroRucConductor", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo,ref Int32 CodigoGuia)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Alvarado(objEntidad);
                    MsgError = objEntidad.MsgError; 
                    Codigo = objEntidad.CodDocumentoVenta;
                    break;
                default: //Facturas y Boletas
                    if (objEntidad.FlagFacturaANTIGUA == 0)
                    {
                            if (objEntidad.NotaPedido == 0)
                            {
                                //if (objEntidad.FlagNotaVentaANTIGUA == 0)
                                    objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Alvarado(objEntidad); //Insert Normal
                                //else
                                //    objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA_Alvarado(objEntidad); //Insert NV ANTIGUA
                            }
                            else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                                objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Alvarado(objEntidad);
                    }
                    else
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA_Alvarado(objEntidad); //FACTURA ANTIGUA

                    MsgError = objEntidad.MsgError; Codigo = objEntidad.CodDocumentoVenta;CodigoGuia =objEntidad.CodGuia;
                    break;
            }
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,ref Int32 FormaPago, ref String Placa1,
                             ref String Placa2, ref String Placa3, ref String Placa4,ref Int32 CodTraslado, ref String SerieGuia, ref String NumeroGuia,
                             ref String Fecha,ref String Destino,ref String DireccionTrans,ref Int32 CodTransportista, ref String Transportista,
                             ref String DireccionFactura,ref Int32 CodDireccionTransportista, ref String KM,ref String OrdenCompra, ref String Recepcion,
                             ref Int32 FlagComisionable, ref Int32 CodCtaCte, ref Int32 Motorizado,ref String DistritoTrans,ref Int32 CodDistritoTrans, 
                             ref String Placa,ref String Marca, ref String Licencia, ref String Bulto, ref Int32 Peso,ref String NroConductor,ref String Conductor,
            ...
            , ref int codcomprobanteegreso, ref int FlagConCodigo)
                            
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                FlagConCodigo = Convert.ToInt32(dta_consulta.Rows[0]["FlagConCodigo"]);
                try
                {
                    ...
                    //Serie = Convert.ToInt32(dta_consulta.Rows[0]["Serie"]);
        ...
        public void P_Inicializar_GrillaVacia_Devolucion()
        {
            DataTable dta_consultadetalle = null;
            DataRow dtr_filadetalle = null;
            ...
            dta_consultadetalle.Columns.Add("PrecioDscto", typeof(string));
            dta_consultadetalle.Columns.Add("ImporteReeim", typeof(string));
        ...
        public String F_LlenarGridDevolucion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleDevolcion_html = "";
            int int_resultado_operacion = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Devolucion(obj_parametros, ref grvDetalleDevolcion);
                if (grvDetalleDevolcion.Rows.Count == 0)
                {
                    P_Inicializar_GrillaVacia_Devolucion();
                    str_mensaje_operacion = "No se encontraron registros";
                }
                else
                {
                ...
                str_grvDetalleDevolcion_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleDevolcion);
                int_resultado_operacion = 0;
        ...
        public String F_AgregarDevolucion_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_DevolucionAgregar(obj_parametros, ref MsgError);
                //Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                //P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref NotaPedido);
                //if (grvDetalleArticulo.Rows.Count == 0)
                //    P_Inicializar_GrillaVacia_Detalle();
        ...
        public String F_PermisoObservacion_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodDocumentoVenta = Codigo;
                grvPermisoObservacion.DataSource = objOperacion.F_DOCUMENTOVENTACAB_PERMISOOBSERVACION(objEntidad);
                grvPermisoObservacion.DataBind();
        ...
        public void P_Devolucion(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            dta_consulta = objOperacion.F_DocumentoVentaDet_Devolucion_Listar(objEntidad);

            GrillaBuscar.DataSource = dta_consulta;
            GrillaBuscar.DataBind();
        }

        public void P_DevolucionAgregar(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_DevolucionAgregar(objEntidad);
