...
{
    public partial class RegistroCotizacionesTractos : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            if (objEntidadProforma.CodProformaAnterior > 0)
            {
                ...
                objOperacionProforma.F_Proformas_Insert_Edicion_Tractos(objEntidadProforma);
            }
            else
            {
                objOperacionProforma.F_Proformas_Insert_Tractos(objEntidadProforma);
            }
