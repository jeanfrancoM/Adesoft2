...
{
    public partial class RegistroFacturaMultipleTractos : System.Web.UI.Page
    {
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref CodEmpresa, ref PlacaGuia, ref Marca, ref Licencia,
                                               ref Bulto, ref Peso, ref NroConductor, ref Conductor, ref CodConductor, ref Serie, ref DistritoTrans,
                                               ref CodDistritoTrans, ref CodVendedor, ref NombreAgencia,
            ...
            str_resultado =
                ...
                CodEmpresa + "~" +//23
                DistritoTrans.ToString() + "~" +//24
                PlacaGuia.ToString() + "~" +//25
                Marca.ToString()+ "~" +//26
                Licencia.ToString()+ "~" +//27
                Bulto.ToString()+ "~" +//28
                Peso.ToString()+ "~" +//29
                NroConductor.ToString()+ "~" +//30
                Conductor.ToString()+ "~" +//31
                CodConductor.ToString() + "~" +//32
                Serie + "~" + //33
        ...
        public String F_EdicionFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                int_resultado_operacion = 1;
                str_mensaje_operacion = MsgError.ToString();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref Int32 CodigoGuia)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 5: //Orden de Compra
                    ...
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                    MsgError = objEntidad.MsgError; Codigo = objEntidad.CodDocumentoVenta;
                    break;
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Tracto(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                    MsgError = objEntidad.MsgError; Codigo = objEntidad.CodDocumentoVenta;
                    break;
                default: //Facturas y Boletas                  
                    if (objEntidad.NotaPedido == 0)
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Tracto(objEntidad); //Insert Normal                           
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref String OrdenCompra, ref String Recepcion, ref Int32 FlagComisionable, ref Int32 CodEmpresa, ref String PlacaGuia, ref String Marca, 
            ref String Licencia, ref String Bulto, ref Int32 Peso, ref String NroConductor,ref String Conductor, ref Int32 CodConductor, ref Int32 Serie,
            ref String DistritoTrans, ref Int32 CodDistritoTrans, ref Int32 CodVendedor, ref String NombreAgencia, ref String GuiaAgencia, ref String ClaveAgencia)
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    try { PlacaGuia = Convert.ToString(dta_consulta.Rows[0]["PlacaGuia"]); }
                    catch (Exception) { }
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_EdicionFactura_Tracto(objEntidad);
