var AppSession = "../Ventas/RegistroOrdenTrabajoFundicion.aspx";
...
$(document).ready(function () {
        ...
        select: function (e, i) {
            ...
            F_BuscarDireccionesCliente();
             $('#lblNombreComercial').text(i.item.NombreComercial);   
              $('#hfCodEmpresa').val(i.item.CodEmpresa);     
  ...
  if($("#MainContent_txtDescuento2").val()<100 && $("#MainContent_txtDescuento2").val()>=0){
    ...
    if (!F_SesionRedireccionar(AppSession)) return false;
    if (F_PermisoOpcion(CodigoMenu, 4001001, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
        try 
        {
     ...
     try 
        {
            ...
            if (confirm("ESTA SEGURO DE GRABAR LA ORDEN DE PEDIDO"))
            F_GrabarDocumento();
...
//    });
    ...
    $('#MainContent_txtFPago').css('background', '#FFFFE0');

    $('#MainContent_txtFEntrega').css('background', '#FFFFE0');
    ...
    $("#MainContent_txtDescuentoFamiliaMarca").css('background', '#FFFFE0');
    ...
    try {
        ...
        F_EliminarTemporal_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                ...
                if ($('#MainContent_ddlFormaPago').val() == 1 | $('#MainContent_ddlFormaPago').val() == 6 | $('#MainContent_ddlFormaPago').val() == 17)
...
{
            F_Mostrar_CorrelativoVarios(17);
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_Empresa', result.split('~')[17]);
                        F_Update_Division_HTML('div_EmpresaConsulta', result.split('~')[18]);
                        ...
                        $('#MainContent_ddlEmpresa').val(result.split('~')[19]);
                        $('#MainContent_ddlEmpresaConsulta').val(result.split('~')[19]);
...
function F_ValidarStockGrilla(ControlID) {
    ...
    if ($('#MainContent_chkNotaPedido').is(':checked')) {
        ...
        if ($('#MainContent_chkServicios').is(':checked') == false && boolEstado && parseFloat($(txtcantidad_Grilla).val()) > parseFloat($(lblstock).text()) & $('#MainContent_ddlTipoDoc').val() != '17') {
            alertify.log("STOCK INSUFICIENTE");
...
function F_AsignacionPreciosDll(Precio1, Precio2, Precio3, Precio4, Precio5, Precio6) {
    ...
    if (Precio3 != '' ) {
        ...
        if (Number(Precio3) < Number($("#hfMenorPrecioAgregar").val()) & Number(Precio3) > 0)
            $("#hfMenorPrecioAgregar").val(Precio3);
...
function F_AgregarTemporal() {
    ...
    try {
        ...
        DescuentoPorcMax: $('#MainContent_txtDescuentoFamiliaMarca').val(),
        ...
        AgregandoProducto = false;
            ...
            if (str_resultado_operacion == "1") {
                ...
                if ($('#MainContent_ddlFormaPago').val() == "1" | $('#MainContent_ddlFormaPago').val() == "6" | $('#MainContent_ddlFormaPago').val() == "17" | $('#MainContent_ddlFormaPago').val() == "10")
                    $('#MainContent_txtAcuenta').val(parseFloat($('#MainContent_txtTotal').val()) - parseFloat($('#MainContent_txtAcuentaNV').val()).toFixed(2));
...
//                    Cadena=Cadena + '<p></p>' + 'NUMERO DE RUC VALIDO';
                    ...
                    if ($('#hfNotaPedido').val() != '0')
                    {
                        ...
                        {
                            if ($('#hfNotaPedido').val() != '17') //las cotizaciones no deben ser afectadas
                                Cadena=Cadena + '<p></p>' + 'FORMA DE PAGO DEBE SER A CREDITO';
                        }

                        if ($('#hfCodCtaCteNP').val() != $('#hfCodCtaCte').val() & $('#hfNotaPedido').val() != '17') //las Cotizaciones no deben ser afectadas
...
function F_GrabarDocumento(){
  try 
        ...
        var objParams = {
            ...
            Filtro_Atencion: $('#MainContent_txtAtencion').val(),
            Filtro_FPago: $('#MainContent_txtFPago').val(),
            Filtro_FEntrega: $('#MainContent_txtFEntrega').val()
                            };
                ...
                {                    
                    if (str_mensaje_operacion=='Se Grabo Correctamente')
                    {
                        ...
                        F_ImprimirDocumento(result.split('~')[2]);                       
...
function F_Nuevo(){
            ...
            $('#MainContent_txtFPago').val('');
            $('#MainContent_txtFEntrega').val('');
            F_BuscarDireccionesCliente();
              ...
              var objParams = {
                ...
                {                  
                    ...
                    $('#MainContent_grvConsulta .detallesart').each(function () {
                        ...
                        var imgAprobarOrden=fila.replace("lblnumero","imgAprobarOrdenPedido");
                        if($(lblEstado).text()==='FACTURADO'){
                            $(imgAprobarOrden).attr("src","../Asset/images/ok.gif")
                        }else if($(lblEstado).text()==='APROBADO'){
                            $(imgAprobarOrden).attr("src","../Asset/images/refresh-icon.png")                        
                            $(imgAprobarOrden).css({"height":"16px","width":"16px"});
                            $(imgAprobarOrden).attr("title","Abrir orden de pedido");
                        }else{                        
                            $(imgAprobarOrden).attr("src","../Asset/images/ok.gif")                            
                        }
                    });       
...
function ImprimirFacturaDetalle(Fila) {
    ...
    if ($('#' + Fila.id.replace('imgPdf', 'hfCodTipoDoc')).val() == '17')
    {
...
function F_ActualizarPrecio(Fila) {
    try {
        ...
        if (parseInt($(hfCodTipoDoc).val())==15 & parseFloat($(txtPrecio).val())!=parseFloat($(hfPrecio).val()) )
            {
             $(txtPrecio).val(parseFloat($(hfPrecio).val()).toFixed(2));
             alertify.log("EL PRECIO NO PUEDE SER DIFERENTE AL REGISTRADO EN LA COTIZACION");              
            return false;
            }
        ...
        F_ActualizarPrecio_Net(arg, function (result) {
            ...
            if (str_mensaje_operacion == "") {
                ...
                $('.ccsestilo').css('background', '#FFFFE0');
                        $('#MainContent_grvDetalleArticulo .chkDelete :checkbox').each(function () {
                     chkDel = '#' + this.id;
                     hfPxkilo = chkDel.replace('chkEliminar', 'hfPxkilo');
                     txtPestimadoOT = chkDel.replace('chkEliminar', 'txtPestimadoOT');
                      txtPrecio = chkDel.replace('chkEliminar', 'txtPrecio');
                                                 
                         if ($(txtPestimadoOT).val()==0 && $(hfPxkilo).val()==0 ){
                         $(txtPestimadoOT).prop('disabled',true);
                         }
                                                        if (parseFloat($(txtPestimadoOT).val())>0 && parseFloat($(hfPxkilo).val())>0 ){
...
function F_ActualizarCantidad(Fila) {
    try {
        ...
        if (parseInt($(hfCodTipoDoc).val())==15 & parseFloat($(txtCantidad).val())!=parseFloat($(hfCantidad).val()) )
            {
             $(txtCantidad).val(parseFloat($(hfCantidad).val()).toFixed(2));
             alertify.log("LA CANTIDAD NO PUEDE SER DIFERENTE AL REGISTRADO EN LA COTIZACION");              
            return false;
            }
...
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
        try {
            ...
            /*if ($(lblTipoDoc).val() == '5' | $(lblTipoDoc).val() == '16' | $(lblTipoDoc).val() == '17')
            {} else
            {
...
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Editar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informacion
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'RegistroOrdenTrabajoFundicion.aspx/F_ObtenerOrdenPedido_PorID_Net',
        dataType: "json",
        data: "{'CodOrdenPedido':'" + $(lblcodigo).val()  + "'}",
        success: function (dbObject) {
            MostrarEspera(true);
            var data = dbObject.d;
            try {
                    ...
                    var objParams = {
                        Filtro_CodTipoDoc: data.CodTipoDoc,
                ...
                F_AgregarTemporal_NET(arg, function (result) {
                    ...
                    if (result.split('~')[2] == "Los Producto(s) se han agregado con exito") {
                        ...
                        if ($('#MainContent_ddlFormaPago').val() == "1" | $('#MainContent_ddlFormaPago').val() == "6" | $('#MainContent_ddlFormaPago').val() == "10" |  $('#MainContent_ddlFormaPago').val() == "17")
                            $('#MainContent_txtAcuenta').val(parseFloat($('#MainContent_txtTotal').val()) - parseFloat($('#MainContent_txtAcuentaNV').val()).toFixed(2));
                        F_Update_Division_HTML('div_grvDetalleArticulo', result.split('~')[4]);
                        $('#lblCantidadRegistro').text(F_Numerar_Grilla("grvDetalleArticulo", "lblimporte"));
                        ...
                        $('#MainContent_txtFPago').val(data.FPago);
                        $('#MainContent_txtFEntrega').val(data.FEntrega);
...
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Eliminar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
  var imgID = Fila.id;
        ...
        var TipoArchivo = 'application/pdf';
        var CodMenu = '215';
        var NombreArchivo = 'Web_Reporte_Ventas_rptOrdenPedido_Povis_TK.rpt';
...
function F_ImprimirDocumento(Fila) {
if (F_PermisoOpcion(CodigoMenu, CodigoInterno, 'Eliminar') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
  var imgID = Fila.id;
        var lblCodigo = Fila;
        var rptURL = '';
        ...
        rptURL = rptURL + '?';
        rptURL = rptURL + 'CodMenu=' + CodMenu + '&';
        rptURL = rptURL + 'Codigo=' + lblCodigo  + '&';
        rptURL = rptURL + 'TipoArchivo=' + TipoArchivo + '&';
        rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
        rptURL = rptURL + 'NombreTabla=' + NombreTabla + '&';
...
CodEmpresa=$('#hfCodEmpresa').val();
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '../Servicios/DeudasConsultaAPI.asmx/F_Lista_Almacenes_Deudas_Clientes_Povis',
        data: "",
        dataType: "json",
        async: false,
        success: function (dbObject) {
...
function F_AnularPopUP(Fila) {
    ...
    if ($(lblEstado).text() == "ANULADO") {
        ...
        if ($(lblEstado).text() == "FACTURADO") {
            alertify.log("LAS ORDEN DE PEDIDO FACTURADAS NO SE PUEDEN ANULAR");
            return false;
        }
...
function F_AprobarOrdenPedido_Ventana(Fila) {

    var imgID = Fila.id;
    var lblID = '#' + imgID.replace('imgAprobarOrdenPedido', 'lblCodigo');
    var lblEstado = '#' + imgID.replace('imgAprobarOrdenPedido', 'lblEstado');
    var lblNumero = '#' + imgID.replace('imgAprobarOrdenPedido', 'lblnumero');
    var lblCliente = '#' + imgID.replace('imgAprobarOrdenPedido', 'lblcliente');
    

    try {

        if ($(lblEstado).text().trim() != "PENDIENTE" && $(lblEstado).text().trim() != "APROBADO") {
            alertify.log("SOLO PUEDEN ABRIRSE Y APROBARSE ORDENES DE PEDIDO EN ESTADO DE APROBADO O PENDIENTE");
            return true;
        }       

        if($(lblEstado).text().trim() == "PENDIENTE"){
            if (!confirm("ESTA SEGURO DE APROBAR LA ORDEN DE PEDIDO : " + $(lblNumero).text() + "\n" + "DEL CLIENTE : " + $(lblCliente).text()))
            return false;
        }else{
            if (!confirm("ESTA SEGURO DE ABRIR LA ORDEN DE PEDIDO : " + $(lblNumero).text() + "\n" + "DEL CLIENTE : " + $(lblCliente).text()))
            return false;
        }
        MostrarEspera(true);
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '../Servicios/Servicios.asmx/F_Aprobar_OrdenPedido',
            data: "{'CodOrdenPedido':'" + $(lblID).val() + "','Observacion':''}",
            dataType: "json",
            async: true,
            success: function (dbObject) {
                var data = dbObject.d;
...
function F_ActualizarPestimado(Fila) {
    try {
        var txtPestimadoOT = '#' + Fila;
        var hfCodDetalle = txtPestimadoOT.replace('txtPestimadoOT', 'hfCodDetalle');
        var hfPrecio = txtPestimadoOT.replace('txtPestimadoOT', 'hfPrecio');
        var hfCantidad = txtPestimadoOT.replace('txtPestimadoOT', 'hfCantidad');
        var txtPrecio = txtPestimadoOT.replace('txtPestimadoOT', 'txtPrecio');
        var txtDescripcion = txtPestimadoOT.replace('txtPestimadoOT', 'txtDescripcion');
        var hfCodDetalleOC = txtPestimadoOT.replace('txtPestimadoOT', 'hfCodDetalleOC');
        var lblAcuenta = txtPestimadoOT.replace('txtPestimadoOT', 'lblAcuenta');
        var hfPrecioOriginal = txtPestimadoOT.replace('txtPestimadoOT', 'hfPrecioOriginal');
        var hfDescuentoPorcMax = txtPestimadoOT.replace('txtPestimadoOT', 'hfDescuentoPorcMax');
        var hfCodTipoDoc = txtPestimadoOT.replace('txtPestimadoOT', 'hfCodTipoDoc');
        var hfPestimado = txtPestimadoOT.replace('txtPestimadoOT', 'hfPestimado');
        var hfPxkilo = txtPestimadoOT.replace('txtPestimadoOT', 'hfPxkilo');
        var Flag = 0;
        var FlagIgv = 0;

       
        if (parseFloat($(txtPestimadoOT).val()) == parseFloat($(hfPestimado).val()) ) {
            $(txtPestimadoOT).val(parseFloat($(txtPestimadoOT).val()).toFixed(2));
            return false;
        }
        ...
        var objParams = {
            ...
            Filtro_Flag: Flag,
            Filtro_TasaIgvDscto: parseFloat($("#MainContent_ddlIgv option:selected").text()) + parseFloat(1) ,
            Filtro_Pestimado: $(txtPestimadoOT).val() ,
            Filtro_Pxkilo: $(hfPxkilo).val()    
        };

        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
        MostrarEspera(true);
        F_ActualizarPEstimado_Net(arg, function (result) {
