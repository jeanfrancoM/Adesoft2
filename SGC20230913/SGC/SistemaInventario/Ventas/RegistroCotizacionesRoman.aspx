<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroCotizacionesRoman.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesRoman" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesRoman.js"
        charset="UTF-8"></script>
