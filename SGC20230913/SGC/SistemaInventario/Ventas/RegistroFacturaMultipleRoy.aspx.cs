...
{
    public partial class RegistroFacturaMultipleRoy : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ref ddlTipoDoc, ref ddlTipoDoc2, ref CantidadPlacas, ref ddlSerieNV, ref ddlEstado, ref ddlFormaPagoEdicion, ref ddlSerieGuiaEdicion,
        ...
        public String F_Series_Documentos_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Series_Documentos(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlSerieNV);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref GuiaAgencia, ref ClaveAgencia);
        ...
        public void P_Series_Documentos(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
                                        ref DropDownList ddl_serieguia, ref DropDownList ddl_comboserienv)
        {
                    ...
                    if (objEntidad.FlagFacturaANTIGUA == 0)
                    {
                            if (objEntidad.NotaPedido == 0)
                            {
                                if (objEntidad.FlagNotaVentaANTIGUA == 0)
                                    objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Roy(objEntidad); //Insert Normal
                                else
                                ...
                                objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Roy(objEntidad);
                    }
                    else
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_EdicionFactura_Roy(objEntidad);
