...
{
    public partial class RegistroFacturaMultipleKarina : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_ConsultarDetalleMultiple_NET);
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (lblCodigo.Value != "")
                    {
                        try
                        {
                            GridView grvDetalle = (GridView)(e.Row.FindControl("grvDetalleKardex"));
                            DataTable dta_consultaarticulo = null;
                            DataRow dtr_consultafila = null;
                            dta_consultaarticulo = new DataTable();
                        ...
                        try
                        {
                            GridView grvDetalleProducto = (GridView)(e.Row.FindControl("grvDetalleProducto"));
                            DataTable dta_consultaarticulo = null;
                            DataRow dtr_consultafila = null;
                            dta_consultaarticulo = new DataTable();
                            ...
                            grvDetalleProducto.DataSource = dta_consultaarticulo;
                            grvDetalleProducto.DataBind();
                        }
                        catch (Exception)
                        {
                        }
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_seriecotizacion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ref ddlTipoDoc, ref ddlTipoDoc2, ref ddlSerieNV, ref ddlSerieCT, ref ddlEstado, ref ddlFormaPagoEdicion, ref ddlSerieGuiaEdicion,
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlSerieCotizacion);
                ...
                str_ddl_seriecotizacion_html = Mod_Utilitario.F_GetHtmlForControl(ddlSerieCotizacion);
            ...
            str_resultado =
                ...
                P_CodMoneda_Inicial + "~" +  //25
                str_ddl_seriecotizacion_html; //26
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref MarcaVehiculo, ref DireccionTrans, ref NroBultos, ref Peso, ref PlacaVehiculo,ref Observacion);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref CodEmpresa,ref Motorizado,
                                               ref NroOperacion, ref Observacion, ref CodCtaCte);
        ...
        public String F_ConsultarDetalleMultiple_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String grvNombre = "";
            String str_grv_DetalleKardex_html = "";
            String str_grv_DetalleProducto_html = "";
            Hashtable obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);

            try
            {
                //grvNombre = Convert.ToString(obj_parametros["Filtro_grvNombre"]);
                GridView grvDetalleKardex = (GridView)grvConsultaArticulo.Rows[0].FindControl("grvDetalleKardex");
                GridView grvDetalleProducto = (GridView)grvConsultaArticulo.Rows[0].FindControl("grvDetalleProducto");
                ...
                try
                {
                    ...
                    grvDetalleKardex.DataSource = objOperacion.F_LGPRODUCTOS_STOCKDETALLE(objEntidad);
                ...
                try
                {
                    ...
                    grvDetalleProducto.DataSource = objOperacion.F_ProductoModelo_Listado(objEntidad);
                    grvDetalleProducto.DataBind();
                }
                catch (Exception)
                {
                ...
                str_grv_DetalleKardex_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleKardex);
                str_grv_DetalleProducto_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleProducto);        
            ...
            str_resultado =
                Convert.ToString(int_resultado_operacion) + "~" + //0
                str_mensaje_operacion + "~" + //1
                str_grv_DetalleKardex_html + "~" + //2
                str_grv_DetalleProducto_html; //3
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref String Direccion, ref DropDownList ddl_tipodoc, ref DropDownList ddl_tipodoc2, ref DropDownList ddl_comboserienv,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_seriecotizacion)
        {
            ...
            ddl_seriecotizacion.Items.Clear();

            ddl_seriecotizacion.DataSource = dta_consulta;
            ddl_seriecotizacion.DataTextField = "SerieDoc";
            ddl_seriecotizacion.DataValueField = "CodSerie";
            ddl_seriecotizacion.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_DetalleOC()
        {
            ...
            dta_consultadetalleoc.Columns.Add("ObservacionesCliente", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 5: //Orden de Compra
                    ...
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Karina(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                ...
                default: //Facturas y Boletas                  
                    if (objEntidad.NotaPedido == 0)
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Karina(objEntidad); //Insert Normal                           
                    else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Karina(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref Int32 CodTraslado, ref String SerieGuia, ref String NumeroGuia, ref String Fecha,ref String Destino,
                            ref String DireccionTrans, ref Int32 CodTransportista, ref String Transportista,ref String DireccionFactura,
                            ref Int32 CodDireccionTransportista, ref String KM,ref String OrdenCompra, ref String Recepcion, ref Int32 FlagComisionable, 
                            ref Int32 CodEmpresa,ref Int32 Motorizado, ref string NroOperacion, ref String Observacion, ref Int32 CodCtaCte)
        {
        ...
        ref String MarcaVehiculo, ref String DireccionTrans, ref String NroBultos, ref String Peso, ref String PlacaVehiculo, ref String Observacion)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
        ...
        [WebMethod]
        public static ProformaCabCE F_ObtenerCotizacion_PorNumero_Net(int NumeroCotizacion, string Serie)
        {
