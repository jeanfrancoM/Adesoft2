<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroCotizacionesKarina.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesKarina" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesKarina.js"  charset="UTF-8"></script>     
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgReemplazar" ImageUrl="~/Asset/images/Reemplazo.png"
                                                ToolTip="ACTUALIZAR COTIZACION" OnClientClick="F_ReemplazarDocumento(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
