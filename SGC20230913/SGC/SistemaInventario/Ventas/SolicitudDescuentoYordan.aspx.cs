...
{
    public partial class SolicitudDescuentoYordan : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_BuscarSolicitudes_NET);
            CallbackManager.Register(F_GestionarSolicitud_Net);
        }
        ...
        public String F_BuscarSolicitudes_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_CargarGrillaTemporal_SolicitudDescuentos(obj_parametros, Codigo, ref grvDetalleArticulo);
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Detalle();
                str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleArticulo);
        ...
        public String F_GestionarSolicitud_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_GestionarSolicitud(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                P_CargarGrillaTemporal_SolicitudDescuentos(obj_parametros, Codigo, ref grvDetalleArticulo);
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Detalle();
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("FechaSolicitud", typeof(string));
            dta_consultadetalle.Columns.Add("Almacen", typeof(string));
            dta_consultadetalle.Columns.Add("Solicitante", typeof(string));
            ...
            dta_consultadetalle.Columns.Add("TipoDocumento", typeof(string));
        ...
        public void P_CargarGrillaTemporal_SolicitudDescuentos(Hashtable objTablaFiltro, Int32 Codigo, ref GridView grvDetalle)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            DataTable dta_consulta = null;
            dta_consulta = objOperacion.F_TemporalFacturacionDet_SolicitudDescuentos_Listar(objEntidad);
            grvDetalle.DataSource = dta_consulta;
            grvDetalle.DataBind();
        ...
        public void P_GestionarSolicitud(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            objEntidad.Flag = Convert.ToInt32(objTablaFiltro["Filtro_Flag"]);
            objEntidad.SolicitudDescuento = Convert.ToInt32(objTablaFiltro["Filtro_SolicitarDescuento"]);
            objEntidad.TipoAccion = Convert.ToString(objTablaFiltro["Filtro_TipoAccion"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);

            objOperacion = new DocumentoVentaDetCN();

            objOperacion.F_TemporalFacturacionDet_UpdateSolicitudDescuento_Yordan(objEntidad);
