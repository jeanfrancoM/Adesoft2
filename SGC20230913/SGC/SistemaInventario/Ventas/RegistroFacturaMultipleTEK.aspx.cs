...
{
    public partial class RegistroFacturaMultipleTEK : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlEmpresaEdicion);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                               ref CodTraslado, ref SerieGuia, ref NumeroGuia, ref Fecha, ref Destino, ref DireccionTrans,ref CodTransportista,
                               ref Transportista, ref DireccionFactura, ref CodDireccionTransportista,ref KM, ref OrdenCompra, ref Recepcion,
                               ref FlagComisionable, ref CodEmpresa, ref Motorizado, ref CodTipoDoc, ref CodCtaCte);
            ...
            str_resultado =
                ...
                CodEmpresa + "~" + //24
                Motorizado.ToString() + "~" + //25
            CodTipoDoc.ToString() + "~" + //26
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_comboempresaedicion)
        {
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref Int32 CodDireccionTransportista, ref String KM,ref String OrdenCompra,ref String Recepcion, ref Int32 FlagComisionable,
                             ref Int32 CodEmpresa, ref Int32 Motorizado, ref Int32 CodTipoDoc, ref Int32 CodCtaCte)
                            
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                CodTipoDoc = Convert.ToInt32(dta_consulta.Rows[0]["CodTipoDoc"]);
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_EdicionFactura_TEK(objEntidad);
