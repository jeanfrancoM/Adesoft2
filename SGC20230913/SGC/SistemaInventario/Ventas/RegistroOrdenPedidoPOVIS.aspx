<%@ Page Title="Orden de Pedido" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroOrdenPedidoPOVIS.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroOrdenPedidoPOVIS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroOrdenPedidoPOVIS.js"
        charset="UTF-8"></script>
        ...
        <tr valign="top">
            <td style="width: 1100px" valign="top">
                <div class="titulo" style="width: 1045px">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="REGISTRO DE Orden de PedidoS" Font-Bold="False"
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold; padding-left: px">
                                                        Igv (%)
                                                    </td>
                                                    <td>
                                                        <div id="div_igv">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="">
                                                        <asp:CheckBox ID="chkImpresionTicket" runat="server" Text="Imprimir" Checked="True"
                                                            Font-Bold="True" />
                                                    </td>
                                                </tr>
                                            </table>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/Eliminar.jpg"
                            ToolTip="ANULAR Orden de Pedido" OnClientClick="F_AnularPopUP(this); return false;" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
