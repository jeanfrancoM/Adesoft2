var AppSession = "../Ventas/RegistroFacturaMultiplePymes.aspx";
...
//            $('#MainContent_txtNroRucTransportista').val($('#hfNroRucTransportista').val());
     ...
     $('#MainContent_btnCaja').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        
        try {
        
        if($('#MainContent_ddlFormato').val()==1){
            var Mensaje = 'VISTA PRELIMINAR DEL REPORTE';
            F_Reporte(700, $('#MainContent_txtDesde').val(), Mensaje);
            }
            else{
               var Mensaje = 'VISTA PRELIMINAR DEL REPORTE';
            F_ReporteIndividual(700, $('#MainContent_txtDesde').val(), Mensaje);
            }
...
//       
    ...
    return false;
      ...
      $("#MainContent_txtCantidad").blur(function () {
        if (parseFloat($("#MainContent_txtCantidad").val())>=parseFloat($("#hfCantidadMayorista").val()) && parseFloat($("#MainContent_txtStockAgregar").val())>parseFloat($("#hfLimiteMayorista").val()) ){
         $("#MainContent_txtPrecioDisplay").val($("#MainContent_txtPrecioMayorista").val());
        }else{
          $("#MainContent_txtPrecioDisplay").val($("#hfPrecio1").val());
        }
    });
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                       ...
                       // F_Update_Division_HTML('div_DetalleDeudas', result.split('~')[25]);
                        ...
                        //$('#MainContent_ddlVendedor').val(23);
                        ...
                        $('#MainContent_ddlFormato').css('background', '#FFFFE0');
...
//                        $('#MainContent_ddlSerieCT').css('background', '#FFFFE0');
                      ...
                      //  F_Pedidos();
                        ...
                        $('#MainContent_ddlTipoDoc').val(result.split('~')[28]);
                        if(result.split('~')[28] == 16 )   
                        {
                          $('#MainContent_txtArticulo').val('');
                              $('#MainContent_chkServicios').prop('checked',false);
                              $('#MainContent_chkNotaPedido').prop('checked',false);
...
//                $('#MainContent_txtNroRucTransportista').val($(hfRuctransportista).val());
//                $('#MainContent_txtPlacaTraslado').val($(hfNroRuc).val());
//                $('#MainContent_txtMarcaGuia').val($(hfMarca).val());
//                $('#MainContent_txtLicenciaGuia').val($(hfLicencia).val());
//                $('#MainContent_txtNuBultos').val($(hfBultos).val());
//                $('#MainContent_txtPeso').val($(hfPeso).val());
//                $('#MainContent_txtConductorDNI').val($(hfRucConductor).val());
//                }
...
//                            PrecioLimite = $(hfExclusivo).val();
                        ...
                        if(parseFloat($(hfCantidad).val())>=parseFloat($(hfCantidadMayorista).val()) && parseFloat($(txtPrecio).val())>=parseFloat($(hfP3).val()) & parseFloat($(hfP3).val())> 0)
                            return false;
...
function F_Reporte(CodMenu,Fecha,Mensaje) {
    ...
    rptURL = rptURL + 'FechaSaldo=' + $('#MainContent_txtHasta').val() + '&';
    rptURL = rptURL + 'CodCajaFisica=' + $('#MainContent_ddlCajaFisica').val() + '&';
    rptURL = rptURL + 'CodUsuario=' + 0 + '&';
...
function F_ReporteIndividual(CodMenu, Fecha,Mensaje) {
    ...
    var Titulo = "CIERRE CAJA DETALLADO";
    var NombreTabla = "CajaChicaDetalle";
    var NombreArchivo = "Web_Reporte_CajaBanco_rptCajaChicaResumido_Pymes_Ticket.rpt";
    ...
    rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
    rptURL = rptURL + 'Titulo=' + Titulo + '&';
    rptURL = rptURL + 'Mensaje=' + '' + '&';
    rptURL = rptURL + 'CodEmpresa=' + $('#hfCodEmpresa').val() + '&';  
    rptURL = rptURL + 'CodMedioPago=' + 0 + '&';
    rptURL = rptURL + 'CodDoc=' + 0 + '&';
    rptURL = rptURL + 'MedioPago=' + '' + '&';
...
function F_PDF_FACTURA_GUIA(Fila) {
    
    var imgID = Fila.id;
    var Guia = '#' + imgID.replace('imgPdf2', 'hfCodTraslado');
