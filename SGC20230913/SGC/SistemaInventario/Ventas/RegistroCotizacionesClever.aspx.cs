...
{
    public partial class RegistroCotizacionesClever : System.Web.UI.Page
    {
        ...
        public String F_Observacion_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_PROFORMACAB_OBSERVACIONCLEVER(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadProforma.FlagPlaca = Convert.ToInt32(objTablaFiltro["Filtro_FlagPlaca"]);
            objEntidadProforma.FlagKM = Convert.ToInt32(objTablaFiltro["Filtro_FlagKM"]);
            ...
            if (objEntidadProforma.CodProformaAnterior > 0)
            {
                ...
                objOperacionProforma.F_Proformas_Insert_Edicion_Clever(objEntidadProforma);
            }
            else
            {
                objOperacionProforma.F_Proformas_Insert_Clever(objEntidadProforma);
            }
