...
{
    public partial class RegistroCotizacionesReeim : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_ActualizarDescuento_Net);
        }
        ...
        public String F_Observacion_NET(String arg)
        {
            ...
            {      
                ...
                grvDetalle.DataSource = objOperacion.F_PROFORMACAB_OBSERVACION(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_ActualizarDescuento_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_ActualizarDescuento(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref NotaPedido);
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Detalle();
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("FlagConCodigo", typeof(string));
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadProforma.FlagConCodigo = Convert.ToInt32(objTablaFiltro["Filtro_FlagConCodigo"]);
            objEntidadProforma.FlagComisionable = Convert.ToInt32(objTablaFiltro["Filtro_FlagComisionable"]);
            objEntidadProforma.FechaIngreso = Convert.ToDateTime(objTablaFiltro["Filtro_FechaEmision"]);
            objEntidadProforma.FechaSalida = Convert.ToDateTime(objTablaFiltro["Filtro_FechaEmision"]);
        ...
        public void P_ActualizarDescuento(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            objOperacion.F_TemporalFacturacionDet_ACTUALIZAR_DESCUENTO(objEntidad);
