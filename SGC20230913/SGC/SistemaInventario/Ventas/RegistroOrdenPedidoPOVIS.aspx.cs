...
{
    public partial class RegistroOrdenPedidoPOVIS : System.Web.UI.Page
    {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            if (objEntidadOrdenPedido.CodOrdenPedidoAnterior > 0)
            {
                ...
                objOperacionOrdenPedido.F_OrdenPedidos_Insert_Edicion_Povis(objEntidadOrdenPedido);
            }
            else
            {
                objOperacionOrdenPedido.F_OrdenPedidos_Insert_Povis(objEntidadOrdenPedido);
            }              
