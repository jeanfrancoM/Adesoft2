...
{
    public partial class RegistroFacturaMultipleFundidora : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_Series_Guia_NET);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlEmpleadoEditar_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlEmpresa, ref ddlEmpresaConsulta, ref ddlEmpresaEdicion, ref dllvendedorEditor);
                ...
                str_ddlEmpleadoEditar_html = Mod_Utilitario.F_GetHtmlForControl(dllvendedorEditor);
            ...
            str_resultado =
                ...
                str_ddlEmpresa_html + "~" +//25
                str_ddlEmpresaConsulta_html + "~" +//26
                str_ddlEmpresaEdicion_html + "~" +//27
                Session["CodEmpresa"].ToString() + "~" +//28
                str_ddlEmpleadoEditar_html; //29
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref MarcaVehiculo, ref DireccionTrans, ref NroBultos, ref Peso, ref PlacaVehiculo, ref CodAlmacen, ref CodCategoria, ref observacion);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref CodEmpresa, ref codvendedor, ref codctacte, ref observacion);
            ...
            str_resultado =
                ...
                OrdenCompra + "~" + //20
                Recepcion + "~" + //21
                FlagComisionable.ToString() + "~" + //21
                str_ddlSerieGuiaEdicion_html + "~" + //22
                CodEmpresa + "~" + //23
                codvendedor + "~" +//24
                codctacte + "~" +
                observacion;//25
        ...
        public String F_Series_Guia_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_ddlSerieGuia_html = "";
            int int_resultado_operacion = 0;
            Hashtable obj_parametros = null;
            ...
            try
            {
                ...
                P_Series_Guia(obj_parametros, ref ddlSerieGuia);

                str_ddlSerieGuia_html = Mod_Utilitario.F_GetHtmlForControl(ddlSerieGuia);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_comboempresaedicion, ref DropDownList ddl_empleadoEditar)
        {
            ...
            ddlTipoDoc2.Items.Insert(0, new ListItem("TODOS", "0"));

            dta_consulta = null;
            TCEmpresaCN objOperacionTCEmpresa = new TCEmpresaCN();
            dta_consulta = objOperacionTCEmpresa.F_TCEmpresa_Listar(new TCEmpresaCE() { CodEmpresa = Convert.ToInt32(objTablaFiltro["Filtro_CodEmpresa"]) });
            ...
            objEmpleado.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            dta_consulta = (new EmpleadoCN()).F_Empleado_Listar(objEmpleado);
            ddl_empleadoEditar.Items.Clear();

            ddl_empleadoEditar.DataSource = dta_consulta;
            ddl_empleadoEditar.DataTextField = "NombreCompleto";
            ddl_empleadoEditar.DataValueField = "CodEmpleado";
            ddl_empleadoEditar.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("CodMarcaProducto", typeof(string));
            dta_consultadetalle.Columns.Add("IDFamilia", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleNV()
        {
            ...
            dta_consultadetallenv.Columns.Add("PrecioOriginal", typeof(string));
            dta_consultadetallenv.Columns.Add("DescuentoPorcMax", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleCT()
        {
            ...
            dta_consultadetalleCT.Columns.Add("PrecioOriginal", typeof(string));
            dta_consultadetalleCT.Columns.Add("DescuentoPorcMax", typeof(string));
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta)
        {
            ...
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);         
            objEntidad.TipoBusquedaArticulo = Convert.ToInt32(objTablaFiltro["Filtro_TipoBusquedaArticulo"]);


            ////display none a la columna de costo, en el caso de que ese esté excluido segun lamda de abajo
            //if (Utilitarios.Menu.F_PermisoOpcion("4000", "777001") == false)
            //    grvConsultaArticulo.Columns[5].Visible = false;

            grvConsulta.DataSource = objOperacion.F_LGProductos_Select_Ventas_Povis(objEntidad);
            grvConsulta.DataBind();
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objEntidad.DepartamentoTransportista = Convert.ToString(objTablaFiltro["Filtro_DepartamentoTransportista"]);
            objEntidad.ProvinciaTransportista = Convert.ToString(objTablaFiltro["Filtro_ProvinciaTransportista"]);
            objEntidad.DistritoTransportista = Convert.ToString(objTablaFiltro["Filtro_DistritoTransportista"]);
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Povis(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                    ...
                    if (objEntidad.FlagFacturaANTIGUA == 0)
                    {
                        if (objEntidad.NotaPedido == 0)
                        {
                            if (objEntidad.FlagNotaVentaANTIGUA == 0)
                                objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Povis(objEntidad); //Insert Normal
                            else
                                objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA_Povis(objEntidad); //Insert NV ANTIGUA
                        }
                        else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                            objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Povis(objEntidad);
                    }
                    else
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA_Povis(objEntidad); //FACTURA ANTIGUA
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref String OrdenCompra, ref String Recepcion, ref Int32 FlagComisionable, ref Int32 CodEmpresa, ref Int32 codvendedor, ref Int32 codctacte, ref string Observacion)
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                codctacte = Convert.ToInt32(dta_consulta.Rows[0]["codcliente"]);

                Observacion = Convert.ToString(dta_consulta.Rows[0]["ObservacionesCliente"]);
                try
                {
        ...
        public void P_EdicionFactura(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.FlagComisionable = Convert.ToInt32(objTablaFiltro["Filtro_FlagComisionable"]);
            objEntidad.CodVendedor = Convert.ToInt32(objTablaFiltro["Filtro_Vendedor"]);
            objEntidad.Observacion = Convert.ToString(objTablaFiltro["Filtro_Observacion"]);


            objEntidad.ObservacionesCliente = Convert.ToString(objTablaFiltro["Filtro_ObservacionesClientes"]);
            objOperacion = new DocumentoVentaCabCN();
        ...
        ref String MarcaVehiculo, ref String DireccionTrans, ref String NroBultos, ref String Peso, ref String PlacaVehiculo, ref Int32 CodAlmacen, ref Int32 CodCategoria, ref string Observacion)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                Observacion = Convert.ToString(dtTabla.Rows[0]["ObservacionesCliente"]);
            }
        }
        ...
        [WebMethod]
        public static jqOrdenPedidoResult F_Consulta_Pedidos_Pendientes_NET(int CodAlmacen)
        {
            jqOrdenPedidoResult data = new jqOrdenPedidoResult();
            OrdenPedidoCabCE par = new OrdenPedidoCabCE() { CodEmpresa = 3, CodAlmacen = CodAlmacen, CodEstado = 15 };
            data.rows = (new OrdenPedidoCabCN()).F_OrdenPedidoCab_ListarXEstado(par);
            return data;
        }
        public class jqOrdenPedidoResult
        {
            public String msg { get; set; }
            public String ID_Imagen { get; set; }
            public int total { get; set; }
        ...
        [WebMethod]
        public static OrdenPedidoCabCE F_ObtenerOrdenPedido_PorNumero_Net(int NumeroOrdenPedido)
        {
            OrdenPedidoCabCE objEntidad = new OrdenPedidoCabCE();
            OrdenPedidoCabCN objOperacion = new OrdenPedidoCabCN();
            objEntidad.Numero = NumeroOrdenPedido.ToString();
            return objOperacion.F_OrdenPedidoCab_ObtenerXNumero(objEntidad);
        }
        ...
        //[WebMethod]
        //public static TCCuentaCorrienteCE F_ActualizarDescuento(int categoria)
        //{
        //    FormatoImpresionCN objOperacion = new FormatoImpresionCN();
        //    TCCuentaCorrienteCE Zona = objOperacion.F_ObtenerFormatoImpresion(categoria);
