...
{
    public partial class RegistroFacturaMultipleReeim : System.Web.UI.Page
    {
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta)
        {
            ...
            //-----------DLL NUEVO CON VALUE MULTIPLE
            //dta_consulta = null;
            //objEntidadConceptosDet.CodConcepto = 5;
            //dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select_Multiple_Value(objEntidadConceptosDet);
            ...
            switch (objEntidad.CodTipoDoc)
            {
                ...
                default: //Facturas y Boletas                  
                    if (objEntidad.NotaPedido == 0)
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV(objEntidad); //Insert Normal                           
