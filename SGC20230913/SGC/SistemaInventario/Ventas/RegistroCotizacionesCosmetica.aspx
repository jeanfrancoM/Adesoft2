<%@ Page Title="NOTA PEDIDO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroCotizacionesCosmetica.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesCosmetica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesCosmetica.js"   charset="UTF-8"></script>     
        ...
        <tr valign="top">
            <td style="width: 1100px" valign="top">
                <div class="titulo" style="width: 1045px">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="REGISTRO DE NOTA PEDIDO" Font-Bold="False"
                                                    ...
                                                    <td id="tdftNormal">
                                                        <table cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td style="font-weight: bold; padding-left: 32px" id="tdddlSerie">
                                                                    <div id="div_serie">
               ...
               <table cellpadding="0" cellspacing="0" align="center">
                ...
                <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 250px;
                    ...
                    <div id="div2" class="ui-jqdialog-content">
                        ...
                        <div id="div_table_almacenes" style="display:none;">
                            <div>
