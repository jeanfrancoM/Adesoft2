...
{
    public partial class RegistroFacturaMultipleFundicion : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta,ref ddlGratuito);
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref CodCtaCte, ref Motorizado,ref DistritoTrans,
                                               ref CodDistritoTrans, ref Placa, ref Marca, ref Licencia, ref Bulto, ref Peso,ref NroConductor,ref Conductor,ref CodConductor,ref Serie);
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodDocumentoVentaAnticipo = '" + item.CodDocumentoVentaAnticipo + "'";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo,ref Int32 CodigoGuia)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_SALCEDO(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                    ...
                    if (objEntidad.FlagFacturaANTIGUA == 0)
                    {
                            if (objEntidad.NotaPedido == 0)
                            {
                                if (objEntidad.FlagNotaVentaANTIGUA == 0)
                                    objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_SALCEDO(objEntidad); //Insert Normal
                                else
        ...
        public void P_FacturacionNV(Hashtable objTablaFiltro, ref GridView GrillaOC)
        {
            ...
            if (Convert.ToInt32(objTablaFiltro["Filtro_Anticipo"])==0)
                dta_consulta = objOperacion.F_DocumentoVentaCab_NVXFacturar(objEntidad);
            else
                dta_consulta = objOperacion.F_DocumentoVentaCab_FACTURAR_ANTICIPOS(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref String OrdenCompra, ref String Recepcion, ref Int32 FlagComisionable, ref Int32 CodCtaCte, ref Int32 Motorizado,ref String DistritoTrans,
                            ref Int32 CodDistritoTrans, ref String Placa, ref String Marca, ref String Licencia, ref String Bulto, ref Int32 Peso,ref String NroConductor,
                            ref String Conductor,ref Int32 CodConductor,ref Int32 Serie)
                            
        {
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    try { Placa = Convert.ToString(dta_consulta.Rows[0]["Placa"]); }
                    catch (Exception) { }
