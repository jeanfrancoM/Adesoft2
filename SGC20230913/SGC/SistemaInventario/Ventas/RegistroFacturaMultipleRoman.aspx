<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMultipleRoman.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleRoman" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleRoman.js"
        charset="UTF-8"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table>
        <tr valign="top">
                    ...
                    <div id="tabRegistro">
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                                    ...
                                                    <td id="tdftOC">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td id="tdtxtSerieOC">
                                                                    <asp:TextBox ID="txtSerieOC" runat="server" Width="40" ForeColor="Blue" Font-Names="Arial"
                                                                        Font-Bold="True"></asp:TextBox>
                                                                </td>
                                                                <td id="tdtxtNumeroOC">
                                                                    <asp:TextBox ID="txtNumeroOC" runat="server" Width="60" ForeColor="Blue" Font-Names="Arial"
                                                                        Font-Bold="True"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtSubTotal" runat="server" Width="65px" Font-Names="Arial" ForeColor="Blue"
                                                    ...
                                                    <td style="padding-left: 5PX;">
                                                        <asp:TextBox ID="txtDescuento" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True" ReadOnly="True" Text="0.00"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold; padding-left: 5px">
                                                        Igv
                                                    ...
                                                    <td style="padding-left: 5PX;">
                                                        <asp:TextBox ID="txtIgv" runat="server" Width="56px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True" ReadOnly="True" Text="0.00"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        total
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" id="trOrdenCompraPF" style="display: none">
                                                <tr>
                                                    <td id="td2">
                                                        <asp:TextBox ID="txtSerieOCPF" runat="server" Width="40" ForeColor="Blue" Font-Names="Arial"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td id="td3">
                                                        <asp:TextBox ID="txtNumeroOCPF" runat="server" Width="60" ForeColor="Blue" Font-Names="Arial"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        Placa
                                                    ...
                                                    <td id="div_Placa1">
                                                        <asp:TextBox ID="txtPlaca" runat="server" Width="81px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        KM
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="520px" Font-Names="Arial"
                                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                     <td>
                                    ...
                                    <tr>
                                        <td style="display: none">
                                           ...
                                           <tr>
                                                <td>
                                                    <asp:CheckBox ID="chkImpresion_1" runat="server" Text="Impresion" Font-Bold="True" />
                                                </td>
                                            </tr>
                                        </table>
                                        </td>                                    
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="display: none">
                                                                <asp:TextBox ID="txtDescuentoPorcentaje" runat="server" Width="40px" Font-Names="Arial"
                                                                    ForeColor="Blue" Font-Bold="True" ReadOnly="False" Text="0.00"></asp:TextBox>
                                                            </td>
                                                            <td style="display: none">
                            ...
                            <div class="linea-button">
                                ...
                                <asp:Button ID="btnNotaVenta" runat="server" Text="Proforma (F3)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                                <asp:Button ID="btnOC" runat="server" Text="Orden Compra (F4)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                                <asp:Button ID="btnCotizacion" runat="server" Text="Cotizaciones (F5)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                    Font-Names="Arial" Font-Bold="True" Width="120" />
                        ...
                        <div id="div_grvDetalleArticulo">
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                Width="1018px" OnRowDataBound="grvDetalleArticulo_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Descripcion" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfFlagGratuito" runat="server" Value='<%# Bind("FlagGratuito") %>' />
                                    ...
                                    <asp:TemplateField HeaderText="Desc." ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtDescuento" Width="40px" Font-Bold="true" Style="text-align: center;"
                                                CssClass="ccsestilo" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("Descuento") %>'
                                                onblur="F_ActualizarPrecio(this.id, 'txtDescuento'); return false;"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Importe">
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink runat="server" ID="lblImporte" Font-Underline="true" ForeColor="Blue"
                                                Style="cursor: hand" Text='<%# Bind("Importe") %>' onclick="F_Componentes(this.id); return false;"
                                                ToolTip="COMPONENTES">
                                            </asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:Button runat="server" ID="btnGratuito" Text="G" OnClientClick="F_FlagGratuito(this.id); return false;"
                                                ToolTip="Articulo Gratis" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblGratuito" Text='<%# Bind("Gratuito") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
            ...
            <td valign="top" style="width: 120px;">
                ...
                <div id="div_LineaCredito" class="ui-jqgrid ui-widget ui-widget-content ui-corner-all"
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 120px" align="right">
                                    <label id="lbLineaCredito" style="font-size: 12px">
                                        0.00</label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="right">
                                    <label id="lbLineaCreditoConsumido" style="font-size: 12px">
                                        0.00</label>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: 900; font-size: 12px">
                                    DISPONIBLE
                                </td>
                                <td style="font-weight: 900;" align="right">
                                    <label id="lbLineaCreditoDisponible" style="font-weight: bold; font-size: 12px">
                                        0.00</label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-weight: 900; width: 115px" align="right">
                                    <asp:DropDownList runat="server" ID="ddlMonedaLC">
                                        ...
                                        <Columns>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Panel ID="pnlOrdersKardex" runat="server" Style="display: none">
                                                        <asp:GridView ID="grvDetalleKardex" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                            AutoGenerateColumns="False" GridLines="None" class="GridView">
                                                            <Columns>
                                                                <asp:BoundField DataField="La Victoria" HeaderText="VICTORIA">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                ...
                                                                <asp:BoundField DataField="Villa" HeaderText="Villa">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                            </Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Código">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="lblPrecio4" runat="server" Value='<%# Bind("Precio4") %>' />
                                                    <asp:HiddenField ID="lblPrecio5" runat="server" Value='<%# Bind("Precio5") %>' />
        ...
        <div id="div_PrecioMoneda" style="padding-top: 5px;">
            <asp:GridView ID="grvPrecioMoneda" runat="server" AutoGenerateColumns="False" border="0"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Precio5" HeaderText="Precio 5">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ID">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfPrecioDsctoSinIgv" runat="server" Value='<%# Bind("PrecioDsctoSinIgv") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Numero">
                                    <ItemStyle HorizontalAlign="Right" />
    ...
    <div id="div_Editar" style="display: none;height:230px">
        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
            ...
            <table>
                <tr>
                     <td style="font-weight:bold" colspan="2" align="center">
                        <span id="MainContent_Label4" style="font-size:Large;font-weight:bold;">NO MODIFICA LAS COBRANZAS</span>
                    </td>
                </tr>
                <tr>                   
                    <td style="font-weight: bold">
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="padding-left: 18px;">
                                    <asp:TextBox ID="txtClienteEditar" runat="server" Width="355px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td id="div_lblPlaca1Editar" style="font-weight: bold;">
                                    Placa
                                </td>
                                <td id="div_Placa1Editar" style="padding-left: 1px;">
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSerieOCEdicion" runat="server" Width="40px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td>
                ...
                <tr>
                    <td style="font-weight: bold" colspan="2">
                        LAS COBRANZAS SOLO SE MODIFICARAN DEL DIA ACTUAL
                    </td>
                </tr>
            </table>
            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
    ...
    <div id="div_ComponentesPopUp" style="display: none;">
        <div id='div1' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 900px">
            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                Criterio de busqueda
            </div>
            <div class="ui-jqdialog-content" style="width: 900px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtCodigoSuperior" runat="server" Width="100px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold;">
                                        PRODUCTO
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtProductoSuperior" runat="server" Width="500px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold;">
                                        IMPORTE
                                    ...
                                    <td style="padding-left: 5px;">
                                        <asp:TextBox ID="txtImporteSuperior" runat="server" Width="70px" Font-Names="Arial"
                                            ForeColor="Blue" CssClass="Derecha" ReadOnly="True" Font-Bold="True"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtProductoComponente" runat="server" Width="668px" Font-Names="Arial"
                                            ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtStock" runat="server" Width="50px" Font-Names="Arial" ForeColor="Blue"
                                            CssClass="Derecha" Font-Bold="True" ReadOnly="True"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold;">
                                        Cantidad
                                    </td>
                                    <td style="padding-left: 5px;">
                                        <asp:TextBox ID="txtCantidadComponente" runat="server" Width="70px" Font-Names="Arial"
                                    ...
                                    <td style="padding-left: 5px;">
                                        <asp:TextBox ID="txtPrecioComponente" runat="server" Width="70px" Font-Names="Arial"
                                            ForeColor="Blue" CssClass="Derecha" Font-Bold="True"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold;">
                                        TOTAL
                                    ...
                                    <td style="padding-left: 5px;">
                                        <asp:TextBox ID="txtTotalComponente" runat="server" Width="70px" Font-Names="Arial"
                                            ForeColor="Blue" CssClass="Derecha" ReadOnly="True" Font-Bold="True"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
            ...
            <div class="linea-button">
                <asp:Button ID="btnEliminarComponente" runat="server" Text="ELIMINAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                    Font-Names="Arial" Font-Bold="True" Width="120" />
                <asp:Button ID="btnAgregarComponente" runat="server" Text="AGREGAR" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                    Font-Names="Arial" Font-Bold="True" Width="120" />
            </div>
        </div>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td style="padding-top: 5px;">
                    <div id="div_Componentes">
                        <asp:GridView ID="grvComponentes" runat="server" AutoGenerateColumns="False" border="0"
                            CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None" Width="900px">
                            <Columns>
                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:CheckBox runat="server" ID="chkEliminar" CssClass="chkDelete" Text="" />
                                ...
                                <asp:TemplateField HeaderText="Importe">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfCodDetallado" runat="server" Value='<%# Bind("CodDetallado") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
    ...
    <input id="hfCodProductoSuperior" type="hidden" value="0" />
