...
{
    public partial class RegistroFacturaMultipleRoman : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_Componentes_NET);
            CallbackManager.Register(F_EliminarSerie_Net);
            CallbackManager.Register(F_AgregarTemporal_Detallado_NET);
            CallbackManager.Register(F_EliminarDetallado_Net);
        }
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodDocumentoVenta = Codigo;
                grvDetalleAuditoria.DataSource = objOperacion.F_DOCUMENTOVENTACAB_AUDITORIA(objEntidad);
                grvDetalleAuditoria.DataBind();
        ...
        protected void grvConsultaArticulo_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    HiddenField hfPrecio4 = null;
                    HiddenField hfPrecio5 = null;
                    ...
                    hfPrecio4 = (HiddenField)(e.Row.FindControl("lblPrecio4"));
                    hfPrecio5 = (HiddenField)(e.Row.FindControl("lblPrecio5"));
                    ...
                    , hfPrecio4.Value.ToString(), hfPrecio5.Value.ToString()};
                    ddlPrecio.DataBind();
                    ...
                    if (lblCodigo.Value != "")
                    {
                        ...
                        dta_consultaarticulo.Columns.Add("La Victoria", typeof(string));
                        dta_consultaarticulo.Columns.Add("Ate", typeof(string));
                        dta_consultaarticulo.Columns.Add("Villa", typeof(string));
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ...
                                        ref ddlVendedor, ref ddlEmpleadoConsulta);
        ...
        public String F_AgregarTemporal_NET(String arg)
        {
            ...
            try
            {
                ...
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref NotaPedido, ref Descuento);
            ...
            str_resultado =
                ...
                Math.Round(Acuenta, 2).ToString() + "~" + //8
                Convert.ToInt32(NotaPedido) + "~" + //9
                Math.Round(Descuento, 2).ToString(); //10
        ...
        public String F_ActualizarDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Dscto, ref NotaPedido,  ref Descuento);
                if (grvDetalleArticulo.Rows.Count == 0)
        ...
        public String F_ReemplazarFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                if (str_mensaje_operacion == "")
                {
                    ...
                    ref NumeroDoc, ref CodVendedor, ref FechaEmision, ref FechaVencimiento, ref SerieDoc, ref MarcaVehiculo, ref DireccionTrans,
                    ref NroBultos, ref Peso, ref PlacaVehiculo,ref Observacion, ref FlagComisionable);

                    P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref AcuentaNV, ref NotaPedido, ref Descuento);
            ...
            str_resultado =
                ...
                Distrito + "~" + //11
                Direccion + "~" + //12
                CodFormaPago.ToString() + "~" + //13
                CodCliente.ToString() + "~" + //14
                CodDepartamento.ToString() + "~" + //15
                CodProvincia.ToString() + "~" + //16
                CodDistrito.ToString() + "~" + //17
                CodFacturaAnterior.ToString() + "~" + //18
                CodTransportista.ToString() + "~" + //19
                Transportista + "~" + //20
                Placa + "~" + //21
                NroLicencia + "~" + //22
                NumGuia + "~" + //23
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref SerieOC, ref NroOperacion);
        ...
        public String F_Componentes_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            ...
            try
            {
                ...
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodDetDocumentoVenta"]); 

                P_CargarGrillaTemporal_Detallado(Codigo);

                if (grvComponentes.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Componentes();

                str_grvSerieDetalle_html = Mod_Utilitario.F_GetHtmlForControl(grvComponentes);
        ...
        public String F_EliminarSerie_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvSerieDetalle_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarSerie(obj_parametros, ref MsgError);
                P_VerSeries(obj_parametros, ref grvComponentes);
                if (grvComponentes.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Componentes();
        ...
        public String F_AgregarTemporal_Detallado_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_AgregarTemporal_Detallado(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodDetDocumentoVenta"]);
                P_CargarGrillaTemporal_Detallado(Codigo);
                str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvComponentes);
        ...
        public String F_EliminarDetallado_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvConsulta_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarDetallado(obj_parametros, ref str_mensaje_operacion);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodDetDocumentoVenta"]);
                P_CargarGrillaTemporal_Detallado(Codigo);
                if (grvComponentes.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Componentes();
                str_grvConsulta_html = Mod_Utilitario.F_GetHtmlForControl(grvComponentes);
                int_resultado_operacion = 1;
            }
            catch (Exception ex)
            {
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta)
        {
        ...
        public void P_Inicializar_GrillaVacia_Articulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("Precio5", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleOC()
        {
            ...
            dta_consultadetalleoc.Columns.Add("Descuento", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_PrecioMoneda()
        {
            ...
            dta_consultapreciomoneda.Columns.Add("Precio4", typeof(string));
            dta_consultapreciomoneda.Columns.Add("Precio5", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleNV()
        {
            ...
            dta_consultadetallenv.Columns.Add("Descuento", typeof(string));
            ...
            dta_consultadetallenv.Columns.Add("PrecioDsctoSinIgv", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetalleCT()
        {
            ...
            dta_consultadetalleCT.Columns.Add("Descuento", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Componentes()
        {
            ...
            dta_consultadetalleoc.Columns.Add("CodigoProducto", typeof(string));
            dta_consultadetalleoc.Columns.Add("Producto", typeof(string));
            dta_consultadetalleoc.Columns.Add("Cantidad", typeof(string));
            dta_consultadetalleoc.Columns.Add("UM", typeof(string));
            dta_consultadetalleoc.Columns.Add("Precio", typeof(string));
            dta_consultadetalleoc.Columns.Add("Importe", typeof(string));
            dta_consultadetalleoc.Columns.Add("CodDetallado", typeof(string));
            dta_consultadetalleoc.Columns.Add("CodProducto", typeof(string));
            ...
            grvComponentes.DataSource = dta_consultadetalleoc;
        ...
        public void P_CargarGrillaTemporal(Hashtable objTablaFiltro, Int32 Codigo, ref GridView grvDetalle,
            ref Decimal SubTotalFactura, ref Decimal IgvFactura, ref Decimal TotalFactura, ref Decimal Acuenta, ref Int32 NotaPedido, ref Decimal Descuento)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dta_consulta.Rows.Count > 0)
            {
                if (Convert.ToInt32(objTablaFiltro["Filtro_NotaPedido"]) == 1)
                {
                    for (int j = 0; j < dta_consulta.Rows.Count; j++)
                    {
                        if (Convert.ToDecimal(dta_consulta.Rows[j]["CodTipoProducto"]) == 1 & Convert.ToDecimal(dta_consulta.Rows[j]["FlagGratuito"]) == 0)
                        {
                            TotalFactura += Convert.ToDecimal(dta_consulta.Rows[j]["Importe"]);
                            Descuento += Convert.ToDecimal(dta_consulta.Rows[j]["DescuentoTotal"]);
                        }
                    }
                }
                else
                {
                    for (int j = 0; j < dta_consulta.Rows.Count; j++)
                    {
                        if (Convert.ToDecimal(dta_consulta.Rows[j]["FlagGratuito"]) == 0)
                        {
                            TotalFactura += Convert.ToDecimal(dta_consulta.Rows[j]["Importe"]);
                            Acuenta += Convert.ToDecimal(dta_consulta.Rows[j]["Acuenta"]);
                            Descuento += (Convert.ToDecimal(dta_consulta.Rows[j]["DescuentoTotal"])/ Convert.ToDecimal(objTablaFiltro["Filtro_TasaIgvDscto"]));
                        }
                    }
                }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo)
        {
            ...
            objEntidad.SerieOC = Convert.ToString(objTablaFiltro["Filtro_SerieOCPF"]);
            objEntidad.NumeroOC = Convert.ToString(objTablaFiltro["Filtro_NumeroOCPF"]);
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 5: //Orden de Compra
                    ...
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Roman(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
                ...
                default: //Facturas y Boletas                  
                    if (objEntidad.NotaPedido == 0)
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_Roman(objEntidad); //Insert Normal                           
                    else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NV_Roman(objEntidad);
        ...
        public void P_AnularRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objEntidad.CodUsuario = Convert.ToInt32((Session["CodUsuario"]));
            objEntidad.CodAlmacen = Convert.ToInt32(Session["CodSede"]);
            objEntidad.ObservacionAnulacion = Convert.ToString(objTablaFiltro["Filtro_Observacion"]);
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_TemporalFacturacionDet_Update_Roman(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        ref String Transportista, ref String Placa, ref String NroLicencia, ref String NumGuia, ref String Destino,ref String FechaTraslado,
        ref String NumeroDoc, ref Int32 CodVendedor, ref String FechaEmision, ref String FechaVencimiento, ref String SerieDoc,ref String MarcaVehiculo,
        ref String DireccionTrans, ref String NroBultos, ref String Peso, ref String PlacaVehiculo, ref String Observacion, ref int FlagComisionable)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            if (dtTabla.Rows.Count > 0)
            {
                ...
                FlagComisionable = Convert.ToInt32(dtTabla.Rows[0]["FlagComisionable"]);
        ...
        public void P_VerSeries_Factura(Hashtable objTablaFiltro, ref GridView GrillaSeries)
        {
            ...
            objEntidad = new DocumentoVentaDetCE();
            objEntidad.CodDetDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodDetalle"]);

            objOperacion = new DocumentoVentaDetCN();

            DataTable dta_consulta = null;

            dta_consulta = objOperacion.F_DocumentoVentaSerializacionDet_Listar(objEntidad);

            GrillaSeries.DataSource = dta_consulta;
            GrillaSeries.DataBind();

        }

        public void P_EliminarSerie(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodTemporalSerializacionDet = Convert.ToInt32(objTablaFiltro["Filtro_CodTemporalSerializacionDet"]);
            objEntidad.CodDetDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodDetDocumentoVenta"]);
            objEntidad.Flag = 1;

            objOperacion = new DocumentoVentaDetCN();

            objOperacion.F_TemporalFacturacionSerializacionDet_Eliminar(objEntidad);

            MsgError = objEntidad.MsgError;

        }

        public void P_VerSeries(Hashtable objTablaFiltro, ref GridView GrillaSeries)
        {
            ...
            dta_consulta = objOperacion.F_TemporalFacturacionSerializacionDet_Listar(objEntidad);
        ...
        public void P_AgregarTemporal_Detallado(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            objEntidad.CodDetDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodDetDocumentoVenta"]);
            objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodDocumentoVenta"]);
            objEntidad.CodProductoSuperior = Convert.ToInt32(objTablaFiltro["Filtro_CodProductoSuperior"]);
            objEntidad.CodArticulo = Convert.ToInt32(objTablaFiltro["Filtro_CodArticulo"]);
            objEntidad.Cantidad = Convert.ToDecimal(objTablaFiltro["Filtro_Cantidad"]);
            objEntidad.CodUndMedida = Convert.ToInt32(objTablaFiltro["Filtro_CodUndMedida"]);
            objEntidad.Precio = Convert.ToDecimal(objTablaFiltro["Filtro_Precio"]);
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]); 

            objOperacion = new DocumentoVentaCabCN();

            MsgError = objOperacion.F_TemporalFacturacionDetallado_Insert(objEntidad).MsgError;
        }

        public void P_CargarGrillaTemporal_Detallado(Int32 Codigo)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            objEntidad.CodDetDocumentoVenta = Codigo;

            dta_consulta = objOperacion.F_TemporalFacturacionDetallado_Listar(objEntidad);

            grvComponentes.DataSource = dta_consulta;
            grvComponentes.DataBind();
        }

        public void P_EliminarDetallado(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            {
                XmlDetalle = XmlDetalle + "<D ";
                XmlDetalle = XmlDetalle + " CodDetallado = '" + item.CodDetallado + "'";
                XmlDetalle = XmlDetalle + " />";
            }
            ...
            objOperacion.F_TemporalFacturacionDetallado_Eliminar(objEntidad);
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                    ...
                    ref String OrdenCompra, ref String Recepcion, ref Int32 FlagComisionable, ref String SerieOC, ref String NroOperacion)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
