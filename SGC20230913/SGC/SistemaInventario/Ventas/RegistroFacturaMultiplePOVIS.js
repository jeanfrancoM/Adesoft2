var AppSession = "../Ventas/RegistroFacturaMultiplePovis.aspx";
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        $('.ccsestilo').css('background', '#FFFFE0');               
                        F_Mostrar_CorrelativoVarios_Inicio(16);                     
...
function F_AgregarTemporalCTxNumero() {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'RegistroFacturaMultiplePOVIS.aspx/F_ObtenerCotizacion_PorNumero_Net',
        dataType: "json",
...
function F_AgregarTemporalCTxNumero_PEDIDO() {
    ...
    $.ajax({
        ...
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'RegistroFacturaMultiplePOVIS.aspx/F_ObtenerOrdenPedido_PorNumero_Net',
        dataType: "json",
                   ...
                   return false;
                    ...
                    $.each(data.lOrdenPedidoDet, function (index, item) {
                        var objDetalle = {
                            CodArticulo: item.CodArticulo,
                            Cantidad: item.Cantidad,
                            Precio: item.PrecioOriginal / tasaigv,
                            PrecioDscto: item.Precio / tasaigv,
                            Costo: 0,
                            CodUm: item.CodUnidadMedida,
                            CostoUnitario: 0,
