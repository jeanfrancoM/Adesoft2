var AppSession = "../Ventas/RegistroFacturaMultipleTractos.aspx";
    ...
    $("#MainContent_txtDireccionTransportistaEdicion").bind("propertychange change keyup paste input", function(){
        ...
        if ($("#MainContent_txtNroRucTransportista").val() != $("#hfNroRucTransportista").val() & $("#hfCodCtaCteTransportista").val() != '0')
        {
            ...
            if ( Index ==-1 ) {} else {
                if (Cliente.split('-')[0].trim() === "55555555555")
                return true;}
                var nroruc = $("#hfNroRucTransportista").val();
    ...
    try 
        {        
            ...
            var Cadena = 'Ingresar los sgtes. Datos:'; 
             ...
             if ($(Cuerpo + 'txtNroOperacion').val()==''  & ($(Cuerpo + 'ddlFormaPago').val()==5 |$(Cuerpo + 'ddlFormaPago').val()== 10 | $(Cuerpo + 'ddlFormaPago').val()==6 |$(Cuerpo + 'ddlFormaPago').val()==15 ))
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var objParams = {
                      ...
                      Filtro_Placa:$('#MainContent_txtPlacaTrasladoEdicion').val(),
