...
{
    public partial class RegistroCotizaciones : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_LlenarGridDetalleNI_NET);
            ...
            CallbackManager.Register(F_EditarGratuito_NET);
            CallbackManager.Register(F_Observacion_NET);
            CallbackManager.Register(F_Auditoria_NET);
            CallbackManager.Register(F_EliminarTemporalPedido_NET);
            CallbackManager.Register(F_ActualizarPrecioPedido_Net);
            CallbackManager.Register(F_AgregarTemporalPedido_NET);
            CallbackManager.Register(F_LlenarGridDetalleNICab_NET);
            CallbackManager.Register(F_PermisoObservacion_NET);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            P_Inicializar_GrillaVacia_Deudas();
            P_Inicializar_GrillaVacia_DetallePedido();
            P_Inicializar_GrillaVacia_ConsultaNI();
            Session["datos"] = true;
        }
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                GridView grvDetalleNI = null;
                GridView grvPermisoObservacion = null;
                ...
                grvDetalleNI = (GridView)(e.Row.FindControl("grvDetalleNI"));
                ...
                grvPermisoObservacion = (GridView)(e.Row.FindControl("grvPermisoObservacion"));
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    grvPermisoObservacion.DataSource = dta_consultaarticulo;
                    grvPermisoObservacion.DataBind();
                }
            }
        }
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodProforma = Codigo;
                grvDetalle.DataSource = objOperacion.F_ProformaDet_Listar(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_LlenarGridDetalleNI_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            ...
            try
            {
                ...
                //Obtengo el Grid para llenarlo y dibujarlo
                GridView grvDetalleNI = (GridView)grvConsulta.Rows[0].FindControl("grvDetalleNI");
                ...
                grvDetalleNI.DataSource = objOperacion.F_ProformaDet_ListarDetNI(objEntidad);
                grvDetalleNI.DataBind();

                

                //se crea el html a partir del grid llenado
                str_grv_Detalle_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleNI);
        ...
        public String F_LlenarGridDetalleNICab_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            ...
            try
            {
                ...
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodProforma"]);
                //CodTipoDoc = Convert.ToInt32(obj_parametros["Filtro_CodTipoDoc"]);
                ...
                grvNotaIngreso.DataSource = objOperacion.F_ProformaCab_ListarNI(objEntidad);
                grvNotaIngreso.DataBind();

                if (grvNotaIngreso.Rows.Count == 0)
                {
                    str_mensaje_operacion = "LA PROFOMA NO TIENE NOTA DE INGRESOS ASOCIADAS O ESTAS YA HAN SIDO ANULADAS";
                }

                //se crea el html a partir del grid llenado
                str_grv_Detalle_html = Mod_Utilitario.F_GetHtmlForControl(grvNotaIngreso);
        ...
        public static DocumentoVentaCabCE P_AnularNotaIngreso(int CodNotaIngreso, string Observacion)
        {

            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            objEntidad = new DocumentoVentaCabCE();
            objEntidad.CodDocumentoVenta = CodNotaIngreso;
            objEntidad.CodUsuario = int.Parse(HttpContext.Current.Session["CodUsuario"].ToString());
            objEntidad.Observacion = Observacion;
            objOperacion = new DocumentoVentaCabCN();
            objEntidad = objOperacion.F_CotizacionCab_AnularIngreso(objEntidad);
        ...
        protected void grvConsultaArticulo_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    Label hlkCodNeumaticoGv = null;
                    Label lblstock = null;

                    hlkCodNeumaticoGv = (Label)(e.Row.FindControl("hlkCodNeumaticoGv"));
                    lblstock = (Label)(e.Row.FindControl("lblstock"));

                    //if (Convert.ToDecimal(lblstock.Text) <= 0)
                    //{
                    //    lblstock.ForeColor = System.Drawing.Color.Red;
                    //    hlkCodNeumaticoGv.ForeColor = System.Drawing.Color.Red;
                    //}
                    //else
                    //{
                    //    lblstock.ForeColor = System.Drawing.Color.Black;
                    //    hlkCodNeumaticoGv.ForeColor = System.Drawing.Color.Black;
                    //}
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv,
                                        ref ddlEstado, ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlGratuito, ref ddlMonedaEdicion,
                    ref ddlCompraEdicion, ref ddlFamiliaEdicion);
                ...
                str_ddlGratuito_html = Mod_Utilitario.F_GetHtmlForControl(ddlGratuito);
            ...
            str_ddlGratuito_html + "~" + //17
            Session["IdAlmacen"].ToString() + "~" + //18
            str_ddl_monedaedicion_html + "~" + //19
            str_ddl_umcompraedicion_html + "~" + //20
            str_ddl_familiaedicion_html; //21
        ...
        public String F_AgregarTemporal_NET(String arg)
        {
            ...
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            String str_grvDetallePedido_html = "";
            int int_resultado_operacion = 0;
            int Codigo = 0;
            int CodProformaAnterior = 0;
            //int FlagReemplazo = 0;
            Decimal Total = 0;
            Decimal SubTotal = 0;
            Decimal Igv = 0;
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                CodProformaAnterior = Convert.ToInt32(obj_parametros["Filtro_CodFacturaAnterior"]);                
                ...
                //FlagReemplazo = Convert.ToInt32(obj_parametros["Filtro_FlagReemplazo"]);
                //P_CargarGrillaTemporalPedido(Codigo, CodProformaAnterior, FlagReemplazo, ref grvDetallePedido);
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Detalle();
                //if (grvDetallePedido.Rows.Count == 0)
                //    P_Inicializar_GrillaVacia_DetallePedido();
                str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleArticulo);
                //str_grvDetallePedido_html = Mod_Utilitario.F_GetHtmlForControl(grvDetallePedido);
            ...
            str_resultado =
                ...
                + "~" +
                str_grvDetallePedido_html;

            return str_resultado;
        }

        public String F_AgregarTemporalPedido_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            try
            {
                ...
                CodProformaAnterior = Convert.ToInt32(obj_parametros["Filtro_CodFacturaAnterior"]);
                P_AgregarTemporalPedido(obj_parametros, ref MsgError);
                FlagReemplazo = Convert.ToInt32(obj_parametros["Filtro_FlagReemplazo"]);
                P_CargarGrillaTemporalPedido(Codigo, CodProformaAnterior, FlagReemplazo, ref grvDetallePedido);     
                if (grvDetallePedido.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_DetallePedido();
        ...
        public String F_EliminarTemporalPedido_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";            
            String str_grvDetallePedido_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_EliminarTemporalPedido(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                CodProformaAnterior = Convert.ToInt32(obj_parametros["Filtro_CodFacturaAnterior"]);
                FlagReemplazo = Convert.ToInt32(obj_parametros["Filtro_FlagReemplazo"]);
                P_CargarGrillaTemporalPedido(Codigo, CodProformaAnterior, FlagReemplazo, ref grvDetallePedido);
        ...
        public String F_ActualizarPrecioPedido_Net(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetallePedido_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_ActualizarCantidadPedido(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                CodProformaAnterior = Convert.ToInt32(obj_parametros["Filtro_CodFacturaAnterior"]);
                FlagReemplazo = Convert.ToInt32(obj_parametros["Filtro_FlagReemplazo"]);
                P_CargarGrillaTemporalPedido(Codigo, CodProformaAnterior, FlagReemplazo, ref grvDetallePedido);
                ...
                if (MsgError != "Cantidades actualizadas correctamente" || MsgError!="Todas las cantidades no pueden ser 0, si ya no desea este item eliminelo")
                {
                    int_resultado_operacion = 0;
                    str_mensaje_operacion = MsgError;
                }
        ...
        public String F_EditarGratuito_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Actualizar_Gratuito(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref NotaPedido);
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Detalle();
        ...
        public void P_CargarGrillaTemporalPedido(Int32 Codigo, Int32 CodProformaAnterior, Int32 FlagReemplazo, ref GridView grvDetallePedido)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            objEntidad.CodDocumentoVenta = Codigo;
            objEntidad.CodFacturaAnterior = CodProformaAnterior;
            objEntidad.Flag = FlagReemplazo;

            dta_consulta = objOperacion.F_TemporalFacturacionDetPedido_Listar(objEntidad);

            grvDetallePedido.DataSource = dta_consulta;
            grvDetallePedido.DataBind();
        }
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_Gratuito, ref DropDownList ddl_combomonedaedicion, ref DropDownList ddl_combocompraedicion, ref DropDownList ddl_combofamiliaedicion)
        {
            ...
            dta_consulta = null;
            objEntidadConceptosDet.CodConcepto = 15;
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);

            ddl_Gratuito.Items.Clear();

            ddl_Gratuito.DataSource = dta_consulta;
            ddl_Gratuito.DataTextField = "DscAbvConcepto";
            ddl_Gratuito.DataValueField = "CodConcepto";
            ddl_Gratuito.DataBind();
            ...
            LGFamiliasCN objOperacionFamilia = null;

            objOperacionFamilia = new LGFamiliasCN();

            dta_consulta = objOperacionFamilia.F_LGFamilias_Listar();
            ...
            ddl_combofamiliaedicion.Items.Insert(0, new ListItem("--Todos--", "0"));
        }
        ...
        public void P_Inicializar_GrillaVacia_Articulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("ExclusivoEdicion", typeof(string));
            dta_consultaarticulo.Columns.Add("Exclusivo", typeof(string));
            dta_consultaarticulo.Columns.Add("LimiteMayorista", typeof(string));
            dta_consultaarticulo.Columns.Add("CantidadMayorista", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("CodNotaIngresos", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_ConsultaNI()
        {
            DataTable dta_consulta = null;
            DataRow dtr_filaconsulta = null;
            ...
            dta_consulta.Columns.Add("CodMovimiento", typeof(string));
            dta_consulta.Columns.Add("NroNotaIngreso", typeof(string));                    
            dta_consulta.Columns.Add("APartida", typeof(string));
            ...
            grvNotaIngreso.DataSource = dta_consulta;
            grvNotaIngreso.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("CodGratuito", typeof(string));
            dta_consultadetalle.Columns.Add("Exclusivo", typeof(string));
            dta_consultadetalle.Columns.Add("Costo", typeof(string));
            dta_consultadetalle.Columns.Add("LimiteMayorista", typeof(string));
            dta_consultadetalle.Columns.Add("CantidadMayorista", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_DetallePedido()
        {
            DataTable dta_consultadetalle = null;
            DataRow dtr_filadetalle = null;
            ...
            dta_consultadetalle.Columns.Add("CodigoProducto", typeof(string));
            dta_consultadetalle.Columns.Add("CodDetPedido", typeof(string));
            dta_consultadetalle.Columns.Add("CodArticulo", typeof(string));
            dta_consultadetalle.Columns.Add("CodDetDocumentoVenta", typeof(string));
            dta_consultadetalle.Columns.Add("CodDocumentoVenta", typeof(string));
            dta_consultadetalle.Columns.Add("Producto", typeof(string));
            dta_consultadetalle.Columns.Add("UM", typeof(string));      
            dta_consultadetalle.Columns.Add("Cantidad173", typeof(string));
            dta_consultadetalle.Columns.Add("Cantidad250", typeof(string));
            dta_consultadetalle.Columns.Add("CantidadABC", typeof(string));
            dta_consultadetalle.Columns.Add("Cantidad", typeof(string));
            ...
            grvDetallePedido.DataSource = dta_consultadetalle;
            grvDetallePedido.DataBind();
        }
        ...
        public void P_Inicializar_GrillaVacia_Deudas()
        {
            DataTable dta_consultadetallenv = null;
            DataRow dtr_filadetalle = null;
            ...
            dta_consultadetallenv.Columns.Add("Almacen", typeof(string));
            dta_consultadetallenv.Columns.Add("NroDocumento", typeof(string));
            dta_consultadetallenv.Columns.Add("Ruc", typeof(string));
            dta_consultadetallenv.Columns.Add("RazonSocial", typeof(string));
            dta_consultadetallenv.Columns.Add("Emision", typeof(string));
            dta_consultadetallenv.Columns.Add("Vencimiento", typeof(string));
            dta_consultadetallenv.Columns.Add("Retraso", typeof(string));
            dta_consultadetallenv.Columns.Add("MontoDeudaSoles", typeof(string));
            dta_consultadetallenv.Columns.Add("Vendedor", typeof(string));
            ...
            grvDetalleDeudas.DataSource = dta_consultadetallenv;
            grvDetalleDeudas.DataBind();
        }
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            objEntidad.CodTipoOperacion = Convert.ToInt32(objTablaFiltro["Filtro_TipoOperacion"]);                          
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " Exclusivo = '" + item.Exclusivo + "'";
                ...
                XmlDetalle = XmlDetalle + " Cantidad173 = '" + item.Cantidad173 + "'";
                XmlDetalle = XmlDetalle + " Cantidad250 = '" + item.Cantidad250 + "'";
                XmlDetalle = XmlDetalle + " CantidadABC = '" + item.CantidadABC + "'";
        ...
        public void P_AgregarTemporalPedido(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaCabCE objEntidad = null;
            DocumentoVentaCabCN objOperacion = null;
            ...
            objOperacion.F_TemporalFacturacionDetPedido_Insert(objEntidad);
        ...
        public void P_EliminarTemporalPedido(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            {
                XmlDetalle = XmlDetalle + "<D ";
                XmlDetalle = XmlDetalle + " CodPedido = '" + item.CodPedido + "'";
                XmlDetalle = XmlDetalle + " />";
            }
            ...
            objOperacion.F_TemporalFacturacionDetPedido_Eliminar(objEntidad);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadProforma.flagCodigo = Convert.ToInt32(objTablaFiltro["Filtro_Codigo"]);
            ...
            objEntidadProforma.Gratuito = Convert.ToDecimal(objTablaFiltro["Filtro_Gratuito"]);
            ...
            objEntidadProforma.Observacion = Convert.ToString(objTablaFiltro["Filtro_Observacion"]);
            ...
            objEntidadProforma.UsuarioPermiso = Convert.ToString(objTablaFiltro["Filtro_UsuarioPermiso"]);
            objEntidadProforma.ClavePermiso = Convert.ToString(objTablaFiltro["Filtro_ClavePermiso"]);
            objEntidadProforma.ObservacionPermiso = Convert.ToString(objTablaFiltro["Filtro_ObservacionPermiso"]);

            if (objEntidadProforma.CodProformaAnterior > 0)
            {
                objEntidadProforma.NumeroAnterior = objEntidadProforma.Numero;
                objOperacionProforma.F_Proformas_Insert_Edicion_Alvarado(objEntidadProforma);
            }
            else
            {
                objOperacionProforma.F_Proformas_Insert_Alvarado(objEntidadProforma);
            }              
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_ProformaCab_Listar(objEntidad);
        ...
        public void P_ActualizarCantidadPedido(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            objEntidad.CodDetPedido = Convert.ToInt32(objTablaFiltro["Filtro_CodDetPedido"]);
            objEntidad.Cantidad173 = Convert.ToInt32(objTablaFiltro["Filtro_Cantidad173"]);
            objEntidad.Cantidad250 = Convert.ToInt32(objTablaFiltro["Filtro_Cantidad250"]);
            objEntidad.CantidadABC = Convert.ToInt32(objTablaFiltro["Filtro_CantidadABC"]);

            objOperacion = new DocumentoVentaDetCN();

            objOperacion.F_TemporalFacturacionDetPedido_Update(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_Actualizar_Gratuito(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            objEntidad.CodDetDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodDetDocumentoVenta"]);
            objEntidad.CodGratuito = Convert.ToInt32(objTablaFiltro["Filtro_CodGratuito"]);

            objOperacion = new DocumentoVentaDetCN();

            objOperacion.F_TemporalFacturacionDet_Actualizar_Gratuito(objEntidad);
        ...
        public String F_PermisoObservacion_NET(String arg)
        {
            int int_resultado_operacion = 0;
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String grvNombre = "";
            String grvPermisoObservacion_html = "";
            int Col = 0;
            int Codigo = 0;
            Hashtable obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
            ...
            try
            {
                ...
                GridView grvPermisoObservacion = (GridView)grvConsulta.Rows[0].FindControl("grvPermisoObservacion");

                ProformaCabCN objOperacion = new ProformaCabCN();
                ProformaCabCE objEntidad = new ProformaCabCE();

                objEntidad.Codigo = Codigo;
                grvPermisoObservacion.DataSource = objOperacion.F_PROFORMACAB_PERMISOOBSERVACION(objEntidad);
                grvPermisoObservacion.DataBind();

                grvPermisoObservacion_html = Mod_Utilitario.F_GetHtmlForControl(grvPermisoObservacion);
            }
            catch (Exception exxx)
            {
                str_resultado = "ERROR AL BUSCAR DETALLE: " + exxx;
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CantidadMayoristaLimite = Convert.ToInt32(objTablaFiltro["Filtro_Limite"]);
            objEntidad.CantidadMayorista = Convert.ToDecimal(objTablaFiltro["Filtro_Cantidad"]);
            objEntidad.IdImagenProducto1 = Convert.ToInt32(objTablaFiltro["Filtro_IdImagenProducto1"]);           
            objEntidad.PermisoMayorista = Convert.ToInt32(objTablaFiltro["Filtro_PermisoMayorista"]);
            objEntidad.CodigoMenu = Convert.ToInt32(objTablaFiltro["Filtro_CodigoMenu"]);
            objEntidad.ProductoNuevo = Convert.ToInt32(objTablaFiltro["Filtro_ProductoNuevo"]);
            objEntidad.Imagenes = Newtonsoft.Json.JsonConvert.DeserializeObject(objTablaFiltro["Filtro_Imagenes"].ToString());
            objEntidad.Exclusivo = Convert.ToDecimal(objTablaFiltro["Filtro_Exclusivo"]);

            objOperacion = new LGProductosCN();

            //DataTable dta_tableAlmacenesExternos = (new TCAlmacenCN()).F_TCAlmacenesExternos_Listar_Parametros_Conexion();
            if (objEntidad.CodProducto == 0)
            {
                objOperacion.F_LGProductos_Insert_Alvarado(objEntidad, "", "", "", "", "", "");
            }
            else
            {
