...
{
    public partial class RegistroNotaCreditoRoman : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlSerie, ref ddlSerieConsulta, ref ddlTipoOperaciones, ref ddlIgv,
                    ref ddlFormaPago, ref ddlTipoDocumento, ref ddlCajaFisica, ref ddlEmpleadoConsulta);
        ...
        public String F_Auditoria_NET(String arg)
        {
            ...
            try
            {
                ...
                grvAuditoria.DataSource = objOperacion.F_DOCUMENTOVENTACAB_AUDITORIA(objEntidad);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda,
            ...
            ref DropDownList ddl_CajaFisica, ref DropDownList ddl_empleadoconsulta)                                            
        {
            DataTable dta_consulta = null;
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("PrecioDesc", typeof(string));
