var AppSession = "../Ventas/RegistroFacturaMultiple.aspx";
...
$(document).ready(function () {
    ...
    $('#MainContent_txtNroRuc').autocomplete({
        ...
        select: function (e, i) {
            ...
            if($('#hfCodCategoria').val()!=CodCategoria){
            F_NuevoCliente();
            }
            
            CodCategoria=$('#hfCodCategoria').val();
        },
        complete: function () {
...
//            F_BuscarDireccionesTransportistaEdicion();
        ...
        complete: function () {
            $('#MainContent_txtNroRucTransportista').val($('#hfNroRucTransportista').val());
            $('#MainContent_txtNuBultosEdicion').focus();
        },
        minLength: 3
    });
    ...
    $("#MainContent_txtDireccionTransportistaEdicion").bind("propertychange change keyup paste input", function(){
        if ($("#MainContent_txtDistritoTransportistaEdicion").val() != $("#hfDistritoTransportista").val() & $("#hfCodDistritoTransportista").val() != '0')
        {
...
//            $('#MainContent_txtDestino').val('');
     ...
     $('#MainContent_txtConductorDNIEdicion').blur(function () {

        var ConductorEncontrado = false;
        if ($('#hfDniConductor').val() != "0" & $('#hfNombreConductor').val() == "" & $('#MainContent_txtConductorRazonSocialEdicion').val() == "" &
                $('#MainContent_txtConductorDNIEdicion').val().length > 8 & $('#MainContent_txtConductorDNIEdicion').val() == $('#hfDniConductor').val()) 
        {
            ConductorEncontrado = true;
            ...
            if (Index == -1) { } else {
                ...
                var Datos = $('#MainContent_txtConductorDNIEdicion').val().split('-');

                $('#hfDniConductor').val(Datos[0].trim());
                $('#MainContent_txtConductorDNIEdicion').val(Datos[0].trim());
                $('#hfNombreConductor').val(Datos[1].trim());
                $('#MainContent_txtConductorRazonSocialEdicion').val(Datos[1].trim());
        ...
        if ($('#MainContent_txtConductorDNIEdicion').val().trim() != "")
        if (!F_ValidarDniConductor()) {
            $('#hfCodConductor').val('0');
            $('#hfDniConductor').val('');
            $('#MainContent_txtConductorDNIEdicion').select;
            $('#hfNombreConductor').val('');
            $('#MainContent_txtConductorRazonSocialEdicion').val('');
        }
        return false;
...
//            $('#MainContent_chkSinIgvMaestro').prop('disabled',true);
    ...
    $('#MainContent_btnEliminar').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
        if (F_PermisoOpcion(CodigoMenu, 4000210, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac]
        try {
    ...
    $('#MainContent_btnComision').click(function () {
    if (!F_SesionRedireccionar(AppSession)) return false;
     try 
        {
          F_ReporteComision();
...
//       
    ...
    $('#MainContent_btnGrabarEdicion').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;   
        try {
            if (confirm("ESTA SEGURO DE LA ACTUALIZACION"))
                F_EditarGratuito();
            return false;
        }
        catch (e) {
    ...
    $('#MainContent_txtCliente').blur(function () {
        try 
        {
            ...
            if ( Index ==-1 ) {} else {
                if ($("#MainContent_txtCliente").val() != '---NUEVO CLIENTE---' & $('#hfCodCtaCte').val()>0)
                {
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") 
                    {
                        ...
                        F_Update_Division_HTML('div_DetalleDeudas', result.split('~')[25]);
                        F_Update_Division_HTML('div_Gratuito', result.split('~')[26]);
                        F_Update_Division_HTML('div_VendedorEdicion', result.split('~')[27]);
                        ...
                        $('#MainContent_ddlFormaPago').css('background', '#FFFFE0');
                        $('#MainContent_txtConductorDNI').prop("disabled", true);
                        $('#MainContent_txtComisionTarjeta').prop("disabled", true);
                        ...
                        $('#MainContent_txtCantidadMayorista').css('background', '#FFFFE0');
                        ...
                        $('#lblComisionTarjeta').text('Total Tarjeta (+ ' + result.split('~')[28] + '%)'); 
                        ComisionTarjeta = result.split('~')[28];
                        //trasnportista
            //            $('#MainContent_txtDestino').val('') ;
            $('#MainContent_txtNumeroGuia').val('');
//            $('#MainContent_txtDestino').val('');
...
function F_AgregarArticulo(ControlID, DirectoBoton) {
    ...
    var CantidadMayorista_grilla = '';
    var limiteMayorista_grilla = '';
    var lblexclusivo_grilla = '';
    var cadena = 'Ingrese los sgtes. campos: '
    ...
    hfLimiteMayorista_grilla = imgAgregar_grilla.replace('imgAgregar', 'hfLimiteMayorista');
    hfCantidadMayorista_grilla = imgAgregar_grilla.replace('imgAgregar', 'hfCantidadMayorista');
    ...
    $('#hfLimiteMayorista').val($(hfLimiteMayorista_grilla).val());
    $('#hfCantidadMayorista').val($(hfCantidadMayorista_grilla).val());
    $('#MainContent_txtPrecioMayorista').val($(hfPrecio3_grilla).val());
    $('#MainContent_txtCantidadMayorista').val($(hfCantidadMayorista_grilla).val());
    $('#hfPrecio1').val($(hfPrecio1_grilla).val());
...
function F_FormaPago(CodFormaPago){ 
 var arg;
    try 
    {
             if (CodFormaPago == 1 | CodFormaPago == 5 | CodFormaPago == 6 | CodFormaPago == 10 |  CodFormaPago == 15)
                    $('#MainContent_txtAcuenta').val(parseFloat($('#MainContent_txtTotal').val()) - parseFloat($('#MainContent_txtAcuentaNV').val()).toFixed(2));
             else
                    $('#MainContent_txtAcuenta').val('0.00');
             ...
             if (CodFormaPago==10)
             {
                $('#MainContent_txtComisionTarjeta').prop('disabled',false);
                $('#MainContent_txtComisionTarjeta').val(parseFloat($('#MainContent_txtTotal').val() * (1 + ComisionTarjeta/100)).toFixed(2));
             }
             else
             {
                $('#MainContent_txtComisionTarjeta').prop('disabled',true);
...
function F_AgregarTemporal() {
    ...
    try {
        ...
        var tasaigv = 1;
        var FlagIgv = 0;
        var Precio2 = $("#hfMenorPrecioAgregar").val();
...
//        }
        ...
        Exclusivo: parseFloat($('#MainContent_txtExclusivo').val()) / tasaigv,
...
//        if ($(hfCodGratuito).val()==1)
            Total += parseFloat($(lblimporte).text());
//        else 
//            Gratuito += parseFloat($(lblimporte).text());
    });
...
//$(Cuerpo + 'txtGratuito').val(Gratuito.toFixed(2));
    ...
    try 
        {        
            ...
            var Cadena = 'Ingresar los sgtes. Datos:'; 
             ...
             if ($.trim($(Cuerpo + 'txtCliente').val())=='---NUEVO CLIENTE---')
                    Cadena=Cadena + '<p></p>' + 'Cliente No Valido';

             if ( $.trim($(Cuerpo + 'txtCliente').val()) =='')
                    Cadena=Cadena + '<p></p>' + 'Cliente';
             ...
             if ($(Cuerpo + 'txtNroOperacion').val().trim()==''  & ($(Cuerpo + 'ddlFormaPago').val()== 10 | $(Cuerpo + 'ddlFormaPago').val()==6 ))
              ...
              //si es electronica
                ...
                if (($(Cuerpo + 'chkGuia').is(':checked')) && ($(Cuerpo + 'txtNuBultos').val() === "") && SerieGuia === "T")
                    Cadena = Cadena + '<p></p>' + 'Nro. Bultos';      
                        ...
                        if (($(Cuerpo + 'chkGuia').is(':checked')) && ($(Cuerpo + 'txtPeso').val() === "") && SerieGuia === "T")
           ...
           $('#MainContent_grvDetalleArticulo .chkDelete :checkbox').each(function () {
               chkSi = '#' + this.id;
               Acuenta+=parseFloat($(chkSi.replace('chkEliminar', 'hfAcuenta')).val());          
           });

           if (parseFloat(Acuenta)==parseFloat($(Cuerpo + 'txtTotal').val()) & $("#MainContent_ddlFormaPago").val() != 1)
               Cadena=Cadena + '<p></p>' + 'ESTE DOCUMENTO SOLO PUEDO SER AL CONTADO, LA NV ESTA CANCELADA';
...
function F_GrabarDocumento(){
  try 
        ...
        if ($('#MainContent_txtComisionTarjeta').val() != '')
            ComisionTarjetaFinal = $('#MainContent_txtComisionTarjeta').val();
        ...
        var FlagComisionable = 0; if ($('#MainContent_chkComisionable').is(':checked')) {FlagComisionable = 1; };
         if ($(Contenedor + 'chkConCodigo').is(':checked'))
                FlagConCodigo='1';
        ...
        var objParams = {
            ...
            Filtro_DireccionTransportista: $('#MainContent_txtDireccionTransportista').val(),

            Filtro_CodTransportista: $('#hfCodCtaCteTransportista').val(),
...
function F_Nuevo(){
    $('#MainContent_ddlTipoDoc').prop('disabled', false);
       ...
       $('#MainContent_chkConCodigo').prop('checked', false);
       ...
       $('#hfSaldoCreditoFavor').val("0.00");
       $('#txtSaldoCreditoFavor').text("S/ 0.00");
       $("#MainContent_txtComisionTarjeta").val('');
       $('#MainContent_ddlVendedor').val(CodEmpleado);
       $('#MainContent_txtKM').val('');
       $('#MainContent_chkNotaVentaANTIGUA').prop('checked', false);
       $("#MainContent_txtUsuarioPrecio").val('');
                ...
                {                  
                    ...
                    $('#lblGrillaConsulta').text(F_Numerar_Grilla("grvConsulta",'lblnumero')); 
                     ...
                     $('#MainContent_grvConsulta .detallesart').each(function () {
                        ...
                        var hfCodDocNC=fila.replace("lblnumero","hfCodDocNC");  
                        var lblnumero=fila.replace("lblnumero","lblnumero");                                     
                        
                         if($(hfCodDocNC).val()>0){
                            $(lblnumero).css("color","blue");
                        }
                    });       
...
function F_EditarRegistro(Fila) {
 ...
 try 
    ...
    F_DatosFactura_NET(arg, function (result) {
                    ...
                    //$('#MainContent_ddlSerieGuiaEdicion').text(result.split('~')[10]);
                    if (result.split('~')[10] !='')
                    ...
                    if ($(hfCodTipoDoc).val() == "16")
                        ...
                        {
                        if ( result.split('~')[10].substring(0, 1)=="T" ){
                                 $('#MainContent_ddlSerieGuiaEdicion').prop('disabled',true);
                                 $('#MainContent_txtNumeroGuiaEdicion').prop('disabled',true);
                                 $('#MainContent_txtFechaTrasladoEdicion').prop('disabled',true);
                                 $('#MainContent_txtDestinoEdicion').prop('disabled',true);
                        ...
                        F_LlenarGridDetalleEdicion(imgID,result.split('~')[39]);
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var Motorizado = 0; if ($('#MainContent_chkMotorizadoEdicion').is(':checked')) {Motorizado = 1; };
...
var arrDetalle = new Array();
    ...
    var objParams = {
                      ...
                      Filtro_Bulto:$('#MainContent_txtNuBultosEdicion').val(),
...
function F_ImprimirGuia(Fila,TipoDoc) {
    var imgID = Fila.id;
...
function F_ImprimirFacturaGrilla(Fila) {
        var imgID = Fila.id;
        var lblCodigo = '#' + imgID.replace('imgPdf', 'lblCodigo');     
        var lblEstado = '#' + imgID.replace('imgPdf', 'lblestado');  
        ...
        F_ImprimirFactura($(lblCodigo).val());
        return false;
}
...
function F_ActualizarPrecio(Fila) {
    try {
        ...
        var hfCosto = txtPrecio.replace('txtPrecio', 'hfCosto');
        var FlagIgv = 0;
       ...
       if (parseInt($(hfCodTipoDoc).val())==16 & parseFloat($(txtPrecio).val())!=parseFloat($(hfPrecio).val()) )
            ...
            if (parseFloat($(hfCosto).val())>=parseFloat($(txtPrecio).val()))
            {
             $(txtPrecio).val(parseFloat($(hfPrecio).val()).toFixed(2));
             alertify.log("EL PRECIO NO PUEDE SER MENOR O IGUAL COSTO");              
             return false;
            }
...
//        }
        ...
        var objParams = {
            ...
            Filtro_Precio2: PrecioLimite / tasaigv,      
...
function F_ActualizarCantidad(Fila) {
    try {
        ...
        var hfLimiteMayorista = txtCantidad.replace('txtCantidad', 'hfLimiteMayorista');
        var hfCantidadMayorista = txtCantidad.replace('txtCantidad', 'hfCantidadMayorista');
        var hfPrecioMayorista = txtCantidad.replace('txtCantidad', 'hfP3');
        var hfPrecio1 = txtCantidad.replace('txtCantidad', 'hfP1');
...
function F_AgregarTemporalNV() {
    try {
        ...
        $('#MainContent_grvDetalleNV .chkDelete :checkbox').each(function () {
            ...
            hfPlaca = chkSi.replace('chkEliminar', 'hfPlaca');
            hfFlagGuia = chkSi.replace('chkEliminar', 'hfFlagGuia');
            hfRuctransportista = chkSi.replace('chkEliminar', 'hfRuctransportista');
            hfMarca = chkSi.replace('chkEliminar', 'hfMarca');
            hfLicencia = chkSi.replace('chkEliminar', 'hfLicencia');
            hfBultos = chkSi.replace('chkEliminar', 'hfBultos');
            hfPeso = chkSi.replace('chkEliminar', 'hfPeso');
            hfRucConductor = chkSi.replace('chkEliminar', 'hfRucConductor');
    ...
    $.ajax({
        ...
        success: function (dbObject) {
            ...
            $('#MainContent_ddlMoneda').val(data.CodMoneda);
              ...
              if (data.FlagConCodigo==1)
                  $('#MainContent_chkConCodigo').prop('checked', true);   
              else
                  $('#MainContent_chkConCodigo').prop('checked', false);  
        ...
        var tasaigv = parseFloat($("#MainContent_ddlIgv option:selected").text()) + parseFloat(1);
                    ...
                    $.each(data.lProformaDet, function (index, item) {
                        var objDetalle = {
                            ...
                            Exclusivo: item.Exclusivo / tasaigv,
                            Costo: 0,
...
if (!F_SesionRedireccionar(AppSession)) return false;
    ...
    $.each(AlmacenesDeudasClientes, function (index, item) {
        $("#" + item.conexionAlmacen).text( "S./ 0,00" );
    });
...
//        if ($(Cuerpo + 'txtClienteEditar').val().trim()==''  | $('#hfCodCtaCteEdicion').val()== 0)
//            Cadena=Cadena + '<p></p>' + 'CLIENTE';
...
function F_Inicializar_TextBox()
{
    ...
    $("#MainContent_txtProductoEdicion").css('background', '#FFFFE0');
  ...
  //  $("#MainContent_txtComisionTarjeta").ForceNumericOnly();

    forceNumber($('#MainContent_txtComisionTarjeta'));
}
...
function F_ChequearTodo(objRef) {
    var checkallid = '#' + objRef.id;
...
function F_ValidarPrecioExclusivo() {
    try {
        ...
        $('#MainContent_grvDetalleArticulo .chkDelete :checkbox').each(function () {
            ...
            hfP2 = chkSi.replace('chkEliminar', 'hfP2');
            hfP3 = chkSi.replace('chkEliminar', 'hfP3');

            Minimo = parseFloat($(hfP1).val());

            if (parseFloat($(hfP2).val())>0)
                Minimo = parseFloat($(hfP2).val());

            if (parseFloat($(hfP3).val())>0)
                Minimo = parseFloat($(hfP3).val());
             
            if (parseFloat($(hfExclusivo).val()) > 0 & parseFloat($(hfExclusivo).val()) < parseFloat (Minimo))
                Valor=true;
         });
...
function F_VisualizarGuia(codigo,Fila,TipoImp,Codtipo) {

if (codigo == undefined) {
    var imgID = Fila.id;
    var lblCodigo = '#' + imgID.replace('imgPdf3', 'hfCodTraslado');
    var lblEstado = '#' + imgID.replace('imgPdf3', 'lblestado');
    codigo=$(lblCodigo).val()
   }
    ...
    rptURL = rptURL + 'TipoArchivo=' + TipoArchivo + '&';
    rptURL = rptURL + 'TipoImp=' + TipoImp + '&';
    rptURL = rptURL + 'CodTipoFormato=' + Codtipo + '&';
    rptURL = rptURL + 'Codigo=' + codigo + '&' ;
...
function F_AbrirPanelDevolucion() {
  ...
  var lblnumero='';
                ...
                if ($(chkDel).is(':checked') && c==0) {
                    hfcodigo = chkDel.replace('chkEliminar', 'lblCodigo');
                    lblnumero = chkDel.replace('chkEliminar', 'lblnumero');
                    lblcliente = chkDel.replace('chkEliminar', 'lblcliente');
                Hfgv =  chkDel.replace('chkEliminar', 'hfDetalleCargado');
                    c =c+ 1;
                }
                else{
                 alertify.log("Solo se puede Hacer Devolucion de 1 Factura " );
                return false;
                }
        ...
        var arg = Sys.Serialization.JavaScriptSerializer.serialize(objParams);
        MostrarEspera(true);
               F_LlenarGridDevolucion_NET(arg, function (result) { 
               ...
               var str_resultado_operacion = result.split('~')[0];
                        ...
                        if (str_resultado_operacion === "0")
                        {
                           ...
                           $('#div_Devolucion').dialog({
                    resizable: false,
                    modal: true,
                    title: "Factura para Devolucion",
                    title_html: true,
                    height: 500,
                    width: 1000,
                    autoOpen: false
                         ...
                         $('.ccsestilo').css('background', '#FFFFE0');
                         F_Update_Division_HTML('div_DevolucionDetalle', result.split('~')[2]);
                         
                         $('#MainContent_lblFacturaDevolucion').text($(lblnumero).text());
                         $('#MainContent_lblClienteDevolucion').text($(lblcliente).text());
                         
                $('#MainContent_lblcantidadDevolucion').text(F_Numerar_Grilla("grvDetalleDevolcion", "lblNumero"));
                         $('.ccsestilo').css('background', '#FFFFE0');
                         $('#div_Devolucion').dialog('open');
                        MostrarEspera(false);
                        }
                        else
                        {
...
function F_ValidarStockGrillaDevolucion(ControlID) {
    ...
    if (boolEstado &&  parseFloat($(txtcantidad_Grilla).val()) > parseFloat($(lblstock).text())) {
            alertify.log("Cantidad insuficiente");
            $(txtcantidad_Grilla).val($(lblstock).text());
            F_MostrarTotales();
            return false;
    }
 ...
 function F_ValidarCheck_Devolucion(ControlID) {
...
function F_AgregarDevolucion() {
    ...
    try {
        ...
        var FlagIgv = 0;
            ...
            $('#MainContent_grvDetalleDevolcion .chkDelete :checkbox').each(function () {
                
               chkSi = '#' + this.id;
            hfCodDetalle = chkSi.replace('chkEliminar', 'hfCodDetalle');
            hfCantidad = chkSi.replace('chkEliminar', 'txtCantidadEntregada');
            if ($(chkSi).is(':checked')) {
                var objDetalle = {
                    CodDetalle: $(hfCodDetalle).val(),
                    Cantidad: $(hfCantidad).val()
                };
                arrDetalle.push(objDetalle);
            }
        ...
        //MostrarEspera(true);
        AgregandoProducto = true;
        F_AgregarDevolucion_NET(arg, function (result) {
        AgregandoProducto = false;
            //MostrarEspera(false);
...
function F_ImprimirDocumentonc(codigo, Fila, rplc, TipoImp, TipoDoc) {
//    if (F_PermisoOpcion(CodigoMenu, 4000602, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac

    var nrodoc = '';
    if (codigo == undefined) {
        var imgID = Fila.id;
        var lblCodigo = '#' + imgID.replace(rplc, 'hfCodDocNC');
        var lblNumero = '#' + imgID.replace(rplc, 'hfNumeroNC');
        codigo = $(lblCodigo).val();
        nrodoc = $(lblNumero).val();
        TipoDoc = 3;
    }
    else {
...
$('#MainContent_grvDetalleArticulo .chkDelete :checkbox').each(function () {
                         var chkDel = '#' + this.id;
                        var txtPrecio = chkDel.replace("chkEliminar", "txtPrecio");
                        var lblCodigo = chkDel.replace("chkEliminar", "lblCodigo");
                        var txtDescripcion = chkDel.replace("chkEliminar", "txtDescripcion");
                        var txtCantidad = chkDel.replace("chkEliminar", "txtCantidad");
                        var hfP1 = chkDel.replace("chkEliminar", "hfP1");
                        var hfP2 = chkDel.replace('chkEliminar', 'hfP2');
                        var hfP3 = chkDel.replace('chkEliminar', 'hfP3');
                        var hfExclusivo = chkDel.replace('chkEliminar', 'hfExclusivo');
                        ...
                        if(parseFloat(PrecioLimite) != parseFloat($(hfP3).val())  & parseFloat($(hfCantidad).val())>=parseFloat($(hfCantidadMayorista).val()) && parseFloat($(txtPrecio).val())>=parseFloat($(hfP3).val()) & parseFloat($(hfP3).val())> 0)
                            return false;
...
ContadorPrecioMinimo=0;
 $('#MainContent_grvDetalleArticulo .chkDelete :checkbox').each(function () {
               ...
               hfCantidadMayorista = chkDel.replace('chkEliminar', 'hfCantidadMayorista');
               hfLimiteMayorista = chkDel.replace('chkEliminar', 'hfLimiteMayorista');
               hfStock = chkDel.replace('chkEliminar', 'hfStock');
               hfCantidad = chkDel.replace('chkEliminar', 'hfCantidad');
      ...
      if(parseFloat($(hfCantidad).val())>=parseFloat( $(hfCantidadMayorista).val()) && parseFloat( $(txtPrecio).val())==parseFloat( $(hfP3).val()))
                 {
                  return false;
                 }
        ...
        if (parseFloat($(hfExclusivo).val())>0)
            PrecioLimite = $(hfExclusivo).val();
               ...
               {                     
                     ...
                     if (parseFloat($(txtPrecio).val()) == parseFloat($(hfP3).val()) & parseFloat($(hfP3).val()) > 0 & parseFloat($(hfP3).val()) >= PrecioLimite & parseFloat($(hfCantidad).val())<parseFloat($(hfCantidadMayorista).val()) & C==0)
                     {
                          if (UsuarioIniciado_PermisoCambioPrecios === '0' & PermisoCambio == false &  F_VerificarTipoCliente() == false) 
                          {
                               $("#MainContent_txtUsuarioPrecio").val('');
               ...
               else
               {
                     ...
                     if (parseFloat($(txtPrecio).val()) == parseFloat($(hfP3).val()) & parseFloat($(hfP3).val()) > 0 & parseFloat($(hfP3).val()) >= PrecioLimite & parseFloat($(hfCantidad).val())<parseFloat($(hfCantidadMayorista).val()) & Flag == 0  & C==0)
                     {
                          if (UsuarioIniciado_PermisoCambioPrecios === '0' & PermisoCambio == false &  F_VerificarTipoCliente() == false) 
                          {
                               $("#MainContent_txtUsuarioPrecio").val('');
...
function F_ReporteComision() {
    if (F_PermisoOpcion(CodigoMenu, 4000212, '') === "0") return false; 
   
    var rptURL = '';
    var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
    var TipoArchivo = 'application/pdf';
    var CodMenu = 409;
    var NombreArchivo = 'Web_Reporte_Ventas_rptComision.rpt';
    var NombreTabla = 'COMISION';
    var Titulo = 'REPORTE COMISIONES';
    ...
    rptURL = rptURL + 'CodMotivo=' + 3 + '&';
    rptURL = rptURL + 'CodTipoDoc=' + 13 + '&';
    rptURL = rptURL + 'TipoArchivo=' + TipoArchivo + '&';
    rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
    rptURL = rptURL + 'NombreTabla=' + NombreTabla + '&';
...
function F_Imprimir (Fila, rplc, TipoImp, TipoDoc){

   var codigo; var nrodoc = ''; TipoDoc = '1';
    var imgID = Fila.id;
    var Guia = '#' + imgID.replace(rplc, 'hfCodTraslado');
    var Codigo = '#' + imgID.replace(rplc, 'lblCodigo');
    var lblGuia = '#' + imgID.replace(rplc, 'lblGuia');

    if ($(Guia).val() == 0 | $(lblGuia).text().substring(0,1)!='T')
    {
        F_VistaPreliminar(Fila);
        return false;
    }
 ...
 if ($('#MainContent_chkFactura').is(':checked')){
           ...
           F_VistaPreliminar(Fila)
            ...
            F_ImprimirFacturaHTML(Fila, rplc, TipoImp, TipoDoc)
           }
...
function F_ImprimirFacturaHTML(Fila, rplc, TipoImp, TipoDoc) {
    var codigo; var nrodoc = ''; TipoDoc = '1';
    var imgID = Fila.id;
    var Guia = '#' + imgID.replace(rplc, 'hfCodTraslado');
    var Codigo = '#' + imgID.replace(rplc, 'lblCodigo');
...
return false;
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '../Servicios/PDF.asmx/F_Facturas_Guia_Lote2_PDF',
        data: "{'Codigos':'" + $(Codigo).val() + "','Guia':'" + $(Guia).val() + "','TipoImp':'" + TipoImp + "'}",
        dataType: "json",
        async: true,
        success: function (data) {
