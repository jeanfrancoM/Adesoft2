<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroCotizacionesReeim.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesReeim.js" charset="UTF-8"></script>       
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtAtencion" runat="server" Width="292px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        Referencia
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold;">
                                                        <asp:CheckBox ID="chkConCodigo" runat="server" Text="Con Codigo" Checked="True" Font-Bold="True" />
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDescuentoTotal" runat="server" Width="40px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True" Text="0.00"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                     <asp:Button ID="btnDescuentoTotal" runat="server" Text=">" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                                        Font-Names="Arial" Font-Bold="True" Width="40" />
                                                    </td>
                                                    <td style="font-weight: bold;">
                                                        SubTotal
                                                    </td>
                                                    ...
                                                    <td style="font-weight: bold; display: none; padding-left: 16px">
                                                        CORREO
                                                    </td>
                                                    <td style="display: none;">
                                                    ...
                                                    <td style="display: none;">
                                                        <asp:CheckBox ID="chkImpresionTicket" runat="server" Text="Imprim" Checked="False"
                                                            Font-Bold="True" />
                                                    </td>
                                                    <td style="font-weight: bold; display: none">
                                                        vcto
                            ...
                            <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="UM" HeaderText="UM">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblPrecioOriginal" Text='<%# Bind("PrecioOriginal") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Importe">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblImporte" Text='<%# Bind("ImporteReeim") %>' CssClass="detallesart"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgReemplazar" ImageUrl="~/Asset/images/Reemplazo.png"
                                                ToolTip="MODIFICAR COTIZACION" OnClientClick="F_ReemplazarDocumento2(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Numero" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfFlagConCodigo" runat="server" Value='<%# Bind("FlagConCodigo") %>' />
