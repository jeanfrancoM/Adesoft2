<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroCotizacionesSalcedo.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesSalcedo" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesSalcedo.js"   charset="UTF-8"></script>     
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDistrito" runat="server" Width="330px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                                    ...
                                                    <td id="tdftNormal">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td id="tdddlSerie"style="font-weight: bold; padding-left: 4px">
                                                                    <div id="div_serie">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <tr>
                                        <td>
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="915px" Font-Names="Arial" ForeColor="Blue"
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtClienteConsulta" runat="server" Width="250" Font-Names="Arial"
                                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                            </td>
                                            <td style="font-weight: bold">
                                                VEND.
