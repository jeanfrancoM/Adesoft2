<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroCotizacionesConvergente.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionesConvergente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionesConvergente.js"   charset="UTF-8"></script>     
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold;">
                                                        <asp:CheckBox runat="server" ID="chkSinIgvMaestro" Text="SIN Igv" onclick="F_ValidarCheckSinIgvMaestro(this.id);"
                                                            Checked="True" Font-Bold="True" Enabled="False" />
                                                    </td>
                                                    <td>
                                 ...
                                 <%--   <asp:TemplateField HeaderText="">
                                    ...
                                    <asp:TemplateField HeaderText="Moneda">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="SubTotal" HeaderText="Total" HeaderStyle-HorizontalAlign="Right">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                <%--            <asp:BoundField DataField="Igv" HeaderText="Igv" HeaderStyle-HorizontalAlign="Right">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style ="padding-left:20px;">
                                         <asp:TextBox ID="txtDescuentoProducto" runat="server" Width="100px" Font-Names="Arial"
                                                CssClass="Derecha" ForeColor="Blue" Font-Bold="True" Font-Size="16"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
