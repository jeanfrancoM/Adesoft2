...
{
    public partial class RegistroOrdenPedidoKlc : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_Actualizar_Tiempo_NET);
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    ...
                    dta_consultaarticulo.Columns.Add("ValorVenta", typeof(string));
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_OrdenPedidoDet_Select_Detalle(objEntidad);
                grvDetalle.DataBind();
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlTiempoProducto_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, 
                                        ref ddlEstado, ref ddlVendedor,ref ddlEmpleadoConsulta,ref ddlTiempoProducto);
                ...
                str_ddlTiempoProducto_html = Mod_Utilitario.F_GetHtmlForControl(ddlTiempoProducto);
        ...
        public String F_Actualizar_Tiempo_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_Actualizar_Tiempo(obj_parametros, ref MsgError);
                Codigo = Convert.ToInt32(obj_parametros["Filtro_CodigoTemporal"]);
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref NotaPedido);
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Detalle();
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_TiempoProducto)
        {
            ...
            objEntidadConceptosDet.CodConcepto = 30;
                   
            dta_consulta = null;
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);

            ddl_TiempoProducto.Items.Clear();
            
            ddl_TiempoProducto.DataSource = dta_consulta;
            ddl_TiempoProducto.DataTextField = "DscAbvConcepto";
            ddl_TiempoProducto.DataValueField = "CodConcepto";
            ddl_TiempoProducto.DataBind();
        }
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("PrecioNormal", typeof(string));
            dta_consultadetalle.Columns.Add("Descuento", typeof(string));
            dta_consultadetalle.Columns.Add("Comentario", typeof(string));
            dta_consultadetalle.Columns.Add("ComentarioProducto", typeof(string));
            dta_consultadetalle.Columns.Add("TiempoProducto", typeof(string));
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " Comentario = '" + item.Comentario + "'";
                XmlDetalle = XmlDetalle + " CodTiempoProducto = '" + item.CodTiempoProducto + "'";
                XmlDetalle = XmlDetalle + " TiempoProducto = '" + item.TiempoProducto + "'";
                XmlDetalle = XmlDetalle + " Descuento = '" + item.Descuento + "'";
                XmlDetalle = XmlDetalle + " />";
            }

            XmlDetalle = "<R><XmlLC> " + XmlDetalle.Replace("&", "&amp;").Replace("”", "&quot;").Replace(",", "&apos;") + "</XmlLC></R>";
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadProforma.CorreoAtencion = Convert.ToString(objTablaFiltro["Filtro_CorreoAtencion"]);
            objEntidadProforma.LugarEntrega = Convert.ToString(objTablaFiltro["Filtro_LugarEntrega"]);
            objEntidadProforma.TiempoEntrega = Convert.ToString(objTablaFiltro["Filtro_TiempoEntrega"]);    
            if (objEntidadProforma.CodProformaAnterior > 0)
            {
                objEntidadProforma.NumeroAnterior = objEntidadProforma.Numero;
                objOperacionProforma.F_OrdenPedidoCab_Insert_Edicion(objEntidadProforma);
            }
            else
            {
                objOperacionProforma.F_OrdenPedidoCab_Insert(objEntidadProforma);
            }
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            dta_consulta = objOperacion.F_OrdenPedidoCab_Select(objEntidad);
        ...
        public void P_AnularRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_OrdenPedidoCab_Anulacion(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_Actualizar_Tiempo(Hashtable objTablaFiltro, ref String MsgError)
        {
            DocumentoVentaDetCE objEntidad = null;
            DocumentoVentaDetCN objOperacion = null;
            ...
            objEntidad.TiempoProducto = Convert.ToString(objTablaFiltro["Filtro_TiempoProducto"]);

            objOperacion = new DocumentoVentaDetCN();

            objOperacion.F_TemporalFacturacionDet_Actualizar_TIEMPO(objEntidad);
