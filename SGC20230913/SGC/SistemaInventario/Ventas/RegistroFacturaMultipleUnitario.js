var AppSession = "../Ventas/RegistroFacturaMultipleUnitario.aspx";
...
//                        
//                        if ($(Cuerpo + 'txtNuBultos').val().trim()=='')
//                        Cadena=Cadena + '<p></p>' + 'Numero de Bultos';

//                 if ($(Cuerpo + 'txtPeso').val().trim()=='')
...
////                            if(result.split('~')[4]!=0){
////                            F_VisualizarGuia(result.split('~')[4],p1, ti, 1);
////                            }
...
function F_VistaPreliminarGR(Fila) {

//if (F_PermisoOpcion(CodigoMenu, 4000205, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
  var imgID = Fila.id;
        var hfCodTraslado = '#' + imgID.replace('imgPdf3', 'hfCodTraslado');
        var rptURL = '';
        var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
        var TipoArchivo = 'application/pdf';
        var CodMenu = 106;
        ...
        rptURL = rptURL + '?';
        rptURL = rptURL + 'CodMenu=' + CodMenu + '&';
        rptURL = rptURL + 'Codigo=' + $(hfCodTraslado).val()  + '&';
        rptURL = rptURL + 'TipoArchivo=' + TipoArchivo + '&';
        rptURL = rptURL + 'NombreArchivo=' + NombreArchivo + '&';
        rptURL = rptURL + 'NombreTabla=' + NombreTabla + '&';
...
//function F_ImprimirFactura(Fila) {
//        var imgID = Fila.id;
//        var lblCodigo = '#' + imgID.replace('imgPdf', 'lblCodigo');
//        var rptURL = '';
//        var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
...
//            Cadena=Cadena + '<p></p>' + 'DESTINO';
//     
//           if ($('#MainContent_chkGuiaEdicion').prop('checked') && $('#MainContent_txtNuBultosEdicion').val().trim() == "")
//            Cadena=Cadena + '<p></p>' + 'NUMERO BULTOS';

//                  if ($('#MainContent_chkGuiaEdicion').prop('checked') && $('#MainContent_txtPesoEdicion').val().trim() == "")
//            Cadena=Cadena + '<p></p>' + 'PESO';
