<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="RegistroCotizaciones.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizaciones" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizaciones.js"   charset="UTF-8"></script>     
                                                    ...
                                                    <td id="tdftNormal">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td id="tdddlSerie"  style="padding-left: 4px">
                                                                    <div id="div_serie">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold; padding-left: 13px">
                                                        total
                                                    </td>
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                     ...
                                     <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Código">
                                                ...
                                                <asp:HiddenField ID="hfExclusivoEdicion" runat="server" Value='<%# Bind("ExclusivoEdicion") %>' />
                    ...
                    <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 698px";
                        ...
                        <div class="ui-jqdialog-content" style="width: 700px">
                            ...
                            <td colspan='2'>
                              ...
                              <label id="lblEdicionProducto" style="font-size: medium; font-variant: inherit; font-weight: bold;"></label>
                                        
                            <asp:CheckBox ID="chkProductoNuevo" runat="server" Text="Producto Nuevo" Font-Bold="True" Font-Size="Medium" />
                            </td>
                            </tr>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtExclusivoEdicion" runat="server" Width="70px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                    ...
                                    <td colspan='5'>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 17px;">
                                                    <asp:TextBox ID="txtLimiteEdicion" runat="server" Width="60px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True" CssClass="Derecha"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                  ...
                                  <tr style=" display: none">
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtCodigo1Edicion" runat="server" Width="244px" Font-Names="Arial"
                                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                                </td>
                                                <td style="font-weight: bold">
                                                    Codigo 2
