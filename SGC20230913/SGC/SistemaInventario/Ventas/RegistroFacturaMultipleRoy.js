var AppSession = "../Ventas/RegistroFacturaMultipleRoy.aspx";
        ...
        {        
            ...
            var Cadena = 'Ingresar los sgtes. Datos:'; 
             ...
             if ($(Cuerpo + 'chkGuia').is(':checked')) {
                 ...
                 if ($(Cuerpo + 'txtDestino').val()=='')
                       ...
                       if (($(Cuerpo + 'txtNuBultos').val() == "" | $(Cuerpo + 'txtNuBultos').val() == '0') && ($("#MainContent_ddlSerieGuia option:selected").text().substr(0, 1) == 'T'))
                    Cadena = Cadena + '<p></p>' + 'Nro. Bultos';   

                    
                    if (($(Cuerpo + 'txtPeso').val() == "" | $(Cuerpo + 'txtPeso').val() == '0') && ($("#MainContent_ddlSerieGuia option:selected").text().substr(0, 1) == 'T'))
           ...
           if (!F_ValidarCorreo($(Cuerpo + 'txtCorreo').val()))
            Cadena = Cadena + '<p></p>' + 'Correo';
             ...
             if   (($('#MainContent_chkGuia').prop('checked') && $('#MainContent_ddlTipoDoc').val() == 16 )) /*$('#MainContent_chkGuia').prop('checked', true)) && $("#MainContent_ddlSerieGuia option:selected").text().substr(0, 1) == 'T') */
            Cadena=Cadena + '<p></p>' + 'LA NOTA DE VENTA NO PUEDE TENER GUIA';                 
...
function F_EditarRegistro(Fila) {
 ...
 try 
    ...
    F_DatosFactura_NET(arg, function (result) {
                    ...
                    $('#hfDireccionTransportistaEdicion').val(result.split('~')[14]);
                    $('#hfCodTransportistaEdicion').val(result.split('~')[15]);
                    $('#MainContent_txtTransportistaEdicion').val(result.split('~')[16]);
                    $('#MainContent_txtNroRucTransportistaEdicion').val(result.split('~')[16].split('-')[0].trim());
                    $('#hfDireccionFacturaEditar').val(result.split('~')[17]);
                    $('#hfCodDireccionTransportistaEdicion').val(result.split('~')[18]);
                    ...
                    if (result.split('~')[29] == '') { $('#MainContent_txtNuBultosEdicion').val('0');}
                    ...
                    if (result.split('~')[10].substring(0, 1)==="T" && result.split('~')[9] != 0){
...
function F_GuardarCambiosFactura() {
 try 
    ...
    var objParams = {
                      ...
                      Filtro_DireccionTraslado: $('#MainContent_txtDireccionTransladoEdicion').val(),
...
//if (F_PermisoOpcion(CodigoMenu, 4000205, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
  var imgID = Fila.id;
        ...
        if ($(hfCodTraslado).val() == '0' | $(hfCodTraslado).val()  == '') {
        alertify.log("NO HAY DOCUMENTO A MOSTRAR");
        return false;
        }
        var rptURL = '';
        var Params = 'width=' + (screen.width * 0.48) + ', height=' + (screen.height * 0.40) + ', top=0, left=0, directories=no, menubar=no, toolbar=no, location=no, resizable=yes, scrollbars=yes, titlebar=yes';
...
function F_ValidarEdicionFactura() {
        ...
        if ($(Cuerpo + 'chkGuiaEdicion').is(':checked') && $('#MainContent_txtNumeroGuiaEdicion').val().trim() == "")
            Cadena=Cadena + '<p></p>' + 'NUMERO GUIA';

        if ($(Cuerpo + 'chkGuiaEdicion').is(':checked') && $('#MainContent_txtDestinoEdicion').val().trim() == "")
            Cadena=Cadena + '<p></p>' + 'DESTINO';
     
  if ($(Cuerpo + 'chkGuiaEdicion').is(':checked') && $('#MainContent_ddlTipoDoc2').val() == 16 )/*&&  $("#MainContent_ddlSerieGuiaEdicion option:selected").text().substr(0, 1) == 'T')*/
            Cadena=Cadena + '<p></p>' + 'LA NOTA DE VENTA NO PUEDE TENER GUIA';  

        if (($(Cuerpo + 'chkGuiaEdicion').is(':checked') && $('#MainContent_txtNuBultosEdicion').val().trim() == "" &&  $("#MainContent_ddlSerieGuiaEdicion option:selected").text().substr(0, 1) == 'T')  | 
        ($('#MainContent_chkGuiaEdicion').prop('checked') && $('#MainContent_txtNuBultosEdicion').val() == 0 &&  $("#MainContent_ddlSerieGuiaEdicion option:selected").text().substr(0, 1) == 'T')  )
         ...
         if    (($(Cuerpo + 'chkGuiaEdicion').is(':checked') && $('#MainContent_txtPesoEdicion').val().trim() == "" &&  $("#MainContent_ddlSerieGuiaEdicion option:selected").text().substr(0, 1) == 'T' ) | 
