...
{
    public partial class RegistroCotizacionVehicular : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_AplicarPlanTemporal_NET);
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                objEntidad.CodProforma = Codigo; objEntidad.CodTipoDoc = CodTipoDoc;
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv,
                                        ref ddlEstado, ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlTipoUso);
                P_Obtener_TipoCambio(obj_parametros, ref TC);
                P_LlenarGrillaVacia_Detalle();
                P_Inicializar_GrillaVacia_Articulo();

                str_ddl_TipoUso_html = Mod_Utilitario.F_GetHtmlForControl(ddlTipoUso);
        ...
        public String F_AplicarPlanTemporal_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            {
                obj_parametros = SistemaInventario.Clases.JsonSerializer.FromJson<Hashtable>(arg);
                P_AplicarPlanTemporal(obj_parametros, ref Codigo, ref MsgError);
                P_CargarGrillaTemporal(obj_parametros, Codigo, ref grvDetalleArticulo, ref SubTotal, ref Igv, ref Total, ref Acuenta, ref NotaPedido);
                str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleArticulo);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
            ...
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_TipoUso)
        {
            ...
            ddl_TipoUso.Items.Clear();

            ddl_TipoUso.DataSource = dta_consulta;
            ddl_TipoUso.DataTextField = "DscAbvConcepto";
            ddl_TipoUso.DataValueField = "CodConcepto";
            ddl_TipoUso.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Articulo()
        {
            ...
            dta_consultaarticulo.Columns.Add("PlanMantenimiento", typeof(string));
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("PlanMantenimiento", typeof(string));
        ...
        public void P_AplicarPlanTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            DocumentoVentaCabCE objEntidad = null;
            ...
            objEntidad.Kilometros = Convert.ToInt32(objTablaFiltro["Filtro_Kilometros"]);
            objEntidad.CodVehiculo = Convert.ToInt32(objTablaFiltro["Filtro_CodVehiculo"]);

            
            if (Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]) == 0)
            {
                objOperacion.F_AplicarPlanMantenimientoDet(objEntidad);
                Codigo = objEntidad.CodDocumentoVenta;
            }
            else
            {
                objEntidad.CodDocumentoVenta = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
                objOperacion.F_AplicarPlanMantenimientoDetalle(objEntidad);
                Codigo = Convert.ToInt32(objTablaFiltro["Filtro_CodigoTemporal"]);
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            objEntidadProforma.CodEmpresa = 3;
            ...
            objEntidadProforma.FechaIngreso = Convert.ToDateTime(objTablaFiltro["Filtro_FechaIngreso"]);
            ...
            objEntidadProforma.FechaSalida = Convert.ToDateTime(objTablaFiltro["Filtro_FechaSalida"]);
            ...
            objEntidadProforma.Kilometraje = Convert.ToDecimal(objTablaFiltro["Filtro_Kilometraje"]);
            objEntidadProforma.CodVehiculo = Convert.ToInt32(objTablaFiltro["Filtro_CodVehiculo"]);
            objEntidadProforma.Horometro = Convert.ToDecimal(objTablaFiltro["Filtro_Horometro"]);

            objEntidadProforma.CodTipoMantenimiento = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoMantenimiento"]);
            

            if (objEntidadProforma.CodProformaAnterior > 0)
            {
                objEntidadProforma.NumeroAnterior = objEntidadProforma.Numero;
                objOperacionProforma.F_ProformasVehicular_Insert_Edicion_Tractos(objEntidadProforma);
            }
            else
            {
                objOperacionProforma.F_ProformasVehicular_Insert_Tractos(objEntidadProforma);
            }
