...
{
    public partial class RegistroFacturaMultipleCosmetica : System.Web.UI.Page
    {
        ...
        protected void grvDetalleArticulo_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    HiddenField hfCodGratuito = null;
                    TextBox txtDescripcion = null;
                    TextBox txtCantidad = null;
                    TextBox txtPrecio = null;
                    HyperLink lblCodigo = null;
                    Label lblimporte = null;
                    Label lblUM = null;

                    lblCodigo = (HyperLink)(e.Row.FindControl("lblCodigo"));
                    lblimporte = (Label)(e.Row.FindControl("lblimporte"));
                    lblUM = (Label)(e.Row.FindControl("lblUM"));
                    txtDescripcion = (TextBox)(e.Row.FindControl("txtDescripcion"));
                    txtCantidad = (TextBox)(e.Row.FindControl("txtCantidad"));
                    txtPrecio = (TextBox)(e.Row.FindControl("txtPrecio"));
                    hfCodGratuito = (HiddenField)(e.Row.FindControl("hfCodGratuito"));  

                    if (Convert.ToInt32(hfCodGratuito.Value) == 1)
                    {
                        lblCodigo.ForeColor = System.Drawing.Color.Blue;
                        lblimporte.ForeColor = System.Drawing.Color.Black;
                        lblUM.ForeColor = System.Drawing.Color.Black;
                        txtDescripcion.ForeColor = System.Drawing.Color.Blue;
                        txtCantidad.ForeColor = System.Drawing.Color.Blue;
                        txtPrecio.ForeColor = System.Drawing.Color.Blue;             
                    }
                    else
                    {                      
                        lblCodigo.ForeColor = System.Drawing.Color.Red;
                        lblimporte.ForeColor = System.Drawing.Color.Red;
                        lblUM.ForeColor = System.Drawing.Color.Red;
                        txtDescripcion.ForeColor = System.Drawing.Color.Red;
                        txtCantidad.ForeColor = System.Drawing.Color.Red;
                        txtPrecio.ForeColor = System.Drawing.Color.Red;  
                    }                  
                }
            }
            catch (Exception exx) { }
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable, ref CodCtaCte);
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " CodGratuito = '" + item.CodGratuito + "'";
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref String OrdenCompra, ref String Recepcion, ref Int32 FlagComisionable, ref Int32 CodCtaCte)
