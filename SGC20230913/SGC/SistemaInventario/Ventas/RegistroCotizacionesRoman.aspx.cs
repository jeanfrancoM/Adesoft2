...
{
    public partial class RegistroCotizacionesRoman : System.Web.UI.Page
    {
        ...
        public String F_LlenarGridDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_ProformaDet_Listar_ROMAN(objEntidad);
                grvDetalle.DataBind();
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref String NumeroDoc)
        {
            ...
            if (objEntidadProforma.CodProformaAnterior > 0)
            {
                ...
                objOperacionProforma.F_Proformas_Insert_Edicion_Roman(objEntidadProforma);
            }
            else
            {
                objOperacionProforma.F_Proformas_Insert_Roman(objEntidadProforma);
            }
