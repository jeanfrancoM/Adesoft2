...
{
    public partial class RegistroFacturaMultipleOmar : System.Web.UI.Page
    {
                    ...
                    if (objEntidad.FlagFacturaANTIGUA == 0)
                    {
                            if (objEntidad.NotaPedido == 0)
                            {
                                if (objEntidad.FlagNotaVentaANTIGUA == 0)
                                    ...
                                    objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA(objEntidad); //Insert NV ANTIGUA
                            }
                            else //Insert con NOTAPEDIDO NOTA VENTA, COTIZACION
                                objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad);
                    }
                    else
                        objOperacion.F_DocumentoVentaCab_Insert_Factura_NONV_NVANTIGUA(objEntidad); //FACTURA ANTIGUA
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public void P_DatosFactura(Hashtable objTablaFiltro, ref String Emision, ref String Vencimiento,
                            ...
                            ref Int32 CodTraslado, ref String SerieGuia, ref String NumeroGuia, ref String Fecha,
                            ref String Destino, ref String DireccionTrans,
                            ref Int32 CodTransportista, ref String Transportista, ref String DireccionFactura,
                            ref Int32 CodDireccionTransportista, ref String KM)
        {
