<%@ Page Title="COTIZACION" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroCotizacionVehicular.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroCotizacionVehicular" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroCotizacionVehicular.js"   charset="UTF-8"></script>     
        ...
        <tr valign="top">
            <td style="width: 1100px" valign="top">
                <div class="titulo" style="width: 1045px">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="REGISTRO DE COTIZACIONES VEHICULAR" Font-Bold="False"
                ...
                <div id="divTabs" style="width: 1045px">
                    ...
                    <div id="tabRegistro">
                        <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                 <td>
                                                        <asp:TextBox ID="txtPlaca" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                 ...
                                                 <td style="font-weight: bold">
                                                    ...
                                                    <td id="div_Cliente">
                                                     ...
                                                     <td style="font-weight: bold;">
                                                      ...
                                                      <td>
                                                      <div id="div_TipoCotizacionVehiculo">
                                                                        <asp:DropDownList ID="ddlTipoUso" Width="90" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                                            Font-Bold="True">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </td>
                                                    ...
                                                    <td >
                                                        <asp:TextBox ID="txtColor" runat="server" Width="90px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"  ReadOnly="true"  ></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td >
                                                        <asp:TextBox ID="txtAnio" runat="server" Width="35px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"  ReadOnly="true"  ></asp:TextBox>
                                                    </td>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td style ="padding-left:3px;">
                                                        <asp:TextBox ID="txtKM" runat="server" Width="65px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                     ...
                                                     <td style ="padding-left:3px;">
                                                        <asp:TextBox ID="txtHorometro" runat="server" Width="70px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                       <td style="font-weight: bold;">
                                                        Ingreso
                            ...
                            <asp:Button ID="btnPlan" runat="server" Text="Aplicar Plan (F1)" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CodigoProducto" HeaderText="Código">
                                     ...
                                     <asp:TemplateField HeaderText="Plan">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblPlan" Text='<%# Bind("PlanMantenimiento") %>' CssClass="detallesart"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-weight: bold;">
                                <asp:CheckBox ID="chkServicios" runat="server" Text="MANUAL" Font-Bold="True" />
                            </td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
    ...
    <input id="hfFlagRuc" type="hidden" value="0" />
     ...
     <input id="hfPlaca" type="hidden" value="0" />
      <input id="hfCodTipoPlan" type="hidden" value="0" />
       <input id="hfCodCliente" type="hidden" value="0" />
