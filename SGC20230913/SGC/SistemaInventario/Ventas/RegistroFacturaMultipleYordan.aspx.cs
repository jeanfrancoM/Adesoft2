...
{
    public partial class RegistroFacturaMultipleYordan : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_SoloActualizarDetalle_NET);

        }

        private string _menu = "4000"; private string _opcion = "2";
        public bool PermisoVerCosto = false;
        public bool PermisoVerStock = false;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Utilitarios.Menu.F_ValidarPermisoOpcion(4000, 777003, "") == "1")
                PermisoVerStock = true;
        ...
        protected void grvDetalleArticulo_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HiddenField lblCodigo = (HiddenField)(e.Row.FindControl("hfCodDetalle"));
                HiddenField hfSolicitudDescuento = (HiddenField)(e.Row.FindControl("hfSolicitudDescuento"));
                HiddenField hfCodUsuarioSolicitudDescuento = (HiddenField)(e.Row.FindControl("hfCodUsuarioSolicitudDescuento"));
                HiddenField hfDescuentoAprobado = (HiddenField)(e.Row.FindControl("hfDescuentoAprobado"));

                ImageButton ImgPermiso = (ImageButton)(e.Row.FindControl("imgPermiso"));

                ImgPermiso.Visible = false;

                if (lblCodigo.Value != "")
                {
                    if (Convert.ToInt32(hfSolicitudDescuento.Value) > 0)
                    {
                        ImgPermiso.Visible = true;
                        ImgPermiso.ImageUrl = "../Asset/images/Circle_Yellow.png";
                        ImgPermiso.ToolTip = "PRESIONE PARA SOLICITAR DESCUENTO AL ENCARGADO";
                        if (Convert.ToInt32(hfCodUsuarioSolicitudDescuento.Value) > 0)
                        {
                            if (Convert.ToInt32(hfDescuentoAprobado.Value) == 1)
                            {
                                ImgPermiso.ImageUrl = "../Asset/images/Circle_Green.png";
                                ImgPermiso.ToolTip = "APROBADO";
                            }

                            if (Convert.ToInt32(hfDescuentoAprobado.Value) == 2)
                            {
                                ImgPermiso.ImageUrl = "../Asset/images/Circle_Red.png";
                                ImgPermiso.ToolTip = "RECHAZADO";
                            }

                            if (Convert.ToInt32(hfDescuentoAprobado.Value) == 3)
                            {
                                ImgPermiso.ImageUrl = "../Asset/images/btnEdit.gif";
                                ImgPermiso.ToolTip = "EDITADO POR EL SUPERVISOR";
                            }
                        }
                        else {
                            ImgPermiso.ImageUrl = "../Asset/images/Circle_Yellow.png";
        ...
        public String F_SoloActualizarDetalle_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_grvDetalleArticulo_html = "";
            ...
            try
            {
                ...
                if (grvDetalleArticulo.Rows.Count == 0)
                    P_Inicializar_GrillaVacia_Detalle(); //P_Inicializar_GrillaVacia_DetalleArticulo();
                str_grvDetalleArticulo_html = Mod_Utilitario.F_GetHtmlForControl(grvDetalleArticulo);
                str_mensaje_operacion = "Actualizado, si aun aparece el boton es porque no han aprobado";
                int_resultado_operacion = 1;
            }
            catch (Exception ex)
            {
        ...
        public String F_DatosFactura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_DatosFactura(obj_parametros, ref Emision, ref Vencimiento, ref FormaPago, ref Placa1, ref Placa2, ref Placa3, ref Placa4,
                                               ...
                                               ref KM, ref OrdenCompra, ref Recepcion, ref FlagComisionable);
        ...
        public void P_Inicializar_GrillaVacia_Detalle()
        {
            ...
            dta_consultadetalle.Columns.Add("DescuentoAprobado", typeof(string));
            dta_consultadetalle.Columns.Add("SolicitudDescuento", typeof(string));
            dta_consultadetalle.Columns.Add("CodUsuarioSolicitudDescuento", typeof(string));
            dta_consultadetalle.Columns.Add("UsuarioSolicitudDescuento", typeof(string));
        ...
        public void P_ActualizarPrecios(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.SolicitudDescuento = Convert.ToInt32(objTablaFiltro["Filtro_SolicitarDescuento"]);

            objOperacion = new DocumentoVentaDetCN();

            objOperacion.F_TemporalFacturacionDet_Update_Yordan(objEntidad);
