<%@ Page Title="Nota de Credito-Venta" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="RegistroNotaDebitoAra.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroNotaDebitoAra" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroNotaDebitoAra.js"        charset="UTF-8"></script> 
