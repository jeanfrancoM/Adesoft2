<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleRoy.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleRoy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleRoy.js" charset="UTF-8"></script>       
                                    ...
                                    <asp:TemplateField HeaderText="IMP">
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgPdf" ImageUrl="~/Asset/images/imprimir.gif"
                                                ToolTip="Imprimir Factura" OnClientClick="F_ImprimirFactura(this); return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                                    ...
                                                    Conductor
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtConductorRazonSocialEdicion" runat="server" Width="357px" Font-Names="Arial"
                                                                    ForeColor="Blue" Font-Bold="True"  ReadOnly="true"   placeholder="NOMBRE CONDUCTOR"></asp:TextBox>
                                                            </td>
