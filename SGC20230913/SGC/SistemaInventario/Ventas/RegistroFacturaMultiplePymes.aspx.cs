...
{
    public partial class RegistroFacturaMultiplePymes : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                                        ref ddlTipoDoc, ref ddlTipoDoc2, ref CantidadPlacas, ref ddlEstado, ref ddlFormaPagoEdicion, ref ddlSerieGuiaEdicion,
                                        ref ddlVendedor, ref ddlEmpleadoConsulta, ref ddlVendedorEdicion, ref ddlCajaFisica);
                P_Obtener_TipoCambio(obj_parametros, ref TC);
                P_Obtener_TipoDoc(obj_parametros, ref tipodoc);
            ...
            str_resultado =
                ...
                tipodoc.ToString() + "~" +//28
                str_ddlCajaFisica_html + "~" + //29
                 Session["CodEmpresa"].ToString(); //30
        ...
        public String F_Series_Documentos_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Series_Documentos(obj_parametros, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combofactura, ref DropDownList ddl_combofacturaconsulta,
            ...
            ref String Direccion, ref DropDownList ddl_tipodoc, ref DropDownList ddl_tipodoc2, ref Int32 CantidadPlacas, 
            ref DropDownList ddl_comboestado, ref DropDownList ddl_comboformapagoedicion, ref DropDownList ddl_comboguiaedicion,
            ref DropDownList ddl_empleado, ref DropDownList ddl_empleadoconsulta, ref DropDownList ddl_VendedorEdicion, ref DropDownList ddl_CajaFisica)
        {
        ...
        public void P_Series_Documentos(Hashtable objTablaFiltro, ref DropDownList ddl_serie, ref DropDownList ddl_serieconsulta,
                                        ref DropDownList ddl_serieguia)
        {
            TCCorrelativoCE objEntidad = null;
            TCCorrelativoCN objOperacion = null;
            DataTable dta_consulta = null;
        ...
        public void P_Obtener_TipoDoc(Hashtable objTablaFiltro, ref Int32 TipoDocPyme)
        {
            ...
            dta_consulta = objOperacion.F_tipodoc_Select(objEntidad);

            TipoDocPyme = Convert.ToInt32(dta_consulta.Rows[0]["TipoDocPyme"]);
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref Int32 CodigoGuia)
        {
            ...
            switch (objEntidad.CodTipoDoc)
            {
                case 16: //Nota de Venta
                    objOperacion.F_DocumentoVentaCab_Insert_NV_OC_Alvarado(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_Factura_NV(objEntidad); //objOperacion.F_DocumentoVentaCab_Insert_NP_OC(objEntidad);
    ...
    ref String Cliente, ref String NumeroDoc, ref Int32 CodProformaAnterior, ref Int32 FlagConCodigo)
        ...
        public int TipoDocPyme { get; set; }
    }
}
