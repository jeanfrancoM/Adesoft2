<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMultiplePOVIS.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultiplePOVIS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultiplePOVIS.js"  charset="UTF-8"></script>      
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                ...
                                                <td style="font-weight: bold; padding-left: 2px">
                                                    ...
                                                    <td style="">
                                                        <asp:TextBox ID="txtObservacion" runat="server" Width="910" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                        </td>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfDescuentoPorcMax" runat="server" Value='<%# Bind("DescuentoPorcMax") %>' />
                                             <asp:HiddenField ID="hfCodMarca" runat="server" Value='<%# Bind("CodMarcaProducto") %>' />
                                              <asp:HiddenField ID="hfIDFami" runat="server" Value='<%# Bind("IDFamilia") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <div id="div5">
                                                <asp:DropDownList ID="ddlTipoBusquedaArticulo" runat="server" Font-Names="Arial"
                                                    ...
                                                    <asp:ListItem Value="1" Selected="True">Descripcion</asp:ListItem>
                                                    <asp:ListItem Value="2">Marca y Modelo</asp:ListItem>
