<%@ Page Title="REG. VENTA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="RegistroFacturaMultipleReeim.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMultipleReeim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMultipleReeim.js"  charset="UTF-8"></script>      
                                ...
                                <table cellpadding="0" cellspacing="0" class="form-inputs" width="750">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPlaca" runat="server" Width="82px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtTotal" runat="server" Width="85px" Font-Names="Arial" ForeColor="Blue"
                                                            CssClass="Derecha" Font-Bold="True" ReadOnly="True" Text="0.00"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtNroOC" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                            Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td style="font-weight: bold">
                                                        Cotizacion
                                      ...
                                      <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox ID="txtObservacion" runat="server" Width="926px" Font-Names="Arial"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Descripcion" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfPrecio" runat="server" Value='<%# Bind("PrecioDscto") %>' />
                                            ...
                                            <asp:HiddenField ID="hfPrecioNormal" runat="server" Value='<%# Bind("Precio") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Valor Venta" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtPrecio" Width="75px" Font-Bold="true" Style="text-align: center;"
                                                CssClass="ccsestilo" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("PrecioDscto") %>'
                                    ...
                                    <asp:TemplateField HeaderText="Importe">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblImporte" Text='<%# Bind("ImporteReeim") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                                    ...
                                    <asp:TemplateField HeaderText="IMP">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton runat="server" ID="imgDSP" ImageUrl="~/Asset/images/texto.png" ToolTip="IMPRIMIR DESPACHO"
                                                OnClientClick="F_ImprimirDespachoFila(this);  return false;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <asp:Panel ID="pnlOrdersAuditoria" runat="server" Style="display: none">
                                            ...
                                            <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Precio" HeaderText="Valor Venta">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="Numero" HeaderStyle-HorizontalAlign="Center">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblnumero" Text='<%# Bind("Numero") %>' CssClass="detallesart"/>
                                    ...
                                    <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Stock">
                                                <ItemStyle HorizontalAlign="Center" Width="50px" Font-Size="Medium" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblstock" Font-Size="Medium"  Text='<%# Bind("Stock") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Pre Min">
                                                <ItemStyle Width="64px"/>
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblPrecio" Font-Size="Medium"  Text='<%# Bind("Precio1") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                              <asp:TemplateField HeaderText="Pre Sug">
                                                <ItemStyle Width="64px"/>
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblPrecioSugerido" Font-Size="Medium"  Text='<%# Bind("Precio2") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td id="div_Placa1Editar" style="padding-left: 51px;">
