...
{
    public partial class TipoPlan : System.Web.UI.Page
    {
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consultaarticulo.Columns.Add("DscTipoPlan", typeof(string));
            dta_consultaarticulo.Columns.Add("Estado", typeof(string));
            dta_consultaarticulo.Columns.Add("Recorrido", typeof(string));
        ...
        {
            VehiculoTipoPlanCE objEntidad = null;
            VehiculoTipoPlanCN objOperacion = null;

            objEntidad = new VehiculoTipoPlanCE();

          
            objEntidad.CodEstado = Convert.ToInt32(objTablaFiltro["Filtro_CodEstado"]);
            objEntidad.CodUsuario = Convert.ToInt32(Session["CodUsuario"]);
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_DscTipoPlan"]);
            objEntidad.Recorrido = Convert.ToDecimal(objTablaFiltro["Filtro_Recorrido"]);

            objOperacion = new VehiculoTipoPlanCN();

            objOperacion.F_VehiculoTipoPlan_Insert(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objOperacion = new VehiculoTipoPlanCN();
            objEntidad = new VehiculoTipoPlanCE();
            objEntidad.Descripcion = Convert.ToString(objTablaFiltro["Filtro_DscFamilia"]);

            dta_consulta = objOperacion.F_VehiculoTipoPlan_Listado(objEntidad);
        ...
        public void P_EliminarRegistro(Hashtable objTablaFiltro, ref String Mensaje)
        {
            ...
            objOperacion.F_VehiculoTipoPlan_Delete(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_VehiculoTipoPlan_Update(objEntidad);
