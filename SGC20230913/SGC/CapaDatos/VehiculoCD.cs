            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.CommandText = "pa_VEHICULO_Insert";
                        ...
                        sql_comando.Parameters.Add("@CodUsuarioRegistro", SqlDbType.Int).Value = objEntidadBE.CodUsuarioRegistro;

                        if (objEntidadBE.CodVehiculoTipoPlan != 0)
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_Vehiculos_Listar";
