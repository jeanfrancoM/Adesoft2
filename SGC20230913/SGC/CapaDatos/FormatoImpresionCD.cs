...
namespace CapaDatos
{
    ...
    {
        public DataTable F_FormatoImpresion_Listar_X_CodTipoDoc(FormatoImpresionCE facturador)
        {
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.CommandText = "pa_FormatoImpresion_Listar_X_CodTipoDoc";

                        sql_comando.Parameters.Add("@CodTipoDoc", SqlDbType.Int).Value = facturador.CodTipoDoc;
                        sql_comando.Parameters.Add("@SerieDoc", SqlDbType.VarChar, 4).Value = facturador.SerieDoc;
        ...
        public DataTable F_FormatoImpresion_Listar_X_CodFormatoImpresion(int CodFormatoImpresion)
        {
            DataTable dta_consulta = null;
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "pa_FormatoImpresion_Listar_X_CodFormatoImpresion";
        ...
        public DataTable F_FormatoImpresion_Obtener_CodFormatoImpresion(int CodFormatoImpresion)
        {
            DataTable dta_consulta = null;
