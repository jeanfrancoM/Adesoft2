...
namespace CapaDatos
{
    public class UsuarioCD
    {
            ...
            try
            {
                ...
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Parameters.Add("@NombreUsuario", SqlDbType.VarChar, 160).Value = objEntidadBE.NombreUsuario;
        ...
        public DataTable F_UsuarioCopia_Listar_NET(int CodAlmacen, int CodEstado, string Usuario)
        {
