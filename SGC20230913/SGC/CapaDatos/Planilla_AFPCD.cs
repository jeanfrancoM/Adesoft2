...
namespace CapaDatos
{
    public class Planilla_AFPCD
    {
        public DataTable F_Planilla_AFP_Listar(Planilla_AFPCE objEntidadBE)
        {
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.CommandText = "pa_Planilla_AFP_Listar";
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "[pa_AFP_Insert]";
                        ...
                        SqlParameter CodAFP = sql_comando.Parameters.Add("@CodAFP", SqlDbType.Int);
                        CodAFP.Direction = ParameterDirection.Output;


                        sql_comando.ExecuteNonQuery();

                        objEntidadBE.MsgError = MsgError.Value.ToString();
                        objEntidadBE.CodAFP = Convert.ToInt32(CodAFP.Value.ToString());
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "[pa_AFP_Update]";
            ...
            try
            {
                using (SqlConnection sql_conexion = new SqlConnection())
                {
                    ...
                    using (SqlCommand sql_comando = new SqlCommand())
                    {
                        ...
                        sql_comando.Connection = sql_conexion;
                        sql_comando.CommandType = CommandType.StoredProcedure;
                        sql_comando.CommandText = "[pa_AFP_Eliminar]";
